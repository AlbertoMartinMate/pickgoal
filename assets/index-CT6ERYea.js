(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Ze="https://pickgoal-backend.onrender.com/api";function Qe(){return localStorage.getItem("token")}async function m(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Qe();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Ze}${e}`,{cache:"no-store",...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const c={get:e=>m(e),post:(e,a)=>m(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>m(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>m(e,{method:"DELETE"}),auth:{register:e=>m("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>m("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>m("/auth/me"),forgotPassword:e=>m("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>m("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>m(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>m("/auth/account",{method:"DELETE"}),users:()=>m("/auth/users"),usersForMentions:()=>m("/auth/users/for-mentions"),toggleAdmin:e=>m(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>m(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>m("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>m("/matches/grouped"),list:(e="")=>m(`/matches/${e}`),get:e=>m(`/matches/${e}`),today:()=>m("/matches/today"),setResult:(e,a,t,s=null)=>m(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>m("/matches/sync",{method:"POST"}),recalculate:()=>m("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>m(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>m(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>m("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>m(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>m(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>m("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>m("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>m("/leagues/all"),public:()=>m("/leagues/public"),my:()=>m("/leagues/my"),create:e=>m("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>m("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>m(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>m("/leagues/admin"),get:e=>m(`/leagues/${e}`),update:(e,a)=>m(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>m(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>m(`/leagues/${e}/members`),matchPredictions:(e,a)=>m(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>m("/home/summary")},board:{messages:(e=1,a=null)=>m(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>m(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>m("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>m(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>m(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>m(`/board/${e}`,{method:"DELETE"}),mentions:e=>m(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>m("/notifications/vapid-public-key"),subscribe:e=>m("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>m("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:(e,a,t)=>m(`/v2/admin/partidos-disponibles?date_from=${encodeURIComponent(e)}&date_to=${encodeURIComponent(a)}${t&&t.length?`&competitions=${encodeURIComponent(t.join(","))}`:""}`),jornadas:()=>m("/v2/admin/jornadas"),createJornada:e=>m("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>m(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>m(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>m(`/v2/admin/jornada/${e}/publish`,{method:"POST"}),closeJornada:e=>m(`/v2/admin/jornada/${e}/close`,{method:"POST"}),jornadaMatches:e=>m(`/v2/admin/jornada/${e}/matches`),setResultado:(e,a)=>m(`/v2/admin/jornada-match/${e}/resultado`,{method:"POST",body:JSON.stringify(a)}),cancelMatch:e=>m(`/v2/admin/jornada-match/${e}/cancel`,{method:"POST"}),addManualMatch:(e,a)=>m(`/v2/admin/jornada/${e}/match/manual`,{method:"POST",body:JSON.stringify(a)}),deleteManualMatch:e=>m(`/v2/admin/jornada-match/${e}`,{method:"DELETE"}),generateBots:()=>m("/v2/admin/bots/generate",{method:"POST"}),weeklyChecklist:()=>m("/v2/admin/weekly-checklist")},jornada:{info:()=>m("/v2/jornada/info"),current:()=>m("/v2/jornada/current"),list:()=>m("/v2/jornada/list"),predict:e=>m("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>m("/v2/jornada/history"),myStats:()=>m("/v2/jornada/my-stats")},duelo:{list:()=>m("/v2/duelo/list"),current:e=>m(`/v2/duelo/current${e?`?jornada_id=${e}`:""}`),detail:e=>m(`/v2/duelo/current/detail${e?`?jornada_id=${e}`:""}`)},messages:{unread:()=>m("/messages/unread"),list:()=>m("/messages/"),get:e=>m(`/messages/${e}`),send:(e,a)=>m(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>m("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>m(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>m("/v2/clasificacion/general"),allDivisions:()=>m("/v2/clasificacion/all-divisions")}};let H=null;const E={async init(){if(localStorage.getItem("token"))try{const{user:a}=await c.auth.me();H=a}catch{localStorage.removeItem("token")}},setUser(e,a){H=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){H=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return H},isLoggedIn(){return!!H},isAdmin(){return(H==null?void 0:H.is_admin)===!0}};let le=null;function _(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,le&&clearTimeout(le),le=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function ea(){return`
  ...
  `}function oa(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function He(e=null,a=!1){let t,s;if(a&&(e!=null&&e.jornada_number))s="Temporada 26/27 · En curso",t=`
  ...
  `}function ra(e){const a=e.next_to_predict?`<div class="league-card__next">
      ...
      <div class="container">
        ...
        ${i&&!o&&d.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${d.leagues.map(v=>$e(v,!0)).join("")}</div>
          </section>
        `:""}
  ...
  `}const Ne={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga",DED:"🇳🇱 Eredivisie",ELC:"🇪🇸 LaLiga 2",CDR:"🇪🇸 Copa del Rey",UNL:"🌍 UEFA Nations League",EC2024:"🌍 Eliminatorias Europa",CLI:"🌎 Amistosos internacionales",BSA:"🇧🇷 Brasileirao",MLS:"🇺🇸 MLS"},Oe=[{key:"principales",label:"📌 Principales",expandable:!1,defaultChecked:!0,codes:["PD","PL","CL"]},{key:"europa",label:"🌍 Europa",expandable:!0,defaultChecked:!1,codes:["BL1","SA","FL1","PPL","DED"]},{key:"espana",label:"🇪🇸 España",expandable:!0,defaultChecked:!1,codes:["ELC","CDR"]},{key:"selecciones",label:"🌎 Selecciones",expandable:!0,defaultChecked:!1,codes:["UNL","EC2024","CLI"]},{key:"otras",label:"⚽ Otras ligas",expandable:!0,defaultChecked:!1,codes:["BSA","MLS"]}];let T=[],ne=null;async function W(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await c.adminV2.jornadas();a.innerHTML=Ca(t),Pa(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Ca(e){return`
    <div class="jv2-panel">
  ...
  `}function Ba(){return Oe.map(e=>{const a=e.codes.map(s=>`<span class="jv2-comp-filter-chip">${Ne[s]||s}</span>`).join(""),t=`
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await c.auth.resetPassword(t,o),_("Contraseña actualizada. Ya puedes iniciar sesión."),S.navigate("/login")}catch(r){i.textContent=r.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function Ja(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!E.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),S.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await c.leagues.joinByCode(t);_(`¡Te has unido a "${s.name}"!`),S.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){_("Ya eres miembro de esta liga");try{const{leagues:n}=await c.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){S.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function za(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ga(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=za(),{user:n,predictions:i}=await c.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const G=20,Fe=5;let P={},R=0,ue=null,je=null,ee=[];async function Xa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await c.jornada.list();if(!a.length){e.innerHTML=Wa();return}Je(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Je(e,a,t){var l,h;je=a[t];const{jornada:s,matches:n,units_used:i}=je;P={};for(const v of n)P[v.jornada_match_id]={predicted_result:((l=v.prediction)==null?void 0:l.predicted_result)??null,units:((h=v.prediction)==null?void 0:h.units_wagered)??0};R=i;const o=n.filter(v=>!v.predict_locked);ee=o,ue=o.length===1?o[0].jornada_match_id:null;const r=s.status==="finished",d=a.length>1?`<div class="jornada-tabs">
  ...
  `,ze(),Ge(),_e(),tt(e,a,t),Q(e),requestAnimationFrame(()=>{var v;(v=e.querySelector(".jornada-tab--active"))==null||v.scrollIntoView({block:"nearest",inline:"center"})})}function Wa(){return`
    <div class="container">
  ...
  `}function te(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function Ka(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function ce(e){return e!=null?e.toFixed(2):"—"}function Ya(e){return e.jm_status==="cancelled"?'<span class="tag tag--cancelled">Suspendido</span>':e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${Ka(e.opens_until)}</span>`}const Za=new Set(["r32","r16","quarters","semis","third","final","no_draw"]);function Qa(e,a,t){const n={1:t.odds_1,X:t.odds_x,2:t.odds_2}[a];return n!=null?Math.round(e.units_wagered*parseFloat(n)*100)/100:e.points_earned??0}function et(e){if(e.jm_status==="cancelled")return"";const a=e.prediction;if(e.status==="finished"&&e.result_90!=null){if(!a)return'<span class="jornada-pts-label jornada-pts-label--penalty">-1 pt ⚠️</span>';if(a.predicted_result===e.result_90){const n=Qa(a,e.result_90,e);return`<span class="jornada-pts-label jornada-pts-label--win">+${L(n)} pts</span>`}return'<span class="jornada-pts-label jornada-pts-label--loss">0 pts</span>'}if(!a||!a.units_wagered)return"";const s=e.predict_locked;return`<span class="jornada-pts-label jornada-pts-label--${s?"live":"pending"}">${a.units_wagered}u${s?" en juego":" apostadas"}</span>`}function at(e){const a=e.jm_status==="cancelled",t=e.predict_locked,s=P[e.jornada_match_id]??{predicted_result:null,units:0},n=Za.has(e.phase);return`
  ...
  `}function ze(){const e=document.getElementById("unitsCounter");if(!e)return;const a=R>G;e.innerHTML=`
    <div class="units-counter__bar">
      <div class="units-counter__fill ${a?"units-counter__fill--over":""}" style="width:${Math.min(100,R/G*100)}%"></div>
    </div>
    <span class="units-counter__label ${a?"units-counter__label--over":""}">${R}/${G} unidades usadas</span>
  `}function Ge(){if(!ue)return;const e=document.getElementById(`warning-${ue}`);if(!e)return;const a=G-R;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function Le(){R=Object.values(P).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),ze(),Ge(),_e()}function tt(e,a,t){var s;e.querySelectorAll(".jornada-tab").forEach(n=>{n.addEventListener("click",()=>{const i=parseInt(n.dataset.idx);i!==t&&Je(e,a,i)})}),e.querySelectorAll(".jornada-match").forEach(n=>{const i=parseInt(n.dataset.jmId);n.querySelectorAll('input[type="radio"]').forEach(r=>{r.addEventListener("change",()=>{P[i].predicted_result=r.value,Le()})});const o=n.querySelector(".jornada-units__input");o==null||o.addEventListener("input",()=>{let r=parseInt(o.value);isNaN(r)&&(r=0),r=Math.max(0,Math.min(Fe,r)),P[i].units=r,Le()})}),(s=document.getElementById("jornadaSaveAllBtn"))==null||s.addEventListener("click",st)}function _e(){const e=document.getElementById("jornadaSaveAllBtn");if(!e)return;const a=ee.filter(s=>{var n;return(n=P[s.jornada_match_id])==null?void 0:n.predicted_result}).length,t=ee.length;e.textContent=`💾 Guardar predicciones (${a}/${t} predichos)`}async function st(){const e=ee.filter(i=>{var o;return!((o=P[i.jornada_match_id])!=null&&o.predicted_result)});if(e.length>0&&!confirm(`⚠️ Te quedan ${e.length} partido${e.length!==1?"s":""} sin predecir (−1 pt cada uno).

¿Guardar igualmente?`))return;if(R>G){_(`Superas el máximo de ${G} unidades`,"error");return}const a=ee.filter(i=>{var o;return(o=P[i.jornada_match_id])==null?void 0:o.predicted_result});if(!a.length){_("No hay predicciones que guardar","error");return}const t=document.getElementById("jornadaSaveAllBtn");t&&(t.disabled=!0,t.textContent="Guardando…");const n=(await Promise.allSettled(a.map(i=>c.jornada.predict({jornada_match_id:i.jornada_match_id,predicted_result:P[i.jornada_match_id].predicted_result,units:P[i.jornada_match_id].units})))).filter(i=>i.status==="rejected").length;n===0?_(`${a.length} predicción${a.length!==1?"es":""} guardadas ✓`):_(`${n} error${n!==1?"es":""} al guardar`,"error"),t&&(t.disabled=!1,_e())}let se=null;function ge(){se&&(clearInterval(se),se=null)}const ke={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}},nt={ganado:"🏆 Victoria",perdido:"💔 Derrota",empate:"🤝 Empate"};function Se(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}async function it(e){ge(),e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const[{duelos:a},t]=await Promise.all([c.duelo.list(),Promise.resolve(E.getUser())]);if(!a.length){e.innerHTML=`
        <div class="container">
      ...
      <button class="jornada-tab ${r===n?"jornada-tab--active":""}" data-idx="${r}">
        J${o.jornada_number} · ${Se(o.jornada_date_start)}–${Se(o.jornada_date_end)}
      </button>
    `).join("");e.innerHTML=`
      <div class="container">
        <div class="page-title-row">
    ...
    `,Q(e),requestAnimationFrame(()=>{var o;(o=e.querySelector(".jornada-tab--active"))==null||o.scrollIntoView({block:"nearest",inline:"center"})}),e.querySelectorAll(".jornada-tab").forEach(o=>{o.addEventListener("click",()=>{e.querySelectorAll(".jornada-tab").forEach(r=>r.classList.remove("jornada-tab--active")),o.classList.add("jornada-tab--active"),Ie(e,a[parseInt(o.dataset.idx)],t)})}),await Ie(e,a[n],t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando duelos: ${a.message}</p></div>`}}async function Ie(e,a,t){var i;ge();const s=e.querySelector("#dueloContent");if(!s)return;s.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const n=a.jornada_status==="active"||a.jornada_status==="upcoming";try{const{duelo:o}=await c.duelo.current(a.jornada_id);if(n){if(!o){s.innerHTML=dt();return}if(s.innerHTML=ot(o,t),Ce(s,o.division_league_id,t.id),!a.is_bye){const r=((i=a.rival)==null?void 0:i.username)??"—";xe(a.jornada_id,t.username,r),se=setInterval(()=>xe(a.jornada_id,t.username,r),6e4)}}else s.innerHTML=rt(a,o,t),Ce(s,a.division_league_id,t.id)}catch(o){s.innerHTML=`<p class="form__error">Error: ${o.message}</p>`}}function ot(e,a){var i;const t=ke[e.status]??ke.en_curso,s=e.rival?e.rival.username:a.username,n=!e.rival||e.rival.id===a.id;return`
  ...
  `}async function xe(e,a,t){const s=document.getElementById("dueloTracker");if(!s){ge();return}try{const{detail:n}=await c.duelo.detail(e);if(!n)return;s.innerHTML=lt(n,a,t)}catch{}}function lt(e,a,t){const{me:s,rival:n}=e;function i(o,r){return`
  ...
  `}function ct(e,a){var i;const t=(i=e.my_prediction)==null?void 0:i.predicted_result;let s,n;return e.started?e.rival_prediction?(s=e.rival_prediction.predicted_result,n=""):(s="—",n="duelo-pick__value--empty"):(s="?",n="duelo-pick__value--hidden"),`
  ...
  `}async function Ce(e,a,t){const s=e.querySelector("#divisionStandings");if(s)try{const{standings:n}=await c.clasificacion.division(a);if(!n.length){s.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}s.innerHTML=`
    ...
    `}catch(n){s.innerHTML=`<p class="form__error">Error cargando la clasificación: ${n.message}</p>`}}async function ut(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:t}=await c.clasificacion.general(),s=E.getUser();e.innerHTML=`
      <div class="container">
        <div class="page-title-row">
          <h1 class="page-title">Clasificación</h1>
          <button class="btn-info" id="btnPointsInfo" aria-label="Cómo funciona">ℹ️</button>
    ...
    `,pt(s,a.tab),Q(e),mt(),bt(e,s)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${t.message}</p></div>`}}async function mt(){const e=document.getElementById("tablonTabDot");if(!e)return;if(!E.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString();try{const{count:s}=await c.board.unread(null,t);console.log("[tablonDot] count:",s,"since:",t),e.classList.toggle("hidden",s===0)}catch(s){console.warn("[tablonDot] error:",s),e.classList.add("hidden")}}function pt(e,a){const t={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")},tablon:{btn:document.getElementById("tabTablon"),panel:document.getElementById("panelTablon")}};function s(i){for(const[o,{btn:r,panel:d}]of Object.entries(t))r.classList.toggle("league-tab--active",o===i),d.classList.toggle("hidden",o!==i)}t.general.btn.addEventListener("click",()=>s("general")),t.miDivision.btn.addEventListener("click",()=>{s("miDivision"),t.miDivision.panel.dataset.loaded||(t.miDivision.panel.dataset.loaded="1",vt(e))}),t.divisiones.btn.addEventListener("click",()=>{s("divisiones"),t.divisiones.panel.dataset.loaded||(t.divisiones.panel.dataset.loaded="1",_t(e))});function n(){var i;s("tablon"),localStorage.setItem("tablon_general_last_read",new Date().toISOString()),(i=document.getElementById("tablonTabDot"))==null||i.classList.add("hidden"),document.dispatchEvent(new CustomEvent("tablon:read")),t.tablon.panel.dataset.loaded||(t.tablon.panel.dataset.loaded="1",pe(t.tablon.panel,{forceGeneral:!0}))}t.tablon.btn.addEventListener("click",n),a==="tablon"&&n()}async function vt(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await c.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function _t(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await c.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>gt(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function gt(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
  ...
  `}function ie(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function bt(e,a){let t=document.getElementById("userCtxMenu");t||(t=document.createElement("div"),t.id="userCtxMenu",t.className="user-ctx-menu hidden",t.innerHTML=`
  ...
  `}async function Be(e,{params:a={}}={}){const t=a.userId?parseInt(a.userId):null;t?await yt(e,t):await ht(e)}async function ht(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{conversations:a}=await c.messages.list();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">💬 Mensajes</h1>
        ${a.length===0?'<p class="empty">No tienes conversaciones aún. Pulsa el nombre de un jugador en la clasificación para enviar un mensaje.</p>':`<div class="mensajes-list">${a.map(ft).join("")}</div>`}
      </div>
    `,e.querySelectorAll(".mensajes-item").forEach(t=>{t.addEventListener("click",()=>{window.location.hash=`/mensajes/${t.dataset.userId}`})})}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function ft(e){return`
  ...
  `}async function yt(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=E.getUser();try{const{messages:n,partner:i}=await c.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
      <div class="container">
  ...
  `}function K(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Pe=e=>()=>{window.location.hash=e},$t={"/":ta,"/login":la,"/register":ca,"/quiniela":Pe("/jornada"),"/resultados":Pe("/tabla-v2"),"/ranking":ma,"/tablon":pe,"/ligas":va,"/ligas/:id":ga,"/perfil":ha,"/campeon":ja,"/admin":La,"/forgot-password":Ua,"/reset-password":Fa,"/unirse":Ja,"/jugador/:id":Ga,"/jornada":Xa,"/duelo":it,"/tabla-v2":ut,"/mensajes":Be,"/mensajes/:userId":Be};function Et(e){for(const[a,t]of Object.entries($t)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,r)=>(s.push(r),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((r,d)=>{o[r]=i[d+1]}),{handler:t,params:o}}}return null}const Me=()=>document.getElementById("mainContent"),S={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=Et(a);if(!n){Me().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2","/mensajes"].includes(a)&&!E.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!E.isAdmin()){this.navigate("/");return}const d=Me();d.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(d,{params:o,query:s})}};let X=[],z=null,F=null,oe=!1;async function wt(){document.documentElement.dataset.build="2026-09-20T12",await E.init(),S.init(),kt(),jt(),xt()}function Xe(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function jt(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!Xe()&&(z=e,Lt())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),z=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function Lt(){if(Xe()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `}function J(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}wt();
