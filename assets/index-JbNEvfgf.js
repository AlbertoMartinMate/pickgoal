(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Ie="https://pickgoal-backend.onrender.com/api";function je(){return localStorage.getItem("token")}async function c(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=je();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Ie}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const u={get:e=>c(e),post:(e,a)=>c(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>c(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>c(e,{method:"DELETE"}),auth:{register:e=>c("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>c("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>c("/auth/me"),forgotPassword:e=>c("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>c("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>c(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>c("/auth/account",{method:"DELETE"}),users:()=>c("/auth/users"),toggleAdmin:e=>c(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>c("/matches/grouped"),list:(e="")=>c(`/matches/${e}`),get:e=>c(`/matches/${e}`),today:()=>c("/matches/today"),setResult:(e,a,t,s=null)=>c(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>c("/matches/sync",{method:"POST"}),recalculate:()=>c("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>c(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>c(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>c("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>c(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>c(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>c("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>c("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>c("/leagues/all"),public:()=>c("/leagues/public"),my:()=>c("/leagues/my"),create:e=>c("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>c("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>c(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>c("/leagues/admin"),get:e=>c(`/leagues/${e}`),update:(e,a)=>c(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>c(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>c(`/leagues/${e}/members`),matchPredictions:(e,a)=>c(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>c("/home/summary")},board:{messages:(e=1,a=null)=>c(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>c(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>c("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>c(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>c(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>c(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>c("/notifications/vapid-public-key"),subscribe:e=>c("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>c("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>c(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>c("/v2/admin/jornadas"),createJornada:e=>c("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>c(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>c(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>c(`/v2/admin/jornada/${e}/publish`,{method:"POST"})},jornada:{info:()=>c("/v2/jornada/info"),current:()=>c("/v2/jornada/current"),list:()=>c("/v2/jornada/list"),predict:e=>c("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>c("/v2/jornada/history")},duelo:{current:()=>c("/v2/duelo/current")},clasificacion:{division:e=>c(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>c("/v2/clasificacion/general"),allDivisions:()=>c("/v2/clasificacion/all-divisions")}};let P=null;const f={async init(){if(localStorage.getItem("token"))try{const{user:a}=await u.auth.me();P=a}catch{localStorage.removeItem("token")}},setUser(e,a){P=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){P=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return P},isLoggedIn(){return!!P},isAdmin(){return(P==null?void 0:P.is_admin)===!0}};let W=null;function p(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,W&&clearTimeout(W),W=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function ke(){return`
  ...
  `}function te(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function d(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",d),n==null||n.addEventListener("click",d),document.addEventListener("keydown",r=>{r.key==="Escape"&&d()},{once:!1}),i}function M(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function Se(e){if(!f.getUser()){Be(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await u.home.summary();if(s){e.innerHTML=`
        ...
        ${ae()}
      `,te(e);return}if(!t||t.length===0){xe(e);return}const i=(()=>{const r=localStorage.getItem("activeLeagueId");return r?parseInt(r):null})(),d=[...t].sort((r,m)=>r.league_id===i?-1:m.league_id===i?1:0);e.innerHTML=`
      <div class="home-dashboard container">
        <div class="home-dashboard__topbar">
          <button class="btn btn--ghost btn--sm" id="btnPointsInfo">📊 Sistema de puntos</button>
        </div>
      ...
      ${ae()}
    `,te(e),e.querySelectorAll(".league-card[data-league-id]").forEach(r=>{r.style.cursor="pointer",r.addEventListener("click",m=>{m.target.closest("[data-go-ranking]")||m.target.closest("a")||(localStorage.setItem("activeLeagueId",r.dataset.leagueId),$.navigate(`/ligas/${r.dataset.leagueId}`))})}),e.querySelectorAll("[data-go-ranking]").forEach(r=>{r.addEventListener("click",m=>{m.stopPropagation(),localStorage.setItem("activeLeagueId",r.dataset.goRanking),$.navigate("/ranking")})})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el inicio: ${t.message}</p></div>`}}async function Be(e){const t=new Date>=new Date("2026-08-15T00:00:00Z");let s=null;if(t)try{s=await u.jornada.info()}catch{}e.innerHTML=`
    <section class="hero">
  ...
  `}function Ce(e){const a={promotion:"⬆️ Zona ascenso",relegation:"⬇️ Zona descenso",mid:""},t=a[e.zone]?`<span class="div-card__zone div-card__zone--${e.zone}">${a[e.zone]}</span>`:"";return`
    <div class="div-card">
  ...
  `}function Te(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function pe(e=null,a=!1){let t,s;if(a&&(e!=null&&e.jornada_number))s="Temporada 26/27 · En curso",t=`
      ...
      </div>`;else if(a)s="Temporada 26/27 · En curso",t='<div class="pg-league-card__countdown pg-league-card__countdown--soon">Temporada en curso</div>';else{const n=Te("2026-08-15");s="Temporada 26/27 · Próximamente",t=n>0?`<div class="pg-league-card__countdown">
  ...
  `}function Pe(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `}const ne="pickgoal_welcome_shown";function ge(e="/jornada"){if(localStorage.getItem(ne))return;localStorage.setItem(ne,"1");const a=document.createElement("div");a.innerHTML=`
  ...
  `;const t=a.firstElementChild;document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("welcome-modal--open"));function s(n){t.classList.remove("welcome-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0}),n&&(window.location.hash=n)}document.getElementById("welcomeOverlay").addEventListener("click",()=>s()),document.getElementById("welcomeCta").addEventListener("click",()=>s(e)),document.addEventListener("keydown",function n(i){i.key==="Escape"&&(s(),document.removeEventListener("keydown",n))})}function De(e){e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:d}=await u.auth.register(n);f.setUser(d,i),p("¡Cuenta creada! Bienvenido a PickGoal");const r=sessionStorage.getItem("pendingInviteCode");if(r){sessionStorage.removeItem("pendingInviteCode");try{const{league:m}=await u.leagues.joinByCode(r);p(`¡Te has unido a "${m.name}"!`),$.navigate(`/ligas/${m.id}`)}catch{$.navigate("/ligas")}}else $.navigate("/"),ge("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function Ae(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ne(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(f.isLoggedIn()){const{leagues:g}=await u.leagues.my();if(g.length===0){e.innerHTML=ke();return}}const s=Ae(),[{ranking:n},i]=await Promise.all([u.auth.ranking(s),f.isLoggedIn()?u.leagues.my():Promise.resolve({leagues:[]})]),d=f.getUser(),r=i.leagues.find(g=>g.id===s),m=document.getElementById("tablonBadge"),b=m&&!m.classList.contains("hidden"),h=b?m.textContent:"",v=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        <div class="ranking-header">
          ...
          ${s?`
            <button class="ranking-tablon-btn" data-league-id="${s}">
              💬 Tablón
              <span class="ranking-tablon-btn__badge${b?"":" hidden"}">${h}</span>
            </button>
          `:""}
        </div>
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(g=>{var x,o,l;const _=g.predictions_made??0,E=`${_}/${v}`,S=`${g.correct_results??0}/${_}`,B=`${g.exact_scores??0}/${_}`;return`
                  <tr class="${d&&g.id===d.id?"ranking-table__row--me":""}">
                    ...
                    <td class="ranking-table__stat ranking-table__status">${((l=g.status)==null?void 0:l.name)||"—"}</td>
                    <td class="ranking-table__stat">${E}</td>
                    <td class="ranking-table__stat">${S}</td>
    ...
    `,(t=e.querySelector(".ranking-tablon-btn"))==null||t.addEventListener("click",()=>{$.navigate(`/tablon?liga=${s}`)})}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error: ${s.message}</p></div>`}}async function ve(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=f.getUser();let s=a.liga?parseInt(a.liga):null;if(s){localStorage.setItem(`tablon_last_read_${s}`,new Date().toISOString());const o=document.getElementById("tablonBadge");o&&(o.classList.add("hidden"),o.textContent="")}let n=null,i=[],d=1,r=1;try{if(!s&&t){const{leagues:o}=await u.leagues.my();o&&o.length&&(s=o[0].id,n=o[0].name)}else if(s)try{const{league:o}=await u.leagues.get(s);n=o.name}catch{}if(s&&t)try{const{members:o}=await u.leagues.members(s);i=o||[]}catch{}}catch{}async function m(){const o=await u.board.messages(d,s);return r=o.pages||1,o}try{const o=await m();b(o)}catch(o){e.innerHTML=`<div class="container"><p class="form__error">Error: ${o.message}</p></div>`}function b(o){const{pinned:l=[],messages:y=[]}=o;e.innerHTML=`
      <div class="container">
        ...
        <section class="board-section">
          ...
          ${r>1?`<div class="pagination">
                 <button class="btn btn--ghost btn--sm" id="prevPage" ${d<=1?"disabled":""}>← Anterior</button>
                 <span>Página ${d} / ${r}</span>
                 <button class="btn btn--ghost btn--sm" id="nextPage" ${d>=r?"disabled":""}>Siguiente →</button>
               </div>`:""}
        </section>
      </div>
    `,E(),S(),B()}function h(o){return o.length?o.map(l=>`
      <div class="board-message board-message--pinned" data-id="${l.id}">
        <div class="board-message__header">
          ...
          <strong class="board-message__author">${T(l.username)}</strong>
        ...
        <p class="board-message__text">${_(l.message)}</p>

        ${l.replies&&l.replies.length?`<div class="board-replies">
               ${l.replies.map(y=>v(y)).join("")}
             </div>`:""}
    ...
    `).join(""):""}function v(o){return`
      <div class="board-reply ${o.is_deleted?"board-reply--deleted":""}" data-id="${o.id}">
        <div class="board-reply__header">
          ...
          <span class="board-reply__date">${M(o.created_at)}</span>
          ${!o.is_deleted&&t&&(t.id===o.user_id||t.is_admin)?`<button class="btn btn--danger btn--xs delete-msg" data-id="${o.id}">✕</button>`:""}
        </div>
        <p class="board-reply__text">${_(o.message)}</p>
      </div>
    `}function g(o){return o.length?o.map(l=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function _(o){const l=T(o);if(!i.length)return l;const y=i.map(L=>Oe(L.username)),j=new RegExp(`@(${y.join("|")})`,"gi");return l.replace(j,'<span class="mention">@$1</span>')}function E(){const o=document.getElementById("boardForm");if(!o)return;const l=document.getElementById("boardMsg"),y=document.getElementById("charCounter"),j=document.getElementById("mentionDropdown");l.addEventListener("input",()=>{y.textContent=`${l.value.length} / 500`,x(l,j)}),o.addEventListener("submit",async L=>{L.preventDefault();const D=l.value.trim();if(D)try{await u.board.post(D,s),l.value="",y.textContent="0 / 500",j.classList.add("hidden");const C=await m();w(C),p("Mensaje publicado")}catch(C){p(C.message,"error")}})}function S(){e.querySelectorAll(".reply-form").forEach(o=>{const l=parseInt(o.dataset.parent),y=o.querySelector(".reply-input"),j=`mentionDropdown-${l}`,L=document.getElementById(j);y==null||y.addEventListener("input",()=>{x(y,L)}),o.addEventListener("submit",async D=>{D.preventDefault();const C=y.value.trim();if(C)try{await u.board.reply(l,C),y.value="",L==null||L.classList.add("hidden");const J=await m();w(J),p("Respuesta enviada")}catch(J){p(J.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(o=>{o.addEventListener("click",async()=>{try{await u.board.pin(o.dataset.id);const l=await m();w(l),p("Mensaje fijado")}catch(l){p(l.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(o=>{o.addEventListener("click",async()=>{try{await u.board.pin(o.dataset.id);const l=await m();w(l),p("Mensaje desfijado")}catch(l){p(l.message,"error")}})})}function B(){e.querySelectorAll(".delete-msg").forEach(o=>{o.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await u.board.delete(o.dataset.id);const l=await m();w(l),p("Mensaje eliminado")}catch(l){p(l.message,"error")}})})}function w(o){const{pinned:l=[],messages:y=[]}=o,j=document.getElementById("boardPinned");if(j)j.innerHTML=h(l);else if(l.length){b(o);return}const L=document.getElementById("boardMessages");L&&(L.innerHTML=g(y)),S(),B()}e.addEventListener("click",async o=>{if(o.target.id==="prevPage"&&d>1){d--;const l=await m();w(l)}else if(o.target.id==="nextPage"&&d<r){d++;const l=await m();w(l)}});function x(o,l){if(!l||!i.length)return;const y=o.value,j=o.selectionStart,L=y.slice(0,j),D=L.match(/@(\w*)$/);if(!D){l.classList.add("hidden");return}const C=D[1].toLowerCase(),J=i.filter(k=>k.username.toLowerCase().startsWith(C)&&k.id!==(t==null?void 0:t.id)),Q=[...f.isAdmin()&&"todos".startsWith(C)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...J.slice(0,6)];if(!Q.length){l.classList.add("hidden");return}l.innerHTML=Q.map(k=>k.description?`<div class="mention-item mention-item--broadcast" data-username="${T(k.username)}">
             <span class="mention-item__name">@${T(k.username)}</span>
             <span class="mention-item__desc">${T(k.description)}</span>
           </div>`:`<div class="mention-item" data-username="${T(k.username)}">${T(k.username)}</div>`).join(""),l.classList.remove("hidden"),l.querySelectorAll(".mention-item").forEach(k=>{k.addEventListener("mousedown",Le=>{Le.preventDefault();const we=k.dataset.username,V=L.replace(/@(\w*)$/,`@${we} `);if(o.value=V+y.slice(j),o.setSelectionRange(V.length,V.length),l.classList.add("hidden"),o.tagName==="TEXTAREA"){const ee=document.getElementById("charCounter");ee&&(ee.textContent=`${o.value.length} / 500`)}})})}document.addEventListener("click",o=>{!o.target.closest(".board-form__input-wrap")&&!o.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(l=>l.classList.add("hidden"))},{capture:!0})}function T(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Oe(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function qe(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=f.getUser(),d=i==null?void 0:i.is_admin,[r,m]=await Promise.all([d?u.leagues.adminAll():u.leagues.all(),f.isLoggedIn()&&!d?u.leagues.my():Promise.resolve({leagues:[]})]),b=new Set(m.leagues.map(v=>v.id)),h=d?r.leagues:r.leagues.filter(v=>!b.has(v.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!d&&m.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${m.leagues.map(v=>ie(v,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${h.length?`<div class="leagues-grid">${h.map(v=>ie(v,!1,b,d)).join("")}</div>`:d?'<p class="empty">No hay ligas creadas aún.</p>':m.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(v=>{v.addEventListener("click",()=>$.navigate(`/ligas/${v.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(v=>{v.addEventListener("click",async g=>{g.stopPropagation();const _=parseInt(v.dataset.id);v.disabled=!0,v.textContent="…";try{const{league:E}=await u.leagues.join({league_id:_});p(`¡Te has unido a "${E.name}"!`),$.navigate(`/ligas/${E.id}`)}catch(E){p(E.message,"error"),v.disabled=!1,v.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(v=>{v.addEventListener("click",g=>{g.stopPropagation(),p("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var v,g;(v=document.getElementById("createLeaguePanel"))==null||v.classList.remove("hidden"),(g=document.getElementById("btnShowCreate"))==null||g.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var v,g;(v=document.getElementById("createLeaguePanel"))==null||v.classList.add("hidden"),(g=document.getElementById("btnShowCreate"))==null||g.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async v=>{v.preventDefault();const g=document.getElementById("inviteCode").value.trim().toUpperCase();if(g)try{const{league:_}=await u.leagues.join({invite_code:g});p(`Te has unido a "${_.name}"`),$.navigate(`/ligas/${_.id}`)}catch(_){p(_.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async v=>{var x;v.preventDefault();const g=document.getElementById("createBtn");g.disabled=!0,g.textContent="Creando…";const _=document.getElementById("leagueName").value.trim(),E=document.getElementById("leagueDesc").value.trim(),S=document.getElementById("leaguePrize").value.trim(),B=document.getElementById("isPublic").checked,w=((x=document.getElementById("isOfficial"))==null?void 0:x.checked)??!1;try{const{league:o}=await u.leagues.create({name:_,description:E,prize:S,is_public:B,is_official:w});Ue(o)}catch(o){p(o.message,"error"),g.disabled=!1,g.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function ie(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",d=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `}function Ue(e){var s,n;const a=e.invite_link||"",t=document.getElementById("createLeaguePanel");t&&(t.innerHTML=`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),p("Enlace copiado")}catch{p("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function Je(e,{params:a}){var s,n,i,d,r;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const m=await u.leagues.get(t),{league:b,ranking:h,is_member:v,is_admin_view:g}=m,_=f.getUser(),E=b.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        <div class="league-header">
          <h1 class="page-title">${b.name} ${E}</h1>
          ${b.description?`<p class="league-header__desc">${b.description}</p>`:""}
          <div class="league-header__meta">
            <span>${b.is_public?"🌍 Pública":"🔒 Privada"}</span>
            <span>${b.member_count} participantes</span>
            ${b.prize?`<span>🏆 ${b.prize}</span>`:""}
          </div>
        </div>

        ${(v||_!=null&&_.is_admin)&&b.invite_link?`
          <div class="invite-share-box">
            <span class="invite-share-box__label">Enlace de invitación:</span>
            <div class="invite-link-box">
              <span class="invite-link-box__url">${b.invite_link}</span>
        ...
        <div class="league-actions">
          ${v?'<button class="btn btn--danger btn--sm" id="btnLeave">Abandonar liga</button>':!(_!=null&&_.is_admin)&&_?'<button class="btn btn--primary" id="btnJoin">Unirse a esta liga</button>':""}
          ${_!=null&&_.is_admin||v&&_&&b.created_by===_.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
        ...
        <section class="section" id="sectionRanking">
          <table class="ranking-table">
            ...
            <tbody>
              ${h.map(o=>`
                <tr class="${_&&o.id===_.id?"ranking-table__row--me":""}">
                  <td>${o.position}</td>
                  <td>${o.username}</td>
                  <td>${o.country||"—"}</td>
    ...
    `,(s=document.getElementById("btnCopyInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(b.invite_link),p("Enlace copiado")}catch{p("No se pudo copiar","error")}}),(n=document.getElementById("btnShareInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${b.name} en PickGoal`,url:b.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await u.leagues.leave(t),p("Has abandonado la liga"),$.navigate("/ligas")}catch(o){p(o.message,"error")}}),(d=document.getElementById("btnJoin"))==null||d.addEventListener("click",async()=>{try{await u.leagues.join({league_id:t}),p("¡Te has unido a la liga!"),$.navigate(`/ligas/${t}`)}catch(o){p(o.message,"error")}}),(r=document.getElementById("btnEditLeague"))==null||r.addEventListener("click",()=>{Re(b,t,_)});const S=document.getElementById("tabRanking"),B=document.getElementById("tabTablon"),w=document.getElementById("sectionRanking"),x=document.getElementById("sectionTablon");S&&B&&(S.addEventListener("click",()=>{S.classList.add("league-tab--active"),B.classList.remove("league-tab--active"),w.classList.remove("hidden"),x.classList.add("hidden")}),B.addEventListener("click",()=>{B.classList.add("league-tab--active"),S.classList.remove("league-tab--active"),w.classList.add("hidden"),x.classList.remove("hidden");const o=document.getElementById("tablonEmbed");o&&!o.dataset.loaded&&(o.dataset.loaded="1",ve(o,{query:{liga:String(t)}}))}))}catch(m){e.innerHTML=`<div class="container"><p class="form__error">Error: ${m.message}</p><a href="#/ligas">Volver</a></div>`}}function Re(e,a,t){const s=document.getElementById("editLeagueModal");s&&s.remove();const n=document.createElement("div");n.id="editLeagueModal",n.className="edit-league-modal",n.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async d=>{d.preventDefault();const r=document.getElementById("btnSaveEdit");r.disabled=!0,r.textContent="Guardando…";const m={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(m.is_official=document.getElementById("editOfficial").checked);try{await u.leagues.update(a,m),p("Liga actualizada"),i(),$.navigate(`/ligas/${a}`)}catch(b){p(b.message,"error"),r.disabled=!1,r.textContent="Guardar cambios"}})}async function ze(e){var t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=f.getUser();try{const[i,d,r,m]=await Promise.all([u.predictions.mine(null),u.clasificacion.division(),u.auth.me(),a!=null&&a.is_admin?u.leagues.adminAll():Promise.resolve({leagues:[]})]),b=r.user,h=b.status,v=b.total_points_all_time,g=(t=d.standings)==null?void 0:t.find(_=>_.user_id===b.id);e.innerHTML=`
      <div class="container">
        ...
        ${i.predictions.length>0?`
          <section class="section">
            ...
            <div class="predictions-list">${i.predictions.map(Ge).join("")}</div>
          </section>
        `:""}
        ...
        ${a!=null&&a.is_admin&&m.leagues.length?`
          <section class="section">
            ...
            <ul class="leagues-list">
              ${m.leagues.map(_=>`
                <li>
                  <span>${_.is_official?"⭐ ":""}${_.name}</span>
                  <span class="tag">${_.is_public?"Pública":"Privada"}</span>
                  <a href="#/ligas/${_.id}" class="btn btn--sm btn--outline">Gestionar</a>
                </li>
              `).join("")}
            </ul>
          </section>
    ...
    `,(s=e.querySelector("#btnLogoutPerfil"))==null||s.addEventListener("click",()=>{f.logout(),window.location.hash="/"}),(n=e.querySelector("#btnDeleteAccount"))==null||n.addEventListener("click",()=>{Ve()})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function Fe(e,a){if(e.next_threshold===null)return`
  ...
  `}function Ve(){const e=document.createElement("div");e.className="delete-modal",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.body.style.overflow="hidden",requestAnimationFrame(()=>e.classList.add("delete-modal--open"));const a=e.querySelector("#deleteConfirmInput"),t=e.querySelector("#deleteConfirmBtn"),s=e.querySelector("#deleteCancelBtn"),n=e.querySelector("#deleteOverlay"),i=e.querySelector("#deleteError");function d(){e.classList.remove("delete-modal--open"),document.body.style.overflow="",e.addEventListener("transitionend",()=>e.remove(),{once:!0})}a.addEventListener("input",()=>{t.disabled=a.value.trim()!=="CERRAR"}),s.addEventListener("click",d),n.addEventListener("click",d),t.addEventListener("click",async()=>{t.disabled=!0,t.textContent="Cerrando…",i.classList.add("hidden");try{await u.auth.deleteAccount(),d(),f.logout(),p("Cuenta cerrada. Hasta pronto."),window.location.hash="/"}catch(r){i.textContent=r.message||"Error al cerrar la cuenta",i.classList.remove("hidden"),t.disabled=!1,t.textContent="Cerrar mi cuenta"}})}function We(){window.location.hash="/"}async function Xe(e){if(!f.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await u.auth.users();e.innerHTML=`
    ...
    `,Ye(e),G(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function Ye(e){var s,n,i,d;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const r=document.getElementById("syncResult");r.textContent="Sincronizando…";try{await u.matches.sync(),r.textContent="✓ Sincronización completada",p("Sincronización completada")}catch(m){r.textContent=`Error: ${m.message}`,p(m.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async r=>{r.preventDefault();const m=document.getElementById("pushTitle").value.trim()||"Aviso",b=document.getElementById("pushBody").value.trim(),h=a.value,v=parseInt(document.getElementById("pushTargetId").value)||null,g=document.getElementById("pushResult"),_={title:`📣 PickGoal — ${m}`,body:b};h==="league"&&v&&(_.league_id=v),h==="user"&&v&&(_.user_id=v),g.textContent="Enviando…";try{const{sent:E}=await u.notifications.send(_);g.textContent=`✓ Enviada a ${E} suscripción(es)`,p(`Notificación enviada a ${E} suscripción(es)`)}catch(E){g.textContent=`Error: ${E.message}`,p(E.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const r=document.getElementById("btnCloseSeason"),m=document.getElementById("closeSeasonResult");r.disabled=!0,m.textContent="Cerrando…";try{const{message:b}=await u.post("/v2/admin/season/1/close");m.textContent=`✓ ${b||"Temporada cerrada"}`,p("Temporada cerrada")}catch(b){m.textContent=`Error: ${b.message}`,p(b.message,"error"),r.disabled=!1}}),(d=document.getElementById("usersTableBody"))==null||d.addEventListener("click",async r=>{const m=r.target.closest(".toggle-admin");if(!m)return;const b=parseInt(m.dataset.id);try{const{user:h}=await u.auth.toggleAdmin(b);m.closest("tr").querySelector(".admin-badge").textContent=h.is_admin?"Sí":"No",p(`${h.username} ${h.is_admin?"ahora es admin":"ya no es admin"}`)}catch(h){p(h.message,"error")}})}function Ke(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const Ze={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let I=[],F=null;async function G(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await u.adminV2.jornadas();a.innerHTML=Qe(t),aa(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Qe(e){const t=ra(new Date);return`
    <div class="jv2-panel">
      ...
      <div class="jv2-list">
        ${e.length===0?'<p class="admin-section__desc">No hay jornadas creadas.</p>':e.map(ea).join("")}
      </div>
  ...
  `}function aa(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{F=null,I=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",Z()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",I=[],F=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",sa),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",ia),e.querySelectorAll(".jv2-pub-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${i.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){i.disabled=!0,i.textContent="Publicando…";try{const d=await u.adminV2.publishJornada(i.dataset.id);p(`Jornada ${i.dataset.num} publicada — push enviado a ${d.push_sent} suscriptores`),await G(document.getElementById("jornadasV2Section"))}catch(d){p(d.message,"error"),i.disabled=!1,i.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>ta(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await u.adminV2.deleteJornada(i.dataset.id),p("Jornada eliminada"),G(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(d){p(d.message,"error")}})})}async function ta(e){const{jornadas:a}=await u.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(F=t.id,I=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",Z())}async function sa(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){p("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await u.adminV2.partidos(a);na(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){p(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function na(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        <div class="jv2-comp-group__title">${Ze[s]||s}</div>
        ${n.map(i=>`
          <label class="jv2-match-item">
            ...
            <span class="jv2-match-item__date">${oa(i.match_datetime)}</span>
          </label>
        `).join("")}
      </div>
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(I.length>=10){s.checked=!1,p("Máximo 10 partidos","error");return}I.push(n)}else I=I.filter(i=>i.api_id!==n.api_id);Z()})})}function Z(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=I.length),a&&(a.style.display=I.length>0&&I.length!==10?"inline":"none")}async function ia(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){p("Completa número y fechas","error");return}if(I.length!==10){p("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:I},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await u.adminV2.updateJornada(s,n),p(`Jornada ${e} actualizada`)):(await u.adminV2.createJornada(n),p(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",I=[],F=null,await G(document.getElementById("jornadasV2Section"))}catch(d){p(d.message,"error")}finally{i.disabled=!1}}function oa(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}function da(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function ra(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(da(a)).padStart(2,"0");return`${t}-W${s}`}function la(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),d=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await u.auth.resetPassword(t,d),p("Contraseña actualizada. Ya puedes iniciar sesión."),$.navigate("/login")}catch(r){i.textContent=r.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function ua(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!f.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),$.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await u.leagues.joinByCode(t);p(`¡Te has unido a "${s.name}"!`),$.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){p("Ya eres miembro de esta liga");try{const{leagues:n}=await u.leagues.my(),i=n.find(d=>d.invite_code===t);if(i){$.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function ma(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function pa(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=ma(),{user:n,predictions:i}=await u.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const U=20,_e=5;let A={},H=0,Y=null,oe=null;async function va(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await u.jornada.list();if(!a.length){e.innerHTML=_a();return}be(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function be(e,a,t){var m,b;oe=a[t];const{jornada:s,matches:n,units_used:i}=oe;A={};for(const h of n)A[h.jornada_match_id]={predicted_result:((m=h.prediction)==null?void 0:m.predicted_result)??null,units:((b=h.prediction)==null?void 0:b.units_wagered)??0};H=i;const d=n.filter(h=>!h.predict_locked);Y=d.length===1?d[0].jornada_match_id:null;const r=a.length>1?`<div class="jornada-tabs">
        ${a.map((h,v)=>`
          <button class="jornada-tab ${v===t?"jornada-tab--active":""}" data-idx="${v}">
            J${h.jornada.number} · ${z(h.jornada.date_start)}–${z(h.jornada.date_end)}
          </button>
        `).join("")}
       </div>`:"";e.innerHTML=`
    <div class="container">
      ...
      ${r}
      ${s.locked?'<p class="notice">⚠️ El plazo de predicción ha cerrado (ya empezó el primer partido).</p>':s.first_match_datetime?`<p class="notice notice--info">Abierto hasta ${ha(s.first_match_datetime)}</p>`:""}
      <div class="units-counter" id="unitsCounter"></div>
      <div class="jornada-matches">
        ${n.map(ya).join("")}
      </div>
    </div>
  `,he(),fe(),$a(e,a,t)}function _a(){return`
    <div class="container">
  ...
  `}function z(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function ba(e){return new Date(e).toLocaleTimeString("es-ES",{hour:"2-digit",minute:"2-digit"})}function ha(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function X(e){return e!=null?e.toFixed(2):"—"}function fa(e){return e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${ba(e.opens_until)}</span>`}function ya(e){const a=e.predict_locked,t=A[e.jornada_match_id]??{predicted_result:null,units:0};return`
    <div class="match-card jornada-match ${a?"match-card--locked":""}" data-jm-id="${e.jornada_match_id}">
      ...
      <div class="jornada-odds">
        <span class="jornada-odds__item"><b>1</b> (${X(e.odds_1)})</span>
        <span class="jornada-odds__item"><b>X</b> (${X(e.odds_x)})</span>
        <span class="jornada-odds__item"><b>2</b> (${X(e.odds_2)})</span>
      </div>
      <div class="jornada-match__controls ${a?"jornada-match__controls--disabled":""}">
        ...
        <div class="jornada-units">
          ...
          <input type="number" id="units-${e.jornada_match_id}" class="jornada-units__input" min="0" max="${_e}" value="${t.units}" ${a?"disabled":""} />
        </div>
      </div>
      ${a?"":`
  ...
  `}function he(){const e=document.getElementById("unitsCounter");if(!e)return;const a=H>U;e.innerHTML=`
    <div class="units-counter__bar">
      <div class="units-counter__fill ${a?"units-counter__fill--over":""}" style="width:${Math.min(100,H/U*100)}%"></div>
    </div>
    <span class="units-counter__label ${a?"units-counter__label--over":""}">${H}/${U} unidades usadas</span>
  `}function fe(){if(!Y)return;const e=document.getElementById(`warning-${Y}`);if(!e)return;const a=U-H;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function de(){H=Object.values(A).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),he(),fe()}function $a(e,a,t){e.querySelectorAll(".jornada-tab").forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.idx);n!==t&&be(e,a,n)})}),e.querySelectorAll(".jornada-match").forEach(s=>{var d;const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(r=>{r.addEventListener("change",()=>{A[n].predicted_result=r.value,de()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let r=parseInt(i.value);isNaN(r)&&(r=0),r=Math.max(0,Math.min(_e,r)),A[n].units=r,de()}),(d=s.querySelector(".jornada-match__save-btn"))==null||d.addEventListener("click",()=>Ea(n))})}async function Ea(e){const a=A[e];if(!a.predicted_result){p("Selecciona un resultado 1X2","error");return}if(H>U){p(`Superas el máximo de ${U} unidades`,"error");return}const t=document.querySelector(`.jornada-match__save-btn[data-jm-id="${e}"]`);t&&(t.disabled=!0,t.textContent="…");try{await u.jornada.predict({jornada_match_id:e,predicted_result:a.predicted_result,units:a.units}),p("Predicción guardada"),t&&(t.textContent="✓ Guardada")}catch(s){p(s.message||"Error al guardar","error")}finally{t&&(t.disabled=!1,setTimeout(()=>{t&&(t.textContent="Guardar")},2e3))}}const re={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function La(e){var a;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:t}=await u.duelo.current(),s=f.getUser();if(!t){e.innerHTML=`
        <div class="container">
      ...
      `;return}const n=re[t.status]??re.en_curso,i=t.rival?t.rival.username:s.username,d=!t.rival||t.rival.id===s.id;e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Tu duelo esta jornada</h1>
        ...
        <div class="duelo-card">
          ...
          <div class="duelo-card__matchup">
            ...
            <div class="duelo-card__player">
              <span class="duelo-card__name">${d?"Descanso":i}</span>
              <span class="duelo-card__pts">${d?"—":t.rival_points}</span>
            </div>
          </div>
        </div>

        ${!d&&((a=t.matches)==null?void 0:a.length)>0?`
          <h2 class="section-title">Partido a partido</h2>
          <div class="duelo-matches">
            ${t.matches.map(r=>wa(r,i)).join("")}
          </div>
        `:""}
    ...
    `,Ia(t.division_league_id,s.id)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${t.message}</p></div>`}}function wa(e,a){var i;const t=(i=e.my_prediction)==null?void 0:i.predicted_result;let s,n;return e.started?e.rival_prediction?(s=e.rival_prediction.predicted_result,n=""):(s="—",n="duelo-pick__value--empty"):(s="?",n="duelo-pick__value--hidden"),`
  ...
  `}async function Ia(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await u.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function ja(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:a}=await u.clasificacion.general(),t=f.getUser();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Clasificación</h1>
    ...
    `,ka(t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${a.message}</p></div>`}}function ka(e){const a={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")}};function t(s){for(const[n,{btn:i,panel:d}]of Object.entries(a))i.classList.toggle("league-tab--active",n===s),d.classList.toggle("hidden",n!==s)}a.general.btn.addEventListener("click",()=>t("general")),a.miDivision.btn.addEventListener("click",()=>{t("miDivision"),a.miDivision.panel.dataset.loaded||(a.miDivision.panel.dataset.loaded="1",Sa(e))}),a.divisiones.btn.addEventListener("click",()=>{t("divisiones"),a.divisiones.panel.dataset.loaded||(a.divisiones.panel.dataset.loaded="1",Ba(e))})}async function Sa(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await u.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function Ba(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await u.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>xa(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function xa(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
      ...
      <div class="div-accordion__body">
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${e.standings.map(s=>ye(s,a)).join("")}
            </tbody>
          </table>
        </div>
      </div>
    </div>
  `}function ye(e,a){const t=a&&e.user_id===a.id,s=e.zone==="promotion"?"background:rgba(0,255,135,0.08)":e.zone==="relegation"?"background:rgba(255,56,96,0.08)":"";return`
  ...
  `}const le=e=>()=>{window.location.hash=e},Ca={"/":Se,"/login":De,"/register":He,"/quiniela":le("/jornada"),"/resultados":le("/tabla-v2"),"/ranking":Ne,"/tablon":ve,"/ligas":qe,"/ligas/:id":Je,"/perfil":ze,"/campeon":We,"/admin":Xe,"/forgot-password":la,"/reset-password":ca,"/unirse":ua,"/jugador/:id":pa,"/jornada":va,"/duelo":La,"/tabla-v2":ja};function Ta(e){for(const[a,t]of Object.entries(Ca)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(d,r)=>(s.push(r),"([^/]+)"))+"$"),i=e.match(n);if(i){const d={};return s.forEach((r,m)=>{d[r]=i[m+1]}),{handler:t,params:d}}}return null}const ce=()=>document.getElementById("mainContent"),$={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=Ta(a);if(!n){ce().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:d}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2"].includes(a)&&!f.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!f.isAdmin()){this.navigate("/");return}const m=ce();m.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(m,{params:d,query:s})}};let R=[],q=null,N=null;async function Pa(){document.documentElement.dataset.build="2026-08-08T20",await f.init(),$.init(),Ha(),Ma(),Oa()}function $e(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Ma(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!$e()&&(q=e,Da())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),q=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function Da(){if($e()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("installBtn").addEventListener("click",async()=>{q&&(q.prompt(),await q.userChoice,q=null,e.remove())}),document.getElementById("installDismissBtn").addEventListener("click",()=>{sessionStorage.setItem("installBannerDismissed","1"),e.remove()})}function O(){var e,a;(e=document.getElementById("userDropdown"))==null||e.classList.add("hidden"),(a=document.getElementById("userBtn"))==null||a.classList.remove("navbar__dropdown-btn--open")}async function K(){const e=document.getElementById("tablonBadge");if(!e)return;if(!f.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("activeLeagueId");if(!t){e.classList.add("hidden");return}const s=localStorage.getItem(`tablon_last_read_${t}`)||new Date(0).toISOString();try{const{count:n}=await u.board.unread(parseInt(t),s);n>0?(e.textContent=n>99?"99+":String(n),e.classList.remove("hidden")):e.classList.add("hidden")}catch{e.classList.add("hidden")}}function Ha(){var e,a,t;document.addEventListener("auth:change",ue),window.addEventListener("hashchange",()=>{O(),Ee(),setTimeout(K,200)}),document.addEventListener("click",O),(e=document.getElementById("userBtn"))==null||e.addEventListener("click",s=>{var d;s.stopPropagation();const n=document.getElementById("userDropdown"),i=n==null?void 0:n.classList.contains("hidden");O(),i&&(n==null||n.classList.remove("hidden"),(d=document.getElementById("userBtn"))==null||d.classList.add("navbar__dropdown-btn--open"))}),(a=document.getElementById("userDropdown"))==null||a.addEventListener("click",s=>{s.stopPropagation(),s.target.closest("#navProfileLink")&&O()}),(t=document.getElementById("navLogoutBtn"))==null||t.addEventListener("click",()=>{R=[],localStorage.removeItem("activeLeagueId"),O(),f.logout(),$.navigate("/")}),ue()}async function ue(){var i;const e=document.getElementById("navAuthLinks"),a=document.getElementById("userBtn"),t=document.getElementById("navUsername"),s=document.getElementById("bottomNav"),n=f.getUser();if(O(),n){e==null||e.classList.add("hidden"),t&&(t.textContent=n.username),a.style.visibility="visible",s==null||s.classList.remove("hidden"),document.body.classList.add("has-bottom-nav"),(i=document.getElementById("navAdminLink"))==null||i.classList.toggle("hidden",!n.is_admin);try{const{leagues:d}=n.is_admin?await u.leagues.adminAll():await u.leagues.my();R=d}catch{R=[]}Aa(R),K(),N&&clearInterval(N),N=setInterval(K,5*60*1e3)}else e==null||e.classList.remove("hidden"),a.style.visibility="hidden",s==null||s.classList.add("hidden"),document.body.classList.remove("has-bottom-nav"),R=[],localStorage.removeItem("activeLeagueId"),N&&(clearInterval(N),N=null);Ee()}function Aa(e){const a=localStorage.getItem("activeLeagueId");a&&e.some(s=>String(s.id)===String(a))||(e.length>0?localStorage.setItem("activeLeagueId",String(e[0].id)):localStorage.removeItem("activeLeagueId"))}function Ee(){const e=window.location.hash.slice(1).split("?")[0]||"/";document.querySelectorAll(".bottom-nav__item").forEach(a=>{const t=a.dataset.route,s=t==="/"?e==="/":e===t||e.startsWith(t+"/");a.classList.toggle("bottom-nav__item--active",s)})}function Na(e){const a="=".repeat((4-e.length%4)%4),t=(e+a).replace(/-/g,"+").replace(/_/g,"/"),s=atob(t);return Uint8Array.from([...s].map(n=>n.charCodeAt(0)))}async function Oa(){if(!(!("serviceWorker"in navigator)||!("PushManager"in window)))try{const e=await navigator.serviceWorker.register("/sw.js");document.addEventListener("auth:change",async a=>{a.detail&&await me(e)}),f.getUser()&&await me(e)}catch{}}async function me(e){try{if(await Notification.requestPermission()!=="granted")return;const t=await e.pushManager.getSubscription();if(t){await u.notifications.subscribe(t.toJSON());return}const{public_key:s}=await u.notifications.vapidPublicKey();if(!s)return;const n=await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Na(s)});await u.notifications.subscribe(n.toJSON())}catch{}}Pa();
