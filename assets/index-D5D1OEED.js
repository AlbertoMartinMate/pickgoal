(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Ee="https://pickgoal-backend.onrender.com/api";function Le(){return localStorage.getItem("token")}async function c(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Le();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Ee}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const u={get:e=>c(e),post:(e,a)=>c(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>c(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>c(e,{method:"DELETE"}),auth:{register:e=>c("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>c("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>c("/auth/me"),forgotPassword:e=>c("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>c("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>c(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>c("/auth/users"),toggleAdmin:e=>c(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>c("/matches/grouped"),list:(e="")=>c(`/matches/${e}`),get:e=>c(`/matches/${e}`),today:()=>c("/matches/today"),setResult:(e,a,t,s=null)=>c(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>c("/matches/sync",{method:"POST"}),recalculate:()=>c("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>c(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>c(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>c("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>c(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>c(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>c("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>c("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>c("/leagues/all"),public:()=>c("/leagues/public"),my:()=>c("/leagues/my"),create:e=>c("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>c("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>c(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>c("/leagues/admin"),get:e=>c(`/leagues/${e}`),update:(e,a)=>c(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>c(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>c(`/leagues/${e}/members`),matchPredictions:(e,a)=>c(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>c("/home/summary")},board:{messages:(e=1,a=null)=>c(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>c(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>c("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>c(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>c(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>c(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>c("/notifications/vapid-public-key"),subscribe:e=>c("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>c("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>c(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>c("/v2/admin/jornadas"),createJornada:e=>c("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>c(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>c(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>c(`/v2/admin/jornada/${e}/publish`,{method:"POST"})},jornada:{current:()=>c("/v2/jornada/current"),list:()=>c("/v2/jornada/list"),predict:e=>c("/v2/jornada/predict",{method:"POST",body:JSON.stringify({predictions:e})}),history:()=>c("/v2/jornada/history")},duelo:{current:()=>c("/v2/duelo/current")},clasificacion:{division:e=>c(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>c("/v2/clasificacion/general"),allDivisions:()=>c("/v2/clasificacion/all-divisions")}};let T=null;const f={async init(){if(localStorage.getItem("token"))try{const{user:a}=await u.auth.me();T=a}catch{localStorage.removeItem("token")}},setUser(e,a){T=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){T=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return T},isLoggedIn(){return!!T},isAdmin(){return(T==null?void 0:T.is_admin)===!0}};let V=null;function p(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,V&&clearTimeout(V),V=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function we(){return`
  ...
  `}function je(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",l=>{l.key==="Escape"&&o()},{once:!1}),i}function D(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function Se(e){if(!f.getUser()){ke(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,upcoming_matches:s}=await u.home.summary();if(t.length===0){Be(e);return}const n=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),i=[...t].sort((o,l)=>o.league_id===n?-1:l.league_id===n?1:0);e.innerHTML=`
      ...
      ${Ie()}
    `,je(e),ce(e),e.querySelectorAll(".league-card[data-league-id]").forEach(o=>{o.style.cursor="pointer",o.addEventListener("click",l=>{l.target.closest("[data-go-ranking]")||l.target.closest("a")||(localStorage.setItem("activeLeagueId",o.dataset.leagueId),E.navigate(`/ligas/${o.dataset.leagueId}`))})}),e.querySelectorAll("[data-go-ranking]").forEach(o=>{o.addEventListener("click",l=>{l.stopPropagation(),localStorage.setItem("activeLeagueId",o.dataset.goRanking),E.navigate("/ranking")})})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el inicio: ${t.message}</p></div>`}}function ke(e){e.innerHTML=`
    <section class="hero">
  ...
  `,ce(e)}function xe(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function le(){const e=xe("2026-08-15");return`
  ...
  `}function ce(e){var a;(a=e.querySelector("#btnWaitlist"))==null||a.addEventListener("click",()=>{p("¡Ya estás dentro! Te avisaremos cuando empiece la temporada 🎉")})}function Ce(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `:""}const ee="pickgoal_welcome_shown";function ue(e="/ligas"){if(localStorage.getItem(ee))return;localStorage.setItem(ee,"1");const a=document.createElement("div");a.innerHTML=`
  ...
  `;const t=a.firstElementChild;document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("welcome-modal--open"));function s(n){t.classList.remove("welcome-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0}),n&&(window.location.hash=n)}document.getElementById("welcomeOverlay").addEventListener("click",()=>s()),document.getElementById("welcomeCta").addEventListener("click",()=>s(e)),document.addEventListener("keydown",function n(i){i.key==="Escape"&&(s(),document.removeEventListener("keydown",n))})}function Te(e){e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await u.auth.register(n);f.setUser(o,i),p("¡Cuenta creada! Bienvenido a PickGoal");const l=sessionStorage.getItem("pendingInviteCode");if(l){sessionStorage.removeItem("pendingInviteCode");try{const{league:m}=await u.leagues.joinByCode(l);p(`¡Te has unido a "${m.name}"!`),E.navigate(`/ligas/${m.id}`)}catch{E.navigate("/ligas")}}else E.navigate("/campeon"),ue("/ligas")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function De(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function He(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(f.isLoggedIn()){const{leagues:_}=await u.leagues.my();if(_.length===0){e.innerHTML=we();return}}const s=De(),[{ranking:n},i]=await Promise.all([u.auth.ranking(s),f.isLoggedIn()?u.leagues.my():Promise.resolve({leagues:[]})]),o=f.getUser(),l=i.leagues.find(_=>_.id===s),m=document.getElementById("tablonBadge"),g=m&&!m.classList.contains("hidden"),y=g?m.textContent:"",v=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        <div class="ranking-header">
          ...
          ${s?`
            <button class="ranking-tablon-btn" data-league-id="${s}">
              💬 Tablón
              <span class="ranking-tablon-btn__badge${g?"":" hidden"}">${y}</span>
            </button>
          `:""}
        </div>
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(_=>{var x,d,r;const b=_.predictions_made??0,h=`${b}/${v}`,w=`${_.correct_results??0}/${b}`,B=`${_.exact_scores??0}/${b}`;return`
                  <tr class="${o&&_.id===o.id?"ranking-table__row--me":""}">
                    ...
                    <td>
                      <a class="ranking-table__link" href="#/jugador/${_.id}">
                        <span class="status-emoji" title="${((x=_.status)==null?void 0:x.name)||""}">${((d=_.status)==null?void 0:d.emoji)||""}</span>${_.username}
                      </a>
                    </td>
                    <td class="ranking-table__stat ranking-table__status">${((r=_.status)==null?void 0:r.name)||"—"}</td>
                    <td class="ranking-table__stat">${h}</td>
    ...
    `,(t=e.querySelector(".ranking-tablon-btn"))==null||t.addEventListener("click",()=>{E.navigate(`/tablon?liga=${s}`)})}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error: ${s.message}</p></div>`}}async function me(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=f.getUser();let s=a.liga?parseInt(a.liga):null;if(s){localStorage.setItem(`tablon_last_read_${s}`,new Date().toISOString());const d=document.getElementById("tablonBadge");d&&(d.classList.add("hidden"),d.textContent="")}let n=null,i=[],o=1,l=1;try{if(!s&&t){const{leagues:d}=await u.leagues.my();d&&d.length&&(s=d[0].id,n=d[0].name)}else if(s)try{const{league:d}=await u.leagues.get(s);n=d.name}catch{}if(s&&t)try{const{members:d}=await u.leagues.members(s);i=d||[]}catch{}}catch{}async function m(){const d=await u.board.messages(o,s);return l=d.pages||1,d}try{const d=await m();g(d)}catch(d){e.innerHTML=`<div class="container"><p class="form__error">Error: ${d.message}</p></div>`}function g(d){const{pinned:r=[],messages:$=[]}=d;e.innerHTML=`
      <div class="container">
    ...
    `,h(),w(),B()}function y(d){return d.length?d.map(r=>`
      <div class="board-message board-message--pinned" data-id="${r.id}">
        <div class="board-message__header">
          ...
          <strong class="board-message__author">${P(r.username)}</strong>
    ...
    `).join(""):""}function v(d){return`
      <div class="board-reply ${d.is_deleted?"board-reply--deleted":""}" data-id="${d.id}">
        <div class="board-reply__header">
          <strong class="board-reply__author">${P(d.username)}</strong>
          <span class="board-reply__date">${D(d.created_at)}</span>
          ${!d.is_deleted&&t&&(t.id===d.user_id||t.is_admin)?`<button class="btn btn--danger btn--xs delete-msg" data-id="${d.id}">✕</button>`:""}
        </div>
        <p class="board-reply__text">${b(d.message)}</p>
      </div>
    `}function _(d){return d.length?d.map(r=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function b(d){const r=P(d);if(!i.length)return r;const $=i.map(L=>Ne(L.username)),S=new RegExp(`@(${$.join("|")})`,"gi");return r.replace(S,'<span class="mention">@$1</span>')}function h(){const d=document.getElementById("boardForm");if(!d)return;const r=document.getElementById("boardMsg"),$=document.getElementById("charCounter"),S=document.getElementById("mentionDropdown");r.addEventListener("input",()=>{$.textContent=`${r.value.length} / 500`,x(r,S)}),d.addEventListener("submit",async L=>{L.preventDefault();const M=r.value.trim();if(M)try{await u.board.post(M,s),r.value="",$.textContent="0 / 500",S.classList.add("hidden");const C=await m();I(C),p("Mensaje publicado")}catch(C){p(C.message,"error")}})}function w(){e.querySelectorAll(".reply-form").forEach(d=>{const r=parseInt(d.dataset.parent),$=d.querySelector(".reply-input"),S=`mentionDropdown-${r}`,L=document.getElementById(S);$==null||$.addEventListener("input",()=>{x($,L)}),d.addEventListener("submit",async M=>{M.preventDefault();const C=$.value.trim();if(C)try{await u.board.reply(r,C),$.value="",L==null||L.classList.add("hidden");const U=await m();I(U),p("Respuesta enviada")}catch(U){p(U.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(d=>{d.addEventListener("click",async()=>{try{await u.board.pin(d.dataset.id);const r=await m();I(r),p("Mensaje fijado")}catch(r){p(r.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(d=>{d.addEventListener("click",async()=>{try{await u.board.pin(d.dataset.id);const r=await m();I(r),p("Mensaje desfijado")}catch(r){p(r.message,"error")}})})}function B(){e.querySelectorAll(".delete-msg").forEach(d=>{d.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await u.board.delete(d.dataset.id);const r=await m();I(r),p("Mensaje eliminado")}catch(r){p(r.message,"error")}})})}function I(d){const{pinned:r=[],messages:$=[]}=d,S=document.getElementById("boardPinned");if(S)S.innerHTML=y(r);else if(r.length){g(d);return}const L=document.getElementById("boardMessages");L&&(L.innerHTML=_($)),w(),B()}e.addEventListener("click",async d=>{if(d.target.id==="prevPage"&&o>1){o--;const r=await m();I(r)}else if(d.target.id==="nextPage"&&o<l){o++;const r=await m();I(r)}});function x(d,r){if(!r||!i.length)return;const $=d.value,S=d.selectionStart,L=$.slice(0,S),M=L.match(/@(\w*)$/);if(!M){r.classList.add("hidden");return}const C=M[1].toLowerCase(),U=i.filter(k=>k.username.toLowerCase().startsWith(C)&&k.id!==(t==null?void 0:t.id)),Q=[...f.isAdmin()&&"todos".startsWith(C)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...U.slice(0,6)];if(!Q.length){r.classList.add("hidden");return}r.innerHTML=Q.map(k=>k.description?`<div class="mention-item mention-item--broadcast" data-username="${P(k.username)}">
             <span class="mention-item__name">@${P(k.username)}</span>
             <span class="mention-item__desc">${P(k.description)}</span>
           </div>`:`<div class="mention-item" data-username="${P(k.username)}">${P(k.username)}</div>`).join(""),r.classList.remove("hidden"),r.querySelectorAll(".mention-item").forEach(k=>{k.addEventListener("mousedown",ye=>{ye.preventDefault();const $e=k.dataset.username,z=L.replace(/@(\w*)$/,`@${$e} `);if(d.value=z+$.slice(S),d.setSelectionRange(z.length,z.length),r.classList.add("hidden"),d.tagName==="TEXTAREA"){const Z=document.getElementById("charCounter");Z&&(Z.textContent=`${d.value.length} / 500`)}})})}document.addEventListener("click",d=>{!d.target.closest(".board-form__input-wrap")&&!d.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(r=>r.classList.add("hidden"))},{capture:!0})}function P(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ne(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Oe(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=f.getUser(),o=i==null?void 0:i.is_admin,[l,m]=await Promise.all([o?u.leagues.adminAll():u.leagues.all(),f.isLoggedIn()&&!o?u.leagues.my():Promise.resolve({leagues:[]})]),g=new Set(m.leagues.map(v=>v.id)),y=o?l.leagues:l.leagues.filter(v=>!g.has(v.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&m.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${m.leagues.map(v=>ae(v,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${y.length?`<div class="leagues-grid">${y.map(v=>ae(v,!1,g,o)).join("")}</div>`:o?'<p class="empty">No hay ligas creadas aún.</p>':m.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(v=>{v.addEventListener("click",()=>E.navigate(`/ligas/${v.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(v=>{v.addEventListener("click",async _=>{_.stopPropagation();const b=parseInt(v.dataset.id);v.disabled=!0,v.textContent="…";try{const{league:h}=await u.leagues.join({league_id:b});p(`¡Te has unido a "${h.name}"!`),E.navigate(`/ligas/${h.id}`)}catch(h){p(h.message,"error"),v.disabled=!1,v.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(v=>{v.addEventListener("click",_=>{_.stopPropagation(),p("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var v,_;(v=document.getElementById("createLeaguePanel"))==null||v.classList.remove("hidden"),(_=document.getElementById("btnShowCreate"))==null||_.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var v,_;(v=document.getElementById("createLeaguePanel"))==null||v.classList.add("hidden"),(_=document.getElementById("btnShowCreate"))==null||_.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async v=>{v.preventDefault();const _=document.getElementById("inviteCode").value.trim().toUpperCase();if(_)try{const{league:b}=await u.leagues.join({invite_code:_});p(`Te has unido a "${b.name}"`),E.navigate(`/ligas/${b.id}`)}catch(b){p(b.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async v=>{var x;v.preventDefault();const _=document.getElementById("createBtn");_.disabled=!0,_.textContent="Creando…";const b=document.getElementById("leagueName").value.trim(),h=document.getElementById("leagueDesc").value.trim(),w=document.getElementById("leaguePrize").value.trim(),B=document.getElementById("isPublic").checked,I=((x=document.getElementById("isOfficial"))==null?void 0:x.checked)??!1;try{const{league:d}=await u.leagues.create({name:b,description:h,prize:w,is_public:B,is_official:I});Ae(d)}catch(d){p(d.message,"error"),_.disabled=!1,_.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function ae(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",o=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `}function Ae(e){var s,n;const a=e.invite_link||"",t=document.getElementById("createLeaguePanel");t&&(t.innerHTML=`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),p("Enlace copiado")}catch{p("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function qe(e,{params:a}){var s,n,i,o,l;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const m=await u.leagues.get(t),{league:g,ranking:y,is_member:v,is_admin_view:_}=m,b=f.getUser(),h=g.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        <div class="league-header">
          <h1 class="page-title">${g.name} ${h}</h1>
          ${g.description?`<p class="league-header__desc">${g.description}</p>`:""}
          <div class="league-header__meta">
            <span>${g.is_public?"🌍 Pública":"🔒 Privada"}</span>
            <span>${g.member_count} participantes</span>
            ${g.prize?`<span>🏆 ${g.prize}</span>`:""}
          </div>
        </div>

        ${(v||b!=null&&b.is_admin)&&g.invite_link?`
          <div class="invite-share-box">
            <span class="invite-share-box__label">Enlace de invitación:</span>
            <div class="invite-link-box">
              <span class="invite-link-box__url">${g.invite_link}</span>
        ...
        <div class="league-actions">
          ${v?'<button class="btn btn--danger btn--sm" id="btnLeave">Abandonar liga</button>':!(b!=null&&b.is_admin)&&b?'<button class="btn btn--primary" id="btnJoin">Unirse a esta liga</button>':""}
          ${b!=null&&b.is_admin||v&&b&&g.created_by===b.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
        ...
        <section class="section" id="sectionRanking">
          <table class="ranking-table">
            ...
            <tbody>
              ${y.map(d=>`
                <tr class="${b&&d.id===b.id?"ranking-table__row--me":""}">
                  <td>${d.position}</td>
                  <td>${d.username}</td>
                  <td>${d.country||"—"}</td>
    ...
    `,(s=document.getElementById("btnCopyInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(g.invite_link),p("Enlace copiado")}catch{p("No se pudo copiar","error")}}),(n=document.getElementById("btnShareInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${g.name} en PickGoal`,url:g.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await u.leagues.leave(t),p("Has abandonado la liga"),E.navigate("/ligas")}catch(d){p(d.message,"error")}}),(o=document.getElementById("btnJoin"))==null||o.addEventListener("click",async()=>{try{await u.leagues.join({league_id:t}),p("¡Te has unido a la liga!"),E.navigate(`/ligas/${t}`)}catch(d){p(d.message,"error")}}),(l=document.getElementById("btnEditLeague"))==null||l.addEventListener("click",()=>{Ue(g,t,b)});const w=document.getElementById("tabRanking"),B=document.getElementById("tabTablon"),I=document.getElementById("sectionRanking"),x=document.getElementById("sectionTablon");w&&B&&(w.addEventListener("click",()=>{w.classList.add("league-tab--active"),B.classList.remove("league-tab--active"),I.classList.remove("hidden"),x.classList.add("hidden")}),B.addEventListener("click",()=>{B.classList.add("league-tab--active"),w.classList.remove("league-tab--active"),I.classList.add("hidden"),x.classList.remove("hidden");const d=document.getElementById("tablonEmbed");d&&!d.dataset.loaded&&(d.dataset.loaded="1",me(d,{query:{liga:String(t)}}))}))}catch(m){e.innerHTML=`<div class="container"><p class="form__error">Error: ${m.message}</p><a href="#/ligas">Volver</a></div>`}}function Ue(e,a,t){const s=document.getElementById("editLeagueModal");s&&s.remove();const n=document.createElement("div");n.id="editLeagueModal",n.className="edit-league-modal",n.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const l=document.getElementById("btnSaveEdit");l.disabled=!0,l.textContent="Guardando…";const m={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(m.is_official=document.getElementById("editOfficial").checked);try{await u.leagues.update(a,m),p("Liga actualizada"),i(),E.navigate(`/ligas/${a}`)}catch(g){p(g.message,"error"),l.disabled=!1,l.textContent="Guardar cambios"}})}async function Je(e){var t,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=f.getUser();try{const n=(()=>{const h=localStorage.getItem("activeLeagueId");return h?parseInt(h):null})(),[i,o,l,m,g]=await Promise.all([u.predictions.mine(n),u.predictions.getChampion(n),u.leagues.my(),u.auth.me(),a!=null&&a.is_admin?u.leagues.adminAll():Promise.resolve({leagues:[]})]),y=i.predictions.reduce((h,w)=>h+w.total_points,0)+(((t=o.champion_prediction)==null?void 0:t.points_earned)||0),v=m.user,_=v.status,b=v.total_points_all_time;e.innerHTML=`
      <div class="container">
        ...
        <section class="section">
          <h2>Mis ligas</h2>
          ${l.leagues.length?`<ul class="leagues-list">${l.leagues.map(h=>`<li><a href="#/ligas/${h.id}">${h.name}</a> <span class="tag">${h.is_public?"Pública":"Privada"}</span></li>`).join("")}</ul>`:'<p class="empty">No perteneces a ninguna liga. <a href="#/ligas">Ver ligas</a></p>'}
        </section>

        ${a!=null&&a.is_admin&&g.leagues.length?`
          <section class="section">
            <h2>Ligas gestionadas</h2>
            <ul class="leagues-list">
              ${g.leagues.map(h=>`
                <li>
                  <span>${h.is_official?"⭐ ":""}${h.name}</span>
                  <span class="tag">${h.is_public?"Pública":"Privada"}</span>
                  <a href="#/ligas/${h.id}" class="btn btn--sm btn--outline">Gestionar</a>
                </li>
              `).join("")}
            </ul>
          </section>
    ...
    `,(s=e.querySelector("#btnLogoutPerfil"))==null||s.addEventListener("click",()=>{f.logout(),window.location.hash="/"})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function Re(e,a){if(e.next_threshold===null)return`
  ...
  `}function Ge(){window.location.hash="/"}async function ze(e){if(!f.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await u.auth.users();e.innerHTML=`
      <div class="container">
    ...
    `,Ve(e),G(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function Ve(e){var s,n,i,o;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const l=document.getElementById("syncResult");l.textContent="Sincronizando…";try{await u.matches.sync(),l.textContent="✓ Sincronización completada",p("Sincronización completada")}catch(m){l.textContent=`Error: ${m.message}`,p(m.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async l=>{l.preventDefault();const m=document.getElementById("pushTitle").value.trim()||"Aviso",g=document.getElementById("pushBody").value.trim(),y=a.value,v=parseInt(document.getElementById("pushTargetId").value)||null,_=document.getElementById("pushResult"),b={title:`📣 PickGoal — ${m}`,body:g};y==="league"&&v&&(b.league_id=v),y==="user"&&v&&(b.user_id=v),_.textContent="Enviando…";try{const{sent:h}=await u.notifications.send(b);_.textContent=`✓ Enviada a ${h} suscripción(es)`,p(`Notificación enviada a ${h} suscripción(es)`)}catch(h){_.textContent=`Error: ${h.message}`,p(h.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const l=document.getElementById("btnCloseSeason"),m=document.getElementById("closeSeasonResult");l.disabled=!0,m.textContent="Cerrando…";try{const{message:g}=await u.post("/v2/admin/season/1/close");m.textContent=`✓ ${g||"Temporada cerrada"}`,p("Temporada cerrada")}catch(g){m.textContent=`Error: ${g.message}`,p(g.message,"error"),l.disabled=!1}}),(o=document.getElementById("usersTableBody"))==null||o.addEventListener("click",async l=>{const m=l.target.closest(".toggle-admin");if(!m)return;const g=parseInt(m.dataset.id);try{const{user:y}=await u.auth.toggleAdmin(g);m.closest("tr").querySelector(".admin-badge").textContent=y.is_admin?"Sí":"No",p(`${y.username} ${y.is_admin?"ahora es admin":"ya no es admin"}`)}catch(y){p(y.message,"error")}})}function We(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const Xe={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let j=[],F=null;async function G(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await u.adminV2.jornadas();a.innerHTML=Ye(t),Qe(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Ye(e){const t=ia(new Date);return`
    <div class="jv2-panel">
      ...
      <div class="jv2-list">
        ${e.length===0?'<p class="admin-section__desc">No hay jornadas creadas.</p>':e.map(Ke).join("")}
      </div>
  ...
  `}function Qe(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{F=null,j=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",K()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",j=[],F=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",ea),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",ta),e.querySelectorAll(".jv2-pub-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${i.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){i.disabled=!0,i.textContent="Publicando…";try{const o=await u.adminV2.publishJornada(i.dataset.id);p(`Jornada ${i.dataset.num} publicada — push enviado a ${o.push_sent} suscriptores`),await G(document.getElementById("jornadasV2Section"))}catch(o){p(o.message,"error"),i.disabled=!1,i.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>Ze(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await u.adminV2.deleteJornada(i.dataset.id),p("Jornada eliminada"),G(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(o){p(o.message,"error")}})})}async function Ze(e){const{jornadas:a}=await u.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(F=t.id,j=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",K())}async function ea(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){p("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await u.adminV2.partidos(a);aa(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){p(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function aa(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        <div class="jv2-comp-group__title">${Xe[s]||s}</div>
        ${n.map(i=>`
    ...
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(j.length>=10){s.checked=!1,p("Máximo 10 partidos","error");return}j.push(n)}else j=j.filter(i=>i.api_id!==n.api_id);K()})})}function K(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=j.length),a&&(a.style.display=j.length>0&&j.length!==10?"inline":"none")}async function ta(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){p("Completa número y fechas","error");return}if(j.length!==10){p("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:j},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await u.adminV2.updateJornada(s,n),p(`Jornada ${e} actualizada`)):(await u.adminV2.createJornada(n),p(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",j=[],F=null,await G(document.getElementById("jornadasV2Section"))}catch(o){p(o.message,"error")}finally{i.disabled=!1}}function sa(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}function na(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function ia(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(na(a)).padStart(2,"0");return`${t}-W${s}`}function oa(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await u.auth.resetPassword(t,o),p("Contraseña actualizada. Ya puedes iniciar sesión."),E.navigate("/login")}catch(l){i.textContent=l.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function ra(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!f.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),E.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await u.leagues.joinByCode(t);p(`¡Te has unido a "${s.name}"!`),E.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){p("Ya eres miembro de esta liga");try{const{leagues:n}=await u.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){E.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
      <div class="container">
        <div class="league-gate">
    ...
    `}}function la(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ca(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=la(),{user:n,predictions:i}=await u.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const R=20,pe=5;let H={},q=0,X=null;async function ma(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await u.jornada.list();if(!a.length){e.innerHTML=pa();return}ge(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function ge(e,a,t){var l,m;X=a[t];const{jornada:s,matches:n,units_used:i}=X;H={};for(const g of n)H[g.jornada_match_id]={predicted_result:((l=g.prediction)==null?void 0:l.predicted_result)??null,units:((m=g.prediction)==null?void 0:m.units_wagered)??0};q=i;const o=a.length>1?`<div class="jornada-tabs">
        ${a.map((g,y)=>`
          <button class="jornada-tab ${y===t?"jornada-tab--active":""}" data-idx="${y}">
            J${g.jornada.number} · ${te(g.jornada.date_start)}–${te(g.jornada.date_end)}
          </button>
        `).join("")}
       </div>`:"";e.innerHTML=`
    <div class="container">
      ...
      ${o}
      ${s.locked?'<p class="notice">⚠️ El plazo de predicción ha cerrado (ya empezó el primer partido).</p>':s.first_match_datetime?`<p class="notice notice--info">Abierto hasta ${ve(s.first_match_datetime)}</p>`:""}
  ...
  `,_e(),_a(e,s.locked,a,t)}function pa(){return`
    <div class="container">
  ...
  `}function te(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function ve(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function W(e){return e!=null?e.toFixed(2):"—"}function ga(e){const a=new Date,t=new Date(e.match_datetime);return e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.status!=="scheduled"||t<=a?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${ve(e.match_datetime)}</span>`}function va(e){const a=e.status!=="scheduled"||new Date(e.match_datetime)<=new Date,t=H[e.jornada_match_id]??{predicted_result:null,units:0};return`
    <div class="match-card jornada-match ${a?"match-card--locked":""}" data-jm-id="${e.jornada_match_id}">
      ...
      <div class="jornada-match__controls ${a?"jornada-match__controls--disabled":""}">
        ...
        <div class="jornada-units">
          ...
          <input type="number" id="units-${e.jornada_match_id}" class="jornada-units__input" min="0" max="${pe}" value="${t.units}" ${a?"disabled":""} />
        </div>
      </div>
    </div>
  `}function _e(){const e=document.getElementById("unitsCounter");if(!e)return;const a=q>R;e.innerHTML=`
  ...
  `}function se(){q=Object.values(H).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),_e()}function _a(e,a,t,s){var n;e.querySelectorAll(".jornada-tab").forEach(i=>{i.addEventListener("click",()=>{const o=parseInt(i.dataset.idx);o!==s&&ge(e,t,o)})}),!a&&(e.querySelectorAll(".jornada-match").forEach(i=>{const o=parseInt(i.dataset.jmId);i.querySelectorAll('input[type="radio"]').forEach(m=>{m.addEventListener("change",()=>{H[o].predicted_result=m.value,se()})});const l=i.querySelector(".jornada-units__input");l==null||l.addEventListener("input",()=>{let m=parseInt(l.value);isNaN(m)&&(m=0),m=Math.max(0,Math.min(pe,m)),H[o].units=m,se()})}),(n=document.getElementById("jornadaSaveBtn"))==null||n.addEventListener("click",()=>ba(X.jornada.id)))}async function ba(e){const a=document.getElementById("jornadaSaveBtn"),t=Object.entries(H).filter(([,s])=>s.predicted_result).map(([s,n])=>({jornada_match_id:parseInt(s),predicted_result:n.predicted_result,units:n.units}));if(t.length===0){p("Selecciona al menos un resultado 1X2","error");return}if(q>R){p(`Superas el máximo de ${R} unidades`,"error");return}a.disabled=!0,a.textContent="…";try{await u.jornada.predict(t),p("Predicciones guardadas"),a.textContent="✓ Guardadas"}catch(s){p(s.message||"Error al guardar","error")}finally{a.disabled=!1,setTimeout(()=>{a&&(a.textContent="Guardar predicciones")},2e3)}}const ne={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function ha(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:a}=await u.duelo.current(),t=f.getUser();if(!a){e.innerHTML=`
        <div class="container">
      ...
      `;return}const s=ne[a.status]??ne.en_curso,n=a.rival?a.rival.username:t.username,i=!a.rival||a.rival.id===t.id;e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Tu duelo esta jornada</h1>
    ...
    `,fa(a.division_league_id,t.id)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${a.message}</p></div>`}}async function fa(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await u.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function ya(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:a}=await u.clasificacion.general(),t=f.getUser();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Clasificación</h1>
    ...
    `,$a(t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${a.message}</p></div>`}}function $a(e){const a={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")}};function t(s){for(const[n,{btn:i,panel:o}]of Object.entries(a))i.classList.toggle("league-tab--active",n===s),o.classList.toggle("hidden",n!==s)}a.general.btn.addEventListener("click",()=>t("general")),a.miDivision.btn.addEventListener("click",()=>{t("miDivision"),a.miDivision.panel.dataset.loaded||(a.miDivision.panel.dataset.loaded="1",Ea(e))}),a.divisiones.btn.addEventListener("click",()=>{t("divisiones"),a.divisiones.panel.dataset.loaded||(a.divisiones.panel.dataset.loaded="1",La(e))})}async function Ea(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await u.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function La(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await u.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>wa(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function wa(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
  ...
  `}function be(e,a){const t=a&&e.user_id===a.id,s=e.zone==="promotion"?"background:rgba(0,255,135,0.08)":e.zone==="relegation"?"background:rgba(255,56,96,0.08)":"";return`
  ...
  `}const ie=e=>()=>{window.location.hash=e},Ia={"/":Se,"/login":Te,"/register":Me,"/quiniela":ie("/jornada"),"/resultados":ie("/tabla-v2"),"/ranking":He,"/tablon":me,"/ligas":Oe,"/ligas/:id":qe,"/perfil":Je,"/campeon":Ge,"/admin":ze,"/forgot-password":oa,"/reset-password":da,"/unirse":ra,"/jugador/:id":ca,"/jornada":ma,"/duelo":ha,"/tabla-v2":ya};function ja(e){for(const[a,t]of Object.entries(Ia)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,l)=>(s.push(l),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((l,m)=>{o[l]=i[m+1]}),{handler:t,params:o}}}return null}const oe=()=>document.getElementById("mainContent"),E={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=ja(a);if(!n){oe().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2"].includes(a)&&!f.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!f.isAdmin()){this.navigate("/");return}const m=oe();m.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(m,{params:o,query:s})}};let J=[],A=null,N=null;async function Sa(){document.documentElement.dataset.build="2026-08-07T14",await f.init(),E.init(),xa(),ka(),Ta()}function he(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function ka(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!he()&&(A=e,Ba())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),A=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function Ba(){if(he()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("installBtn").addEventListener("click",async()=>{A&&(A.prompt(),await A.userChoice,A=null,e.remove())}),document.getElementById("installDismissBtn").addEventListener("click",()=>{sessionStorage.setItem("installBannerDismissed","1"),e.remove()})}function O(){var e,a;(e=document.getElementById("userDropdown"))==null||e.classList.add("hidden"),(a=document.getElementById("userBtn"))==null||a.classList.remove("navbar__dropdown-btn--open")}async function Y(){const e=document.getElementById("tablonBadge");if(!e)return;if(!f.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("activeLeagueId");if(!t){e.classList.add("hidden");return}const s=localStorage.getItem(`tablon_last_read_${t}`)||new Date(0).toISOString();try{const{count:n}=await u.board.unread(parseInt(t),s);n>0?(e.textContent=n>99?"99+":String(n),e.classList.remove("hidden")):e.classList.add("hidden")}catch{e.classList.add("hidden")}}function xa(){var e,a,t;document.addEventListener("auth:change",de),window.addEventListener("hashchange",()=>{O(),fe(),setTimeout(Y,200)}),document.addEventListener("click",O),(e=document.getElementById("userBtn"))==null||e.addEventListener("click",s=>{var o;s.stopPropagation();const n=document.getElementById("userDropdown"),i=n==null?void 0:n.classList.contains("hidden");O(),i&&(n==null||n.classList.remove("hidden"),(o=document.getElementById("userBtn"))==null||o.classList.add("navbar__dropdown-btn--open"))}),(a=document.getElementById("userDropdown"))==null||a.addEventListener("click",s=>{s.stopPropagation(),s.target.closest("#navProfileLink")&&O()}),(t=document.getElementById("navLogoutBtn"))==null||t.addEventListener("click",()=>{J=[],localStorage.removeItem("activeLeagueId"),O(),f.logout(),E.navigate("/")}),de()}async function de(){var i;const e=document.getElementById("navAuthLinks"),a=document.getElementById("userBtn"),t=document.getElementById("navUsername"),s=document.getElementById("bottomNav"),n=f.getUser();if(O(),n){e==null||e.classList.add("hidden"),t&&(t.textContent=n.username),a.style.visibility="visible",s==null||s.classList.remove("hidden"),document.body.classList.add("has-bottom-nav"),(i=document.getElementById("navAdminLink"))==null||i.classList.toggle("hidden",!n.is_admin);try{const{leagues:o}=n.is_admin?await u.leagues.adminAll():await u.leagues.my();J=o}catch{J=[]}Ca(J),Y(),N&&clearInterval(N),N=setInterval(Y,5*60*1e3)}else e==null||e.classList.remove("hidden"),a.style.visibility="hidden",s==null||s.classList.add("hidden"),document.body.classList.remove("has-bottom-nav"),J=[],localStorage.removeItem("activeLeagueId"),N&&(clearInterval(N),N=null);fe()}function Ca(e){const a=localStorage.getItem("activeLeagueId");a&&e.some(s=>String(s.id)===String(a))||(e.length>0?localStorage.setItem("activeLeagueId",String(e[0].id)):localStorage.removeItem("activeLeagueId"))}function fe(){const e=window.location.hash.slice(1).split("?")[0]||"/";document.querySelectorAll(".bottom-nav__item").forEach(a=>{const t=a.dataset.route,s=t==="/"?e==="/":e===t||e.startsWith(t+"/");a.classList.toggle("bottom-nav__item--active",s)})}function Pa(e){const a="=".repeat((4-e.length%4)%4),t=(e+a).replace(/-/g,"+").replace(/_/g,"/"),s=atob(t);return Uint8Array.from([...s].map(n=>n.charCodeAt(0)))}async function Ta(){if(!(!("serviceWorker"in navigator)||!("PushManager"in window)))try{const e=await navigator.serviceWorker.register("/sw.js");document.addEventListener("auth:change",async a=>{a.detail&&await re(e)}),f.getUser()&&await re(e)}catch{}}async function re(e){try{if(await Notification.requestPermission()!=="granted")return;const t=await e.pushManager.getSubscription();if(t){await u.notifications.subscribe(t.toJSON());return}const{public_key:s}=await u.notifications.vapidPublicKey();if(!s)return;const n=await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Pa(s)});await u.notifications.subscribe(n.toJSON())}catch{}}Sa();
