(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const de="https://pickgoal-backend.onrender.com/api";function ce(){return localStorage.getItem("token")}async function g(e,a={}){const t={"Content-Type":"application/json",...a.headers},n=ce();n&&(t.Authorization=`Bearer ${n}`);const s=await fetch(`${de}${e}`,{...a,headers:t}),i=await s.json().catch(()=>({}));if(!s.ok)throw{status:s.status,message:i.error||"Error desconocido"};return i}const p={get:e=>g(e),post:(e,a)=>g(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>g(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>g(e,{method:"DELETE"}),auth:{register:e=>g("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>g("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>g("/auth/me"),forgotPassword:e=>g("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>g("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>g(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>g("/auth/users"),toggleAdmin:e=>g(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>g("/matches/grouped"),list:(e="")=>g(`/matches/${e}`),get:e=>g(`/matches/${e}`),sync:()=>g("/matches/sync",{method:"POST"})},predictions:{mine:e=>g(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>g(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>g("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>g(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>g(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>g("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>g("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>g("/leagues/all"),public:()=>g("/leagues/public"),my:()=>g("/leagues/my"),create:e=>g("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>g("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>g(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>g("/leagues/admin"),get:e=>g(`/leagues/${e}`),update:(e,a)=>g(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>g(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>g(`/leagues/${e}/members`),matchPredictions:(e,a)=>g(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>g("/home/summary")},board:{messages:(e=1,a=null)=>g(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>g(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>g("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>g(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>g(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>g(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>g("/notifications/vapid-public-key"),subscribe:e=>g("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>g("/notifications/send",{method:"POST",body:JSON.stringify(e)})}};let B=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await p.auth.me();B=a}catch{localStorage.removeItem("token")}},setUser(e,a){B=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){B=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return B},isLoggedIn(){return!!B},isAdmin(){return(B==null?void 0:B.is_admin)===!0}};let R=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,R&&clearTimeout(R),R=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function ae(){return`
  ...
  `}function T(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function pe(e){if(!y.getUser()){ue(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,upcoming_matches:n}=await p.home.summary();if(t.length===0){me(e);return}const s=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),i=[...t].sort((o,l)=>o.league_id===s?-1:l.league_id===s?1:0);e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),n=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",n.classList.add("hidden");const s={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await p.auth.register(s);y.setUser(o,i),v("¡Cuenta creada! Bienvenido a PickGoal");const l=sessionStorage.getItem("pendingInviteCode");if(l){sessionStorage.removeItem("pendingInviteCode");try{const{league:c}=await p.leagues.joinByCode(l);v(`¡Te has unido a "${c.name}"!`),L.navigate(`/ligas/${c.id}`)}catch{L.navigate("/ligas")}}else L.navigate("/campeon"),te("/ligas")}catch(i){n.textContent=i.message||"Error al registrarse",n.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function J(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function $e(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{let n=null;if(y.isLoggedIn()){const{leagues:$}=await p.leagues.my();if($.length===0){e.innerHTML=ae();return}const w=J(),k=$.find(r=>r.id===w);n=k?k.name:((a=$[0])==null?void 0:a.name)??null}const s=J(),[{groups:i},o,l]=await Promise.all([p.matches.grouped(),y.isLoggedIn()?p.predictions.mine(s):Promise.resolve({predictions:[]}),y.isLoggedIn()?p.predictions.getChampion(s):Promise.resolve({champion_prediction:null})]),c={};for(const $ of o.predictions)c[$.match_id]=$;const m=i.flatMap($=>$.matches),_=new Map;for(const $ of m){const w=X($.match_datetime);_.has(w)||_.set(w,[]),_.get(w).push($)}const u=[..._.keys()].sort(),b=X(new Date().toISOString()),h=u.find($=>$>=b)??u[0],f=((t=l.champion_prediction)==null?void 0:t.team_name)??null,S=y.isLoggedIn()?f?`<p class="champion-banner champion-banner--set">🏆 Tu campeón: <a href="#/campeon" style="color:inherit;font-weight:bold;">${f}</a></p>`:'<p class="champion-banner champion-banner--missing">⚠️ <a href="#/campeon">¡Elige tu campeón antes del inicio del torneo!</a></p>':"";e.innerHTML=`
    ...
    `,Ee(u,h,_,c,s)}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error cargando los partidos: ${n.message}</p></div>`}}function Ee(e,a,t,n,s){var o;const i=document.getElementById("dateNav");i&&(i.innerHTML=e.map(l=>`
  ...
  `}function Se(e,a,t){const n=parseInt(e.dataset.matchId),s=e.querySelector(".pred-save-btn"),i=e.querySelector(".pred-status");let o=e.dataset.saved==="true";function l(){e.classList.contains("prediction-form--dirty")||(e.classList.remove("prediction-form--saved","prediction-form--unsaved"),e.classList.add("prediction-form--dirty"),s.className="btn btn--primary btn--sm pred-save-btn",s.textContent="Guardar",i&&(i.className="pred-status pred-status--unsaved",i.textContent="Sin guardar"))}function c(){o=!0,e.classList.remove("prediction-form--unsaved","prediction-form--dirty"),e.classList.add("prediction-form--saved"),s.className="btn btn--saved btn--sm pred-save-btn",s.textContent="✓ Guardado",s.disabled=!1,i&&(i.className="pred-status pred-status--saved",i.textContent="✓ Guardado")}e.querySelectorAll("input").forEach(m=>{m.addEventListener("change",l),m.addEventListener("input",l)}),e.addEventListener("submit",async m=>{var h;m.preventDefault();const _=parseInt(e.querySelector("[name=predicted_home]").value),u=parseInt(e.querySelector("[name=predicted_away]").value),b=(h=e.querySelector("[name=predicted_result]:checked"))==null?void 0:h.value;if(!(isNaN(_)||isNaN(u)||!b)){s.disabled=!0,s.textContent="…";try{const{prediction:f}=await p.predictions.save({match_id:n,predicted_result:b,predicted_home:_,predicted_away:u,league_id:t??null});a[n]=f,v("Predicción guardada"),c()}catch(f){v(f.message||"Error al guardar","error"),s.disabled=!1,o?(s.className="btn btn--saved btn--sm pred-save-btn",s.textContent="✓ Guardado"):(s.className="btn btn--primary btn--sm pred-save-btn",s.textContent="Guardar")}}})}function xe(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ke(e){var a;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:_}=await p.leagues.my();if(_.length===0){e.innerHTML=ae();return}}const t=xe(),[{ranking:n},s]=await Promise.all([p.auth.ranking(t),y.isLoggedIn()?p.leagues.my():Promise.resolve({leagues:[]})]),i=y.getUser(),o=s.leagues.find(_=>_.id===t),l=document.getElementById("tablonBadge"),c=l&&!l.classList.contains("hidden"),m=c?l.textContent:"";e.innerHTML=`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function h(r){const d=H(r);if(!i.length)return d;const E=i.map(I=>Ce(I.username)),x=new RegExp(`@(${E.join("|")})`,"gi");return d.replace(x,'<span class="mention">@$1</span>')}function f(){const r=document.getElementById("boardForm");if(!r)return;const d=document.getElementById("boardMsg"),E=document.getElementById("charCounter"),x=document.getElementById("mentionDropdown");d.addEventListener("input",()=>{E.textContent=`${d.value.length} / 500`,k(d,x)}),r.addEventListener("submit",async I=>{I.preventDefault();const M=d.value.trim();if(M)try{await p.board.post(M,n),d.value="",E.textContent="0 / 500",x.classList.add("hidden");const C=await c();w(C),v("Mensaje publicado")}catch(C){v(C.message,"error")}})}function S(){e.querySelectorAll(".reply-form").forEach(r=>{const d=parseInt(r.dataset.parent),E=r.querySelector(".reply-input"),x=`mentionDropdown-${d}`,I=document.getElementById(x);E==null||E.addEventListener("input",()=>{k(E,I)}),r.addEventListener("submit",async M=>{M.preventDefault();const C=E.value.trim();if(C)try{await p.board.reply(d,C),E.value="",I==null||I.classList.add("hidden");const j=await c();w(j),v("Respuesta enviada")}catch(j){v(j.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await p.board.pin(r.dataset.id);const d=await c();w(d),v("Mensaje fijado")}catch(d){v(d.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await p.board.pin(r.dataset.id);const d=await c();w(d),v("Mensaje desfijado")}catch(d){v(d.message,"error")}})})}function $(){e.querySelectorAll(".delete-msg").forEach(r=>{r.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await p.board.delete(r.dataset.id);const d=await c();w(d),v("Mensaje eliminado")}catch(d){v(d.message,"error")}})})}function w(r){const{pinned:d=[],messages:E=[]}=r,x=document.getElementById("boardPinned");if(x)x.innerHTML=_(d);else if(d.length){m(r);return}const I=document.getElementById("boardMessages");I&&(I.innerHTML=b(E)),S(),$()}e.addEventListener("click",async r=>{if(r.target.id==="prevPage"&&o>1){o--;const d=await c();w(d)}else if(r.target.id==="nextPage"&&o<l){o++;const d=await c();w(d)}});function k(r,d){if(!d||!i.length)return;const E=r.value,x=r.selectionStart,I=E.slice(0,x),M=I.match(/@(\w*)$/);if(!M){d.classList.add("hidden");return}const C=M[1].toLowerCase(),j=i.filter(P=>P.username.toLowerCase().startsWith(C)&&P.id!==(t==null?void 0:t.id));if(!j.length){d.classList.add("hidden");return}d.innerHTML=j.slice(0,6).map(P=>`<div class="mention-item" data-username="${H(P.username)}">${H(P.username)}</div>`).join(""),d.classList.remove("hidden"),d.querySelectorAll(".mention-item").forEach(P=>{P.addEventListener("mousedown",re=>{re.preventDefault();const le=P.dataset.username,O=I.replace(/@(\w*)$/,`@${le} `);if(r.value=O+E.slice(x),r.setSelectionRange(O.length,O.length),d.classList.add("hidden"),r.tagName==="TEXTAREA"){const F=document.getElementById("charCounter");F&&(F.textContent=`${r.value.length} / 500`)}})})}document.addEventListener("click",r=>{!r.target.closest(".board-form__input-wrap")&&!r.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(d=>d.classList.add("hidden"))},{capture:!0})}function H(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ce(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Pe(e){var a,t,n,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=y.getUser(),o=i==null?void 0:i.is_admin,[l,c]=await Promise.all([o?p.leagues.adminAll():p.leagues.all(),y.isLoggedIn()&&!o?p.leagues.my():Promise.resolve({leagues:[]})]),m=new Set(c.leagues.map(u=>u.id)),_=o?l.leagues:l.leagues.filter(u=>!m.has(u.id));e.innerHTML=`
      <div class="container">
  ...
  `}async function De(e){if(!y.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await p.auth.users();e.innerHTML=`
      <div class="container">
    ...
    `,document.getElementById("btnSync").addEventListener("click",async()=>{const s=document.getElementById("syncResult");s.textContent="Sincronizando…";try{await p.matches.sync(),s.textContent="✓ Sincronización completada",v("Sincronización completada")}catch(i){s.textContent=`Error: ${i.message}`,v(i.message,"error")}}),document.getElementById("awardForm").addEventListener("submit",async s=>{s.preventDefault();const i=document.getElementById("winnerTeam").value.trim();if(i)try{const{message:o}=await p.predictions.awardChampion(i);v(o)}catch(o){v(o.message,"error")}});const t=document.getElementById("pushTarget"),n=document.getElementById("pushTargetIdGroup");t.addEventListener("change",()=>{n.classList.toggle("hidden",t.value==="all")}),document.getElementById("pushForm").addEventListener("submit",async s=>{s.preventDefault();const i=document.getElementById("pushTitle").value.trim()||"PickGoal",o=document.getElementById("pushBody").value.trim(),l=t.value,c=parseInt(document.getElementById("pushTargetId").value)||null,m=document.getElementById("pushResult"),_={title:i,body:o};l==="league"&&c&&(_.league_id=c),l==="user"&&c&&(_.user_id=c),m.textContent="Enviando…";try{const{sent:u}=await p.notifications.send(_);m.textContent=`✓ Enviada a ${u} suscripción(es)`,v(`Notificación enviada a ${u} suscripción(es)`)}catch(u){m.textContent=`Error: ${u.message}`,v(u.message,"error")}}),document.getElementById("usersTableBody").addEventListener("click",async s=>{const i=s.target.closest(".toggle-admin");if(!i)return;const o=parseInt(i.dataset.id);try{const{user:l}=await p.auth.toggleAdmin(o);i.closest("tr").querySelector(".admin-badge").textContent=l.is_admin?"Sí":"No",v(`${l.username} ${l.is_admin?"ahora es admin":"ya no es admin"}`)}catch(l){v(l.message,"error")}})}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function Oe(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}async function Ke(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!y.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),L.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:n}=await p.leagues.joinByCode(t);v(`¡Te has unido a "${n.name}"!`),L.navigate(`/ligas/${n.id}`)}catch(n){if(n.status===409){v("Ya eres miembro de esta liga");try{const{leagues:s}=await p.leagues.my(),i=s.find(o=>o.invite_code===t);if(i){L.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function We(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ye(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const n=We(),{user:s,predictions:i}=await p.predictions.forUser(t,n);e.innerHTML=`
      <div class="container">
