(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Ve="https://pickgoal-backend.onrender.com/api";function Ge(){return localStorage.getItem("token")}async function u(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Ge();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Ve}${e}`,{cache:"no-store",...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const c={get:e=>u(e),post:(e,a)=>u(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>u(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>u(e,{method:"DELETE"}),auth:{register:e=>u("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>u("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>u("/auth/me"),forgotPassword:e=>u("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>u("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>u(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>u("/auth/account",{method:"DELETE"}),users:()=>u("/auth/users"),usersForMentions:()=>u("/auth/users/for-mentions"),toggleAdmin:e=>u(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>u(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>u("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>u("/matches/grouped"),list:(e="")=>u(`/matches/${e}`),get:e=>u(`/matches/${e}`),today:()=>u("/matches/today"),setResult:(e,a,t,s=null)=>u(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>u("/matches/sync",{method:"POST"}),recalculate:()=>u("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>u(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>u(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>u("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>u(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>u(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>u("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>u("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>u("/leagues/all"),public:()=>u("/leagues/public"),my:()=>u("/leagues/my"),create:e=>u("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>u("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>u(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>u("/leagues/admin"),get:e=>u(`/leagues/${e}`),update:(e,a)=>u(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>u(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>u(`/leagues/${e}/members`),matchPredictions:(e,a)=>u(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>u("/home/summary")},board:{messages:(e=1,a=null)=>u(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>u(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>u("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>u(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>u(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>u(`/board/${e}`,{method:"DELETE"}),mentions:e=>u(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>u("/notifications/vapid-public-key"),subscribe:e=>u("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>u("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>u(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>u("/v2/admin/jornadas"),createJornada:e=>u("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>u(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>u(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>u(`/v2/admin/jornada/${e}/publish`,{method:"POST"}),closeJornada:e=>u(`/v2/admin/jornada/${e}/close`,{method:"POST"}),jornadaMatches:e=>u(`/v2/admin/jornada/${e}/matches`),setResultado:(e,a)=>u(`/v2/admin/jornada-match/${e}/resultado`,{method:"POST",body:JSON.stringify(a)}),cancelMatch:e=>u(`/v2/admin/jornada-match/${e}/cancel`,{method:"POST"}),generateBots:()=>u("/v2/admin/bots/generate",{method:"POST"})},jornada:{info:()=>u("/v2/jornada/info"),current:()=>u("/v2/jornada/current"),list:()=>u("/v2/jornada/list"),predict:e=>u("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>u("/v2/jornada/history"),myStats:()=>u("/v2/jornada/my-stats")},duelo:{list:()=>u("/v2/duelo/list"),current:e=>u(`/v2/duelo/current${e?`?jornada_id=${e}`:""}`),detail:e=>u(`/v2/duelo/current/detail${e?`?jornada_id=${e}`:""}`)},messages:{unread:()=>u("/messages/unread"),list:()=>u("/messages/"),get:e=>u(`/messages/${e}`),send:(e,a)=>u(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>u("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>u(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>u("/v2/clasificacion/general"),allDivisions:()=>u("/v2/clasificacion/all-divisions")}};let H=null;const f={async init(){if(localStorage.getItem("token"))try{const{user:a}=await c.auth.me();H=a}catch{localStorage.removeItem("token")}},setUser(e,a){H=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){H=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return H},isLoggedIn(){return!!H},isAdmin(){return(H==null?void 0:H.is_admin)===!0}};let oe=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,oe&&clearTimeout(oe),oe=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function We(){return`
  ...
  `}function K(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",r=>{r.key==="Escape"&&o()},{once:!1}),i}function k(e){const a=parseFloat(e);return isNaN(a)||e==null?"—":parseFloat(a.toFixed(2)).toString()}function T(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}const Xe="/assets/icon-512-v2-CAowBaBi.png";async function Ye(e){if(!f.getUser()){Ze(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await c.home.summary();if(s){e.innerHTML=`
        ...
        ${Z()}
      `,K(e);return}if(!t||t.length===0){Ke(e);return}const i=(()=>{const r=localStorage.getItem("activeLeagueId");return r?parseInt(r):null})(),o=[...t].sort((r,d)=>r.league_id===i?-1:d.league_id===i?1:0);e.innerHTML=`
      <div class="home-dashboard container">
        <div class="home-dashboard__topbar">
          <button class="btn btn--ghost btn--sm" id="btnPointsInfo">📊 Sistema de puntos</button>
        </div>
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await c.auth.register(n);f.setUser(o,i),v("¡Cuenta creada! Bienvenido a PickGoal");const r=sessionStorage.getItem("pendingInviteCode");if(r){sessionStorage.removeItem("pendingInviteCode");try{const{league:d}=await c.leagues.joinByCode(r);v(`¡Te has unido a "${d.name}"!`),S.navigate(`/ligas/${d.id}`)}catch{S.navigate("/ligas")}}else S.navigate("/"),Me("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function ia(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function oa(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(f.isLoggedIn()){const{leagues:p}=await c.leagues.my();if(p.length===0){e.innerHTML=We();return}}const s=ia(),[{ranking:n},i]=await Promise.all([c.auth.ranking(s),f.isLoggedIn()?c.leagues.my():Promise.resolve({leagues:[]})]),o=f.getUser(),r=i.leagues.find(p=>p.id===s),d=document.getElementById("tablonBadge"),l=d&&!d.classList.contains("hidden"),b=l?d.textContent:"",_=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
    ...
    `,(t=e.querySelector(".ranking-tablon-btn"))==null||t.addEventListener("click",()=>{S.navigate(`/tablon?liga=${s}`)})}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error: ${s.message}</p></div>`}}async function ue(e,{query:a={},forceGeneral:t=!1}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const s=f.getUser();let n=t?null:a.liga?parseInt(a.liga):null;if(t)localStorage.setItem("tablon_general_last_read",new Date().toISOString()),document.dispatchEvent(new CustomEvent("tablon:read"));else if(n){localStorage.setItem(`tablon_last_read_${n}`,new Date().toISOString());const m=document.getElementById("tablonBadge");m&&(m.classList.add("hidden"),m.textContent="")}let i=null,o=[],r=1,d=1;if(t&&s)try{const{users:m}=await c.auth.usersForMentions();o=m||[],console.log("[tablon] usuarios cargados:",o.length)}catch(m){console.warn("[tablon] error cargando usuarios:",m)}if(!t)try{if(!n&&s){const{leagues:m}=await c.leagues.my();m&&m.length&&(n=m[0].id,i=m[0].name)}else if(n)try{const{league:m}=await c.leagues.get(n);i=m.name}catch{}if(n&&s)try{const{members:m}=await c.leagues.members(n);o=m||[]}catch{}}catch{}async function l(){const m=await c.board.messages(r,n);return d=m.pages||1,m}try{const m=await l();b(m)}catch(m){e.innerHTML=`<div class="container"><p class="form__error">Error: ${m.message}</p></div>`}function b(m){const{pinned:g=[],messages:w=[]}=m;e.innerHTML=`
      <div class="container">
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function y(m){const g=D(m);if(!o.length)return g.replace(/@(\w+)/g,'<span class="mention">@$1</span>');const w=o.map(I=>ra(I.username)),B=new RegExp(`@(${w.join("|")})`,"gi");return g.replace(B,'<span class="mention">@$1</span>')}function $(){const m=document.getElementById("boardForm");if(!m)return;const g=document.getElementById("boardMsg"),w=document.getElementById("charCounter"),B=document.getElementById("mentionDropdown");g.addEventListener("input",()=>{w.textContent=`${g.value.length} / 500`,E(g,B)}),m.addEventListener("submit",async I=>{I.preventDefault();const A=g.value.trim();if(A)try{await c.board.post(A,n),g.value="",w.textContent="0 / 500",B.classList.add("hidden");const P=await l();L(P),v("Mensaje publicado")}catch(P){v(P.message,"error")}})}function j(){e.querySelectorAll(".reply-form").forEach(m=>{const g=parseInt(m.dataset.parent),w=m.querySelector(".reply-input"),B=`mentionDropdown-${g}`,I=document.getElementById(B);w==null||w.addEventListener("input",()=>{E(w,I)}),m.addEventListener("submit",async A=>{A.preventDefault();const P=w.value.trim();if(P)try{await c.board.reply(g,P),w.value="",I==null||I.classList.add("hidden");const U=await l();L(U),v("Respuesta enviada")}catch(U){v(U.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(m=>{m.addEventListener("click",async()=>{try{await c.board.pin(m.dataset.id);const g=await l();L(g),v("Mensaje fijado")}catch(g){v(g.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(m=>{m.addEventListener("click",async()=>{try{await c.board.pin(m.dataset.id);const g=await l();L(g),v("Mensaje desfijado")}catch(g){v(g.message,"error")}})})}function M(){e.querySelectorAll(".delete-msg").forEach(m=>{m.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await c.board.delete(m.dataset.id);const g=await l();L(g),v("Mensaje eliminado")}catch(g){v(g.message,"error")}})})}function L(m){const{pinned:g=[],messages:w=[]}=m,B=document.getElementById("boardPinned");if(B)B.innerHTML=_(g);else if(g.length){b(m);return}const I=document.getElementById("boardMessages");I&&(I.innerHTML=h(w)),j(),M()}e.addEventListener("click",async m=>{if(m.target.id==="prevPage"&&r>1){r--;const g=await l();L(g)}else if(m.target.id==="nextPage"&&r<d){r++;const g=await l();L(g)}});function E(m,g){if(!g||!o.length){console.log("[tablon] handleMentionInput: sin dropdown o members vacío",{dropdown:!!g,membersLen:o.length});return}const w=m.value,B=m.selectionStart,I=w.slice(0,B),A=I.match(/@(\w*)$/);if(!A){g.classList.add("hidden");return}const P=A[1].toLowerCase();console.log("[tablon] mention detected, query:",P);const U=o.filter(C=>C.username.toLowerCase().startsWith(P)&&C.id!==(s==null?void 0:s.id));console.log("[tablon] matches:",U.map(C=>C.username));const ve=[...f.isAdmin()&&"todos".startsWith(P)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...U.slice(0,6)];if(!ve.length){g.classList.add("hidden");return}g.innerHTML=ve.map(C=>C.description?`<div class="mention-item mention-item--broadcast" data-username="${D(C.username)}">
             <span class="mention-item__name">@${D(C.username)}</span>
             <span class="mention-item__desc">${D(C.description)}</span>
           </div>`:`<div class="mention-item" data-username="${D(C.username)}">${D(C.username)}</div>`).join(""),g.classList.remove("hidden"),g.querySelectorAll(".mention-item").forEach(C=>{C.addEventListener("mousedown",Fe=>{Fe.preventDefault();const ze=C.dataset.username,ie=I.replace(/@(\w*)$/,`@${ze} `);if(m.value=ie+w.slice(B),m.setSelectionRange(ie.length,ie.length),g.classList.add("hidden"),m.tagName==="TEXTAREA"){const ge=document.getElementById("charCounter");ge&&(ge.textContent=`${m.value.length} / 500`)}})})}document.addEventListener("click",m=>{!m.target.closest(".board-form__input-wrap")&&!m.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(g=>g.classList.add("hidden"))},{capture:!0})}function D(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ra(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function da(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=f.getUser(),o=i==null?void 0:i.is_admin,[r,d]=await Promise.all([o?c.leagues.adminAll():c.leagues.all(),f.isLoggedIn()&&!o?c.leagues.my():Promise.resolve({leagues:[]})]),l=new Set(d.leagues.map(_=>_.id)),b=o?r.leagues:r.leagues.filter(_=>!l.has(_.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&d.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${d.leagues.map(_=>he(_,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${b.length?`<div class="leagues-grid">${b.map(_=>he(_,!1,l,o)).join("")}</div>`:o?'<p class="empty">No hay ligas creadas aún.</p>':d.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(_=>{_.addEventListener("click",()=>S.navigate(`/ligas/${_.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(_=>{_.addEventListener("click",async p=>{p.stopPropagation();const h=parseInt(_.dataset.id);_.disabled=!0,_.textContent="…";try{const{league:y}=await c.leagues.join({league_id:h});v(`¡Te has unido a "${y.name}"!`),S.navigate(`/ligas/${y.id}`)}catch(y){v(y.message,"error"),_.disabled=!1,_.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(_=>{_.addEventListener("click",p=>{p.stopPropagation(),v("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var _,p;(_=document.getElementById("createLeaguePanel"))==null||_.classList.remove("hidden"),(p=document.getElementById("btnShowCreate"))==null||p.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var _,p;(_=document.getElementById("createLeaguePanel"))==null||_.classList.add("hidden"),(p=document.getElementById("btnShowCreate"))==null||p.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async _=>{_.preventDefault();const p=document.getElementById("inviteCode").value.trim().toUpperCase();if(p)try{const{league:h}=await c.leagues.join({invite_code:p});v(`Te has unido a "${h.name}"`),S.navigate(`/ligas/${h.id}`)}catch(h){v(h.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async _=>{var L;_.preventDefault();const p=document.getElementById("createBtn");p.disabled=!0,p.textContent="Creando…";const h=document.getElementById("leagueName").value.trim(),y=document.getElementById("leagueDesc").value.trim(),$=document.getElementById("leaguePrize").value.trim(),j=document.getElementById("isPublic").checked,M=((L=document.getElementById("isOfficial"))==null?void 0:L.checked)??!1;try{const{league:E}=await c.leagues.create({name:h,description:y,prize:$,is_public:j,is_official:M});la(E)}catch(E){v(E.message,"error"),p.disabled=!1,p.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function he(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",o=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const r=document.getElementById("btnSaveEdit");r.disabled=!0,r.textContent="Guardando…";const d={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(d.is_official=document.getElementById("editOfficial").checked);try{await c.leagues.update(a,d),v("Liga actualizada"),i(),S.navigate(`/ligas/${a}`)}catch(l){v(l.message,"error"),r.disabled=!1,r.textContent="Guardar cambios"}})}async function ma(e){var t,s,n,i,o,r;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=f.getUser();try{const[d,l,b]=await Promise.all([c.clasificacion.division(),c.auth.me(),a!=null&&a.is_admin?c.leagues.adminAll():Promise.resolve({leagues:[]})]),_=l.user,p=_.status,h=_.total_points_all_time,y=(t=d.standings)==null?void 0:t.find($=>$.user_id===_.id);e.innerHTML=`
    ...
    </div>`}async function _a(e){var t,s;const a=e.querySelector("#predStatsWrap");if(a)try{const{total_predictions:n,correct_results:i,predictions:o}=await c.jornada.myStats();if(n===0){a.innerHTML='<p class="empty">Aún no tienes predicciones en esta temporada.</p>';return}const r=Math.round(i/n*100),d=50,l=+(2*Math.PI*d).toFixed(2),b=+(r/100*l).toFixed(2),_=+(l-b).toFixed(2);a.innerHTML=`
    ...
    `,(t=a.querySelector("#predCircleBtn"))==null||t.addEventListener("click",()=>{fe(o)}),(s=a.querySelector("#predCircleBtn"))==null||s.addEventListener("keydown",p=>{(p.key==="Enter"||p.key===" ")&&fe(o)})}catch{a.innerHTML='<p class="empty">No se pudieron cargar las predicciones.</p>'}}function fe(e){var i,o;let a="all";const t=document.createElement("div");t.className="pred-modal",t.innerHTML=`
  ...
  `,document.body.appendChild(e),document.body.style.overflow="hidden",requestAnimationFrame(()=>e.classList.add("delete-modal--open"));const a=e.querySelector("#deleteConfirmInput"),t=e.querySelector("#deleteConfirmBtn"),s=e.querySelector("#deleteCancelBtn"),n=e.querySelector("#deleteOverlay"),i=e.querySelector("#deleteError");function o(){e.classList.remove("delete-modal--open"),document.body.style.overflow="",e.addEventListener("transitionend",()=>e.remove(),{once:!0})}a.addEventListener("input",()=>{t.disabled=a.value.trim()!=="CERRAR"}),s.addEventListener("click",o),n.addEventListener("click",o),t.addEventListener("click",async()=>{t.disabled=!0,t.textContent="Cerrando…",i.classList.add("hidden");try{await c.auth.deleteAccount(),o(),f.logout(),v("Cuenta cerrada. Hasta pronto."),window.location.hash="/"}catch(r){i.textContent=r.message||"Error al cerrar la cuenta",i.classList.remove("hidden"),t.disabled=!1,t.textContent="Cerrar mi cuenta"}})}function ha(){window.location.hash="/"}async function fa(e){if(!f.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await c.auth.users();e.innerHTML=`
    ...
    `,ya(e),W(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function ya(e){var s,n,i,o,r;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const d=document.getElementById("syncResult");d.textContent="Sincronizando…";try{await c.matches.sync(),d.textContent="✓ Sincronización completada",v("Sincronización completada")}catch(l){d.textContent=`Error: ${l.message}`,v(l.message,"error")}}),(n=document.getElementById("btnGenerateBots"))==null||n.addEventListener("click",async()=>{const d=document.getElementById("btnGenerateBots"),l=document.getElementById("generateBotsResult");d.disabled=!0,l.textContent="Generando…";try{const{message:b}=await c.adminV2.generateBots();l.textContent=`✓ ${b}`,v(b)}catch(b){l.textContent=`Error: ${b.message}`,v(b.message,"error")}finally{d.disabled=!1}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(i=document.getElementById("pushForm"))==null||i.addEventListener("submit",async d=>{d.preventDefault();const l=document.getElementById("pushTitle").value.trim()||"Aviso",b=document.getElementById("pushBody").value.trim(),_=a.value,p=parseInt(document.getElementById("pushTargetId").value)||null,h=document.getElementById("pushResult"),y={title:`📣 PickGoal — ${l}`,body:b};_==="league"&&p&&(y.league_id=p),_==="user"&&p&&(y.user_id=p),h.textContent="Enviando…";try{const{sent:$}=await c.notifications.send(y);h.textContent=`✓ Enviada a ${$} suscripción(es)`,v(`Notificación enviada a ${$} suscripción(es)`)}catch($){h.textContent=`Error: ${$.message}`,v($.message,"error")}}),(o=document.getElementById("btnCloseSeason"))==null||o.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const d=document.getElementById("btnCloseSeason"),l=document.getElementById("closeSeasonResult");d.disabled=!0,l.textContent="Cerrando…";try{const{message:b}=await c.post("/v2/admin/season/1/close");l.textContent=`✓ ${b||"Temporada cerrada"}`,v("Temporada cerrada")}catch(b){l.textContent=`Error: ${b.message}`,v(b.message,"error"),d.disabled=!1}}),(r=document.getElementById("usersTableBody"))==null||r.addEventListener("click",async d=>{const l=d.target.closest(".toggle-admin");if(l){const _=parseInt(l.dataset.id);try{const{user:p}=await c.auth.toggleAdmin(_);l.closest("tr").querySelector(".admin-badge").textContent=p.is_admin?"Sí":"No",v(`${p.username} ${p.is_admin?"ahora es admin":"ya no es admin"}`)}catch(p){v(p.message,"error")}return}const b=d.target.closest(".toggle-mute");if(b){const _=parseInt(b.dataset.id);try{const{user:p}=await c.auth.toggleMute(_),h=b.closest("tr");h.querySelector(".mute-badge").textContent=p.is_muted?"Sí":"No",b.textContent=p.is_muted?"Activar":"Silenciar",v(`${p.username} ${p.is_muted?"silenciado":"activado"}`)}catch(p){v(p.message,"error")}}})}function $a(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const Ea={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let x=[],ae=null;async function W(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await c.adminV2.jornadas();a.innerHTML=La(t),ja(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function La(e){const t=Da(new Date);return`
    <div class="jv2-panel">
  ...
  `}function ja(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{ae=null,x=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",me()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",x=[],ae=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",ka),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",Ca),e.querySelectorAll(".jv2-results-btn").forEach(i=>{i.addEventListener("click",()=>Ba(i.dataset.id,i))}),e.querySelectorAll(".jv2-pub-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${i.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){i.disabled=!0,i.textContent="Publicando…";try{const o=await c.adminV2.publishJornada(i.dataset.id);v(`Jornada ${i.dataset.num} publicada — push enviado a ${o.push_sent} suscriptores`),await W(document.getElementById("jornadasV2Section"))}catch(o){v(o.message,"error"),i.disabled=!1,i.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-close-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Cerrar jornada ${i.dataset.num}? Se calcularán los puntos y se resolverán los duelos. Esta acción es irreversible.`)){i.disabled=!0,i.textContent="Cerrando…";try{const o=await c.adminV2.closeJornada(i.dataset.id);v(o.message||`Jornada ${i.dataset.num} cerrada`),await W(document.getElementById("jornadasV2Section"))}catch(o){v(o.message,"error"),i.disabled=!1,i.textContent="Cerrar jornada"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>Sa(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await c.adminV2.deleteJornada(i.dataset.id),v("Jornada eliminada"),W(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(o){v(o.message,"error")}})})}async function Sa(e){const{jornadas:a}=await c.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(ae=t.id,x=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",me())}async function ka(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){v("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await c.adminV2.partidos(a);Ia(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){v(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function Ia(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
  ...
  `}function He(e,a){var t;(t=e.querySelector(".jv2-sync-btn"))==null||t.addEventListener("click",async s=>{const n=s.currentTarget;n.disabled=!0,n.textContent="⏳ Sincronizando…";try{await c.matches.sync(),v("Sincronización completada"),await re(a)}catch(i){v(i.message,"error"),n.disabled=!1,n.textContent="🔄 Sincronizar resultados ahora"}}),e.querySelectorAll(".jv2-save-result-btn").forEach(s=>{s.addEventListener("click",async()=>{var l,b,_;const n=s.dataset.jmId,i=e.querySelector(`.jv2-results-row[data-jm-id="${n}"]`),o=(l=i.querySelector('.jv2-score-input[data-side="home"]'))==null?void 0:l.value,r=(b=i.querySelector('.jv2-score-input[data-side="away"]'))==null?void 0:b.value,d=((_=i.querySelector(".jv2-r90-select"))==null?void 0:_.value)||void 0;if(o===""||r===""){v("Introduce los dos marcadores","error");return}s.disabled=!0,s.textContent="…";try{const p={home_score:parseInt(o),away_score:parseInt(r)};d&&(p.result_90=d),await c.adminV2.setResultado(n,p),v("Resultado guardado y puntos recalculados"),await re(a)}catch(p){v(p.message,"error"),s.disabled=!1,s.textContent="Guardar"}})}),e.querySelectorAll(".jv2-cancel-match-btn").forEach(s=>{s.addEventListener("click",async()=>{const{jmId:n,home:i,away:o}=s.dataset;if(confirm(`¿Cancelar el partido ${i} vs ${o}? Las unidades apostadas se devolverán a los usuarios.`)){s.disabled=!0,s.textContent="…";try{const{message:r}=await c.adminV2.cancelMatch(n);v(r),await re(a)}catch(r){v(r.message,"error"),s.disabled=!1,s.textContent="Cancelar"}}})})}async function re(e){const a=document.getElementById(`jv2-results-${e}`);if(!(!a||a.style.display==="none"))try{const{matches:t}=await c.adminV2.jornadaMatches(e);a.innerHTML=De(t,e),He(a,e)}catch(t){v(`Error recargando: ${t.message}`,"error")}}function Ma(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function Da(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(Ma(a)).padStart(2,"0");return`${t}-W${s}`}function Ha(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await c.auth.resetPassword(t,o),v("Contraseña actualizada. Ya puedes iniciar sesión."),S.navigate("/login")}catch(r){i.textContent=r.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function Aa(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!f.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),S.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await c.leagues.joinByCode(t);v(`¡Te has unido a "${s.name}"!`),S.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){v("Ya eres miembro de esta liga");try{const{leagues:n}=await c.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){S.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function Na(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Oa(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=Na(),{user:n,predictions:i}=await c.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const V=20,qe=5;let R={},O=0,le=null,ye=null;async function Ua(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await c.jornada.list();if(!a.length){e.innerHTML=Ja();return}Ae(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Ae(e,a,t){var d,l;ye=a[t];const{jornada:s,matches:n,units_used:i}=ye;R={};for(const b of n)R[b.jornada_match_id]={predicted_result:((d=b.prediction)==null?void 0:d.predicted_result)??null,units:((l=b.prediction)==null?void 0:l.units_wagered)??0};O=i;const o=n.filter(b=>!b.predict_locked);le=o.length===1?o[0].jornada_match_id:null;const r=a.length>1?`<div class="jornada-tabs">
        ${a.map((b,_)=>`
          <button class="jornada-tab ${_===t?"jornada-tab--active":""}" data-idx="${_}">
            J${b.jornada.number} · ${Q(b.jornada.date_start)}–${Q(b.jornada.date_end)}
          </button>
        `).join("")}
       </div>`:"";e.innerHTML=`
    <div class="container">
      <div class="page-title-row">
        <h1 class="page-title">Jornada ${s.number} — del ${Q(s.date_start)} al ${Q(s.date_end)}</h1>
  ...
  `,Ne(),Oe(),Ga(e,a,t),K(e)}function Ja(){return`
    <div class="container">
  ...
  `}function Oe(){if(!le)return;const e=document.getElementById(`warning-${le}`);if(!e)return;const a=V-O;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function $e(){O=Object.values(R).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),Ne(),Oe()}function Ga(e,a,t){e.querySelectorAll(".jornada-tab").forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.idx);n!==t&&Ae(e,a,n)})}),e.querySelectorAll(".jornada-match").forEach(s=>{var o;const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(r=>{r.addEventListener("change",()=>{R[n].predicted_result=r.value,$e()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let r=parseInt(i.value);isNaN(r)&&(r=0),r=Math.max(0,Math.min(qe,r)),R[n].units=r,$e()}),(o=s.querySelector(".jornada-match__save-btn"))==null||o.addEventListener("click",()=>Wa(n))})}async function Wa(e){const a=R[e];if(!a.predicted_result){v("Selecciona un resultado 1X2","error");return}if(O>V){v(`Superas el máximo de ${V} unidades`,"error");return}const t=document.querySelector(`.jornada-match__save-btn[data-jm-id="${e}"]`);t&&(t.disabled=!0,t.textContent="…");try{await c.jornada.predict({jornada_match_id:e,predicted_result:a.predicted_result,units:a.units}),v("Predicción guardada"),t&&(t.textContent="✓ Guardada")}catch(s){v(s.message||"Error al guardar","error")}finally{t&&(t.disabled=!1,setTimeout(()=>{t&&(t.textContent="Guardar")},2e3))}}let ee=null;function pe(){ee&&(clearInterval(ee),ee=null)}const Ee={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}},Xa={ganado:"🏆 Victoria",perdido:"💔 Derrota",empate:"🤝 Empate"};function Le(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}async function Ya(e){pe(),e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const[{duelos:a},t]=await Promise.all([c.duelo.list(),Promise.resolve(f.getUser())]);if(!a.length){e.innerHTML=`
    ...
    `,K(e),e.querySelectorAll(".jornada-tab").forEach(o=>{o.addEventListener("click",()=>{e.querySelectorAll(".jornada-tab").forEach(r=>r.classList.remove("jornada-tab--active")),o.classList.add("jornada-tab--active"),we(e,a[parseInt(o.dataset.idx)],t)})}),await we(e,a[n],t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando duelos: ${a.message}</p></div>`}}async function we(e,a,t){var i;pe();const s=e.querySelector("#dueloContent");if(!s)return;if(s.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',a.jornada_status==="active"||a.jornada_status==="upcoming")try{const{duelo:o}=await c.duelo.current(a.jornada_id);if(!o){s.innerHTML=Qa();return}if(s.innerHTML=Za(o,t),Se(s,o.division_league_id,t.id),!a.is_bye){const r=((i=a.rival)==null?void 0:i.username)??"—";je(a.jornada_id,t.username,r),ee=setInterval(()=>je(a.jornada_id,t.username,r),6e4)}}catch(o){s.innerHTML=`<p class="form__error">Error: ${o.message}</p>`}else s.innerHTML=Ka(a,t),Se(s,a.division_league_id,t.id)}function Za(e,a){var i;const t=Ee[e.status]??Ee.en_curso,s=e.rival?e.rival.username:a.username,n=!e.rival||e.rival.id===a.id;return`
  ...
  `}async function je(e,a,t){const s=document.getElementById("dueloTracker");if(!s){pe();return}try{const{detail:n}=await c.duelo.detail(e);if(!n)return;s.innerHTML=et(n,a,t)}catch{}}function et(e,a,t){const{me:s,rival:n}=e;function i(o,r){return`
  ...
  `}async function Se(e,a,t){const s=e.querySelector("#divisionStandings");if(s)try{const{standings:n}=await c.clasificacion.division(a);if(!n.length){s.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}s.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(n){s.innerHTML=`<p class="form__error">Error cargando la clasificación: ${n.message}</p>`}}async function tt(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:t}=await c.clasificacion.general(),s=f.getUser();e.innerHTML=`
      <div class="container">
        <div class="page-title-row">
          <h1 class="page-title">Clasificación</h1>
          <button class="btn-info" id="btnPointsInfo" aria-label="Cómo funciona">ℹ️</button>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function ot(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await c.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>rt(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function rt(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
  ...
  `}async function ke(e,{params:a={}}={}){const t=a.userId?parseInt(a.userId):null;t?await ut(e,t):await lt(e)}async function lt(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{conversations:a}=await c.messages.list();e.innerHTML=`
      <div class="container">
  ...
  `}async function ut(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=f.getUser();try{const{messages:n,partner:i}=await c.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
      <div class="container">
