(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Oe="https://pickgoal-backend.onrender.com/api";function Ne(){return localStorage.getItem("token")}async function p(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Ne();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Oe}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const c={get:e=>p(e),post:(e,a)=>p(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>p(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>p(e,{method:"DELETE"}),auth:{register:e=>p("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>p("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>p("/auth/me"),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>p("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>p(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>p("/auth/account",{method:"DELETE"}),users:()=>p("/auth/users"),usersForMentions:()=>p("/auth/users/for-mentions"),toggleAdmin:e=>p(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>p(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>p("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>p("/matches/grouped"),list:(e="")=>p(`/matches/${e}`),get:e=>p(`/matches/${e}`),today:()=>p("/matches/today"),setResult:(e,a,t,s=null)=>p(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>p("/matches/sync",{method:"POST"}),recalculate:()=>p("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>p(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>p(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>p("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>p(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>p(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>p("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>p("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>p("/leagues/all"),public:()=>p("/leagues/public"),my:()=>p("/leagues/my"),create:e=>p("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>p("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>p(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>p("/leagues/admin"),get:e=>p(`/leagues/${e}`),update:(e,a)=>p(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>p(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>p(`/leagues/${e}/members`),matchPredictions:(e,a)=>p(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>p("/home/summary")},board:{messages:(e=1,a=null)=>p(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>p(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>p("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>p(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>p(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>p(`/board/${e}`,{method:"DELETE"}),mentions:e=>p(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>p("/notifications/vapid-public-key"),subscribe:e=>p("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>p("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>p(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>p("/v2/admin/jornadas"),createJornada:e=>p("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>p(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>p(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>p(`/v2/admin/jornada/${e}/publish`,{method:"POST"}),jornadaMatches:e=>p(`/v2/admin/jornada/${e}/matches`),setResultado:(e,a)=>p(`/v2/admin/jornada-match/${e}/resultado`,{method:"POST",body:JSON.stringify(a)}),cancelMatch:e=>p(`/v2/admin/jornada-match/${e}/cancel`,{method:"POST"})},jornada:{info:()=>p("/v2/jornada/info"),current:()=>p("/v2/jornada/current"),list:()=>p("/v2/jornada/list"),predict:e=>p("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>p("/v2/jornada/history"),myStats:()=>p("/v2/jornada/my-stats")},duelo:{current:()=>p("/v2/duelo/current")},messages:{unread:()=>p("/messages/unread"),list:()=>p("/messages/"),get:e=>p(`/messages/${e}`),send:(e,a)=>p(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>p("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>p(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>p("/v2/clasificacion/general"),allDivisions:()=>p("/v2/clasificacion/all-divisions")}};let D=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await c.auth.me();D=a}catch{localStorage.removeItem("token")}},setUser(e,a){D=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){D=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return D},isLoggedIn(){return!!D},isAdmin(){return(D==null?void 0:D.is_admin)===!0}};let ne=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,ne&&clearTimeout(ne),ne=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function Ue(){return`
  ...
  `}function Y(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",d=>{d.key==="Escape"&&o()},{once:!1}),i}function B(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}const Re="/assets/icon-512-v2-CAowBaBi.png";async function Je(e){if(!y.getUser()){Fe(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await c.home.summary();if(s){e.innerHTML=`
        ...
        ${X()}
      `,Y(e);return}if(!t||t.length===0){ze(e);return}const i=(()=>{const d=localStorage.getItem("activeLeagueId");return d?parseInt(d):null})(),o=[...t].sort((d,r)=>d.league_id===i?-1:r.league_id===i?1:0);e.innerHTML=`
      <div class="home-dashboard container">
        <div class="home-dashboard__topbar">
          <button class="btn btn--ghost btn--sm" id="btnPointsInfo">📊 Sistema de puntos</button>
        </div>
      ...
      ${X()}
    `,Y(e),e.querySelectorAll(".league-card[data-league-id]").forEach(d=>{d.style.cursor="pointer",d.addEventListener("click",r=>{r.target.closest("[data-go-ranking]")||r.target.closest("a")||(localStorage.setItem("activeLeagueId",d.dataset.leagueId),S.navigate(`/ligas/${d.dataset.leagueId}`))})}),e.querySelectorAll("[data-go-ranking]").forEach(d=>{d.addEventListener("click",r=>{r.stopPropagation(),localStorage.setItem("activeLeagueId",d.dataset.goRanking),S.navigate("/ranking")})})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el inicio: ${t.message}</p></div>`}}async function Fe(e){const t=new Date>=new Date("2026-08-15T00:00:00Z");let s=null;if(t)try{s=await c.jornada.info()}catch{}e.innerHTML=`
    <section class="hero">
      <div class="hero__content">
        <img src="${Re}" alt="PickGoal" class="hero__logo-img" />
        <div class="hero__cta">
  ...
  `}function Ve(e){const a={promotion:"⬆️ Zona ascenso",relegation:"⬇️ Zona descenso",mid:""},t=a[e.zone]?`<span class="div-card__zone div-card__zone--${e.zone}">${a[e.zone]}</span>`:"";return`
    <div class="div-card">
  ...
  `}function Ge(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function Se(e=null,a=!1){let t,s;if(a&&(e!=null&&e.jornada_number))s="Temporada 26/27 · En curso",t=`
      ...
      </div>`;else if(a)s="Temporada 26/27 · En curso",t='<div class="pg-league-card__countdown pg-league-card__countdown--soon">Temporada en curso</div>';else{const n=Ge("2026-08-15");s="Temporada 26/27 · Próximamente",t=n>0?`<div class="pg-league-card__countdown">
  ...
  `}function We(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `;const t=a.firstElementChild;document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("welcome-modal--open"));function s(n){t.classList.remove("welcome-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0}),n&&(window.location.hash=n)}document.getElementById("welcomeOverlay").addEventListener("click",()=>s()),document.getElementById("welcomeCta").addEventListener("click",()=>s(e)),document.addEventListener("keydown",function n(i){i.key==="Escape"&&(s(),document.removeEventListener("keydown",n))})}function Ye(e){e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await c.auth.register(n);y.setUser(o,i),v("¡Cuenta creada! Bienvenido a PickGoal");const d=sessionStorage.getItem("pendingInviteCode");if(d){sessionStorage.removeItem("pendingInviteCode");try{const{league:r}=await c.leagues.joinByCode(d);v(`¡Te has unido a "${r.name}"!`),S.navigate(`/ligas/${r.id}`)}catch{S.navigate("/ligas")}}else S.navigate("/"),Ie("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function Ke(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Qe(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:_}=await c.leagues.my();if(_.length===0){e.innerHTML=Ue();return}}const s=Ke(),[{ranking:n},i]=await Promise.all([c.auth.ranking(s),y.isLoggedIn()?c.leagues.my():Promise.resolve({leagues:[]})]),o=y.getUser(),d=i.leagues.find(_=>_.id===s),r=document.getElementById("tablonBadge"),l=r&&!r.classList.contains("hidden"),b=l?r.textContent:"",m=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
    ...
    `,(t=e.querySelector(".ranking-tablon-btn"))==null||t.addEventListener("click",()=>{S.navigate(`/tablon?liga=${s}`)})}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error: ${s.message}</p></div>`}}async function re(e,{query:a={},forceGeneral:t=!1}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const s=y.getUser();let n=t?null:a.liga?parseInt(a.liga):null;if(t)localStorage.setItem("tablon_general_last_read",new Date().toISOString()),document.dispatchEvent(new CustomEvent("tablon:read"));else if(n){localStorage.setItem(`tablon_last_read_${n}`,new Date().toISOString());const u=document.getElementById("tablonBadge");u&&(u.classList.add("hidden"),u.textContent="")}let i=null,o=[],d=1,r=1;if(t&&s)try{const{users:u}=await c.auth.usersForMentions();o=u||[],console.log("[tablon] usuarios cargados:",o.length)}catch(u){console.warn("[tablon] error cargando usuarios:",u)}if(!t)try{if(!n&&s){const{leagues:u}=await c.leagues.my();u&&u.length&&(n=u[0].id,i=u[0].name)}else if(n)try{const{league:u}=await c.leagues.get(n);i=u.name}catch{}if(n&&s)try{const{members:u}=await c.leagues.members(n);o=u||[]}catch{}}catch{}async function l(){const u=await c.board.messages(d,n);return r=u.pages||1,u}try{const u=await l();b(u)}catch(u){e.innerHTML=`<div class="container"><p class="form__error">Error: ${u.message}</p></div>`}function b(u){const{pinned:g=[],messages:w=[]}=u;e.innerHTML=`
      <div class="container">
    ...
    `,E(),j(),P()}function m(u){return u.length?u.map(g=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function f(u){const g=M(u);if(!o.length)return g.replace(/@(\w+)/g,'<span class="mention">@$1</span>');const w=o.map(I=>ea(I.username)),x=new RegExp(`@(${w.join("|")})`,"gi");return g.replace(x,'<span class="mention">@$1</span>')}function E(){const u=document.getElementById("boardForm");if(!u)return;const g=document.getElementById("boardMsg"),w=document.getElementById("charCounter"),x=document.getElementById("mentionDropdown");g.addEventListener("input",()=>{w.textContent=`${g.value.length} / 500`,$(g,x)}),u.addEventListener("submit",async I=>{I.preventDefault();const q=g.value.trim();if(q)try{await c.board.post(q,n),g.value="",w.textContent="0 / 500",x.classList.add("hidden");const T=await l();L(T),v("Mensaje publicado")}catch(T){v(T.message,"error")}})}function j(){e.querySelectorAll(".reply-form").forEach(u=>{const g=parseInt(u.dataset.parent),w=u.querySelector(".reply-input"),x=`mentionDropdown-${g}`,I=document.getElementById(x);w==null||w.addEventListener("input",()=>{$(w,I)}),u.addEventListener("submit",async q=>{q.preventDefault();const T=w.value.trim();if(T)try{await c.board.reply(g,T),w.value="",I==null||I.classList.add("hidden");const U=await l();L(U),v("Respuesta enviada")}catch(U){v(U.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();L(g),v("Mensaje fijado")}catch(g){v(g.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();L(g),v("Mensaje desfijado")}catch(g){v(g.message,"error")}})})}function P(){e.querySelectorAll(".delete-msg").forEach(u=>{u.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await c.board.delete(u.dataset.id);const g=await l();L(g),v("Mensaje eliminado")}catch(g){v(g.message,"error")}})})}function L(u){const{pinned:g=[],messages:w=[]}=u,x=document.getElementById("boardPinned");if(x)x.innerHTML=m(g);else if(g.length){b(u);return}const I=document.getElementById("boardMessages");I&&(I.innerHTML=h(w)),j(),P()}e.addEventListener("click",async u=>{if(u.target.id==="prevPage"&&d>1){d--;const g=await l();L(g)}else if(u.target.id==="nextPage"&&d<r){d++;const g=await l();L(g)}});function $(u,g){if(!g||!o.length){console.log("[tablon] handleMentionInput: sin dropdown o members vacío",{dropdown:!!g,membersLen:o.length});return}const w=u.value,x=u.selectionStart,I=w.slice(0,x),q=I.match(/@(\w*)$/);if(!q){g.classList.add("hidden");return}const T=q[1].toLowerCase();console.log("[tablon] mention detected, query:",T);const U=o.filter(k=>k.username.toLowerCase().startsWith(T)&&k.id!==(s==null?void 0:s.id));console.log("[tablon] matches:",U.map(k=>k.username));const ce=[...y.isAdmin()&&"todos".startsWith(T)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...U.slice(0,6)];if(!ce.length){g.classList.add("hidden");return}g.innerHTML=ce.map(k=>k.description?`<div class="mention-item mention-item--broadcast" data-username="${M(k.username)}">
             <span class="mention-item__name">@${M(k.username)}</span>
             <span class="mention-item__desc">${M(k.description)}</span>
           </div>`:`<div class="mention-item" data-username="${M(k.username)}">${M(k.username)}</div>`).join(""),g.classList.remove("hidden"),g.querySelectorAll(".mention-item").forEach(k=>{k.addEventListener("mousedown",qe=>{qe.preventDefault();const Ae=k.dataset.username,se=I.replace(/@(\w*)$/,`@${Ae} `);if(u.value=se+w.slice(x),u.setSelectionRange(se.length,se.length),g.classList.add("hidden"),u.tagName==="TEXTAREA"){const ue=document.getElementById("charCounter");ue&&(ue.textContent=`${u.value.length} / 500`)}})})}document.addEventListener("click",u=>{!u.target.closest(".board-form__input-wrap")&&!u.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(g=>g.classList.add("hidden"))},{capture:!0})}function M(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ea(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function aa(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=y.getUser(),o=i==null?void 0:i.is_admin,[d,r]=await Promise.all([o?c.leagues.adminAll():c.leagues.all(),y.isLoggedIn()&&!o?c.leagues.my():Promise.resolve({leagues:[]})]),l=new Set(r.leagues.map(m=>m.id)),b=o?d.leagues:d.leagues.filter(m=>!l.has(m.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&r.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${r.leagues.map(m=>ge(m,!0)).join("")}</div>
          </section>
        `:""}
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function sa(e,{params:a}){var s,n,i,o,d;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const r=await c.leagues.get(t),{league:l,ranking:b,is_member:m,is_admin_view:_}=r,h=y.getUser(),f=l.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
    ...
    `,(s=document.getElementById("btnCopyInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(l.invite_link),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShareInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${l.name} en PickGoal`,url:l.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await c.leagues.leave(t),v("Has abandonado la liga"),S.navigate("/ligas")}catch($){v($.message,"error")}}),(o=document.getElementById("btnJoin"))==null||o.addEventListener("click",async()=>{try{await c.leagues.join({league_id:t}),v("¡Te has unido a la liga!"),S.navigate(`/ligas/${t}`)}catch($){v($.message,"error")}}),(d=document.getElementById("btnEditLeague"))==null||d.addEventListener("click",()=>{na(l,t,h)});const E=document.getElementById("tabRanking"),j=document.getElementById("tabTablon"),P=document.getElementById("sectionRanking"),L=document.getElementById("sectionTablon");E&&j&&(E.addEventListener("click",()=>{E.classList.add("league-tab--active"),j.classList.remove("league-tab--active"),P.classList.remove("hidden"),L.classList.add("hidden")}),j.addEventListener("click",()=>{j.classList.add("league-tab--active"),E.classList.remove("league-tab--active"),P.classList.add("hidden"),L.classList.remove("hidden");const $=document.getElementById("tablonEmbed");$&&!$.dataset.loaded&&($.dataset.loaded="1",re($,{query:{liga:String(t)}}))}))}catch(r){e.innerHTML=`<div class="container"><p class="form__error">Error: ${r.message}</p><a href="#/ligas">Volver</a></div>`}}function na(e,a,t){const s=document.getElementById("editLeagueModal");s&&s.remove();const n=document.createElement("div");n.id="editLeagueModal",n.className="edit-league-modal",n.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("btnSaveEdit");d.disabled=!0,d.textContent="Guardando…";const r={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(r.is_official=document.getElementById("editOfficial").checked);try{await c.leagues.update(a,r),v("Liga actualizada"),i(),S.navigate(`/ligas/${a}`)}catch(l){v(l.message,"error"),d.disabled=!1,d.textContent="Guardar cambios"}})}async function ia(e){var t,s,n,i,o,d;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=y.getUser();try{const[r,l,b]=await Promise.all([c.clasificacion.division(),c.auth.me(),a!=null&&a.is_admin?c.leagues.adminAll():Promise.resolve({leagues:[]})]),m=l.user,_=m.status,h=m.total_points_all_time,f=(t=r.standings)==null?void 0:t.find(E=>E.user_id===m.id);e.innerHTML=`
      <div class="container">
        ...
        <section class="section">
          ...
          ${f?`<div class="division-info">
                 <p class="division-info__name">${r.league_name||"PickGoal División"}</p>
                 <div class="division-info__stats">
                   <div class="division-info__stat">
                     <span>${f.pos}º</span>
                     <small>de ${r.standings.length}</small>
                   </div>
                   <div class="division-info__stat">
    ...
    </div>`}async function la(e){var t,s;const a=e.querySelector("#predStatsWrap");if(a)try{const{total_predictions:n,correct_results:i,predictions:o}=await c.jornada.myStats();if(n===0){a.innerHTML='<p class="empty">Aún no tienes predicciones en esta temporada.</p>';return}const d=Math.round(i/n*100),r=50,l=+(2*Math.PI*r).toFixed(2),b=+(d/100*l).toFixed(2),m=+(l-b).toFixed(2);a.innerHTML=`
      <div class="pred-circle-wrap" id="predCircleBtn" role="button" tabindex="0" title="Ver detalle">
        <div class="pred-circle__chart">
          ...
          <div class="pred-circle__label">
            <span class="pred-circle__pct">${d}%</span>
          </div>
        </div>
  ...
  `,document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("pred-modal--open"));function s(){const d=a==="all"?e:a==="correct"?e.filter(l=>l.is_correct):e.filter(l=>l.result_known&&!l.is_correct),r=document.getElementById("predModalList");if(r){if(!d.length){r.innerHTML='<p class="empty" style="text-align:center;padding:1rem">Sin predicciones en este filtro.</p>';return}r.innerHTML=d.map(l=>{const b=l.result_known?l.is_correct?"✅":"❌":"⏳",m=l.score?`${l.score}`:"—",_=l.result_known?`+${l.points_earned} pts`:"—";return`
      ...
      `}).join("")}}s(),t.querySelectorAll(".pred-filter").forEach(d=>{d.addEventListener("click",()=>{t.querySelectorAll(".pred-filter").forEach(r=>r.classList.remove("pred-filter--active")),d.classList.add("pred-filter--active"),a=d.dataset.filter,s()})});function n(){t.classList.remove("pred-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0})}(i=document.getElementById("predModalClose"))==null||i.addEventListener("click",n),(o=document.getElementById("predModalOverlay"))==null||o.addEventListener("click",n)}function ca(){const e=document.createElement("div");e.className="delete-modal",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.body.style.overflow="hidden",requestAnimationFrame(()=>e.classList.add("delete-modal--open"));const a=e.querySelector("#deleteConfirmInput"),t=e.querySelector("#deleteConfirmBtn"),s=e.querySelector("#deleteCancelBtn"),n=e.querySelector("#deleteOverlay"),i=e.querySelector("#deleteError");function o(){e.classList.remove("delete-modal--open"),document.body.style.overflow="",e.addEventListener("transitionend",()=>e.remove(),{once:!0})}a.addEventListener("input",()=>{t.disabled=a.value.trim()!=="CERRAR"}),s.addEventListener("click",o),n.addEventListener("click",o),t.addEventListener("click",async()=>{t.disabled=!0,t.textContent="Cerrando…",i.classList.add("hidden");try{await c.auth.deleteAccount(),o(),y.logout(),v("Cuenta cerrada. Hasta pronto."),window.location.hash="/"}catch(d){i.textContent=d.message||"Error al cerrar la cuenta",i.classList.remove("hidden"),t.disabled=!1,t.textContent="Cerrar mi cuenta"}})}function ua(){window.location.hash="/"}async function ma(e){if(!y.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await c.auth.users();e.innerHTML=`
    ...
    `,pa(e),Q(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function pa(e){var s,n,i,o;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const d=document.getElementById("syncResult");d.textContent="Sincronizando…";try{await c.matches.sync(),d.textContent="✓ Sincronización completada",v("Sincronización completada")}catch(r){d.textContent=`Error: ${r.message}`,v(r.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async d=>{d.preventDefault();const r=document.getElementById("pushTitle").value.trim()||"Aviso",l=document.getElementById("pushBody").value.trim(),b=a.value,m=parseInt(document.getElementById("pushTargetId").value)||null,_=document.getElementById("pushResult"),h={title:`📣 PickGoal — ${r}`,body:l};b==="league"&&m&&(h.league_id=m),b==="user"&&m&&(h.user_id=m),_.textContent="Enviando…";try{const{sent:f}=await c.notifications.send(h);_.textContent=`✓ Enviada a ${f} suscripción(es)`,v(`Notificación enviada a ${f} suscripción(es)`)}catch(f){_.textContent=`Error: ${f.message}`,v(f.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const d=document.getElementById("btnCloseSeason"),r=document.getElementById("closeSeasonResult");d.disabled=!0,r.textContent="Cerrando…";try{const{message:l}=await c.post("/v2/admin/season/1/close");r.textContent=`✓ ${l||"Temporada cerrada"}`,v("Temporada cerrada")}catch(l){r.textContent=`Error: ${l.message}`,v(l.message,"error"),d.disabled=!1}}),(o=document.getElementById("usersTableBody"))==null||o.addEventListener("click",async d=>{const r=d.target.closest(".toggle-admin");if(r){const b=parseInt(r.dataset.id);try{const{user:m}=await c.auth.toggleAdmin(b);r.closest("tr").querySelector(".admin-badge").textContent=m.is_admin?"Sí":"No",v(`${m.username} ${m.is_admin?"ahora es admin":"ya no es admin"}`)}catch(m){v(m.message,"error")}return}const l=d.target.closest(".toggle-mute");if(l){const b=parseInt(l.dataset.id);try{const{user:m}=await c.auth.toggleMute(b),_=l.closest("tr");_.querySelector(".mute-badge").textContent=m.is_muted?"Sí":"No",l.textContent=m.is_muted?"Activar":"Silenciar",v(`${m.username} ${m.is_muted?"silenciado":"activado"}`)}catch(m){v(m.message,"error")}}})}function ga(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const va={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let C=[],K=null;async function Q(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await c.adminV2.jornadas();a.innerHTML=_a(t),ha(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function _a(e){const t=Sa(new Date);return`
    <div class="jv2-panel">
  ...
  `}function ha(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{K=null,C=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",le()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",C=[],K=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",ya),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",Ea),e.querySelectorAll(".jv2-results-btn").forEach(i=>{i.addEventListener("click",()=>wa(i.dataset.id,i))}),e.querySelectorAll(".jv2-pub-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${i.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){i.disabled=!0,i.textContent="Publicando…";try{const o=await c.adminV2.publishJornada(i.dataset.id);v(`Jornada ${i.dataset.num} publicada — push enviado a ${o.push_sent} suscriptores`),await Q(document.getElementById("jornadasV2Section"))}catch(o){v(o.message,"error"),i.disabled=!1,i.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>fa(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await c.adminV2.deleteJornada(i.dataset.id),v("Jornada eliminada"),Q(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(o){v(o.message,"error")}})})}async function fa(e){const{jornadas:a}=await c.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(K=t.id,C=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",le())}async function ya(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){v("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await c.adminV2.partidos(a);$a(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){v(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function $a(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        <div class="jv2-comp-group__title">${va[s]||s}</div>
        ${n.map(i=>`
          <label class="jv2-match-item">
            ...
            <span class="jv2-match-item__date">${La(i.match_datetime)}</span>
          </label>
        `).join("")}
      </div>
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(C.length>=10){s.checked=!1,v("Máximo 10 partidos","error");return}C.push(n)}else C=C.filter(i=>i.api_id!==n.api_id);le()})})}function le(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=C.length),a&&(a.style.display=C.length>0&&C.length!==10?"inline":"none")}async function Ea(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){v("Completa número y fechas","error");return}if(C.length!==10){v("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:C},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await c.adminV2.updateJornada(s,n),v(`Jornada ${e} actualizada`)):(await c.adminV2.createJornada(n),v(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",C=[],K=null,await Q(document.getElementById("jornadasV2Section"))}catch(o){v(o.message,"error")}finally{i.disabled=!1}}function La(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}async function wa(e,a){const t=document.getElementById(`jv2-results-${e}`);if(t){if(t.style.display!=="none"){t.style.display="none",a.textContent="Resultados";return}a.disabled=!0,a.textContent="Cargando…";try{const{matches:s}=await c.adminV2.jornadaMatches(e);t.innerHTML=ke(s),t.style.display="block",Ce(t,e),a.textContent="Ocultar"}catch(s){v(`Error: ${s.message}`,"error"),a.textContent="Resultados"}finally{a.disabled=!1}}}function ke(e){return`
  ...
  `}function Ce(e,a){e.querySelectorAll(".jv2-save-result-btn").forEach(t=>{t.addEventListener("click",async()=>{var r,l,b;const s=t.dataset.jmId,n=e.querySelector(`.jv2-results-row[data-jm-id="${s}"]`),i=(r=n.querySelector('.jv2-score-input[data-side="home"]'))==null?void 0:r.value,o=(l=n.querySelector('.jv2-score-input[data-side="away"]'))==null?void 0:l.value,d=((b=n.querySelector(".jv2-r90-select"))==null?void 0:b.value)||void 0;if(i===""||o===""){v("Introduce los dos marcadores","error");return}t.disabled=!0,t.textContent="…";try{const m={home_score:parseInt(i),away_score:parseInt(o)};d&&(m.result_90=d),await c.adminV2.setResultado(s,m),v("Resultado guardado y puntos recalculados"),await _e(a)}catch(m){v(m.message,"error"),t.disabled=!1,t.textContent="Guardar"}})}),e.querySelectorAll(".jv2-cancel-match-btn").forEach(t=>{t.addEventListener("click",async()=>{const{jmId:s,home:n,away:i}=t.dataset;if(confirm(`¿Cancelar el partido ${n} vs ${i}? Las unidades apostadas se devolverán a los usuarios.`)){t.disabled=!0,t.textContent="…";try{const{message:o}=await c.adminV2.cancelMatch(s);v(o),await _e(a)}catch(o){v(o.message,"error"),t.disabled=!1,t.textContent="Cancelar"}}})})}async function _e(e){const a=document.getElementById(`jv2-results-${e}`);if(!(!a||a.style.display==="none"))try{const{matches:t}=await c.adminV2.jornadaMatches(e);a.innerHTML=ke(t),Ce(a,e)}catch(t){v(`Error recargando: ${t.message}`,"error")}}function ja(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function Sa(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(ja(a)).padStart(2,"0");return`${t}-W${s}`}function Ia(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await c.auth.resetPassword(t,o),v("Contraseña actualizada. Ya puedes iniciar sesión."),S.navigate("/login")}catch(d){i.textContent=d.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function Ca(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!y.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),S.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await c.leagues.joinByCode(t);v(`¡Te has unido a "${s.name}"!`),S.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){v("Ya eres miembro de esta liga");try{const{leagues:n}=await c.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){S.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function xa(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ba(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=xa(),{user:n,predictions:i}=await c.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const z=20,xe=5;let N={},O=0,oe=null,be=null;async function Pa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await c.jornada.list();if(!a.length){e.innerHTML=Ma();return}Be(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Be(e,a,t){var r,l;be=a[t];const{jornada:s,matches:n,units_used:i}=be;N={};for(const b of n)N[b.jornada_match_id]={predicted_result:((r=b.prediction)==null?void 0:r.predicted_result)??null,units:((l=b.prediction)==null?void 0:l.units_wagered)??0};O=i;const o=n.filter(b=>!b.predict_locked);oe=o.length===1?o[0].jornada_match_id:null;const d=a.length>1?`<div class="jornada-tabs">
        ${a.map((b,m)=>`
  ...
  `,Te(),Pe(),Oa(e,a,t),Y(e)}function Ma(){return`
    <div class="container">
  ...
  `}function Z(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function Da(e){return new Date(e).toLocaleTimeString("es-ES",{hour:"2-digit",minute:"2-digit"})}function Ha(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function ie(e){return e!=null?e.toFixed(2):"—"}function qa(e){return e.jm_status==="cancelled"?'<span class="tag tag--cancelled">Suspendido</span>':e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${Da(e.opens_until)}</span>`}function Aa(e){const a=e.jm_status==="cancelled",t=e.predict_locked,s=N[e.jornada_match_id]??{predicted_result:null,units:0};return`
    <div class="match-card jornada-match ${t?"match-card--locked":""} ${a?"match-card--cancelled":""}" data-jm-id="${e.jornada_match_id}">
      ...
      <div class="jornada-odds">
        <span class="jornada-odds__item"><b>1</b> (${ie(e.odds_1)})</span>
        <span class="jornada-odds__item"><b>X</b> (${ie(e.odds_x)})</span>
        <span class="jornada-odds__item"><b>2</b> (${ie(e.odds_2)})</span>
      </div>
      <div class="jornada-match__controls ${t?"jornada-match__controls--disabled":""}">
        ...
        <div class="jornada-units">
          ...
          <input type="number" id="units-${e.jornada_match_id}" class="jornada-units__input" min="0" max="${xe}" value="${s.units}" ${t?"disabled":""} />
        </div>
      </div>
      ${t?"":`
  ...
  `}function Pe(){if(!oe)return;const e=document.getElementById(`warning-${oe}`);if(!e)return;const a=z-O;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function he(){O=Object.values(N).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),Te(),Pe()}function Oa(e,a,t){e.querySelectorAll(".jornada-tab").forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.idx);n!==t&&Be(e,a,n)})}),e.querySelectorAll(".jornada-match").forEach(s=>{var o;const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(d=>{d.addEventListener("change",()=>{N[n].predicted_result=d.value,he()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let d=parseInt(i.value);isNaN(d)&&(d=0),d=Math.max(0,Math.min(xe,d)),N[n].units=d,he()}),(o=s.querySelector(".jornada-match__save-btn"))==null||o.addEventListener("click",()=>Na(n))})}async function Na(e){const a=N[e];if(!a.predicted_result){v("Selecciona un resultado 1X2","error");return}if(O>z){v(`Superas el máximo de ${z} unidades`,"error");return}const t=document.querySelector(`.jornada-match__save-btn[data-jm-id="${e}"]`);t&&(t.disabled=!0,t.textContent="…");try{await c.jornada.predict({jornada_match_id:e,predicted_result:a.predicted_result,units:a.units}),v("Predicción guardada"),t&&(t.textContent="✓ Guardada")}catch(s){v(s.message||"Error al guardar","error")}finally{t&&(t.disabled=!1,setTimeout(()=>{t&&(t.textContent="Guardar")},2e3))}}const fe={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function Ua(e){var a;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:t}=await c.duelo.current(),s=y.getUser();if(!t){e.innerHTML=`
        <div class="container">
    ...
    `,Y(e),Ja(t.division_league_id,s.id)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${t.message}</p></div>`}}function Ra(e,a){var i;const t=(i=e.my_prediction)==null?void 0:i.predicted_result;let s,n;return e.started?e.rival_prediction?(s=e.rival_prediction.predicted_result,n=""):(s="—",n="duelo-pick__value--empty"):(s="?",n="duelo-pick__value--hidden"),`
  ...
  `}async function Ja(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await c.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
                    ...
                    ${t.map(n=>{var i,o;return`
                      <tr class="${s&&n.user_id===s.id?"ranking-table__row--me":""}">
                        ...
                        <td>
                          ...
                          ${n.is_bot||s&&n.user_id===s.id?ee(n.username):`<button class="user-link" data-user-id="${n.user_id}">${ee(n.username)}</button>`}
                        </td>
    ...
    `,Va(s,a.tab),Y(e),za(),Ya(e,s)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${t.message}</p></div>`}}async function za(){const e=document.getElementById("tablonTabDot");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString();try{const{count:s}=await c.board.unread(null,t);console.log("[tablonDot] count:",s,"since:",t),e.classList.toggle("hidden",s===0)}catch(s){console.warn("[tablonDot] error:",s),e.classList.add("hidden")}}function Va(e,a){const t={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")},tablon:{btn:document.getElementById("tabTablon"),panel:document.getElementById("panelTablon")}};function s(i){for(const[o,{btn:d,panel:r}]of Object.entries(t))d.classList.toggle("league-tab--active",o===i),r.classList.toggle("hidden",o!==i)}t.general.btn.addEventListener("click",()=>s("general")),t.miDivision.btn.addEventListener("click",()=>{s("miDivision"),t.miDivision.panel.dataset.loaded||(t.miDivision.panel.dataset.loaded="1",Ga(e))}),t.divisiones.btn.addEventListener("click",()=>{s("divisiones"),t.divisiones.panel.dataset.loaded||(t.divisiones.panel.dataset.loaded="1",Wa(e))});function n(){var i;s("tablon"),localStorage.setItem("tablon_general_last_read",new Date().toISOString()),(i=document.getElementById("tablonTabDot"))==null||i.classList.add("hidden"),document.dispatchEvent(new CustomEvent("tablon:read")),t.tablon.panel.dataset.loaded||(t.tablon.panel.dataset.loaded="1",re(t.tablon.panel,{forceGeneral:!0}))}t.tablon.btn.addEventListener("click",n),a==="tablon"&&n()}async function Ga(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await c.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function Wa(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await c.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>Xa(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Xa(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
      ...
      <div class="div-accordion__body">
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${e.standings.map(s=>Me(s,a)).join("")}
            </tbody>
          </table>
        </div>
      </div>
    </div>
  `}function ee(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ya(e,a){let t=document.getElementById("userCtxMenu");t||(t=document.createElement("div"),t.id="userCtxMenu",t.className="user-ctx-menu hidden",t.innerHTML=`
    ...
    <tr class="${t?"ranking-table__row--me":""}" style="${s}">
      ...
      <td>${t||e.is_bot?ee(e.username):`<button class="user-link" data-user-id="${e.user_id}">${ee(e.username)}</button>`}</td>
  ...
  `}async function ye(e,{params:a={}}={}){const t=a.userId?parseInt(a.userId):null;t?await Qa(e,t):await Za(e)}async function Za(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{conversations:a}=await c.messages.list();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">💬 Mensajes</h1>
        ${a.length===0?'<p class="empty">No tienes conversaciones aún. Pulsa el nombre de un jugador en la clasificación para enviar un mensaje.</p>':`<div class="mensajes-list">${a.map(Ka).join("")}</div>`}
      </div>
    `,e.querySelectorAll(".mensajes-item").forEach(t=>{t.addEventListener("click",()=>{window.location.hash=`/mensajes/${t.dataset.userId}`})})}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function Ka(e){return`
  ...
  `}async function Qa(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=y.getUser();try{const{messages:n,partner:i}=await c.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
      <div class="container">
        ...
        <div class="chat-messages" id="chatMessages">
          ${n.length===0?'<p class="empty" style="text-align:center">Empieza la conversación.</p>':n.map(d=>$e(d,t)).join("")}
        </div>
    ...
    `;const o=document.getElementById("chatMessages");o&&(o.scrollTop=o.scrollHeight),(s=document.getElementById("chatForm"))==null||s.addEventListener("submit",async d=>{d.preventDefault();const r=document.getElementById("chatMsg"),l=r.value.trim();if(!l)return;const b=d.target.querySelector('button[type="submit"]');b.disabled=!0;try{const{message:m}=await c.messages.send(a,l);r.value="";const _=document.getElementById("chatMessages"),h=_==null?void 0:_.querySelector(".empty");h&&h.remove(),_==null||_.insertAdjacentHTML("beforeend",$e(m,t)),_&&(_.scrollTop=_.scrollHeight)}catch(m){v(m.message,"error")}finally{b.disabled=!1}})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function $e(e,a){return`
  ...
  `}function G(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Ee=e=>()=>{window.location.hash=e},et={"/":Je,"/login":Ye,"/register":Ze,"/quiniela":Ee("/jornada"),"/resultados":Ee("/tabla-v2"),"/ranking":Qe,"/tablon":re,"/ligas":aa,"/ligas/:id":sa,"/perfil":ia,"/campeon":ua,"/admin":ma,"/forgot-password":Ia,"/reset-password":ka,"/unirse":Ca,"/jugador/:id":Ba,"/jornada":Pa,"/duelo":Ua,"/tabla-v2":Fa,"/mensajes":ye,"/mensajes/:userId":ye};function at(e){for(const[a,t]of Object.entries(et)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,d)=>(s.push(d),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((d,r)=>{o[d]=i[r+1]}),{handler:t,params:o}}}return null}const Le=()=>document.getElementById("mainContent"),S={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=at(a);if(!n){Le().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2","/mensajes"].includes(a)&&!y.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!y.isAdmin()){this.navigate("/");return}const r=Le();r.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(r,{params:o,query:s})}};let V=[],F=null,R=null,ae=!1;async function tt(){document.documentElement.dataset.build="2026-08-13T17",await y.init(),S.init(),it(),st(),rt()}function De(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function st(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!De()&&(F=e,nt())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),F=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function nt(){if(De()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("installBtn").addEventListener("click",async()=>{F&&(F.prompt(),await F.userChoice,F=null,e.remove())}),document.getElementById("installDismissBtn").addEventListener("click",()=>{sessionStorage.setItem("installBannerDismissed","1"),e.remove()})}function A(){var e,a;(e=document.getElementById("userDropdown"))==null||e.classList.add("hidden"),(a=document.getElementById("userBtn"))==null||a.classList.remove("navbar__dropdown-btn--open")}async function W(){const e=document.getElementById("perfilBadge"),a=document.getElementById("navMensajesDot");if(!y.getUser()){e==null||e.classList.add("hidden"),a==null||a.classList.add("hidden");return}try{const s=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString(),[n,i]=await Promise.all([c.board.mentions(s).catch(r=>(console.warn("[perfilBadge] mentions error:",r),{count:0})),c.messages.unread().catch(r=>(console.warn("[perfilBadge] pm unread error:",r),{count:0}))]),o=n.count||0,d=i.count||0;console.log("[perfilBadge] mentions:",o,"pm:",d),e==null||e.classList.toggle("hidden",o+d===0),a==null||a.classList.toggle("hidden",d===0)}catch(s){console.warn("[perfilBadge] error:",s),e==null||e.classList.add("hidden"),a==null||a.classList.add("hidden")}}async function te(){const e=document.getElementById("tablonBadge");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString();try{const{count:s}=await c.board.unread(null,t);s>0?(e.textContent=s>99?"99+":String(s),e.classList.remove("hidden")):e.classList.add("hidden")}catch{e.classList.add("hidden")}}function it(){var e,a,t,s;document.addEventListener("auth:change",we),window.addEventListener("hashchange",()=>{A(),He(),setTimeout(te,200),setTimeout(W,200)}),document.addEventListener("tablon:read",()=>{W(),te()}),document.addEventListener("messages:read",()=>{W()}),document.addEventListener("click",A),(e=document.getElementById("userBtn"))==null||e.addEventListener("click",n=>{var d;n.stopPropagation();const i=document.getElementById("userDropdown"),o=i==null?void 0:i.classList.contains("hidden");A(),o&&(i==null||i.classList.remove("hidden"),(d=document.getElementById("userBtn"))==null||d.classList.add("navbar__dropdown-btn--open"))}),(a=document.getElementById("userDropdown"))==null||a.addEventListener("click",n=>{n.stopPropagation(),n.target.closest("#navProfileLink")&&A()}),(t=document.getElementById("navMensajesLink"))==null||t.addEventListener("click",async n=>{n.preventDefault(),n.stopPropagation(),A(),ae?de():await lt()}),document.addEventListener("click",n=>{ae&&!n.target.closest("#notifPanel")&&!n.target.closest("#navMensajesLink")&&de()}),(s=document.getElementById("navLogoutBtn"))==null||s.addEventListener("click",()=>{V=[],localStorage.removeItem("activeLeagueId"),A(),y.logout(),S.navigate("/")}),we()}async function we(){var i;const e=document.getElementById("navAuthLinks"),a=document.getElementById("userBtn"),t=document.getElementById("navUsername"),s=document.getElementById("bottomNav"),n=y.getUser();if(A(),n){e==null||e.classList.add("hidden"),t&&(t.textContent=n.username),a.style.visibility="visible",console.log("[navbar] userBtn visibility:",a.style.visibility,"computed:",getComputedStyle(a).visibility,"offsetWidth:",a.offsetWidth,"right rect:",a.getBoundingClientRect().right),s==null||s.classList.remove("hidden"),document.body.classList.add("has-bottom-nav"),(i=document.getElementById("navAdminLink"))==null||i.classList.toggle("hidden",!n.is_admin);try{const{leagues:o}=n.is_admin?await c.leagues.adminAll():await c.leagues.my();V=o}catch{V=[]}ot(V),te(),W(),R&&clearInterval(R),R=setInterval(()=>{te(),W()},5*60*1e3)}else e==null||e.classList.remove("hidden"),a.style.visibility="hidden",s==null||s.classList.add("hidden"),document.body.classList.remove("has-bottom-nav"),V=[],localStorage.removeItem("activeLeagueId"),R&&(clearInterval(R),R=null);He()}function ot(e){const a=localStorage.getItem("activeLeagueId");a&&e.some(s=>String(s.id)===String(a))||(e.length>0?localStorage.setItem("activeLeagueId",String(e[0].id)):localStorage.removeItem("activeLeagueId"))}function He(){const e=window.location.hash.slice(1).split("?")[0]||"/";document.querySelectorAll(".bottom-nav__item").forEach(a=>{const t=a.dataset.route,s=t==="/"?e==="/":e===t||e.startsWith(t+"/");a.classList.toggle("bottom-nav__item--active",s)})}function dt(e){const a="=".repeat((4-e.length%4)%4),t=(e+a).replace(/-/g,"+").replace(/_/g,"/"),s=atob(t);return Uint8Array.from([...s].map(n=>n.charCodeAt(0)))}async function rt(){if(!(!("serviceWorker"in navigator)||!("PushManager"in window)))try{const e=await navigator.serviceWorker.register("/sw.js");document.addEventListener("auth:change",async a=>{a.detail&&await je(e)}),y.getUser()&&await je(e)}catch{}}async function je(e){try{if(await Notification.requestPermission()!=="granted")return;const t=await e.pushManager.getSubscription();if(t){await c.notifications.subscribe(t.toJSON());return}const{public_key:s}=await c.notifications.vapidPublicKey();if(!s)return;const n=await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:dt(s)});await c.notifications.subscribe(n.toJSON())}catch{}}function de(){var e;(e=document.getElementById("notifPanel"))==null||e.classList.add("hidden"),ae=!1}async function lt(){const e=document.getElementById("notifPanel"),a=document.getElementById("notifPanelBody");if(!(!e||!a)){ae=!0,e.classList.remove("hidden"),a.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const t=new Date(Date.now()-2592e6).toISOString(),[s,n,i]=await Promise.all([c.messages.list().catch(()=>({conversations:[]})),c.board.messages(1,null).catch(()=>({messages:[]})),c.board.mentions(t).catch(()=>({messages:[]}))]),o=(s.conversations||[]).slice(0,5),d=(n.messages||[]).slice(0,5),r=new Set((i.messages||[]).map(l=>l.id));a.innerHTML=ct(o,d,r),a.querySelectorAll(".notif-item[data-nav]").forEach(l=>{l.addEventListener("click",()=>{de(),window.location.hash=l.dataset.nav})})}catch{a.innerHTML='<p class="notif-panel__empty">Error cargando notificaciones</p>'}}}function ct(e,a,t){const s=e.length===0?'<p class="notif-panel__empty">Aún no tienes mensajes</p>':e.map(i=>`
  ...
  `}function J(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}tt();
