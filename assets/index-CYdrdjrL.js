(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Le="https://pickgoal-backend.onrender.com/api";function we(){return localStorage.getItem("token")}async function u(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=we();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Le}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const m={get:e=>u(e),post:(e,a)=>u(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>u(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>u(e,{method:"DELETE"}),auth:{register:e=>u("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>u("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>u("/auth/me"),forgotPassword:e=>u("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>u("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>u(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>u("/auth/users"),toggleAdmin:e=>u(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>u("/matches/grouped"),list:(e="")=>u(`/matches/${e}`),get:e=>u(`/matches/${e}`),today:()=>u("/matches/today"),setResult:(e,a,t,s=null)=>u(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>u("/matches/sync",{method:"POST"}),recalculate:()=>u("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>u(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>u(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>u("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>u(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>u(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>u("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>u("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>u("/leagues/all"),public:()=>u("/leagues/public"),my:()=>u("/leagues/my"),create:e=>u("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>u("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>u(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>u("/leagues/admin"),get:e=>u(`/leagues/${e}`),update:(e,a)=>u(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>u(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>u(`/leagues/${e}/members`),matchPredictions:(e,a)=>u(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>u("/home/summary")},board:{messages:(e=1,a=null)=>u(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>u(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>u("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>u(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>u(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>u(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>u("/notifications/vapid-public-key"),subscribe:e=>u("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>u("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>u(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>u("/v2/admin/jornadas"),createJornada:e=>u("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>u(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>u(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>u(`/v2/admin/jornada/${e}/publish`,{method:"POST"})},jornada:{current:()=>u("/v2/jornada/current"),list:()=>u("/v2/jornada/list"),predict:e=>u("/v2/jornada/predict",{method:"POST",body:JSON.stringify({predictions:e})}),history:()=>u("/v2/jornada/history")},duelo:{current:()=>u("/v2/duelo/current")},clasificacion:{division:e=>u(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>u("/v2/clasificacion/general"),allDivisions:()=>u("/v2/clasificacion/all-divisions")}};let T=null;const f={async init(){if(localStorage.getItem("token"))try{const{user:a}=await m.auth.me();T=a}catch{localStorage.removeItem("token")}},setUser(e,a){T=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){T=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return T},isLoggedIn(){return!!T},isAdmin(){return(T==null?void 0:T.is_admin)===!0}};let V=null;function p(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,V&&clearTimeout(V),V=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function Ie(){return`
  ...
  `}function ae(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function d(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",d),n==null||n.addEventListener("click",d),document.addEventListener("keydown",l=>{l.key==="Escape"&&d()},{once:!1}),i}function D(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function je(e){if(!f.getUser()){Se(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await m.home.summary();if(s){e.innerHTML=`
        ...
        ${ee()}
      `,ae(e);return}if(!t||t.length===0){ke(e);return}const i=(()=>{const l=localStorage.getItem("activeLeagueId");return l?parseInt(l):null})(),d=[...t].sort((l,c)=>l.league_id===i?-1:c.league_id===i?1:0);e.innerHTML=`
      <div class="home-dashboard container">
        <div class="home-dashboard__topbar">
          <button class="btn btn--ghost btn--sm" id="btnPointsInfo">📊 Sistema de puntos</button>
        </div>
      ...
      ${ee()}
    `,ae(e),e.querySelectorAll(".league-card[data-league-id]").forEach(l=>{l.style.cursor="pointer",l.addEventListener("click",c=>{c.target.closest("[data-go-ranking]")||c.target.closest("a")||(localStorage.setItem("activeLeagueId",l.dataset.leagueId),E.navigate(`/ligas/${l.dataset.leagueId}`))})}),e.querySelectorAll("[data-go-ranking]").forEach(l=>{l.addEventListener("click",c=>{c.stopPropagation(),localStorage.setItem("activeLeagueId",l.dataset.goRanking),E.navigate("/ranking")})})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el inicio: ${t.message}</p></div>`}}function Se(e){e.innerHTML=`
    <section class="hero">
  ...
  `,Ce(e)}function Be(e){const a={promotion:"⬆️ Zona ascenso",relegation:"⬇️ Zona descenso",mid:""},t=a[e.zone]?`<span class="div-card__zone div-card__zone--${e.zone}">${a[e.zone]}</span>`:"";return`
    <div class="div-card">
  ...
  `}function xe(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function Pe(){const e=xe("2026-08-15");return`
  ...
  `}function Ce(e){var a;(a=e.querySelector("#btnWaitlist"))==null||a.addEventListener("click",()=>{p("¡Ya estás dentro! Te avisaremos cuando empiece la temporada 🎉")})}function Te(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `:""}const se="pickgoal_welcome_shown";function me(e="/ligas"){if(localStorage.getItem(se))return;localStorage.setItem(se,"1");const a=document.createElement("div");a.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:d}=await m.auth.register(n);f.setUser(d,i),p("¡Cuenta creada! Bienvenido a PickGoal");const l=sessionStorage.getItem("pendingInviteCode");if(l){sessionStorage.removeItem("pendingInviteCode");try{const{league:c}=await m.leagues.joinByCode(l);p(`¡Te has unido a "${c.name}"!`),E.navigate(`/ligas/${c.id}`)}catch{E.navigate("/ligas")}}else E.navigate("/campeon"),me("/ligas")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function He(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ne(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(f.isLoggedIn()){const{leagues:_}=await m.leagues.my();if(_.length===0){e.innerHTML=Ie();return}}const s=He(),[{ranking:n},i]=await Promise.all([m.auth.ranking(s),f.isLoggedIn()?m.leagues.my():Promise.resolve({leagues:[]})]),d=f.getUser(),l=i.leagues.find(_=>_.id===s),c=document.getElementById("tablonBadge"),g=c&&!c.classList.contains("hidden"),y=g?c.textContent:"",v=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        ...
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(_=>{var x,o,r;const b=_.predictions_made??0,h=`${b}/${v}`,w=`${_.correct_results??0}/${b}`,B=`${_.exact_scores??0}/${b}`;return`
                  <tr class="${d&&_.id===d.id?"ranking-table__row--me":""}">
                    ...
                    <td>
                      <a class="ranking-table__link" href="#/jugador/${_.id}">
                        <span class="status-emoji" title="${((x=_.status)==null?void 0:x.name)||""}">${((o=_.status)==null?void 0:o.emoji)||""}</span>${_.username}
                      </a>
                    </td>
    ...
    `,(t=e.querySelector(".ranking-tablon-btn"))==null||t.addEventListener("click",()=>{E.navigate(`/tablon?liga=${s}`)})}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error: ${s.message}</p></div>`}}async function pe(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=f.getUser();let s=a.liga?parseInt(a.liga):null;if(s){localStorage.setItem(`tablon_last_read_${s}`,new Date().toISOString());const o=document.getElementById("tablonBadge");o&&(o.classList.add("hidden"),o.textContent="")}let n=null,i=[],d=1,l=1;try{if(!s&&t){const{leagues:o}=await m.leagues.my();o&&o.length&&(s=o[0].id,n=o[0].name)}else if(s)try{const{league:o}=await m.leagues.get(s);n=o.name}catch{}if(s&&t)try{const{members:o}=await m.leagues.members(s);i=o||[]}catch{}}catch{}async function c(){const o=await m.board.messages(d,s);return l=o.pages||1,o}try{const o=await c();g(o)}catch(o){e.innerHTML=`<div class="container"><p class="form__error">Error: ${o.message}</p></div>`}function g(o){const{pinned:r=[],messages:$=[]}=o;e.innerHTML=`
      <div class="container">
    ...
    `,h(),w(),B()}function y(o){return o.length?o.map(r=>`
      <div class="board-message board-message--pinned" data-id="${r.id}">
        <div class="board-message__header">
          ...
          <strong class="board-message__author">${C(r.username)}</strong>
    ...
    `).join(""):""}function v(o){return`
      <div class="board-reply ${o.is_deleted?"board-reply--deleted":""}" data-id="${o.id}">
        <div class="board-reply__header">
          <strong class="board-reply__author">${C(o.username)}</strong>
    ...
    `}function _(o){return o.length?o.map(r=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function b(o){const r=C(o);if(!i.length)return r;const $=i.map(L=>Oe(L.username)),S=new RegExp(`@(${$.join("|")})`,"gi");return r.replace(S,'<span class="mention">@$1</span>')}function h(){const o=document.getElementById("boardForm");if(!o)return;const r=document.getElementById("boardMsg"),$=document.getElementById("charCounter"),S=document.getElementById("mentionDropdown");r.addEventListener("input",()=>{$.textContent=`${r.value.length} / 500`,x(r,S)}),o.addEventListener("submit",async L=>{L.preventDefault();const M=r.value.trim();if(M)try{await m.board.post(M,s),r.value="",$.textContent="0 / 500",S.classList.add("hidden");const P=await c();I(P),p("Mensaje publicado")}catch(P){p(P.message,"error")}})}function w(){e.querySelectorAll(".reply-form").forEach(o=>{const r=parseInt(o.dataset.parent),$=o.querySelector(".reply-input"),S=`mentionDropdown-${r}`,L=document.getElementById(S);$==null||$.addEventListener("input",()=>{x($,L)}),o.addEventListener("submit",async M=>{M.preventDefault();const P=$.value.trim();if(P)try{await m.board.reply(r,P),$.value="",L==null||L.classList.add("hidden");const U=await c();I(U),p("Respuesta enviada")}catch(U){p(U.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(o=>{o.addEventListener("click",async()=>{try{await m.board.pin(o.dataset.id);const r=await c();I(r),p("Mensaje fijado")}catch(r){p(r.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(o=>{o.addEventListener("click",async()=>{try{await m.board.pin(o.dataset.id);const r=await c();I(r),p("Mensaje desfijado")}catch(r){p(r.message,"error")}})})}function B(){e.querySelectorAll(".delete-msg").forEach(o=>{o.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await m.board.delete(o.dataset.id);const r=await c();I(r),p("Mensaje eliminado")}catch(r){p(r.message,"error")}})})}function I(o){const{pinned:r=[],messages:$=[]}=o,S=document.getElementById("boardPinned");if(S)S.innerHTML=y(r);else if(r.length){g(o);return}const L=document.getElementById("boardMessages");L&&(L.innerHTML=_($)),w(),B()}e.addEventListener("click",async o=>{if(o.target.id==="prevPage"&&d>1){d--;const r=await c();I(r)}else if(o.target.id==="nextPage"&&d<l){d++;const r=await c();I(r)}});function x(o,r){if(!r||!i.length)return;const $=o.value,S=o.selectionStart,L=$.slice(0,S),M=L.match(/@(\w*)$/);if(!M){r.classList.add("hidden");return}const P=M[1].toLowerCase(),U=i.filter(k=>k.username.toLowerCase().startsWith(P)&&k.id!==(t==null?void 0:t.id)),Q=[...f.isAdmin()&&"todos".startsWith(P)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...U.slice(0,6)];if(!Q.length){r.classList.add("hidden");return}r.innerHTML=Q.map(k=>k.description?`<div class="mention-item mention-item--broadcast" data-username="${C(k.username)}">
             <span class="mention-item__name">@${C(k.username)}</span>
             <span class="mention-item__desc">${C(k.description)}</span>
           </div>`:`<div class="mention-item" data-username="${C(k.username)}">${C(k.username)}</div>`).join(""),r.classList.remove("hidden"),r.querySelectorAll(".mention-item").forEach(k=>{k.addEventListener("mousedown",$e=>{$e.preventDefault();const Ee=k.dataset.username,G=L.replace(/@(\w*)$/,`@${Ee} `);if(o.value=G+$.slice(S),o.setSelectionRange(G.length,G.length),r.classList.add("hidden"),o.tagName==="TEXTAREA"){const Z=document.getElementById("charCounter");Z&&(Z.textContent=`${o.value.length} / 500`)}})})}document.addEventListener("click",o=>{!o.target.closest(".board-form__input-wrap")&&!o.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(r=>r.classList.add("hidden"))},{capture:!0})}function C(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Oe(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Ae(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=f.getUser(),d=i==null?void 0:i.is_admin,[l,c]=await Promise.all([d?m.leagues.adminAll():m.leagues.all(),f.isLoggedIn()&&!d?m.leagues.my():Promise.resolve({leagues:[]})]),g=new Set(c.leagues.map(v=>v.id)),y=d?l.leagues:l.leagues.filter(v=>!g.has(v.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!d&&c.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${c.leagues.map(v=>ne(v,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${y.length?`<div class="leagues-grid">${y.map(v=>ne(v,!1,g,d)).join("")}</div>`:d?'<p class="empty">No hay ligas creadas aún.</p>':c.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(v=>{v.addEventListener("click",()=>E.navigate(`/ligas/${v.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(v=>{v.addEventListener("click",async _=>{_.stopPropagation();const b=parseInt(v.dataset.id);v.disabled=!0,v.textContent="…";try{const{league:h}=await m.leagues.join({league_id:b});p(`¡Te has unido a "${h.name}"!`),E.navigate(`/ligas/${h.id}`)}catch(h){p(h.message,"error"),v.disabled=!1,v.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(v=>{v.addEventListener("click",_=>{_.stopPropagation(),p("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var v,_;(v=document.getElementById("createLeaguePanel"))==null||v.classList.remove("hidden"),(_=document.getElementById("btnShowCreate"))==null||_.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var v,_;(v=document.getElementById("createLeaguePanel"))==null||v.classList.add("hidden"),(_=document.getElementById("btnShowCreate"))==null||_.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async v=>{v.preventDefault();const _=document.getElementById("inviteCode").value.trim().toUpperCase();if(_)try{const{league:b}=await m.leagues.join({invite_code:_});p(`Te has unido a "${b.name}"`),E.navigate(`/ligas/${b.id}`)}catch(b){p(b.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async v=>{var x;v.preventDefault();const _=document.getElementById("createBtn");_.disabled=!0,_.textContent="Creando…";const b=document.getElementById("leagueName").value.trim(),h=document.getElementById("leagueDesc").value.trim(),w=document.getElementById("leaguePrize").value.trim(),B=document.getElementById("isPublic").checked,I=((x=document.getElementById("isOfficial"))==null?void 0:x.checked)??!1;try{const{league:o}=await m.leagues.create({name:b,description:h,prize:w,is_public:B,is_official:I});qe(o)}catch(o){p(o.message,"error"),_.disabled=!1,_.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function ne(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",d=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),p("Enlace copiado")}catch{p("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function Ue(e,{params:a}){var s,n,i,d,l;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const c=await m.leagues.get(t),{league:g,ranking:y,is_member:v,is_admin_view:_}=c,b=f.getUser(),h=g.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async d=>{d.preventDefault();const l=document.getElementById("btnSaveEdit");l.disabled=!0,l.textContent="Guardando…";const c={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(c.is_official=document.getElementById("editOfficial").checked);try{await m.leagues.update(a,c),p("Liga actualizada"),i(),E.navigate(`/ligas/${a}`)}catch(g){p(g.message,"error"),l.disabled=!1,l.textContent="Guardar cambios"}})}async function Re(e){var t,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=f.getUser();try{const n=(()=>{const h=localStorage.getItem("activeLeagueId");return h?parseInt(h):null})(),[i,d,l,c,g]=await Promise.all([m.predictions.mine(n),m.predictions.getChampion(n),m.leagues.my(),m.auth.me(),a!=null&&a.is_admin?m.leagues.adminAll():Promise.resolve({leagues:[]})]),y=i.predictions.reduce((h,w)=>h+w.total_points,0)+(((t=d.champion_prediction)==null?void 0:t.points_earned)||0),v=c.user,_=v.status,b=v.total_points_all_time;e.innerHTML=`
      <div class="container">
        ...
        ${d.champion_prediction?`<section class="section">
               <h2>Predicción Campeón</h2>
               <p class="champion-pick">
                 🏆 <strong>${d.champion_prediction.team_name}</strong>
                 — ${d.champion_prediction.points_earned} puntos
               </p>
    ...
    `,(s=e.querySelector("#btnLogoutPerfil"))==null||s.addEventListener("click",()=>{f.logout(),window.location.hash="/"})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function ze(e,a){if(e.next_threshold===null)return`
  ...
  `}function Ge(){window.location.hash="/"}async function Ve(e){if(!f.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await m.auth.users();e.innerHTML=`
      <div class="container">
    ...
    `,We(e),F(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function We(e){var s,n,i,d;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const l=document.getElementById("syncResult");l.textContent="Sincronizando…";try{await m.matches.sync(),l.textContent="✓ Sincronización completada",p("Sincronización completada")}catch(c){l.textContent=`Error: ${c.message}`,p(c.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async l=>{l.preventDefault();const c=document.getElementById("pushTitle").value.trim()||"Aviso",g=document.getElementById("pushBody").value.trim(),y=a.value,v=parseInt(document.getElementById("pushTargetId").value)||null,_=document.getElementById("pushResult"),b={title:`📣 PickGoal — ${c}`,body:g};y==="league"&&v&&(b.league_id=v),y==="user"&&v&&(b.user_id=v),_.textContent="Enviando…";try{const{sent:h}=await m.notifications.send(b);_.textContent=`✓ Enviada a ${h} suscripción(es)`,p(`Notificación enviada a ${h} suscripción(es)`)}catch(h){_.textContent=`Error: ${h.message}`,p(h.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const l=document.getElementById("btnCloseSeason"),c=document.getElementById("closeSeasonResult");l.disabled=!0,c.textContent="Cerrando…";try{const{message:g}=await m.post("/v2/admin/season/1/close");c.textContent=`✓ ${g||"Temporada cerrada"}`,p("Temporada cerrada")}catch(g){c.textContent=`Error: ${g.message}`,p(g.message,"error"),l.disabled=!1}}),(d=document.getElementById("usersTableBody"))==null||d.addEventListener("click",async l=>{const c=l.target.closest(".toggle-admin");if(!c)return;const g=parseInt(c.dataset.id);try{const{user:y}=await m.auth.toggleAdmin(g);c.closest("tr").querySelector(".admin-badge").textContent=y.is_admin?"Sí":"No",p(`${y.username} ${y.is_admin?"ahora es admin":"ya no es admin"}`)}catch(y){p(y.message,"error")}})}function Xe(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const Ye={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let j=[],z=null;async function F(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await m.adminV2.jornadas();a.innerHTML=Ke(t),Ze(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Ke(e){const t=oa(new Date);return`
    <div class="jv2-panel">
  ...
  `}function Ze(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{z=null,j=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",K()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",j=[],z=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",aa),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",sa),e.querySelectorAll(".jv2-pub-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${i.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){i.disabled=!0,i.textContent="Publicando…";try{const d=await m.adminV2.publishJornada(i.dataset.id);p(`Jornada ${i.dataset.num} publicada — push enviado a ${d.push_sent} suscriptores`),await F(document.getElementById("jornadasV2Section"))}catch(d){p(d.message,"error"),i.disabled=!1,i.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>ea(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await m.adminV2.deleteJornada(i.dataset.id),p("Jornada eliminada"),F(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(d){p(d.message,"error")}})})}async function ea(e){const{jornadas:a}=await m.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(z=t.id,j=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",K())}async function aa(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){p("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await m.adminV2.partidos(a);ta(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){p(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function ta(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        <div class="jv2-comp-group__title">${Ye[s]||s}</div>
        ${n.map(i=>`
          <label class="jv2-match-item">
            ...
            <span class="jv2-match-item__date">${na(i.match_datetime)}</span>
          </label>
        `).join("")}
      </div>
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(j.length>=10){s.checked=!1,p("Máximo 10 partidos","error");return}j.push(n)}else j=j.filter(i=>i.api_id!==n.api_id);K()})})}function K(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=j.length),a&&(a.style.display=j.length>0&&j.length!==10?"inline":"none")}async function sa(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){p("Completa número y fechas","error");return}if(j.length!==10){p("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:j},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await m.adminV2.updateJornada(s,n),p(`Jornada ${e} actualizada`)):(await m.adminV2.createJornada(n),p(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",j=[],z=null,await F(document.getElementById("jornadasV2Section"))}catch(d){p(d.message,"error")}finally{i.disabled=!1}}function na(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}function ia(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function oa(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(ia(a)).padStart(2,"0");return`${t}-W${s}`}function da(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),d=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await m.auth.resetPassword(t,d),p("Contraseña actualizada. Ya puedes iniciar sesión."),E.navigate("/login")}catch(l){i.textContent=l.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function la(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!f.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),E.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await m.leagues.joinByCode(t);p(`¡Te has unido a "${s.name}"!`),E.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){p("Ya eres miembro de esta liga");try{const{leagues:n}=await m.leagues.my(),i=n.find(d=>d.invite_code===t);if(i){E.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
      <div class="container">
        <div class="league-gate">
    ...
    `}}function ca(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ua(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=ca(),{user:n,predictions:i}=await m.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const R=20,ge=5;let H={},q=0,X=null;async function pa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await m.jornada.list();if(!a.length){e.innerHTML=ga();return}ve(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function ve(e,a,t){var l,c;X=a[t];const{jornada:s,matches:n,units_used:i}=X;H={};for(const g of n)H[g.jornada_match_id]={predicted_result:((l=g.prediction)==null?void 0:l.predicted_result)??null,units:((c=g.prediction)==null?void 0:c.units_wagered)??0};q=i;const d=a.length>1?`<div class="jornada-tabs">
        ${a.map((g,y)=>`
          <button class="jornada-tab ${y===t?"jornada-tab--active":""}" data-idx="${y}">
            J${g.jornada.number} · ${ie(g.jornada.date_start)}–${ie(g.jornada.date_end)}
          </button>
        `).join("")}
       </div>`:"";e.innerHTML=`
    <div class="container">
      ...
      ${d}
      ${s.locked?'<p class="notice">⚠️ El plazo de predicción ha cerrado (ya empezó el primer partido).</p>':s.first_match_datetime?`<p class="notice notice--info">Abierto hasta ${_e(s.first_match_datetime)}</p>`:""}
  ...
  `,be(),ba(e,s.locked,a,t)}function ga(){return`
    <div class="container">
  ...
  `}function ie(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function _e(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function W(e){return e!=null?e.toFixed(2):"—"}function va(e){const a=new Date,t=new Date(e.match_datetime);return e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.status!=="scheduled"||t<=a?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${_e(e.match_datetime)}</span>`}function _a(e){const a=e.status!=="scheduled"||new Date(e.match_datetime)<=new Date,t=H[e.jornada_match_id]??{predicted_result:null,units:0};return`
    <div class="match-card jornada-match ${a?"match-card--locked":""}" data-jm-id="${e.jornada_match_id}">
      ...
      <div class="jornada-match__controls ${a?"jornada-match__controls--disabled":""}">
        ...
        <div class="jornada-units">
          ...
          <input type="number" id="units-${e.jornada_match_id}" class="jornada-units__input" min="0" max="${ge}" value="${t.units}" ${a?"disabled":""} />
        </div>
      </div>
    </div>
  `}function be(){const e=document.getElementById("unitsCounter");if(!e)return;const a=q>R;e.innerHTML=`
  ...
  `}function oe(){q=Object.values(H).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),be()}function ba(e,a,t,s){var n;e.querySelectorAll(".jornada-tab").forEach(i=>{i.addEventListener("click",()=>{const d=parseInt(i.dataset.idx);d!==s&&ve(e,t,d)})}),!a&&(e.querySelectorAll(".jornada-match").forEach(i=>{const d=parseInt(i.dataset.jmId);i.querySelectorAll('input[type="radio"]').forEach(c=>{c.addEventListener("change",()=>{H[d].predicted_result=c.value,oe()})});const l=i.querySelector(".jornada-units__input");l==null||l.addEventListener("input",()=>{let c=parseInt(l.value);isNaN(c)&&(c=0),c=Math.max(0,Math.min(ge,c)),H[d].units=c,oe()})}),(n=document.getElementById("jornadaSaveBtn"))==null||n.addEventListener("click",()=>ha(X.jornada.id)))}async function ha(e){const a=document.getElementById("jornadaSaveBtn"),t=Object.entries(H).filter(([,s])=>s.predicted_result).map(([s,n])=>({jornada_match_id:parseInt(s),predicted_result:n.predicted_result,units:n.units}));if(t.length===0){p("Selecciona al menos un resultado 1X2","error");return}if(q>R){p(`Superas el máximo de ${R} unidades`,"error");return}a.disabled=!0,a.textContent="…";try{await m.jornada.predict(t),p("Predicciones guardadas"),a.textContent="✓ Guardadas"}catch(s){p(s.message||"Error al guardar","error")}finally{a.disabled=!1,setTimeout(()=>{a&&(a.textContent="Guardar predicciones")},2e3)}}const de={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function fa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:a}=await m.duelo.current(),t=f.getUser();if(!a){e.innerHTML=`
    ...
    `,ya(a.division_league_id,t.id)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${a.message}</p></div>`}}async function ya(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await m.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function $a(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:a}=await m.clasificacion.general(),t=f.getUser();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Clasificación</h1>
    ...
    `,Ea(t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${a.message}</p></div>`}}function Ea(e){const a={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")}};function t(s){for(const[n,{btn:i,panel:d}]of Object.entries(a))i.classList.toggle("league-tab--active",n===s),d.classList.toggle("hidden",n!==s)}a.general.btn.addEventListener("click",()=>t("general")),a.miDivision.btn.addEventListener("click",()=>{t("miDivision"),a.miDivision.panel.dataset.loaded||(a.miDivision.panel.dataset.loaded="1",La(e))}),a.divisiones.btn.addEventListener("click",()=>{t("divisiones"),a.divisiones.panel.dataset.loaded||(a.divisiones.panel.dataset.loaded="1",wa(e))})}async function La(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await m.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function wa(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await m.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>Ia(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Ia(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
      ...
      <div class="div-accordion__body">
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${e.standings.map(s=>he(s,a)).join("")}
            </tbody>
          </table>
        </div>
      </div>
    </div>
  `}function he(e,a){const t=a&&e.user_id===a.id,s=e.zone==="promotion"?"background:rgba(0,255,135,0.08)":e.zone==="relegation"?"background:rgba(255,56,96,0.08)":"";return`
  ...
  `}const re=e=>()=>{window.location.hash=e},ja={"/":je,"/login":Me,"/register":De,"/quiniela":re("/jornada"),"/resultados":re("/tabla-v2"),"/ranking":Ne,"/tablon":pe,"/ligas":Ae,"/ligas/:id":Ue,"/perfil":Re,"/campeon":Ge,"/admin":Ve,"/forgot-password":da,"/reset-password":ra,"/unirse":la,"/jugador/:id":ua,"/jornada":pa,"/duelo":fa,"/tabla-v2":$a};function Sa(e){for(const[a,t]of Object.entries(ja)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(d,l)=>(s.push(l),"([^/]+)"))+"$"),i=e.match(n);if(i){const d={};return s.forEach((l,c)=>{d[l]=i[c+1]}),{handler:t,params:d}}}return null}const le=()=>document.getElementById("mainContent"),E={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=Sa(a);if(!n){le().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:d}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2"].includes(a)&&!f.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!f.isAdmin()){this.navigate("/");return}const c=le();c.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(c,{params:d,query:s})}};let J=[],A=null,N=null;async function ka(){document.documentElement.dataset.build="2026-08-07T14",await f.init(),E.init(),Pa(),Ba(),Ma()}function fe(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Ba(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!fe()&&(A=e,xa())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),A=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function xa(){if(fe()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
