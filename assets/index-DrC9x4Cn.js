(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const we="https://pickgoal-backend.onrender.com/api";function Ie(){return localStorage.getItem("token")}async function u(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Ie();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${we}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const m={get:e=>u(e),post:(e,a)=>u(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>u(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>u(e,{method:"DELETE"}),auth:{register:e=>u("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>u("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>u("/auth/me"),forgotPassword:e=>u("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>u("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>u(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>u("/auth/users"),toggleAdmin:e=>u(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>u("/matches/grouped"),list:(e="")=>u(`/matches/${e}`),get:e=>u(`/matches/${e}`),today:()=>u("/matches/today"),setResult:(e,a,t,s=null)=>u(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>u("/matches/sync",{method:"POST"}),recalculate:()=>u("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>u(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>u(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>u("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>u(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>u(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>u("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>u("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>u("/leagues/all"),public:()=>u("/leagues/public"),my:()=>u("/leagues/my"),create:e=>u("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>u("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>u(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>u("/leagues/admin"),get:e=>u(`/leagues/${e}`),update:(e,a)=>u(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>u(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>u(`/leagues/${e}/members`),matchPredictions:(e,a)=>u(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>u("/home/summary")},board:{messages:(e=1,a=null)=>u(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>u(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>u("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>u(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>u(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>u(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>u("/notifications/vapid-public-key"),subscribe:e=>u("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>u("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>u(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>u("/v2/admin/jornadas"),createJornada:e=>u("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>u(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>u(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>u(`/v2/admin/jornada/${e}/publish`,{method:"POST"})},jornada:{info:()=>u("/v2/jornada/info"),current:()=>u("/v2/jornada/current"),list:()=>u("/v2/jornada/list"),predict:e=>u("/v2/jornada/predict",{method:"POST",body:JSON.stringify({predictions:e})}),history:()=>u("/v2/jornada/history")},duelo:{current:()=>u("/v2/duelo/current")},clasificacion:{division:e=>u(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>u("/v2/clasificacion/general"),allDivisions:()=>u("/v2/clasificacion/all-divisions")}};let C=null;const h={async init(){if(localStorage.getItem("token"))try{const{user:a}=await m.auth.me();C=a}catch{localStorage.removeItem("token")}},setUser(e,a){C=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){C=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return C},isLoggedIn(){return!!C},isAdmin(){return(C==null?void 0:C.is_admin)===!0}};let V=null;function p(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,V&&clearTimeout(V),V=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function je(){return`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:d}=await m.auth.register(n);h.setUser(d,i),p("¡Cuenta creada! Bienvenido a PickGoal");const l=sessionStorage.getItem("pendingInviteCode");if(l){sessionStorage.removeItem("pendingInviteCode");try{const{league:c}=await m.leagues.joinByCode(l);p(`¡Te has unido a "${c.name}"!`),$.navigate(`/ligas/${c.id}`)}catch{$.navigate("/ligas")}}else $.navigate("/"),pe("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function He(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ne(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(h.isLoggedIn()){const{leagues:v}=await m.leagues.my();if(v.length===0){e.innerHTML=je();return}}const s=He(),[{ranking:n},i]=await Promise.all([m.auth.ranking(s),h.isLoggedIn()?m.leagues.my():Promise.resolve({leagues:[]})]),d=h.getUser(),l=i.leagues.find(v=>v.id===s),c=document.getElementById("tablonBadge"),_=c&&!c.classList.contains("hidden"),f=_?c.textContent:"",g=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        <div class="ranking-header">
          ...
          ${s?`
            <button class="ranking-tablon-btn" data-league-id="${s}">
              💬 Tablón
              <span class="ranking-tablon-btn__badge${_?"":" hidden"}">${f}</span>
            </button>
          `:""}
        </div>
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(v=>{var x,o,r;const b=v.predictions_made??0,E=`${b}/${g}`,k=`${v.correct_results??0}/${b}`,B=`${v.exact_scores??0}/${b}`;return`
                  <tr class="${d&&v.id===d.id?"ranking-table__row--me":""}">
                    <td class="ranking-table__pos" data-pos="${v.position}">${v.position}</td>
                    <td>
                      <a class="ranking-table__link" href="#/jugador/${v.id}">
                        <span class="status-emoji" title="${((x=v.status)==null?void 0:x.name)||""}">${((o=v.status)==null?void 0:o.emoji)||""}</span>${v.username}
                      </a>
                    </td>
    ...
    `}function v(o){return o.length?o.map(r=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function b(o){const r=T(o);if(!i.length)return r;const y=i.map(L=>Ae(L.username)),j=new RegExp(`@(${y.join("|")})`,"gi");return r.replace(j,'<span class="mention">@$1</span>')}function E(){const o=document.getElementById("boardForm");if(!o)return;const r=document.getElementById("boardMsg"),y=document.getElementById("charCounter"),j=document.getElementById("mentionDropdown");r.addEventListener("input",()=>{y.textContent=`${r.value.length} / 500`,x(r,j)}),o.addEventListener("submit",async L=>{L.preventDefault();const M=r.value.trim();if(M)try{await m.board.post(M,s),r.value="",y.textContent="0 / 500",j.classList.add("hidden");const P=await c();w(P),p("Mensaje publicado")}catch(P){p(P.message,"error")}})}function k(){e.querySelectorAll(".reply-form").forEach(o=>{const r=parseInt(o.dataset.parent),y=o.querySelector(".reply-input"),j=`mentionDropdown-${r}`,L=document.getElementById(j);y==null||y.addEventListener("input",()=>{x(y,L)}),o.addEventListener("submit",async M=>{M.preventDefault();const P=y.value.trim();if(P)try{await m.board.reply(r,P),y.value="",L==null||L.classList.add("hidden");const q=await c();w(q),p("Respuesta enviada")}catch(q){p(q.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(o=>{o.addEventListener("click",async()=>{try{await m.board.pin(o.dataset.id);const r=await c();w(r),p("Mensaje fijado")}catch(r){p(r.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(o=>{o.addEventListener("click",async()=>{try{await m.board.pin(o.dataset.id);const r=await c();w(r),p("Mensaje desfijado")}catch(r){p(r.message,"error")}})})}function B(){e.querySelectorAll(".delete-msg").forEach(o=>{o.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await m.board.delete(o.dataset.id);const r=await c();w(r),p("Mensaje eliminado")}catch(r){p(r.message,"error")}})})}function w(o){const{pinned:r=[],messages:y=[]}=o,j=document.getElementById("boardPinned");if(j)j.innerHTML=f(r);else if(r.length){_(o);return}const L=document.getElementById("boardMessages");L&&(L.innerHTML=v(y)),k(),B()}e.addEventListener("click",async o=>{if(o.target.id==="prevPage"&&d>1){d--;const r=await c();w(r)}else if(o.target.id==="nextPage"&&d<l){d++;const r=await c();w(r)}});function x(o,r){if(!r||!i.length)return;const y=o.value,j=o.selectionStart,L=y.slice(0,j),M=L.match(/@(\w*)$/);if(!M){r.classList.add("hidden");return}const P=M[1].toLowerCase(),q=i.filter(S=>S.username.toLowerCase().startsWith(P)&&S.id!==(t==null?void 0:t.id)),Z=[...h.isAdmin()&&"todos".startsWith(P)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...q.slice(0,6)];if(!Z.length){r.classList.add("hidden");return}r.innerHTML=Z.map(S=>S.description?`<div class="mention-item mention-item--broadcast" data-username="${T(S.username)}">
             <span class="mention-item__name">@${T(S.username)}</span>
             <span class="mention-item__desc">${T(S.description)}</span>
           </div>`:`<div class="mention-item" data-username="${T(S.username)}">${T(S.username)}</div>`).join(""),r.classList.remove("hidden"),r.querySelectorAll(".mention-item").forEach(S=>{S.addEventListener("mousedown",Ee=>{Ee.preventDefault();const Le=S.dataset.username,G=L.replace(/@(\w*)$/,`@${Le} `);if(o.value=G+y.slice(j),o.setSelectionRange(G.length,G.length),r.classList.add("hidden"),o.tagName==="TEXTAREA"){const Q=document.getElementById("charCounter");Q&&(Q.textContent=`${o.value.length} / 500`)}})})}document.addEventListener("click",o=>{!o.target.closest(".board-form__input-wrap")&&!o.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(r=>r.classList.add("hidden"))},{capture:!0})}function T(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ae(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Oe(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=h.getUser(),d=i==null?void 0:i.is_admin,[l,c]=await Promise.all([d?m.leagues.adminAll():m.leagues.all(),h.isLoggedIn()&&!d?m.leagues.my():Promise.resolve({leagues:[]})]),_=new Set(c.leagues.map(g=>g.id)),f=d?l.leagues:l.leagues.filter(g=>!_.has(g.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!d&&c.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${c.leagues.map(g=>ne(g,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${f.length?`<div class="leagues-grid">${f.map(g=>ne(g,!1,_,d)).join("")}</div>`:d?'<p class="empty">No hay ligas creadas aún.</p>':c.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(g=>{g.addEventListener("click",()=>$.navigate(`/ligas/${g.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(g=>{g.addEventListener("click",async v=>{v.stopPropagation();const b=parseInt(g.dataset.id);g.disabled=!0,g.textContent="…";try{const{league:E}=await m.leagues.join({league_id:b});p(`¡Te has unido a "${E.name}"!`),$.navigate(`/ligas/${E.id}`)}catch(E){p(E.message,"error"),g.disabled=!1,g.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(g=>{g.addEventListener("click",v=>{v.stopPropagation(),p("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var g,v;(g=document.getElementById("createLeaguePanel"))==null||g.classList.remove("hidden"),(v=document.getElementById("btnShowCreate"))==null||v.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var g,v;(g=document.getElementById("createLeaguePanel"))==null||g.classList.add("hidden"),(v=document.getElementById("btnShowCreate"))==null||v.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async g=>{g.preventDefault();const v=document.getElementById("inviteCode").value.trim().toUpperCase();if(v)try{const{league:b}=await m.leagues.join({invite_code:v});p(`Te has unido a "${b.name}"`),$.navigate(`/ligas/${b.id}`)}catch(b){p(b.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async g=>{var x;g.preventDefault();const v=document.getElementById("createBtn");v.disabled=!0,v.textContent="Creando…";const b=document.getElementById("leagueName").value.trim(),E=document.getElementById("leagueDesc").value.trim(),k=document.getElementById("leaguePrize").value.trim(),B=document.getElementById("isPublic").checked,w=((x=document.getElementById("isOfficial"))==null?void 0:x.checked)??!1;try{const{league:o}=await m.leagues.create({name:b,description:E,prize:k,is_public:B,is_official:w});Ue(o)}catch(o){p(o.message,"error"),v.disabled=!1,v.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function ne(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",d=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),p("Enlace copiado")}catch{p("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function qe(e,{params:a}){var s,n,i,d,l;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const c=await m.leagues.get(t),{league:_,ranking:f,is_member:g,is_admin_view:v}=c,b=h.getUser(),E=_.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        <div class="league-header">
          <h1 class="page-title">${_.name} ${E}</h1>
        ...
        ${(g||b!=null&&b.is_admin)&&_.invite_link?`
        ...
        <div class="league-actions">
          ...
          ${b!=null&&b.is_admin||g&&b&&_.created_by===b.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async d=>{d.preventDefault();const l=document.getElementById("btnSaveEdit");l.disabled=!0,l.textContent="Guardando…";const c={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(c.is_official=document.getElementById("editOfficial").checked);try{await m.leagues.update(a,c),p("Liga actualizada"),i(),$.navigate(`/ligas/${a}`)}catch(_){p(_.message,"error"),l.disabled=!1,l.textContent="Guardar cambios"}})}async function ze(e){var t,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=h.getUser();try{const[n,i,d,l]=await Promise.all([m.predictions.mine(null),m.clasificacion.division(),m.auth.me(),a!=null&&a.is_admin?m.leagues.adminAll():Promise.resolve({leagues:[]})]),c=d.user,_=c.status,f=c.total_points_all_time,g=(t=i.standings)==null?void 0:t.find(v=>v.user_id===c.id);e.innerHTML=`
      <div class="container">
        ...
        <section class="section">
          ...
          ${g?`<div class="division-info">
                 <p class="division-info__name">${i.league_name||"PickGoal División"}</p>
                 <div class="division-info__stats">
                   <div class="division-info__stat">
                     <span>${g.pos}º</span>
                     <small>de ${i.standings.length}</small>
                   </div>
                   <div class="division-info__stat">
        ...
        ${n.predictions.length>0?`
          <section class="section">
            ...
            <div class="predictions-list">${n.predictions.map(Fe).join("")}</div>
          </section>
        `:""}

        ${a!=null&&a.is_admin&&l.leagues.length?`
          <section class="section">
            <h2>Ligas gestionadas</h2>
            <ul class="leagues-list">
              ${l.leagues.map(v=>`
                <li>
                  <span>${v.is_official?"⭐ ":""}${v.name}</span>
                  <span class="tag">${v.is_public?"Pública":"Privada"}</span>
                  <a href="#/ligas/${v.id}" class="btn btn--sm btn--outline">Gestionar</a>
                </li>
              `).join("")}
            </ul>
          </section>
    ...
    `,(s=e.querySelector("#btnLogoutPerfil"))==null||s.addEventListener("click",()=>{h.logout(),window.location.hash="/"})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function Re(e,a){if(e.next_threshold===null)return`
  ...
  `}function Ge(){window.location.hash="/"}async function Ve(e){if(!h.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await m.auth.users();e.innerHTML=`
      <div class="container">
    ...
    `,We(e),F(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function We(e){var s,n,i,d;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const l=document.getElementById("syncResult");l.textContent="Sincronizando…";try{await m.matches.sync(),l.textContent="✓ Sincronización completada",p("Sincronización completada")}catch(c){l.textContent=`Error: ${c.message}`,p(c.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async l=>{l.preventDefault();const c=document.getElementById("pushTitle").value.trim()||"Aviso",_=document.getElementById("pushBody").value.trim(),f=a.value,g=parseInt(document.getElementById("pushTargetId").value)||null,v=document.getElementById("pushResult"),b={title:`📣 PickGoal — ${c}`,body:_};f==="league"&&g&&(b.league_id=g),f==="user"&&g&&(b.user_id=g),v.textContent="Enviando…";try{const{sent:E}=await m.notifications.send(b);v.textContent=`✓ Enviada a ${E} suscripción(es)`,p(`Notificación enviada a ${E} suscripción(es)`)}catch(E){v.textContent=`Error: ${E.message}`,p(E.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const l=document.getElementById("btnCloseSeason"),c=document.getElementById("closeSeasonResult");l.disabled=!0,c.textContent="Cerrando…";try{const{message:_}=await m.post("/v2/admin/season/1/close");c.textContent=`✓ ${_||"Temporada cerrada"}`,p("Temporada cerrada")}catch(_){c.textContent=`Error: ${_.message}`,p(_.message,"error"),l.disabled=!1}}),(d=document.getElementById("usersTableBody"))==null||d.addEventListener("click",async l=>{const c=l.target.closest(".toggle-admin");if(!c)return;const _=parseInt(c.dataset.id);try{const{user:f}=await m.auth.toggleAdmin(_);c.closest("tr").querySelector(".admin-badge").textContent=f.is_admin?"Sí":"No",p(`${f.username} ${f.is_admin?"ahora es admin":"ya no es admin"}`)}catch(f){p(f.message,"error")}})}function Xe(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const Ye={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let I=[],R=null;async function F(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await m.adminV2.jornadas();a.innerHTML=Ke(t),Qe(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Ke(e){const t=oa(new Date);return`
    <div class="jv2-panel">
      ...
      <div class="jv2-list">
        ${e.length===0?'<p class="admin-section__desc">No hay jornadas creadas.</p>':e.map(Ze).join("")}
      </div>
  ...
  `}const z=20,ve=5;let H={},U=0,X=null;async function pa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await m.jornada.list();if(!a.length){e.innerHTML=ga();return}_e(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function _e(e,a,t){var l,c;X=a[t];const{jornada:s,matches:n,units_used:i}=X;H={};for(const _ of n)H[_.jornada_match_id]={predicted_result:((l=_.prediction)==null?void 0:l.predicted_result)??null,units:((c=_.prediction)==null?void 0:c.units_wagered)??0};U=i;const d=a.length>1?`<div class="jornada-tabs">
        ${a.map((_,f)=>`
          <button class="jornada-tab ${f===t?"jornada-tab--active":""}" data-idx="${f}">
            J${_.jornada.number} · ${ie(_.jornada.date_start)}–${ie(_.jornada.date_end)}
          </button>
        `).join("")}
       </div>`:"";e.innerHTML=`
    <div class="container">
  ...
  `,he(),ba(e,s.locked,a,t)}function ga(){return`
    <div class="container">
  ...
  `}function he(){const e=document.getElementById("unitsCounter");if(!e)return;const a=U>z;e.innerHTML=`
    <div class="units-counter__bar">
      <div class="units-counter__fill ${a?"units-counter__fill--over":""}" style="width:${Math.min(100,U/z*100)}%"></div>
    </div>
    <span class="units-counter__label ${a?"units-counter__label--over":""}">${U}/${z} unidades usadas</span>
  `}function oe(){U=Object.values(H).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),he()}function ba(e,a,t,s){var n;e.querySelectorAll(".jornada-tab").forEach(i=>{i.addEventListener("click",()=>{const d=parseInt(i.dataset.idx);d!==s&&_e(e,t,d)})}),!a&&(e.querySelectorAll(".jornada-match").forEach(i=>{const d=parseInt(i.dataset.jmId);i.querySelectorAll('input[type="radio"]').forEach(c=>{c.addEventListener("change",()=>{H[d].predicted_result=c.value,oe()})});const l=i.querySelector(".jornada-units__input");l==null||l.addEventListener("input",()=>{let c=parseInt(l.value);isNaN(c)&&(c=0),c=Math.max(0,Math.min(ve,c)),H[d].units=c,oe()})}),(n=document.getElementById("jornadaSaveBtn"))==null||n.addEventListener("click",()=>ha(X.jornada.id)))}async function ha(e){const a=document.getElementById("jornadaSaveBtn"),t=Object.entries(H).filter(([,s])=>s.predicted_result).map(([s,n])=>({jornada_match_id:parseInt(s),predicted_result:n.predicted_result,units:n.units}));if(t.length===0){p("Selecciona al menos un resultado 1X2","error");return}if(U>z){p(`Superas el máximo de ${z} unidades`,"error");return}a.disabled=!0,a.textContent="…";try{await m.jornada.predict(t),p("Predicciones guardadas"),a.textContent="✓ Guardadas"}catch(s){p(s.message||"Error al guardar","error")}finally{a.disabled=!1,setTimeout(()=>{a&&(a.textContent="Guardar predicciones")},2e3)}}const de={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function fa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:a}=await m.duelo.current(),t=h.getUser();if(!a){e.innerHTML=`
        <div class="container">
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function $a(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:a}=await m.clasificacion.general(),t=h.getUser();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Clasificación</h1>
  ...
  `}const re=e=>()=>{window.location.hash=e},ja={"/":Se,"/login":Me,"/register":De,"/quiniela":re("/jornada"),"/resultados":re("/tabla-v2"),"/ranking":Ne,"/tablon":ge,"/ligas":Oe,"/ligas/:id":qe,"/perfil":ze,"/campeon":Ge,"/admin":Ve,"/forgot-password":da,"/reset-password":ra,"/unirse":la,"/jugador/:id":ua,"/jornada":pa,"/duelo":fa,"/tabla-v2":$a};function Sa(e){for(const[a,t]of Object.entries(ja)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(d,l)=>(s.push(l),"([^/]+)"))+"$"),i=e.match(n);if(i){const d={};return s.forEach((l,c)=>{d[l]=i[c+1]}),{handler:t,params:d}}}return null}const le=()=>document.getElementById("mainContent"),$={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=Sa(a);if(!n){le().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:d}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2"].includes(a)&&!h.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!h.isAdmin()){this.navigate("/");return}const c=le();c.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(c,{params:d,query:s})}};let J=[],O=null,N=null;async function ka(){document.documentElement.dataset.build="2026-08-07T15",await h.init(),$.init(),Pa(),Ba(),Ma()}function ye(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Ba(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!ye()&&(O=e,xa())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),O=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function xa(){if(ye()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
