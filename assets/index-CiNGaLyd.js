(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const De="https://pickgoal-backend.onrender.com/api";function He(){return localStorage.getItem("token")}async function u(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=He();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${De}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const l={get:e=>u(e),post:(e,a)=>u(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>u(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>u(e,{method:"DELETE"}),auth:{register:e=>u("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>u("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>u("/auth/me"),forgotPassword:e=>u("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>u("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>u(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>u("/auth/account",{method:"DELETE"}),users:()=>u("/auth/users"),usersForMentions:()=>u("/auth/users/for-mentions"),toggleAdmin:e=>u(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>u(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>u("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>u("/matches/grouped"),list:(e="")=>u(`/matches/${e}`),get:e=>u(`/matches/${e}`),today:()=>u("/matches/today"),setResult:(e,a,t,s=null)=>u(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>u("/matches/sync",{method:"POST"}),recalculate:()=>u("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>u(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>u(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>u("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>u(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>u(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>u("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>u("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>u("/leagues/all"),public:()=>u("/leagues/public"),my:()=>u("/leagues/my"),create:e=>u("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>u("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>u(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>u("/leagues/admin"),get:e=>u(`/leagues/${e}`),update:(e,a)=>u(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>u(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>u(`/leagues/${e}/members`),matchPredictions:(e,a)=>u(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>u("/home/summary")},board:{messages:(e=1,a=null)=>u(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>u(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>u("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>u(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>u(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>u(`/board/${e}`,{method:"DELETE"}),mentions:e=>u(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>u("/notifications/vapid-public-key"),subscribe:e=>u("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>u("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>u(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>u("/v2/admin/jornadas"),createJornada:e=>u("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>u(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>u(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>u(`/v2/admin/jornada/${e}/publish`,{method:"POST"})},jornada:{info:()=>u("/v2/jornada/info"),current:()=>u("/v2/jornada/current"),list:()=>u("/v2/jornada/list"),predict:e=>u("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>u("/v2/jornada/history")},duelo:{current:()=>u("/v2/duelo/current")},messages:{unread:()=>u("/messages/unread"),list:()=>u("/messages/"),get:e=>u(`/messages/${e}`),send:(e,a)=>u(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>u("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>u(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>u("/v2/clasificacion/general"),allDivisions:()=>u("/v2/clasificacion/all-divisions")}};let D=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await l.auth.me();D=a}catch{localStorage.removeItem("token")}},setUser(e,a){D=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){D=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return D},isLoggedIn(){return!!D},isAdmin(){return(D==null?void 0:D.is_admin)===!0}};let ae=null;function g(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,ae&&clearTimeout(ae),ae=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function qe(){return`
  ...
  `}function ue(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",d=>{d.key==="Escape"&&o()},{once:!1}),i}function T(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function Ae(e){if(!y.getUser()){Ne(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await l.home.summary();if(s){e.innerHTML=`
        ...
        ${ce()}
      `,ue(e);return}if(!t||t.length===0){Oe(e);return}const i=(()=>{const d=localStorage.getItem("activeLeagueId");return d?parseInt(d):null})(),o=[...t].sort((d,m)=>d.league_id===i?-1:m.league_id===i?1:0);e.innerHTML=`
      <div class="home-dashboard container">
        <div class="home-dashboard__topbar">
          <button class="btn btn--ghost btn--sm" id="btnPointsInfo">📊 Sistema de puntos</button>
        </div>
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await l.auth.register(n);y.setUser(o,i),g("¡Cuenta creada! Bienvenido a PickGoal");const d=sessionStorage.getItem("pendingInviteCode");if(d){sessionStorage.removeItem("pendingInviteCode");try{const{league:m}=await l.leagues.joinByCode(d);g(`¡Te has unido a "${m.name}"!`),j.navigate(`/ligas/${m.id}`)}catch{j.navigate("/ligas")}}else j.navigate("/"),je("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function Ve(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function We(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:v}=await l.leagues.my();if(v.length===0){e.innerHTML=qe();return}}const s=Ve(),[{ranking:n},i]=await Promise.all([l.auth.ranking(s),y.isLoggedIn()?l.leagues.my():Promise.resolve({leagues:[]})]),o=y.getUser(),d=i.leagues.find(v=>v.id===s),m=document.getElementById("tablonBadge"),_=m&&!m.classList.contains("hidden"),h=_?m.textContent:"",p=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
    ...
    `,L(),E(),S()}function p(r){return r.length?r.map(c=>`
      <div class="board-message board-message--pinned" data-id="${c.id}">
        <div class="board-message__header">
          ...
          <span class="board-message__date">${T(c.created_at)}</span>
          ${s!=null&&s.is_admin&&!c.is_deleted?`<button class="btn btn--ghost btn--xs unpin-msg" data-id="${c.id}" title="Desfijar">📌✕</button>`:""}
          ${!c.is_deleted&&s&&(s.id===c.user_id||s.is_admin)?`<button class="btn btn--danger btn--xs delete-msg" data-id="${c.id}">✕</button>`:""}
        </div>
        <p class="board-message__text">${$(c.message)}</p>

        ${c.replies&&c.replies.length?`<div class="board-replies">
               ${c.replies.map(w=>v(w)).join("")}
             </div>`:""}

        ${s&&!c.is_deleted?`<form class="reply-form" id="replyForm-${c.id}" data-parent="${c.id}">
    ...
    `}function b(r){return r.length?r.map(c=>`
      <div class="board-message ${c.is_deleted?"board-message--deleted":""}" data-id="${c.id}">
        <div class="board-message__header">
          <strong class="board-message__author">${M(c.username)}</strong>
          <span class="board-message__date">${T(c.created_at)}</span>
          ${s!=null&&s.is_admin&&!c.is_deleted?`<button class="btn btn--ghost btn--xs pin-msg" data-id="${c.id}" title="Fijar">📌</button>`:""}
          ${!c.is_deleted&&s&&(s.id===c.user_id||s.is_admin)?`<button class="btn btn--danger btn--xs delete-msg" data-id="${c.id}">✕</button>`:""}
        </div>
        <p class="board-message__text">${$(c.message)}</p>
      </div>
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function $(r){const c=M(r);if(!o.length)return c.replace(/@(\w+)/g,'<span class="mention">@$1</span>');const w=o.map(k=>Xe(k.username)),C=new RegExp(`@(${w.join("|")})`,"gi");return c.replace(C,'<span class="mention">@$1</span>')}function L(){const r=document.getElementById("boardForm");if(!r)return;const c=document.getElementById("boardMsg"),w=document.getElementById("charCounter"),C=document.getElementById("mentionDropdown");c.addEventListener("input",()=>{w.textContent=`${c.value.length} / 500`,f(c,C)}),r.addEventListener("submit",async k=>{k.preventDefault();const H=c.value.trim();if(H)try{await l.board.post(H,n),c.value="",w.textContent="0 / 500",C.classList.add("hidden");const P=await _();I(P),g("Mensaje publicado")}catch(P){g(P.message,"error")}})}function E(){e.querySelectorAll(".reply-form").forEach(r=>{const c=parseInt(r.dataset.parent),w=r.querySelector(".reply-input"),C=`mentionDropdown-${c}`,k=document.getElementById(C);w==null||w.addEventListener("input",()=>{f(w,k)}),r.addEventListener("submit",async H=>{H.preventDefault();const P=w.value.trim();if(P)try{await l.board.reply(c,P),w.value="",k==null||k.classList.add("hidden");const O=await _();I(O),g("Respuesta enviada")}catch(O){g(O.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await l.board.pin(r.dataset.id);const c=await _();I(c),g("Mensaje fijado")}catch(c){g(c.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await l.board.pin(r.dataset.id);const c=await _();I(c),g("Mensaje desfijado")}catch(c){g(c.message,"error")}})})}function S(){e.querySelectorAll(".delete-msg").forEach(r=>{r.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await l.board.delete(r.dataset.id);const c=await _();I(c),g("Mensaje eliminado")}catch(c){g(c.message,"error")}})})}function I(r){const{pinned:c=[],messages:w=[]}=r,C=document.getElementById("boardPinned");if(C)C.innerHTML=p(c);else if(c.length){h(r);return}const k=document.getElementById("boardMessages");k&&(k.innerHTML=b(w)),E(),S()}e.addEventListener("click",async r=>{if(r.target.id==="prevPage"&&d>1){d--;const c=await _();I(c)}else if(r.target.id==="nextPage"&&d<m){d++;const c=await _();I(c)}});function f(r,c){if(!c||!o.length){console.log("[tablon] handleMentionInput: sin dropdown o members vacío",{dropdown:!!c,membersLen:o.length});return}const w=r.value,C=r.selectionStart,k=w.slice(0,C),H=k.match(/@(\w*)$/);if(!H){c.classList.add("hidden");return}const P=H[1].toLowerCase();console.log("[tablon] mention detected, query:",P);const O=o.filter(x=>x.username.toLowerCase().startsWith(P)&&x.id!==(s==null?void 0:s.id));console.log("[tablon] matches:",O.map(x=>x.username));const re=[...y.isAdmin()&&"todos".startsWith(P)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...O.slice(0,6)];if(!re.length){c.classList.add("hidden");return}c.innerHTML=re.map(x=>x.description?`<div class="mention-item mention-item--broadcast" data-username="${M(x.username)}">
             <span class="mention-item__name">@${M(x.username)}</span>
             <span class="mention-item__desc">${M(x.description)}</span>
           </div>`:`<div class="mention-item" data-username="${M(x.username)}">${M(x.username)}</div>`).join(""),c.classList.remove("hidden"),c.querySelectorAll(".mention-item").forEach(x=>{x.addEventListener("mousedown",Pe=>{Pe.preventDefault();const Me=x.dataset.username,ee=k.replace(/@(\w*)$/,`@${Me} `);if(r.value=ee+w.slice(C),r.setSelectionRange(ee.length,ee.length),c.classList.add("hidden"),r.tagName==="TEXTAREA"){const le=document.getElementById("charCounter");le&&(le.textContent=`${r.value.length} / 500`)}})})}document.addEventListener("click",r=>{!r.target.closest(".board-form__input-wrap")&&!r.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(c=>c.classList.add("hidden"))},{capture:!0})}function M(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Xe(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Ye(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=y.getUser(),o=i==null?void 0:i.is_admin,[d,m]=await Promise.all([o?l.leagues.adminAll():l.leagues.all(),y.isLoggedIn()&&!o?l.leagues.my():Promise.resolve({leagues:[]})]),_=new Set(m.leagues.map(p=>p.id)),h=o?d.leagues:d.leagues.filter(p=>!_.has(p.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&m.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${m.leagues.map(p=>ge(p,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${h.length?`<div class="leagues-grid">${h.map(p=>ge(p,!1,_,o)).join("")}</div>`:o?'<p class="empty">No hay ligas creadas aún.</p>':m.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
      ...
      <div class="container">
        ...
        ${m.predictions.length>0?`
          <section class="section">
            ...
            <div class="predictions-list">${m.predictions.map(na).join("")}</div>
          </section>
        `:""}
  ...
  `,document.body.appendChild(e),document.body.style.overflow="hidden",requestAnimationFrame(()=>e.classList.add("delete-modal--open"));const a=e.querySelector("#deleteConfirmInput"),t=e.querySelector("#deleteConfirmBtn"),s=e.querySelector("#deleteCancelBtn"),n=e.querySelector("#deleteOverlay"),i=e.querySelector("#deleteError");function o(){e.classList.remove("delete-modal--open"),document.body.style.overflow="",e.addEventListener("transitionend",()=>e.remove(),{once:!0})}a.addEventListener("input",()=>{t.disabled=a.value.trim()!=="CERRAR"}),s.addEventListener("click",o),n.addEventListener("click",o),t.addEventListener("click",async()=>{t.disabled=!0,t.textContent="Cerrando…",i.classList.add("hidden");try{await l.auth.deleteAccount(),o(),y.logout(),g("Cuenta cerrada. Hasta pronto."),window.location.hash="/"}catch(d){i.textContent=d.message||"Error al cerrar la cuenta",i.classList.remove("hidden"),t.disabled=!1,t.textContent="Cerrar mi cuenta"}})}function oa(){window.location.hash="/"}async function da(e){if(!y.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await l.auth.users();e.innerHTML=`
    ...
    `,ra(e),Z(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function ra(e){var s,n,i,o;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const d=document.getElementById("syncResult");d.textContent="Sincronizando…";try{await l.matches.sync(),d.textContent="✓ Sincronización completada",g("Sincronización completada")}catch(m){d.textContent=`Error: ${m.message}`,g(m.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async d=>{d.preventDefault();const m=document.getElementById("pushTitle").value.trim()||"Aviso",_=document.getElementById("pushBody").value.trim(),h=a.value,p=parseInt(document.getElementById("pushTargetId").value)||null,v=document.getElementById("pushResult"),b={title:`📣 PickGoal — ${m}`,body:_};h==="league"&&p&&(b.league_id=p),h==="user"&&p&&(b.user_id=p),v.textContent="Enviando…";try{const{sent:$}=await l.notifications.send(b);v.textContent=`✓ Enviada a ${$} suscripción(es)`,g(`Notificación enviada a ${$} suscripción(es)`)}catch($){v.textContent=`Error: ${$.message}`,g($.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const d=document.getElementById("btnCloseSeason"),m=document.getElementById("closeSeasonResult");d.disabled=!0,m.textContent="Cerrando…";try{const{message:_}=await l.post("/v2/admin/season/1/close");m.textContent=`✓ ${_||"Temporada cerrada"}`,g("Temporada cerrada")}catch(_){m.textContent=`Error: ${_.message}`,g(_.message,"error"),d.disabled=!1}}),(o=document.getElementById("usersTableBody"))==null||o.addEventListener("click",async d=>{const m=d.target.closest(".toggle-admin");if(m){const h=parseInt(m.dataset.id);try{const{user:p}=await l.auth.toggleAdmin(h);m.closest("tr").querySelector(".admin-badge").textContent=p.is_admin?"Sí":"No",g(`${p.username} ${p.is_admin?"ahora es admin":"ya no es admin"}`)}catch(p){g(p.message,"error")}return}const _=d.target.closest(".toggle-mute");if(_){const h=parseInt(_.dataset.id);try{const{user:p}=await l.auth.toggleMute(h),v=_.closest("tr");v.querySelector(".mute-badge").textContent=p.is_muted?"Sí":"No",_.textContent=p.is_muted?"Activar":"Silenciar",g(`${p.username} ${p.is_muted?"silenciado":"activado"}`)}catch(p){g(p.message,"error")}}})}function la(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const F=20,Ie=5;let N={},A=0,se=null,ve=null;async function Sa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await l.jornada.list();if(!a.length){e.innerHTML=ka();return}Se(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Se(e,a,t){var m,_;ve=a[t];const{jornada:s,matches:n,units_used:i}=ve;N={};for(const h of n)N[h.jornada_match_id]={predicted_result:((m=h.prediction)==null?void 0:m.predicted_result)??null,units:((_=h.prediction)==null?void 0:_.units_wagered)??0};A=i;const o=n.filter(h=>!h.predict_locked);se=o.length===1?o[0].jornada_match_id:null;const d=a.length>1?`<div class="jornada-tabs">
        ${a.map((h,p)=>`
