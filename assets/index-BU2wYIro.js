(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Re="https://pickgoal-backend.onrender.com/api";function Je(){return localStorage.getItem("token")}async function m(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Je();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Re}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const c={get:e=>m(e),post:(e,a)=>m(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>m(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>m(e,{method:"DELETE"}),auth:{register:e=>m("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>m("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>m("/auth/me"),forgotPassword:e=>m("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>m("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>m(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>m("/auth/account",{method:"DELETE"}),users:()=>m("/auth/users"),usersForMentions:()=>m("/auth/users/for-mentions"),toggleAdmin:e=>m(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>m(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>m("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>m("/matches/grouped"),list:(e="")=>m(`/matches/${e}`),get:e=>m(`/matches/${e}`),today:()=>m("/matches/today"),setResult:(e,a,t,s=null)=>m(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>m("/matches/sync",{method:"POST"}),recalculate:()=>m("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>m(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>m(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>m("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>m(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>m(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>m("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>m("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>m("/leagues/all"),public:()=>m("/leagues/public"),my:()=>m("/leagues/my"),create:e=>m("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>m("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>m(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>m("/leagues/admin"),get:e=>m(`/leagues/${e}`),update:(e,a)=>m(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>m(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>m(`/leagues/${e}/members`),matchPredictions:(e,a)=>m(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>m("/home/summary")},board:{messages:(e=1,a=null)=>m(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>m(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>m("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>m(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>m(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>m(`/board/${e}`,{method:"DELETE"}),mentions:e=>m(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>m("/notifications/vapid-public-key"),subscribe:e=>m("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>m("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>m(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>m("/v2/admin/jornadas"),createJornada:e=>m("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>m(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>m(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>m(`/v2/admin/jornada/${e}/publish`,{method:"POST"}),jornadaMatches:e=>m(`/v2/admin/jornada/${e}/matches`),setResultado:(e,a)=>m(`/v2/admin/jornada-match/${e}/resultado`,{method:"POST",body:JSON.stringify(a)}),cancelMatch:e=>m(`/v2/admin/jornada-match/${e}/cancel`,{method:"POST"})},jornada:{info:()=>m("/v2/jornada/info"),current:()=>m("/v2/jornada/current"),list:()=>m("/v2/jornada/list"),predict:e=>m("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>m("/v2/jornada/history"),myStats:()=>m("/v2/jornada/my-stats")},duelo:{current:()=>m("/v2/duelo/current"),detail:()=>m("/v2/duelo/current/detail")},messages:{unread:()=>m("/messages/unread"),list:()=>m("/messages/"),get:e=>m(`/messages/${e}`),send:(e,a)=>m(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>m("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>m(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>m("/v2/clasificacion/general"),allDivisions:()=>m("/v2/clasificacion/all-divisions")}};let D=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await c.auth.me();D=a}catch{localStorage.removeItem("token")}},setUser(e,a){D=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){D=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return D},isLoggedIn(){return!!D},isAdmin(){return(D==null?void 0:D.is_admin)===!0}};let ie=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,ie&&clearTimeout(ie),ie=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function Fe(){return`
  ...
  `}function Y(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function r(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",r),n==null||n.addEventListener("click",r),document.addEventListener("keydown",o=>{o.key==="Escape"&&r()},{once:!1}),i}function B(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}const ze="/assets/icon-512-v2-CAowBaBi.png";async function Ve(e){if(!y.getUser()){Ge(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await c.home.summary();if(s){e.innerHTML=`
        ...
        ${X()}
      `,Y(e);return}if(!t||t.length===0){We(e);return}const i=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),r=[...t].sort((o,d)=>o.league_id===i?-1:d.league_id===i?1:0);e.innerHTML=`
      <div class="home-dashboard container">
        <div class="home-dashboard__topbar">
          <button class="btn btn--ghost btn--sm" id="btnPointsInfo">📊 Sistema de puntos</button>
        </div>
  ...
  `}function Ye(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function Ie(e=null,a=!1){let t,s;if(a&&(e!=null&&e.jornada_number))s="Temporada 26/27 · En curso",t=`
      ...
      </div>`;else if(a)s="Temporada 26/27 · En curso",t='<div class="pg-league-card__countdown pg-league-card__countdown--soon">Temporada en curso</div>';else{const n=Ye("2026-08-15");s="Temporada 26/27 · Próximamente",t=n>0?`<div class="pg-league-card__countdown">
  ...
  `}function Ze(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `}const ve="pickgoal_welcome_shown";function Ce(e="/jornada"){if(localStorage.getItem(ve))return;localStorage.setItem(ve,"1");const a=document.createElement("div");a.innerHTML=`
  ...
  `;const t=a.firstElementChild;document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("welcome-modal--open"));function s(n){t.classList.remove("welcome-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0}),n&&(window.location.hash=n)}document.getElementById("welcomeOverlay").addEventListener("click",()=>s()),document.getElementById("welcomeCta").addEventListener("click",()=>s(e)),document.addEventListener("keydown",function n(i){i.key==="Escape"&&(s(),document.removeEventListener("keydown",n))})}function Qe(e){e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:r}=await c.auth.register(n);y.setUser(r,i),v("¡Cuenta creada! Bienvenido a PickGoal");const o=sessionStorage.getItem("pendingInviteCode");if(o){sessionStorage.removeItem("pendingInviteCode");try{const{league:d}=await c.leagues.joinByCode(o);v(`¡Te has unido a "${d.name}"!`),S.navigate(`/ligas/${d.id}`)}catch{S.navigate("/ligas")}}else S.navigate("/"),Ce("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function aa(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ta(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:_}=await c.leagues.my();if(_.length===0){e.innerHTML=Fe();return}}const s=aa(),[{ranking:n},i]=await Promise.all([c.auth.ranking(s),y.isLoggedIn()?c.leagues.my():Promise.resolve({leagues:[]})]),r=y.getUser(),o=i.leagues.find(_=>_.id===s),d=document.getElementById("tablonBadge"),l=d&&!d.classList.contains("hidden"),b=l?d.textContent:"",p=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
          ...
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(_=>{var L,$,u;const h=_.predictions_made??0,f=`${h}/${p}`,E=`${_.correct_results??0}/${h}`,j=`${_.exact_scores??0}/${h}`;return`
                  <tr class="${r&&_.id===r.id?"ranking-table__row--me":""}">
    ...
    `,E(),j(),P()}function p(u){return u.length?u.map(g=>`
      <div class="board-message board-message--pinned" data-id="${g.id}">
        <div class="board-message__header">
          ...
          <strong class="board-message__author">${M(g.username)}</strong>
    ...
    `).join(""):""}function _(u){return`
      <div class="board-reply ${u.is_deleted?"board-reply--deleted":""}" data-id="${u.id}">
        <div class="board-reply__header">
          <strong class="board-reply__author">${M(u.username)}</strong>
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function f(u){const g=M(u);if(!r.length)return g.replace(/@(\w+)/g,'<span class="mention">@$1</span>');const w=r.map(k=>sa(k.username)),x=new RegExp(`@(${w.join("|")})`,"gi");return g.replace(x,'<span class="mention">@$1</span>')}function E(){const u=document.getElementById("boardForm");if(!u)return;const g=document.getElementById("boardMsg"),w=document.getElementById("charCounter"),x=document.getElementById("mentionDropdown");g.addEventListener("input",()=>{w.textContent=`${g.value.length} / 500`,$(g,x)}),u.addEventListener("submit",async k=>{k.preventDefault();const q=g.value.trim();if(q)try{await c.board.post(q,n),g.value="",w.textContent="0 / 500",x.classList.add("hidden");const T=await l();L(T),v("Mensaje publicado")}catch(T){v(T.message,"error")}})}function j(){e.querySelectorAll(".reply-form").forEach(u=>{const g=parseInt(u.dataset.parent),w=u.querySelector(".reply-input"),x=`mentionDropdown-${g}`,k=document.getElementById(x);w==null||w.addEventListener("input",()=>{$(w,k)}),u.addEventListener("submit",async q=>{q.preventDefault();const T=w.value.trim();if(T)try{await c.board.reply(g,T),w.value="",k==null||k.classList.add("hidden");const U=await l();L(U),v("Respuesta enviada")}catch(U){v(U.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();L(g),v("Mensaje fijado")}catch(g){v(g.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();L(g),v("Mensaje desfijado")}catch(g){v(g.message,"error")}})})}function P(){e.querySelectorAll(".delete-msg").forEach(u=>{u.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await c.board.delete(u.dataset.id);const g=await l();L(g),v("Mensaje eliminado")}catch(g){v(g.message,"error")}})})}function L(u){const{pinned:g=[],messages:w=[]}=u,x=document.getElementById("boardPinned");if(x)x.innerHTML=p(g);else if(g.length){b(u);return}const k=document.getElementById("boardMessages");k&&(k.innerHTML=h(w)),j(),P()}e.addEventListener("click",async u=>{if(u.target.id==="prevPage"&&o>1){o--;const g=await l();L(g)}else if(u.target.id==="nextPage"&&o<d){o++;const g=await l();L(g)}});function $(u,g){if(!g||!r.length){console.log("[tablon] handleMentionInput: sin dropdown o members vacío",{dropdown:!!g,membersLen:r.length});return}const w=u.value,x=u.selectionStart,k=w.slice(0,x),q=k.match(/@(\w*)$/);if(!q){g.classList.add("hidden");return}const T=q[1].toLowerCase();console.log("[tablon] mention detected, query:",T);const U=r.filter(I=>I.username.toLowerCase().startsWith(T)&&I.id!==(s==null?void 0:s.id));console.log("[tablon] matches:",U.map(I=>I.username));const me=[...y.isAdmin()&&"todos".startsWith(T)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...U.slice(0,6)];if(!me.length){g.classList.add("hidden");return}g.innerHTML=me.map(I=>I.description?`<div class="mention-item mention-item--broadcast" data-username="${M(I.username)}">
             <span class="mention-item__name">@${M(I.username)}</span>
             <span class="mention-item__desc">${M(I.description)}</span>
           </div>`:`<div class="mention-item" data-username="${M(I.username)}">${M(I.username)}</div>`).join(""),g.classList.remove("hidden"),g.querySelectorAll(".mention-item").forEach(I=>{I.addEventListener("mousedown",Ne=>{Ne.preventDefault();const Ue=I.dataset.username,ne=k.replace(/@(\w*)$/,`@${Ue} `);if(u.value=ne+w.slice(x),u.setSelectionRange(ne.length,ne.length),g.classList.add("hidden"),u.tagName==="TEXTAREA"){const pe=document.getElementById("charCounter");pe&&(pe.textContent=`${u.value.length} / 500`)}})})}document.addEventListener("click",u=>{!u.target.closest(".board-form__input-wrap")&&!u.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(g=>g.classList.add("hidden"))},{capture:!0})}function M(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function sa(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function na(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=y.getUser(),r=i==null?void 0:i.is_admin,[o,d]=await Promise.all([r?c.leagues.adminAll():c.leagues.all(),y.isLoggedIn()&&!r?c.leagues.my():Promise.resolve({leagues:[]})]),l=new Set(d.leagues.map(p=>p.id)),b=r?o.leagues:o.leagues.filter(p=>!l.has(p.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!r&&d.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${d.leagues.map(p=>_e(p,!0)).join("")}</div>
          </section>
        `:""}
  ...
  `}function ia(e){var s,n;const a=e.invite_link||"",t=document.getElementById("createLeaguePanel");t&&(t.innerHTML=`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function oa(e,{params:a}){var s,n,i,r,o;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const d=await c.leagues.get(t),{league:l,ranking:b,is_member:p,is_admin_view:_}=d,h=y.getUser(),f=l.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        ${(p||h!=null&&h.is_admin)&&l.invite_link?`
        ...
        <div class="league-actions">
          ...
          ${h!=null&&h.is_admin||p&&h&&l.created_by===h.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
    ...
    `,(s=document.getElementById("btnCopyInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(l.invite_link),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShareInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${l.name} en PickGoal`,url:l.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await c.leagues.leave(t),v("Has abandonado la liga"),S.navigate("/ligas")}catch($){v($.message,"error")}}),(r=document.getElementById("btnJoin"))==null||r.addEventListener("click",async()=>{try{await c.leagues.join({league_id:t}),v("¡Te has unido a la liga!"),S.navigate(`/ligas/${t}`)}catch($){v($.message,"error")}}),(o=document.getElementById("btnEditLeague"))==null||o.addEventListener("click",()=>{ra(l,t,h)});const E=document.getElementById("tabRanking"),j=document.getElementById("tabTablon"),P=document.getElementById("sectionRanking"),L=document.getElementById("sectionTablon");E&&j&&(E.addEventListener("click",()=>{E.classList.add("league-tab--active"),j.classList.remove("league-tab--active"),P.classList.remove("hidden"),L.classList.add("hidden")}),j.addEventListener("click",()=>{j.classList.add("league-tab--active"),E.classList.remove("league-tab--active"),P.classList.add("hidden"),L.classList.remove("hidden");const $=document.getElementById("tablonEmbed");$&&!$.dataset.loaded&&($.dataset.loaded="1",ce($,{query:{liga:String(t)}}))}))}catch(d){e.innerHTML=`<div class="container"><p class="form__error">Error: ${d.message}</p><a href="#/ligas">Volver</a></div>`}}function ra(e,a,t){const s=document.getElementById("editLeagueModal");s&&s.remove();const n=document.createElement("div");n.id="editLeagueModal",n.className="edit-league-modal",n.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async r=>{r.preventDefault();const o=document.getElementById("btnSaveEdit");o.disabled=!0,o.textContent="Guardando…";const d={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(d.is_official=document.getElementById("editOfficial").checked);try{await c.leagues.update(a,d),v("Liga actualizada"),i(),S.navigate(`/ligas/${a}`)}catch(l){v(l.message,"error"),o.disabled=!1,o.textContent="Guardar cambios"}})}async function da(e){var t,s,n,i,r,o;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=y.getUser();try{const[d,l,b]=await Promise.all([c.clasificacion.division(),c.auth.me(),a!=null&&a.is_admin?c.leagues.adminAll():Promise.resolve({leagues:[]})]),p=l.user,_=p.status,h=p.total_points_all_time,f=(t=d.standings)==null?void 0:t.find(E=>E.user_id===p.id);e.innerHTML=`
    ...
    `).join("")}catch{a.innerHTML='<p class="empty">Sin menciones recientes.</p>'}}function ua(e,a){if(e.next_threshold===null)return`
    ...
    </div>`}async function ma(e){var t,s;const a=e.querySelector("#predStatsWrap");if(a)try{const{total_predictions:n,correct_results:i,predictions:r}=await c.jornada.myStats();if(n===0){a.innerHTML='<p class="empty">Aún no tienes predicciones en esta temporada.</p>';return}const o=Math.round(i/n*100),d=50,l=+(2*Math.PI*d).toFixed(2),b=+(o/100*l).toFixed(2),p=+(l-b).toFixed(2);a.innerHTML=`
    ...
    `,(t=a.querySelector("#predCircleBtn"))==null||t.addEventListener("click",()=>{be(r)}),(s=a.querySelector("#predCircleBtn"))==null||s.addEventListener("keydown",_=>{(_.key==="Enter"||_.key===" ")&&be(r)})}catch{a.innerHTML='<p class="empty">No se pudieron cargar las predicciones.</p>'}}function be(e){var i,r;let a="all";const t=document.createElement("div");t.className="pred-modal",t.innerHTML=`
  ...
  `,document.body.appendChild(e),document.body.style.overflow="hidden",requestAnimationFrame(()=>e.classList.add("delete-modal--open"));const a=e.querySelector("#deleteConfirmInput"),t=e.querySelector("#deleteConfirmBtn"),s=e.querySelector("#deleteCancelBtn"),n=e.querySelector("#deleteOverlay"),i=e.querySelector("#deleteError");function r(){e.classList.remove("delete-modal--open"),document.body.style.overflow="",e.addEventListener("transitionend",()=>e.remove(),{once:!0})}a.addEventListener("input",()=>{t.disabled=a.value.trim()!=="CERRAR"}),s.addEventListener("click",r),n.addEventListener("click",r),t.addEventListener("click",async()=>{t.disabled=!0,t.textContent="Cerrando…",i.classList.add("hidden");try{await c.auth.deleteAccount(),r(),y.logout(),v("Cuenta cerrada. Hasta pronto."),window.location.hash="/"}catch(o){i.textContent=o.message||"Error al cerrar la cuenta",i.classList.remove("hidden"),t.disabled=!1,t.textContent="Cerrar mi cuenta"}})}function ga(){window.location.hash="/"}async function va(e){if(!y.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await c.auth.users();e.innerHTML=`
    ...
    `,_a(e),ee(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function _a(e){var s,n,i,r;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const o=document.getElementById("syncResult");o.textContent="Sincronizando…";try{await c.matches.sync(),o.textContent="✓ Sincronización completada",v("Sincronización completada")}catch(d){o.textContent=`Error: ${d.message}`,v(d.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("pushTitle").value.trim()||"Aviso",l=document.getElementById("pushBody").value.trim(),b=a.value,p=parseInt(document.getElementById("pushTargetId").value)||null,_=document.getElementById("pushResult"),h={title:`📣 PickGoal — ${d}`,body:l};b==="league"&&p&&(h.league_id=p),b==="user"&&p&&(h.user_id=p),_.textContent="Enviando…";try{const{sent:f}=await c.notifications.send(h);_.textContent=`✓ Enviada a ${f} suscripción(es)`,v(`Notificación enviada a ${f} suscripción(es)`)}catch(f){_.textContent=`Error: ${f.message}`,v(f.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const o=document.getElementById("btnCloseSeason"),d=document.getElementById("closeSeasonResult");o.disabled=!0,d.textContent="Cerrando…";try{const{message:l}=await c.post("/v2/admin/season/1/close");d.textContent=`✓ ${l||"Temporada cerrada"}`,v("Temporada cerrada")}catch(l){d.textContent=`Error: ${l.message}`,v(l.message,"error"),o.disabled=!1}}),(r=document.getElementById("usersTableBody"))==null||r.addEventListener("click",async o=>{const d=o.target.closest(".toggle-admin");if(d){const b=parseInt(d.dataset.id);try{const{user:p}=await c.auth.toggleAdmin(b);d.closest("tr").querySelector(".admin-badge").textContent=p.is_admin?"Sí":"No",v(`${p.username} ${p.is_admin?"ahora es admin":"ya no es admin"}`)}catch(p){v(p.message,"error")}return}const l=o.target.closest(".toggle-mute");if(l){const b=parseInt(l.dataset.id);try{const{user:p}=await c.auth.toggleMute(b),_=l.closest("tr");_.querySelector(".mute-badge").textContent=p.is_muted?"Sí":"No",l.textContent=p.is_muted?"Activar":"Silenciar",v(`${p.username} ${p.is_muted?"silenciado":"activado"}`)}catch(p){v(p.message,"error")}}})}function ba(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const ha={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let C=[],Q=null;async function ee(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await c.adminV2.jornadas();a.innerHTML=fa(t),$a(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function fa(e){const t=Ba(new Date);return`
    <div class="jv2-panel">
      ...
      <div class="jv2-list">
        ${e.length===0?'<p class="admin-section__desc">No hay jornadas creadas.</p>':e.map(ya).join("")}
      </div>
  ...
  `}function $a(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{Q=null,C=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",ue()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",C=[],Q=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",La),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",ja),e.querySelectorAll(".jv2-results-btn").forEach(i=>{i.addEventListener("click",()=>ka(i.dataset.id,i))}),e.querySelectorAll(".jv2-pub-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${i.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){i.disabled=!0,i.textContent="Publicando…";try{const r=await c.adminV2.publishJornada(i.dataset.id);v(`Jornada ${i.dataset.num} publicada — push enviado a ${r.push_sent} suscriptores`),await ee(document.getElementById("jornadasV2Section"))}catch(r){v(r.message,"error"),i.disabled=!1,i.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>Ea(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await c.adminV2.deleteJornada(i.dataset.id),v("Jornada eliminada"),ee(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(r){v(r.message,"error")}})})}async function Ea(e){const{jornadas:a}=await c.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(Q=t.id,C=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",ue())}async function La(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){v("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await c.adminV2.partidos(a);wa(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){v(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function wa(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        <div class="jv2-comp-group__title">${ha[s]||s}</div>
        ${n.map(i=>`
          <label class="jv2-match-item">
            ...
            <span class="jv2-match-item__date">${Sa(i.match_datetime)}</span>
          </label>
        `).join("")}
      </div>
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(C.length>=10){s.checked=!1,v("Máximo 10 partidos","error");return}C.push(n)}else C=C.filter(i=>i.api_id!==n.api_id);ue()})})}function ue(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=C.length),a&&(a.style.display=C.length>0&&C.length!==10?"inline":"none")}async function ja(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){v("Completa número y fechas","error");return}if(C.length!==10){v("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:C},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await c.adminV2.updateJornada(s,n),v(`Jornada ${e} actualizada`)):(await c.adminV2.createJornada(n),v(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",C=[],Q=null,await ee(document.getElementById("jornadasV2Section"))}catch(r){v(r.message,"error")}finally{i.disabled=!1}}function Sa(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}async function ka(e,a){const t=document.getElementById(`jv2-results-${e}`);if(t){if(t.style.display!=="none"){t.style.display="none",a.textContent="Resultados";return}a.disabled=!0,a.textContent="Cargando…";try{const{matches:s}=await c.adminV2.jornadaMatches(e);t.innerHTML=xe(s,e),t.style.display="block",Be(t,e),a.textContent="Ocultar"}catch(s){v(`Error: ${s.message}`,"error"),a.textContent="Resultados"}finally{a.disabled=!1}}}function Ia(e){if(e.jm_status==="cancelled")return'<span class="admin-match-badge admin-match-badge--cancelled">🔴 Suspendido</span>';if(e.jm_status==="finished")return`<span class="admin-match-badge admin-match-badge--done">🟢 Finalizado${e.home_score_90!=null&&e.away_score_90!=null?` ${e.home_score_90}–${e.away_score_90}`:""}</span>`;const a=Date.now(),t=new Date(e.match_datetime).getTime(),s=t+2*60*60*1e3;return a>=t&&a<=s?'<span class="admin-match-badge admin-match-badge--live">🔵 En juego</span>':a>s?'<span class="admin-match-badge admin-match-badge--stale">⚠️ ¿Ya se jugó? Introduce el resultado manualmente</span>':'<span class="admin-match-badge admin-match-badge--pending">🟡 Pendiente</span>'}function Ca(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"—"}function xe(e,a){const t=[...e].sort((s,n)=>new Date(n.match_datetime)-new Date(s.match_datetime));return`
      ...
      ${t.map(s=>{const n=s.jm_status==="cancelled";return`
          <div class="jv2-results-row ${n?"jv2-results-row--cancelled":""}" data-jm-id="${s.jornada_match_id}">
            <div class="jv2-results-row__meta">
              <span class="jv2-results-row__datetime">${Ca(s.match_datetime)}</span>
  ...
  `}function Be(e,a){var t;(t=e.querySelector(".jv2-sync-btn"))==null||t.addEventListener("click",async s=>{const n=s.currentTarget;n.disabled=!0,n.textContent="⏳ Sincronizando…";try{await c.matches.sync(),v("Sincronización completada"),await oe(a)}catch(i){v(i.message,"error"),n.disabled=!1,n.textContent="🔄 Sincronizar resultados ahora"}}),e.querySelectorAll(".jv2-save-result-btn").forEach(s=>{s.addEventListener("click",async()=>{var l,b,p;const n=s.dataset.jmId,i=e.querySelector(`.jv2-results-row[data-jm-id="${n}"]`),r=(l=i.querySelector('.jv2-score-input[data-side="home"]'))==null?void 0:l.value,o=(b=i.querySelector('.jv2-score-input[data-side="away"]'))==null?void 0:b.value,d=((p=i.querySelector(".jv2-r90-select"))==null?void 0:p.value)||void 0;if(r===""||o===""){v("Introduce los dos marcadores","error");return}s.disabled=!0,s.textContent="…";try{const _={home_score:parseInt(r),away_score:parseInt(o)};d&&(_.result_90=d),await c.adminV2.setResultado(n,_),v("Resultado guardado y puntos recalculados"),await oe(a)}catch(_){v(_.message,"error"),s.disabled=!1,s.textContent="Guardar"}})}),e.querySelectorAll(".jv2-cancel-match-btn").forEach(s=>{s.addEventListener("click",async()=>{const{jmId:n,home:i,away:r}=s.dataset;if(confirm(`¿Cancelar el partido ${i} vs ${r}? Las unidades apostadas se devolverán a los usuarios.`)){s.disabled=!0,s.textContent="…";try{const{message:o}=await c.adminV2.cancelMatch(n);v(o),await oe(a)}catch(o){v(o.message,"error"),s.disabled=!1,s.textContent="Cancelar"}}})})}async function oe(e){const a=document.getElementById(`jv2-results-${e}`);if(!(!a||a.style.display==="none"))try{const{matches:t}=await c.adminV2.jornadaMatches(e);a.innerHTML=xe(t,e),Be(a,e)}catch(t){v(`Error recargando: ${t.message}`,"error")}}function xa(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function Ba(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(xa(a)).padStart(2,"0");return`${t}-W${s}`}function Ta(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),r=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await c.auth.resetPassword(t,r),v("Contraseña actualizada. Ya puedes iniciar sesión."),S.navigate("/login")}catch(o){i.textContent=o.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function Ma(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!y.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),S.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await c.leagues.joinByCode(t);v(`¡Te has unido a "${s.name}"!`),S.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){v("Ya eres miembro de esta liga");try{const{leagues:n}=await c.leagues.my(),i=n.find(r=>r.invite_code===t);if(i){S.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
      <div class="container">
        <div class="league-gate">
    ...
    `}}function Da(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ha(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=Da(),{user:n,predictions:i}=await c.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const z=20,Te=5;let N={},O=0,de=null,he=null;async function Aa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await c.jornada.list();if(!a.length){e.innerHTML=Oa();return}Pe(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Pe(e,a,t){var d,l;he=a[t];const{jornada:s,matches:n,units_used:i}=he;N={};for(const b of n)N[b.jornada_match_id]={predicted_result:((d=b.prediction)==null?void 0:d.predicted_result)??null,units:((l=b.prediction)==null?void 0:l.units_wagered)??0};O=i;const r=n.filter(b=>!b.predict_locked);de=r.length===1?r[0].jornada_match_id:null;const o=a.length>1?`<div class="jornada-tabs">
        ${a.map((b,p)=>`
          <button class="jornada-tab ${p===t?"jornada-tab--active":""}" data-idx="${p}">
            J${b.jornada.number} · ${Z(b.jornada.date_start)}–${Z(b.jornada.date_end)}
          </button>
        `).join("")}
       </div>`:"";e.innerHTML=`
    <div class="container">
      <div class="page-title-row">
        <h1 class="page-title">Jornada ${s.number} — del ${Z(s.date_start)} al ${Z(s.date_end)}</h1>
  ...
  `,Me(),De(),Ja(e,a,t),Y(e)}function Oa(){return`
    <div class="container">
  ...
  `}function Z(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function Na(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function re(e){return e!=null?e.toFixed(2):"—"}function Ua(e){return e.jm_status==="cancelled"?'<span class="tag tag--cancelled">Suspendido</span>':e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${Na(e.opens_until)}</span>`}function Ra(e){const a=e.jm_status==="cancelled",t=e.predict_locked,s=N[e.jornada_match_id]??{predicted_result:null,units:0};return`
    <div class="match-card jornada-match ${t?"match-card--locked":""} ${a?"match-card--cancelled":""}" data-jm-id="${e.jornada_match_id}">
      ...
      <div class="jornada-odds">
        <span class="jornada-odds__item"><b>1</b> (${re(e.odds_1)})</span>
        <span class="jornada-odds__item"><b>X</b> (${re(e.odds_x)})</span>
        <span class="jornada-odds__item"><b>2</b> (${re(e.odds_2)})</span>
      </div>
      <div class="jornada-match__controls ${t?"jornada-match__controls--disabled":""}">
        ...
        <div class="jornada-units">
          ...
          <input type="number" id="units-${e.jornada_match_id}" class="jornada-units__input" min="0" max="${Te}" value="${s.units}" ${t?"disabled":""} />
        </div>
      </div>
      ${t?"":`
  ...
  `}function Me(){const e=document.getElementById("unitsCounter");if(!e)return;const a=O>z;e.innerHTML=`
  ...
  `}function De(){if(!de)return;const e=document.getElementById(`warning-${de}`);if(!e)return;const a=z-O;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function fe(){O=Object.values(N).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),Me(),De()}function Ja(e,a,t){e.querySelectorAll(".jornada-tab").forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.idx);n!==t&&Pe(e,a,n)})}),e.querySelectorAll(".jornada-match").forEach(s=>{var r;const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(o=>{o.addEventListener("change",()=>{N[n].predicted_result=o.value,fe()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let o=parseInt(i.value);isNaN(o)&&(o=0),o=Math.max(0,Math.min(Te,o)),N[n].units=o,fe()}),(r=s.querySelector(".jornada-match__save-btn"))==null||r.addEventListener("click",()=>Fa(n))})}async function Fa(e){const a=N[e];if(!a.predicted_result){v("Selecciona un resultado 1X2","error");return}if(O>z){v(`Superas el máximo de ${z} unidades`,"error");return}const t=document.querySelector(`.jornada-match__save-btn[data-jm-id="${e}"]`);t&&(t.disabled=!0,t.textContent="…");try{await c.jornada.predict({jornada_match_id:e,predicted_result:a.predicted_result,units:a.units}),v("Predicción guardada"),t&&(t.textContent="✓ Guardada")}catch(s){v(s.message||"Error al guardar","error")}finally{t&&(t.disabled=!1,setTimeout(()=>{t&&(t.textContent="Guardar")},2e3))}}let K=null;function He(){K&&(clearInterval(K),K=null)}const ye={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function za(e){var a;He(),e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:t}=await c.duelo.current(),s=y.getUser();if(!t){e.innerHTML=`
        <div class="container">
      ...
      `;return}const n=ye[t.status]??ye.en_curso,i=t.rival?t.rival.username:s.username,r=!t.rival||t.rival.id===s.id;e.innerHTML=`
      <div class="container">
        <div class="page-title-row">
          <h1 class="page-title">Tu duelo esta jornada</h1>
          <button class="btn-info" id="btnPointsInfo" aria-label="Cómo funciona">ℹ️</button>
        ...
        <div class="duelo-card">
          ...
          <div class="duelo-card__matchup">
            ...
            <div class="duelo-card__player">
              <span class="duelo-card__name">${r?"Descanso":i}</span>
              <span class="duelo-card__pts">${r?"—":t.rival_points}</span>
            </div>
          </div>
        </div>

        ${r?"":'<div class="duelo-tracker" id="dueloTracker"></div>'}

        ${!r&&((a=t.matches)==null?void 0:a.length)>0?`
          <h2 class="section-title">Partido a partido</h2>
          <div class="duelo-matches">
            ${t.matches.map(o=>Va(o,i)).join("")}
          </div>
        `:""}
    ...
    `,Y(e),Wa(t.division_league_id,s.id),r||($e(s.username,i),K=setInterval(()=>$e(s.username,i),6e4))}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${t.message}</p></div>`}}function Va(e,a){var i;const t=(i=e.my_prediction)==null?void 0:i.predicted_result;let s,n;return e.started?e.rival_prediction?(s=e.rival_prediction.predicted_result,n=""):(s="—",n="duelo-pick__value--empty"):(s="?",n="duelo-pick__value--hidden"),`
  ...
  `}async function $e(e,a){const t=document.getElementById("dueloTracker");if(!t){He();return}try{const{detail:s}=await c.duelo.detail();if(!s)return;t.innerHTML=Ga(s,e,a)}catch{}}function Ga(e,a,t){const{me:s,rival:n}=e;function i(r,o,d){const l=d||o.units_unbet!=null?o.units_unbet:null;return`
      <div class="duelo-tracker__col">
        <div class="duelo-tracker__player">${r}</div>
        <div class="duelo-tracker__pts">${o.points_earned.toFixed(2)}</div>
        <div class="duelo-tracker__rows">
          <div class="duelo-tracker__row">
            ...
            <span class="duelo-tracker__val">${o.points_earned.toFixed(2)}</span>
          </div>
          <div class="duelo-tracker__row">
            <span class="duelo-tracker__icon">⏳</span>
            <span class="duelo-tracker__label">En juego</span>
            <span class="duelo-tracker__val">${o.units_in_play>0?o.units_in_play+" u":"—"}</span>
          </div>
          <div class="duelo-tracker__row">
            <span class="duelo-tracker__icon">💰</span>
            <span class="duelo-tracker__label">Sin apostar</span>
            <span class="duelo-tracker__val">${l!=null?l+" u":"?"}</span>
          </div>
        </div>
      </div>
    `}return`
    <div class="duelo-tracker__inner">
      ...
      ${i(t,n??{points_earned:0,units_in_play:0,units_unbet:null},!1)}
    </div>
    <div class="duelo-tracker__note">Actualizado hace unos segundos · se refresca cada minuto</div>
  `}async function Wa(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await c.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function Xa(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:t}=await c.clasificacion.general(),s=y.getUser();e.innerHTML=`
      <div class="container">
        <div class="page-title-row">
          <h1 class="page-title">Clasificación</h1>
          <button class="btn-info" id="btnPointsInfo" aria-label="Cómo funciona">ℹ️</button>
                    ...
                    ${t.map(n=>{var i,r;return`
                      <tr class="${s&&n.user_id===s.id?"ranking-table__row--me":""}">
                        ...
                        <td>
                          ...
                          ${n.is_bot||s&&n.user_id===s.id?ae(n.username):`<button class="user-link" data-user-id="${n.user_id}">${ae(n.username)}</button>`}
                        </td>
    ...
    `,Za(s,a.tab),Y(e),Ya(),at(e,s)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${t.message}</p></div>`}}async function Ya(){const e=document.getElementById("tablonTabDot");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString();try{const{count:s}=await c.board.unread(null,t);console.log("[tablonDot] count:",s,"since:",t),e.classList.toggle("hidden",s===0)}catch(s){console.warn("[tablonDot] error:",s),e.classList.add("hidden")}}function Za(e,a){const t={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")},tablon:{btn:document.getElementById("tabTablon"),panel:document.getElementById("panelTablon")}};function s(i){for(const[r,{btn:o,panel:d}]of Object.entries(t))o.classList.toggle("league-tab--active",r===i),d.classList.toggle("hidden",r!==i)}t.general.btn.addEventListener("click",()=>s("general")),t.miDivision.btn.addEventListener("click",()=>{s("miDivision"),t.miDivision.panel.dataset.loaded||(t.miDivision.panel.dataset.loaded="1",Ka(e))}),t.divisiones.btn.addEventListener("click",()=>{s("divisiones"),t.divisiones.panel.dataset.loaded||(t.divisiones.panel.dataset.loaded="1",Qa(e))});function n(){var i;s("tablon"),localStorage.setItem("tablon_general_last_read",new Date().toISOString()),(i=document.getElementById("tablonTabDot"))==null||i.classList.add("hidden"),document.dispatchEvent(new CustomEvent("tablon:read")),t.tablon.panel.dataset.loaded||(t.tablon.panel.dataset.loaded="1",ce(t.tablon.panel,{forceGeneral:!0}))}t.tablon.btn.addEventListener("click",n),a==="tablon"&&n()}async function Ka(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await c.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function Qa(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await c.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>et(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function et(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
      ...
      <div class="div-accordion__body">
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${e.standings.map(s=>qe(s,a)).join("")}
            </tbody>
          </table>
        </div>
      </div>
    </div>
  `}function ae(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function at(e,a){let t=document.getElementById("userCtxMenu");t||(t=document.createElement("div"),t.id="userCtxMenu",t.className="user-ctx-menu hidden",t.innerHTML=`
    ...
    <tr class="${t?"ranking-table__row--me":""}" style="${s}">
      ...
      <td>${t||e.is_bot?ae(e.username):`<button class="user-link" data-user-id="${e.user_id}">${ae(e.username)}</button>`}</td>
  ...
  `}async function Ee(e,{params:a={}}={}){const t=a.userId?parseInt(a.userId):null;t?await nt(e,t):await tt(e)}async function tt(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{conversations:a}=await c.messages.list();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">💬 Mensajes</h1>
        ${a.length===0?'<p class="empty">No tienes conversaciones aún. Pulsa el nombre de un jugador en la clasificación para enviar un mensaje.</p>':`<div class="mensajes-list">${a.map(st).join("")}</div>`}
      </div>
    `,e.querySelectorAll(".mensajes-item").forEach(t=>{t.addEventListener("click",()=>{window.location.hash=`/mensajes/${t.dataset.userId}`})})}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function st(e){return`
  ...
  `}async function nt(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=y.getUser();try{const{messages:n,partner:i}=await c.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
      <div class="container">
        ...
        <div class="chat-messages" id="chatMessages">
          ${n.length===0?'<p class="empty" style="text-align:center">Empieza la conversación.</p>':n.map(o=>Le(o,t)).join("")}
        </div>
  ...
  `}function G(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const we=e=>()=>{window.location.hash=e},it={"/":Ve,"/login":Qe,"/register":ea,"/quiniela":we("/jornada"),"/resultados":we("/tabla-v2"),"/ranking":ta,"/tablon":ce,"/ligas":na,"/ligas/:id":oa,"/perfil":da,"/campeon":ga,"/admin":va,"/forgot-password":Ta,"/reset-password":Pa,"/unirse":Ma,"/jugador/:id":Ha,"/jornada":Aa,"/duelo":za,"/tabla-v2":Xa,"/mensajes":Ee,"/mensajes/:userId":Ee};function ot(e){for(const[a,t]of Object.entries(it)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(r,o)=>(s.push(o),"([^/]+)"))+"$"),i=e.match(n);if(i){const r={};return s.forEach((o,d)=>{r[o]=i[d+1]}),{handler:t,params:r}}}return null}const je=()=>document.getElementById("mainContent"),S={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=ot(a);if(!n){je().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:r}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2","/mensajes"].includes(a)&&!y.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!y.isAdmin()){this.navigate("/");return}const d=je();d.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(d,{params:r,query:s})}};let V=[],F=null,R=null,te=!1;async function rt(){document.documentElement.dataset.build="2026-08-13T19",await y.init(),S.init(),ct(),dt(),pt()}function Ae(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function dt(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!Ae()&&(F=e,lt())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),F=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function lt(){if(Ae()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("installBtn").addEventListener("click",async()=>{F&&(F.prompt(),await F.userChoice,F=null,e.remove())}),document.getElementById("installDismissBtn").addEventListener("click",()=>{sessionStorage.setItem("installBannerDismissed","1"),e.remove()})}function A(){var e,a;(e=document.getElementById("userDropdown"))==null||e.classList.add("hidden"),(a=document.getElementById("userBtn"))==null||a.classList.remove("navbar__dropdown-btn--open")}async function W(){const e=document.getElementById("perfilBadge"),a=document.getElementById("navMensajesDot");if(!y.getUser()){e==null||e.classList.add("hidden"),a==null||a.classList.add("hidden");return}try{const s=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString(),[n,i]=await Promise.all([c.board.mentions(s).catch(d=>(console.warn("[perfilBadge] mentions error:",d),{count:0})),c.messages.unread().catch(d=>(console.warn("[perfilBadge] pm unread error:",d),{count:0}))]),r=n.count||0,o=i.count||0;console.log("[perfilBadge] mentions:",r,"pm:",o),e==null||e.classList.toggle("hidden",r+o===0),a==null||a.classList.toggle("hidden",o===0)}catch(s){console.warn("[perfilBadge] error:",s),e==null||e.classList.add("hidden"),a==null||a.classList.add("hidden")}}async function se(){const e=document.getElementById("tablonBadge");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString();try{const{count:s}=await c.board.unread(null,t);s>0?(e.textContent=s>99?"99+":String(s),e.classList.remove("hidden")):e.classList.add("hidden")}catch{e.classList.add("hidden")}}function ct(){var e,a,t,s;document.addEventListener("auth:change",Se),window.addEventListener("hashchange",()=>{A(),Oe(),setTimeout(se,200),setTimeout(W,200)}),document.addEventListener("tablon:read",()=>{W(),se()}),document.addEventListener("messages:read",()=>{W()}),document.addEventListener("click",A),(e=document.getElementById("userBtn"))==null||e.addEventListener("click",n=>{var o;n.stopPropagation();const i=document.getElementById("userDropdown"),r=i==null?void 0:i.classList.contains("hidden");A(),r&&(i==null||i.classList.remove("hidden"),(o=document.getElementById("userBtn"))==null||o.classList.add("navbar__dropdown-btn--open"))}),(a=document.getElementById("userDropdown"))==null||a.addEventListener("click",n=>{n.stopPropagation(),n.target.closest("#navProfileLink")&&A()}),(t=document.getElementById("navMensajesLink"))==null||t.addEventListener("click",async n=>{n.preventDefault(),n.stopPropagation(),A(),te?le():await gt()}),document.addEventListener("click",n=>{te&&!n.target.closest("#notifPanel")&&!n.target.closest("#navMensajesLink")&&le()}),(s=document.getElementById("navLogoutBtn"))==null||s.addEventListener("click",()=>{V=[],localStorage.removeItem("activeLeagueId"),A(),y.logout(),S.navigate("/")}),Se()}async function Se(){var i;const e=document.getElementById("navAuthLinks"),a=document.getElementById("userBtn"),t=document.getElementById("navUsername"),s=document.getElementById("bottomNav"),n=y.getUser();if(A(),n){e==null||e.classList.add("hidden"),t&&(t.textContent=n.username),a.style.visibility="visible",console.log("[navbar] userBtn visibility:",a.style.visibility,"computed:",getComputedStyle(a).visibility,"offsetWidth:",a.offsetWidth,"right rect:",a.getBoundingClientRect().right),s==null||s.classList.remove("hidden"),document.body.classList.add("has-bottom-nav"),(i=document.getElementById("navAdminLink"))==null||i.classList.toggle("hidden",!n.is_admin);try{const{leagues:r}=n.is_admin?await c.leagues.adminAll():await c.leagues.my();V=r}catch{V=[]}ut(V),se(),W(),R&&clearInterval(R),R=setInterval(()=>{se(),W()},5*60*1e3)}else e==null||e.classList.remove("hidden"),a.style.visibility="hidden",s==null||s.classList.add("hidden"),document.body.classList.remove("has-bottom-nav"),V=[],localStorage.removeItem("activeLeagueId"),R&&(clearInterval(R),R=null);Oe()}function ut(e){const a=localStorage.getItem("activeLeagueId");a&&e.some(s=>String(s.id)===String(a))||(e.length>0?localStorage.setItem("activeLeagueId",String(e[0].id)):localStorage.removeItem("activeLeagueId"))}function Oe(){const e=window.location.hash.slice(1).split("?")[0]||"/";document.querySelectorAll(".bottom-nav__item").forEach(a=>{const t=a.dataset.route,s=t==="/"?e==="/":e===t||e.startsWith(t+"/");a.classList.toggle("bottom-nav__item--active",s)})}function mt(e){const a="=".repeat((4-e.length%4)%4),t=(e+a).replace(/-/g,"+").replace(/_/g,"/"),s=atob(t);return Uint8Array.from([...s].map(n=>n.charCodeAt(0)))}async function pt(){if(!(!("serviceWorker"in navigator)||!("PushManager"in window)))try{const e=await navigator.serviceWorker.register("/sw.js");document.addEventListener("auth:change",async a=>{a.detail&&await ke(e)}),y.getUser()&&await ke(e)}catch{}}async function ke(e){try{if(await Notification.requestPermission()!=="granted")return;const t=await e.pushManager.getSubscription();if(t){await c.notifications.subscribe(t.toJSON());return}const{public_key:s}=await c.notifications.vapidPublicKey();if(!s)return;const n=await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:mt(s)});await c.notifications.subscribe(n.toJSON())}catch{}}function le(){var e;(e=document.getElementById("notifPanel"))==null||e.classList.add("hidden"),te=!1}async function gt(){const e=document.getElementById("notifPanel"),a=document.getElementById("notifPanelBody");if(!(!e||!a)){te=!0,e.classList.remove("hidden"),a.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const t=new Date(Date.now()-2592e6).toISOString(),[s,n,i]=await Promise.all([c.messages.list().catch(()=>({conversations:[]})),c.board.messages(1,null).catch(()=>({messages:[]})),c.board.mentions(t).catch(()=>({messages:[]}))]),r=(s.conversations||[]).slice(0,5),o=(n.messages||[]).slice(0,5),d=new Set((i.messages||[]).map(l=>l.id));a.innerHTML=vt(r,o,d),a.querySelectorAll(".notif-item[data-nav]").forEach(l=>{l.addEventListener("click",()=>{le(),window.location.hash=l.dataset.nav})})}catch{a.innerHTML='<p class="notif-panel__empty">Error cargando notificaciones</p>'}}}function vt(e,a,t){const s=e.length===0?'<p class="notif-panel__empty">Aún no tienes mensajes</p>':e.map(i=>`
  ...
  `}function J(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}rt();
