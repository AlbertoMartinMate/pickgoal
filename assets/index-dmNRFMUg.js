(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Te="https://pickgoal-backend.onrender.com/api";function Me(){return localStorage.getItem("token")}async function _(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Me();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Te}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const u={get:e=>_(e),post:(e,a)=>_(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>_(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>_(e,{method:"DELETE"}),auth:{register:e=>_("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>_("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>_("/auth/me"),forgotPassword:e=>_("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>_("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>_(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>_("/auth/users"),toggleAdmin:e=>_(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>_("/matches/grouped"),list:(e="")=>_(`/matches/${e}`),get:e=>_(`/matches/${e}`),today:()=>_("/matches/today"),setResult:(e,a,t,s=null)=>_(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>_("/matches/sync",{method:"POST"}),recalculate:()=>_("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>_(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>_(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>_("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>_(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>_(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>_("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>_("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>_("/leagues/all"),public:()=>_("/leagues/public"),my:()=>_("/leagues/my"),create:e=>_("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>_("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>_(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>_("/leagues/admin"),get:e=>_(`/leagues/${e}`),update:(e,a)=>_(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>_(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>_(`/leagues/${e}/members`),matchPredictions:(e,a)=>_(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>_("/home/summary")},board:{messages:(e=1,a=null)=>_(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>_(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>_("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>_(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>_(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>_(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>_("/notifications/vapid-public-key"),subscribe:e=>_("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>_("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>_(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>_("/v2/admin/jornadas"),createJornada:e=>_("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>_(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>_(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>_(`/v2/admin/jornada/${e}/publish`,{method:"POST"})},jornada:{current:()=>_("/v2/jornada/current"),list:()=>_("/v2/jornada/list"),predict:e=>_("/v2/jornada/predict",{method:"POST",body:JSON.stringify({predictions:e})}),history:()=>_("/v2/jornada/history")},duelo:{current:()=>_("/v2/duelo/current")},clasificacion:{division:e=>_(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>_("/v2/clasificacion/general")}};let D=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await u.auth.me();D=a}catch{localStorage.removeItem("token")}},setUser(e,a){D=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){D=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return D},isLoggedIn(){return!!D},isAdmin(){return(D==null?void 0:D.is_admin)===!0}};let K=null;function p(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,K&&clearTimeout(K),K=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function he(){return`
  ...
  `,$e(e)}function Ne(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function ye(){const e=Ne("2026-08-15");return`
  ...
  `}function $e(e){var a;(a=e.querySelector("#btnWaitlist"))==null||a.addEventListener("click",()=>{p("¡Ya estás dentro! Te avisaremos cuando empiece la temporada 🎉")})}function qe(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `;const t=a.firstElementChild;document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("welcome-modal--open"));function s(n){t.classList.remove("welcome-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0}),n&&(window.location.hash=n)}document.getElementById("welcomeOverlay").addEventListener("click",()=>s()),document.getElementById("welcomeCta").addEventListener("click",()=>s(e)),document.addEventListener("keydown",function n(i){i.key==="Escape"&&(s(),document.removeEventListener("keydown",n))})}function Ue(e){e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await u.auth.register(n);y.setUser(o,i),p("¡Cuenta creada! Bienvenido a PickGoal");const d=sessionStorage.getItem("pendingInviteCode");if(d){sessionStorage.removeItem("pendingInviteCode");try{const{league:l}=await u.leagues.joinByCode(d);p(`¡Te has unido a "${l.name}"!`),I.navigate(`/ligas/${l.id}`)}catch{I.navigate("/ligas")}}else I.navigate("/campeon"),Ee("/ligas")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}const Re=new Set(["r32","r16","quarters","semis","third","final"]);let Z=null;function oe(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Je(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{let s=null;if(y.isLoggedIn()){const{leagues:$}=await u.leagues.my();if($.length===0){e.innerHTML=he();return}const w=oe(),S=$.find(r=>r.id===w);s=S?S.name:((a=$[0])==null?void 0:a.name)??null}const n=oe(),[{groups:i},o,d]=await Promise.all([u.matches.grouped(),y.isLoggedIn()?u.predictions.mine(n):Promise.resolve({predictions:[]}),y.isLoggedIn()?u.predictions.getChampion(n):Promise.resolve({champion_prediction:null})]),l={};for(const $ of o.predictions)l[$.match_id]=$;const g=i.flatMap($=>$.matches),h=new Map;for(const $ of g){const w=de($.match_datetime);h.has(w)||h.set(w,[]),h.get(w).push($)}const m=[...h.keys()].sort(),v=de(new Date().toISOString()),b=m.find($=>$>=v)??m[0],f=((t=d.champion_prediction)==null?void 0:t.team_name)??null,L=y.isLoggedIn()?f?`<p class="champion-banner champion-banner--set">🏆 Tu campeón: <a href="#/campeon" style="color:inherit;font-weight:bold;">${f}</a></p>`:'<p class="champion-banner champion-banner--missing">⚠️ <a href="#/campeon">¡Elige tu campeón antes del inicio del torneo!</a></p>':"";e.innerHTML=`
      ...
      ${be()}
    `,Z=fe(e),Fe(m,b,h,l,n)}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error cargando los partidos: ${s.message}</p></div>`}}function Fe(e,a,t,s,n){var o;const i=document.getElementById("dateNav");i&&(i.innerHTML=e.map(d=>`
    <button class="date-nav__btn ${d===a?"date-nav__btn--active":""}" data-day="${d}">
      ${ze(d)}
    </button>
  `).join(""),(o=i.querySelector(".date-nav__btn--active"))==null||o.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),i.querySelectorAll(".date-nav__btn").forEach(d=>{d.addEventListener("click",()=>{i.querySelectorAll(".date-nav__btn").forEach(l=>l.classList.remove("date-nav__btn--active")),d.classList.add("date-nav__btn--active"),re(t.get(d.dataset.day)??[],s,n)})}),re(t.get(a)??[],s,n))}function re(e,a,t){const s=document.getElementById("matchesContent");if(s){if(e.length===0){s.innerHTML='<p class="empty">Sin partidos este día.</p>';return}s.innerHTML=`<div class="matches-grid">${e.map(n=>Ve(n,a[n.id])).join("")}</div>`,Z&&s.querySelectorAll(".knockout-info-btn").forEach(n=>{n.addEventListener("click",i=>{i.stopPropagation(),Z()})}),y.isLoggedIn()&&s.querySelectorAll(".prediction-form").forEach(n=>{Ke(n,a,t)})}}function de(e){const a=new Date(e);return`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`}function ze(e){const[a,t,s]=e.split("-").map(Number);return new Date(a,t-1,s).toLocaleDateString("es-ES",{day:"numeric",month:"short"})}function Ve(e,a){const t=e.is_locked,s=a?`<span class="pts-badge">${a.total_points} pts</span>`:"",n={scheduled:"Programado",live:"🔴 En juego",finished:"Finalizado"}[e.status];return`
    <div class="match-card ${t?"match-card--locked":""}" data-match-id="${e.id}">
      ...
      ${!t&&y.isLoggedIn()?Xe(e,a):t&&a?`<div class="prediction-result">
               Tu predicción: <strong>${a.predicted_home}-${a.predicted_away}</strong>
               (${a.predicted_result}) · ${a.total_points} pts
             </div>`:""}
    </div>
  `}function Xe(e,a){const t=!!a,s=(a==null?void 0:a.predicted_home)??0,n=(a==null?void 0:a.predicted_away)??0,i=(a==null?void 0:a.predicted_result)??"X",o=t?"prediction-form--saved":"prediction-form--unsaved",d=t?'<span class="pred-status pred-status--saved">✓ Guardado</span>':'<span class="pred-status pred-status--unsaved">Sin predicción</span>',l=t?"btn btn--saved btn--sm pred-save-btn":"btn btn--ghost btn--sm pred-save-btn",g=t?"✓ Guardado":"Guardar",h=Re.has(e.phase);return`
    <form class="prediction-form ${o}" data-match-id="${e.id}" data-saved="${t}" data-is-knockout="${h?"1":"0"}">
      ...
      <button type="submit" class="${l}">${g}</button>
    </form>
  `}function We(e,a,t,s){return e==="1"?a>t:e==="2"?t>a:e==="X"?s?a!==t:a===t:!0}function Ke(e,a,t){const s=parseInt(e.dataset.matchId),n=e.querySelector(".pred-save-btn"),i=e.querySelector(".pred-status");let o=e.dataset.saved==="true";function d(){e.classList.contains("prediction-form--dirty")||(e.classList.remove("prediction-form--saved","prediction-form--unsaved"),e.classList.add("prediction-form--dirty"),n.className="btn btn--primary btn--sm pred-save-btn",n.textContent="Guardar",i&&(i.className="pred-status pred-status--unsaved",i.textContent="Sin guardar"))}function l(){o=!0,e.classList.remove("prediction-form--unsaved","prediction-form--dirty"),e.classList.add("prediction-form--saved"),n.className="btn btn--saved btn--sm pred-save-btn",n.textContent="✓ Guardado",n.disabled=!1,i&&(i.className="pred-status pred-status--saved",i.textContent="✓ Guardado")}e.querySelectorAll("input").forEach(g=>{g.addEventListener("change",d),g.addEventListener("input",d)}),e.addEventListener("submit",async g=>{var f;g.preventDefault();const h=parseInt(e.querySelector("[name=predicted_home]").value),m=parseInt(e.querySelector("[name=predicted_away]").value),v=(f=e.querySelector("[name=predicted_result]:checked"))==null?void 0:f.value;if(isNaN(h)||isNaN(m)||!v)return;const b=e.dataset.isKnockout==="1";if(!We(v,h,m,b)){p("El marcador no coincide con el resultado 1X2 seleccionado","error");return}n.disabled=!0,n.textContent="…";try{const{prediction:L}=await u.predictions.save({match_id:s,predicted_result:v,predicted_home:h,predicted_away:m,league_id:t??null});a[s]=L,p("Predicción guardada"),l()}catch(L){p(L.message||"Error al guardar","error"),n.disabled=!1,o?(n.className="btn btn--saved btn--sm pred-save-btn",n.textContent="✓ Guardado"):(n.className="btn btn--primary btn--sm pred-save-btn",n.textContent="Guardar")}})}function Ye(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Qe(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:v}=await u.leagues.my();if(v.length===0){e.innerHTML=he();return}}const s=Ye(),[{ranking:n},i]=await Promise.all([u.auth.ranking(s),y.isLoggedIn()?u.leagues.my():Promise.resolve({leagues:[]})]),o=y.getUser(),d=i.leagues.find(v=>v.id===s),l=document.getElementById("tablonBadge"),g=l&&!l.classList.contains("hidden"),h=g?l.textContent:"",m=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
        ...
        <div class="ranking-header">
          ...
          ${s?`
            <button class="ranking-tablon-btn" data-league-id="${s}">
              💬 Tablón
              <span class="ranking-tablon-btn__badge${g?"":" hidden"}">${h}</span>
            </button>
          `:""}
        </div>
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),p("Enlace copiado")}catch{p("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function ta(e,{params:a}){var s,n,i,o,d;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const l=await u.leagues.get(t),{league:g,ranking:h,is_member:m,is_admin_view:v}=l,b=y.getUser(),f=g.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        <div class="league-header">
          <h1 class="page-title">${g.name} ${f}</h1>
        ...
        ${(m||b!=null&&b.is_admin)&&g.invite_link?`
        ...
        <div class="league-actions">
          ...
          ${b!=null&&b.is_admin||m&&b&&g.created_by===b.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("btnSaveEdit");d.disabled=!0,d.textContent="Guardando…";const l={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(l.is_official=document.getElementById("editOfficial").checked);try{await u.leagues.update(a,l),p("Liga actualizada"),i(),I.navigate(`/ligas/${a}`)}catch(g){p(g.message,"error"),d.disabled=!1,d.textContent="Guardar cambios"}})}async function na(e){var t,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=y.getUser();try{const n=(()=>{const f=localStorage.getItem("activeLeagueId");return f?parseInt(f):null})(),[i,o,d,l,g]=await Promise.all([u.predictions.mine(n),u.predictions.getChampion(n),u.leagues.my(),u.auth.me(),a!=null&&a.is_admin?u.leagues.adminAll():Promise.resolve({leagues:[]})]),h=i.predictions.reduce((f,L)=>f+L.total_points,0)+(((t=o.champion_prediction)==null?void 0:t.points_earned)||0),m=l.user,v=m.status,b=m.total_points_all_time;e.innerHTML=`
      <div class="container">
        ...
        <section class="section">
          ...
          ${i.predictions.length?`<div class="predictions-list">${i.predictions.map(oa).join("")}</div>`:'<p class="empty">Sin predicciones aún. <a href="#/quiniela">Ir a la quiniela</a></p>'}
        </section>
    ...
    `,(s=e.querySelector("#btnLogoutPerfil"))==null||s.addEventListener("click",()=>{y.logout(),window.location.hash="/"})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function ia(e,a){if(e.next_threshold===null)return`
  ...
  `}const ce=new Date("2026-06-11T21:00:00Z"),ra=["Argentina","Brasil","Francia","España","Inglaterra","Alemania","Portugal","Países Bajos","Italia","Bélgica","Uruguay","Colombia","México","Estados Unidos","Canadá","Marruecos","Senegal","Nigeria","Japón","Corea del Sur","Australia","Arabia Saudí","Irán","Qatar","Ecuador","Chile","Perú","Venezuela","Bolivia","Paraguay","Costa Rica","Honduras","Panamá","Jamaica","Trinidad y Tobago","Guatemala","Turquía","Polonia","Croacia","Serbia","República Checa","Eslovaquia","Austria","Suiza","Dinamarca","Suecia","Noruega","Escocia","Ucrania","Rumanía","Hungría","Grecia","Egipto","Camerún","Ghana","Costa de Marfil","Túnez","Argelia","China","India","Irak","Uzbekistán","Nueva Zelanda","Fiji"];function da(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function we(e){var a;if(!y.isLoggedIn()){e.innerHTML='<div class="container"><p class="notice"><a href="#/login">Inicia sesión</a> para predecir el campeón.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const t=da(),{champion_prediction:s}=await u.predictions.getChampion(t),n=new Date>=ce;let i;s&&n?i=`
    ...
    `,(a=document.getElementById("championForm"))==null||a.addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("champBtn"),l=document.getElementById("champError"),g=document.getElementById("teamSearch").value.trim();if(g){d.disabled=!0,d.textContent="Guardando…",l.classList.add("hidden");try{await u.predictions.saveChampion(g,t),p(`¡${g} guardado como campeón!`),we(e)}catch(h){l.textContent=h.message,l.classList.remove("hidden"),d.disabled=!1,d.textContent=d.dataset.label||"Confirmar predicción"}}})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error: ${t.message}</p></div>`}}function Y(e){const a=e?"Actualizar predicción":"Confirmar predicción";return`
  ...
  `}async function la(e){if(!y.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await u.auth.users();e.innerHTML=`
      <div class="container">
    ...
    `,ca(e),V(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function ca(e){var s,n,i,o;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const d=document.getElementById("syncResult");d.textContent="Sincronizando…";try{await u.matches.sync(),d.textContent="✓ Sincronización completada",p("Sincronización completada")}catch(l){d.textContent=`Error: ${l.message}`,p(l.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async d=>{d.preventDefault();const l=document.getElementById("pushTitle").value.trim()||"Aviso",g=document.getElementById("pushBody").value.trim(),h=a.value,m=parseInt(document.getElementById("pushTargetId").value)||null,v=document.getElementById("pushResult"),b={title:`📣 PickGoal — ${l}`,body:g};h==="league"&&m&&(b.league_id=m),h==="user"&&m&&(b.user_id=m),v.textContent="Enviando…";try{const{sent:f}=await u.notifications.send(b);v.textContent=`✓ Enviada a ${f} suscripción(es)`,p(`Notificación enviada a ${f} suscripción(es)`)}catch(f){v.textContent=`Error: ${f.message}`,p(f.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const d=document.getElementById("btnCloseSeason"),l=document.getElementById("closeSeasonResult");d.disabled=!0,l.textContent="Cerrando…";try{const{message:g}=await u.post("/v2/admin/season/1/close");l.textContent=`✓ ${g||"Temporada cerrada"}`,p("Temporada cerrada")}catch(g){l.textContent=`Error: ${g.message}`,p(g.message,"error"),d.disabled=!1}}),(o=document.getElementById("usersTableBody"))==null||o.addEventListener("click",async d=>{const l=d.target.closest(".toggle-admin");if(!l)return;const g=parseInt(l.dataset.id);try{const{user:h}=await u.auth.toggleAdmin(g);l.closest("tr").querySelector(".admin-badge").textContent=h.is_admin?"Sí":"No",p(`${h.username} ${h.is_admin?"ahora es admin":"ya no es admin"}`)}catch(h){p(h.message,"error")}})}function ua(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const pa={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let k=[],z=null;async function V(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await u.adminV2.jornadas();a.innerHTML=ma(t),_a(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function ma(e){const t=Ea(new Date);return`
    <div class="jv2-panel">
      ...
      <div class="jv2-list">
        ${e.length===0?'<p class="admin-section__desc">No hay jornadas creadas.</p>':e.map(ga).join("")}
      </div>
      ...
      <div class="jv2-comp-group">
        ...
        ${n.map(i=>`
          <label class="jv2-match-item">
            ...
            <span class="jv2-match-item__date">${ya(i.match_datetime)}</span>
          </label>
        `).join("")}
      </div>
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(k.length>=10){s.checked=!1,p("Máximo 10 partidos","error");return}k.push(n)}else k=k.filter(i=>i.api_id!==n.api_id);te()})})}function te(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=k.length),a&&(a.style.display=k.length>0&&k.length!==10?"inline":"none")}async function fa(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){p("Completa número y fechas","error");return}if(k.length!==10){p("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:k},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await u.adminV2.updateJornada(s,n),p(`Jornada ${e} actualizada`)):(await u.adminV2.createJornada(n),p(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",k=[],z=null,await V(document.getElementById("jornadasV2Section"))}catch(o){p(o.message,"error")}finally{i.disabled=!1}}function ya(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}function $a(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function Ea(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String($a(a)).padStart(2,"0");return`${t}-W${s}`}function La(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await u.auth.resetPassword(t,o),p("Contraseña actualizada. Ya puedes iniciar sesión."),I.navigate("/login")}catch(d){i.textContent=d.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}const Ia={r32:"Dieciseisavos",r16:"Octavos",quarters:"Cuartos",semis:"Semis",third:"3º y 4º",final:"Final"};let O=!1,B=null;async function Sa(e){O=!1,B=null,e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{groups:a}=await u.matches.grouped(),t=y.isAdmin();e.innerHTML=`
    ...
    `,t&&document.getElementById("btnEditResults").addEventListener("click",()=>{O=!O;const s=document.getElementById("btnEditResults");O?(s.textContent="✅ Editando — salir",s.classList.add("btn--warning")):(s.textContent="✏️ Editar resultados",s.classList.remove("btn--warning")),B&&X(B.data,B.isGroup)}),document.getElementById("phaseContent").addEventListener("click",async s=>{var h;const n=s.target.closest(".res-match__save");if(!n)return;const i=parseInt(n.dataset.id),o=n.closest(".res-match"),d=o.querySelector(".res-match__input-home").value,l=o.querySelector(".res-match__input-away").value,g=((h=o.querySelector(".res-match__result90"))==null?void 0:h.value)||null;if(d===""||l===""){p("Introduce ambos marcadores","error");return}n.disabled=!0;try{if(await u.matches.setResult(i,parseInt(d),parseInt(l),g),p(`${d} - ${l} guardado`),B){const m=B.data.matches.find(v=>v.id===i);m&&(m.home_score_90=parseInt(d),m.away_score_90=parseInt(l),m.status="finished"),X(B.data,B.isGroup)}}catch(m){p(m.message,"error"),n.disabled=!1}}),ja(a)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando los partidos: ${a.message}</p></div>`}}function ja(e){var i;const a=document.getElementById("phaseNav");if(!a)return;const t=e.filter(o=>o.phase==="group"),s=e.filter(o=>o.phase!=="group"),n=[...t.map(o=>({key:`group_${o.group_name}`,label:`Grupo ${o.group_name}`,data:o,isGroup:!0})),...s.map(o=>({key:o.phase,label:Ia[o.phase]||o.label,data:o,isGroup:!1}))];n.length!==0&&(a.innerHTML=n.map((o,d)=>`
    <button class="phase-nav__btn ${d===0?"phase-nav__btn--active":""}" data-key="${o.key}">
      ${o.label}
    </button>
  `).join(""),(i=a.querySelector(".phase-nav__btn--active"))==null||i.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),a.querySelectorAll(".phase-nav__btn").forEach(o=>{o.addEventListener("click",()=>{a.querySelectorAll(".phase-nav__btn").forEach(l=>l.classList.remove("phase-nav__btn--active")),o.classList.add("phase-nav__btn--active");const d=n.find(l=>l.key===o.dataset.key);d&&(B=d,X(d.data,d.isGroup))})}),B=n[0],X(n[0].data,n[0].isGroup))}function X(e,a){const t=document.getElementById("phaseContent");if(!t)return;const s=ka(e.matches);if(a){const n=xa(e.matches);t.innerHTML=`
    ...
    `}else t.innerHTML=`<div class="resultados-matches">${s}</div>`}function ka(e){return!e||e.length===0?'<p class="empty">Sin partidos en esta fase.</p>':e.map(a=>{const t={scheduled:"Programado",live:"🔴 En juego",finished:"Finalizado"}[a.status]||a.status;let s;if(O){const n=a.home_score_90??"",i=a.away_score_90??"",o=a.result_90??"";s=`
    ...
    `}).join("")}function xa(e){const a={};for(const t of e)if(a[t.home_team]||(a[t.home_team]={name:t.home_team,pj:0,g:0,e:0,p:0,gf:0,gc:0,pts:0}),a[t.away_team]||(a[t.away_team]={name:t.away_team,pj:0,g:0,e:0,p:0,gf:0,gc:0,pts:0}),t.status==="finished"&&t.home_score_90!==null&&t.away_score_90!==null){const s=a[t.home_team],n=a[t.away_team];s.pj++,n.pj++,s.gf+=t.home_score_90,s.gc+=t.away_score_90,n.gf+=t.away_score_90,n.gc+=t.home_score_90,t.home_score_90>t.away_score_90?(s.g++,s.pts+=3,n.p++):t.home_score_90<t.away_score_90?(n.g++,n.pts+=3,s.p++):(s.e++,s.pts++,n.e++,n.pts++)}return Object.values(a).sort((t,s)=>{if(s.pts!==t.pts)return s.pts-t.pts;const n=s.gf-s.gc,i=t.gf-t.gc;return n!==i?n-i:s.gf-t.gf})}function Ca(e){return e.length===0?'<p class="empty">Sin datos de clasificación.</p>':`
  ...
  `}async function Ba(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!y.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),I.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await u.leagues.joinByCode(t);p(`¡Te has unido a "${s.name}"!`),I.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){p("Ya eres miembro de esta liga");try{const{leagues:n}=await u.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){I.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function Pa(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ta(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=Pa(),{user:n,predictions:i}=await u.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const F=20,Ie=5;let A={},G=0,ee=null;async function Da(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await u.jornada.list();if(!a.length){e.innerHTML=Ha();return}Se(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Se(e,a,t){var d,l;ee=a[t];const{jornada:s,matches:n,units_used:i}=ee;A={};for(const g of n)A[g.jornada_match_id]={predicted_result:((d=g.prediction)==null?void 0:d.predicted_result)??null,units:((l=g.prediction)==null?void 0:l.units_wagered)??0};G=i;const o=a.length>1?`<div class="jornada-tabs">
        ${a.map((g,h)=>`
          <button class="jornada-tab ${h===t?"jornada-tab--active":""}" data-idx="${h}">
            J${g.jornada.number} · ${ue(g.jornada.date_start)}–${ue(g.jornada.date_end)}
          </button>
        `).join("")}
       </div>`:"";e.innerHTML=`
    <div class="container">
  ...
  `,ke(),qa(e,s.locked,a,t)}function Ha(){return`
    <div class="container">
  ...
  `}function ue(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function je(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function Q(e){return e!=null?e.toFixed(2):"—"}function Aa(e){const a=new Date,t=new Date(e.match_datetime);return e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.status!=="scheduled"||t<=a?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${je(e.match_datetime)}</span>`}function Na(e){const a=e.status!=="scheduled"||new Date(e.match_datetime)<=new Date,t=A[e.jornada_match_id]??{predicted_result:null,units:0};return`
  ...
  `}function pe(){G=Object.values(A).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),ke()}function qa(e,a,t,s){var n;e.querySelectorAll(".jornada-tab").forEach(i=>{i.addEventListener("click",()=>{const o=parseInt(i.dataset.idx);o!==s&&Se(e,t,o)})}),!a&&(e.querySelectorAll(".jornada-match").forEach(i=>{const o=parseInt(i.dataset.jmId);i.querySelectorAll('input[type="radio"]').forEach(l=>{l.addEventListener("change",()=>{A[o].predicted_result=l.value,pe()})});const d=i.querySelector(".jornada-units__input");d==null||d.addEventListener("input",()=>{let l=parseInt(d.value);isNaN(l)&&(l=0),l=Math.max(0,Math.min(Ie,l)),A[o].units=l,pe()})}),(n=document.getElementById("jornadaSaveBtn"))==null||n.addEventListener("click",()=>Oa(ee.jornada.id)))}async function Oa(e){const a=document.getElementById("jornadaSaveBtn"),t=Object.entries(A).filter(([,s])=>s.predicted_result).map(([s,n])=>({jornada_match_id:parseInt(s),predicted_result:n.predicted_result,units:n.units}));if(t.length===0){p("Selecciona al menos un resultado 1X2","error");return}if(G>F){p(`Superas el máximo de ${F} unidades`,"error");return}a.disabled=!0,a.textContent="…";try{await u.jornada.predict(t),p("Predicciones guardadas"),a.textContent="✓ Guardadas"}catch(s){p(s.message||"Error al guardar","error")}finally{a.disabled=!1,setTimeout(()=>{a&&(a.textContent="Guardar predicciones")},2e3)}}const me={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function Ua(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:a}=await u.duelo.current(),t=y.getUser();if(!a){e.innerHTML=`
        <div class="container">
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function Ra(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:a}=await u.clasificacion.general(),t=y.getUser();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Clasificación</h1>
    ...
    `,Ja(t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${a.message}</p></div>`}}function Ja(e){const a=document.getElementById("tabGeneral"),t=document.getElementById("tabMiDivision"),s=document.getElementById("panelGeneral"),n=document.getElementById("panelMiDivision");!a||!t||(a.addEventListener("click",()=>{a.classList.add("league-tab--active"),t.classList.remove("league-tab--active"),s.classList.remove("hidden"),n.classList.add("hidden")}),t.addEventListener("click",()=>{t.classList.add("league-tab--active"),a.classList.remove("league-tab--active"),n.classList.remove("hidden"),s.classList.add("hidden"),n.dataset.loaded||(n.dataset.loaded="1",Fa(e))}))}async function Fa(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await u.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error cargando la clasificación: ${t.message}</p>`}}const za={"/":De,"/login":Ue,"/register":Ge,"/quiniela":Je,"/resultados":Sa,"/ranking":Qe,"/tablon":Le,"/ligas":ea,"/ligas/:id":ta,"/perfil":na,"/campeon":we,"/admin":la,"/forgot-password":La,"/reset-password":wa,"/unirse":Ba,"/jugador/:id":Ta,"/jornada":Da,"/duelo":Ua,"/tabla-v2":Ra};function Va(e){for(const[a,t]of Object.entries(za)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,d)=>(s.push(d),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((d,l)=>{o[d]=i[l+1]}),{handler:t,params:o}}}return null}const ge=()=>document.getElementById("mainContent"),I={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=Va(a);if(!n){ge().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/campeon","/admin","/jornada","/duelo","/tabla-v2"].includes(a)&&!y.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!y.isAdmin()){this.navigate("/");return}const l=ge();l.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(l,{params:o,query:s})}};let J=[],U=null,N=null;async function Xa(){document.documentElement.dataset.build="2026-08-07T13",await y.init(),I.init(),Ya(),Wa(),et()}function xe(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Wa(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!xe()&&(U=e,Ka())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),U=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function Ka(){if(xe()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
