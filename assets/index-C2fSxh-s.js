(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const _e="https://pickgoal-backend.onrender.com/api";function ve(){return localStorage.getItem("token")}async function h(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=ve();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${_e}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const g={get:e=>h(e),post:(e,a)=>h(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>h(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>h(e,{method:"DELETE"}),auth:{register:e=>h("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>h("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>h("/auth/me"),forgotPassword:e=>h("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>h("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>h(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>h("/auth/users"),toggleAdmin:e=>h(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>h("/matches/grouped"),list:(e="")=>h(`/matches/${e}`),get:e=>h(`/matches/${e}`),today:()=>h("/matches/today"),setResult:(e,a,t,s=null)=>h(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>h("/matches/sync",{method:"POST"}),recalculate:()=>h("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>h(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>h(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>h("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>h(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>h(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>h("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>h("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>h("/leagues/all"),public:()=>h("/leagues/public"),my:()=>h("/leagues/my"),create:e=>h("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>h("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>h(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>h("/leagues/admin"),get:e=>h(`/leagues/${e}`),update:(e,a)=>h(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>h(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>h(`/leagues/${e}/members`),matchPredictions:(e,a)=>h(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>h("/home/summary")},board:{messages:(e=1,a=null)=>h(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>h(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>h("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>h(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>h(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>h(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>h("/notifications/vapid-public-key"),subscribe:e=>h("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>h("/notifications/send",{method:"POST",body:JSON.stringify(e)})}};let M=null;const $={async init(){if(localStorage.getItem("token"))try{const{user:a}=await g.auth.me();M=a}catch{localStorage.removeItem("token")}},setUser(e,a){M=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){M=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return M},isLoggedIn(){return!!M},isAdmin(){return(M==null?void 0:M.is_admin)===!0}};let F=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,F&&clearTimeout(F),F=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function ie(){return`
  ...
  `}function re(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",d=>{d.key==="Escape"&&o()},{once:!1}),i}function j(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function he(e){if(!$.getUser()){be(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,upcoming_matches:s}=await g.home.summary();if(t.length===0){fe(e);return}const n=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),i=[...t].sort((o,d)=>o.league_id===n?-1:d.league_id===n?1:0);e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await g.auth.register(n);$.setUser(o,i),v("¡Cuenta creada! Bienvenido a PickGoal");const d=sessionStorage.getItem("pendingInviteCode");if(d){sessionStorage.removeItem("pendingInviteCode");try{const{league:p}=await g.leagues.joinByCode(d);v(`¡Te has unido a "${p.name}"!`),S.navigate(`/ligas/${p.id}`)}catch{S.navigate("/ligas")}}else S.navigate("/campeon"),le("/ligas")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}const Ie=new Set(["r32","r16","quarters","semis","third","final"]);let V=null;function Y(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Se(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{let s=null;if($.isLoggedIn()){const{leagues:y}=await g.leagues.my();if(y.length===0){e.innerHTML=ie();return}const w=Y(),L=y.find(r=>r.id===w);s=L?L.name:((a=y[0])==null?void 0:a.name)??null}const n=Y(),[{groups:i},o,d]=await Promise.all([g.matches.grouped(),$.isLoggedIn()?g.predictions.mine(n):Promise.resolve({predictions:[]}),$.isLoggedIn()?g.predictions.getChampion(n):Promise.resolve({champion_prediction:null})]),p={};for(const y of o.predictions)p[y.match_id]=y;const u=i.flatMap(y=>y.matches),_=new Map;for(const y of u){const w=Z(y.match_datetime);_.has(w)||_.set(w,[]),_.get(w).push(y)}const l=[..._.keys()].sort(),m=Z(new Date().toISOString()),b=l.find(y=>y>=m)??l[0],f=((t=d.champion_prediction)==null?void 0:t.team_name)??null,E=$.isLoggedIn()?f?`<p class="champion-banner champion-banner--set">🏆 Tu campeón: <a href="#/campeon" style="color:inherit;font-weight:bold;">${f}</a></p>`:'<p class="champion-banner champion-banner--missing">⚠️ <a href="#/campeon">¡Elige tu campeón antes del inicio del torneo!</a></p>':"";e.innerHTML=`
      ...
      ${oe()}
    `,V=re(e),ke(l,b,_,p,n)}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error cargando los partidos: ${s.message}</p></div>`}}function ke(e,a,t,s,n){var o;const i=document.getElementById("dateNav");i&&(i.innerHTML=e.map(d=>`
    <button class="date-nav__btn ${d===a?"date-nav__btn--active":""}" data-day="${d}">
      ${xe(d)}
    </button>
  `).join(""),(o=i.querySelector(".date-nav__btn--active"))==null||o.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),i.querySelectorAll(".date-nav__btn").forEach(d=>{d.addEventListener("click",()=>{i.querySelectorAll(".date-nav__btn").forEach(p=>p.classList.remove("date-nav__btn--active")),d.classList.add("date-nav__btn--active"),Q(t.get(d.dataset.day)??[],s,n)})}),Q(t.get(a)??[],s,n))}function Q(e,a,t){const s=document.getElementById("matchesContent");if(s){if(e.length===0){s.innerHTML='<p class="empty">Sin partidos este día.</p>';return}s.innerHTML=`<div class="matches-grid">${e.map(n=>Pe(n,a[n.id])).join("")}</div>`,V&&s.querySelectorAll(".knockout-info-btn").forEach(n=>{n.addEventListener("click",i=>{i.stopPropagation(),V()})}),$.isLoggedIn()&&s.querySelectorAll(".prediction-form").forEach(n=>{Te(n,a,t)})}}function Z(e){const a=new Date(e);return`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`}function xe(e){const[a,t,s]=e.split("-").map(Number);return new Date(a,t-1,s).toLocaleDateString("es-ES",{day:"numeric",month:"short"})}function Pe(e,a){const t=e.is_locked,s=a?`<span class="pts-badge">${a.total_points} pts</span>`:"",n={scheduled:"Programado",live:"🔴 En juego",finished:"Finalizado"}[e.status];return`
  ...
  `}function Ce(e,a){const t=!!a,s=(a==null?void 0:a.predicted_home)??0,n=(a==null?void 0:a.predicted_away)??0,i=(a==null?void 0:a.predicted_result)??"X",o=t?"prediction-form--saved":"prediction-form--unsaved",d=t?'<span class="pred-status pred-status--saved">✓ Guardado</span>':'<span class="pred-status pred-status--unsaved">Sin predicción</span>',p=t?"btn btn--saved btn--sm pred-save-btn":"btn btn--ghost btn--sm pred-save-btn",u=t?"✓ Guardado":"Guardar",_=Ie.has(e.phase);return`
  ...
  `}function Be(e,a,t,s){return e==="1"?a>t:e==="2"?t>a:e==="X"?s?a!==t:a===t:!0}function Te(e,a,t){const s=parseInt(e.dataset.matchId),n=e.querySelector(".pred-save-btn"),i=e.querySelector(".pred-status");let o=e.dataset.saved==="true";function d(){e.classList.contains("prediction-form--dirty")||(e.classList.remove("prediction-form--saved","prediction-form--unsaved"),e.classList.add("prediction-form--dirty"),n.className="btn btn--primary btn--sm pred-save-btn",n.textContent="Guardar",i&&(i.className="pred-status pred-status--unsaved",i.textContent="Sin guardar"))}function p(){o=!0,e.classList.remove("prediction-form--unsaved","prediction-form--dirty"),e.classList.add("prediction-form--saved"),n.className="btn btn--saved btn--sm pred-save-btn",n.textContent="✓ Guardado",n.disabled=!1,i&&(i.className="pred-status pred-status--saved",i.textContent="✓ Guardado")}e.querySelectorAll("input").forEach(u=>{u.addEventListener("change",d),u.addEventListener("input",d)}),e.addEventListener("submit",async u=>{var f;u.preventDefault();const _=parseInt(e.querySelector("[name=predicted_home]").value),l=parseInt(e.querySelector("[name=predicted_away]").value),m=(f=e.querySelector("[name=predicted_result]:checked"))==null?void 0:f.value;if(isNaN(_)||isNaN(l)||!m)return;const b=e.dataset.isKnockout==="1";if(!Be(m,_,l,b)){v("El marcador no coincide con el resultado 1X2 seleccionado","error");return}n.disabled=!0,n.textContent="…";try{const{prediction:E}=await g.predictions.save({match_id:s,predicted_result:m,predicted_home:_,predicted_away:l,league_id:t??null});a[s]=E,v("Predicción guardada"),p()}catch(E){v(E.message||"Error al guardar","error"),n.disabled=!1,o?(n.className="btn btn--saved btn--sm pred-save-btn",n.textContent="✓ Guardado"):(n.className="btn btn--primary btn--sm pred-save-btn",n.textContent="Guardar")}})}function Me(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function je(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if($.isLoggedIn()){const{leagues:m}=await g.leagues.my();if(m.length===0){e.innerHTML=ie();return}}const s=Me(),[{ranking:n},i]=await Promise.all([g.auth.ranking(s),$.isLoggedIn()?g.leagues.my():Promise.resolve({leagues:[]})]),o=$.getUser(),d=i.leagues.find(m=>m.id===s),p=document.getElementById("tablonBadge"),u=p&&!p.classList.contains("hidden"),_=u?p.textContent:"",l=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function b(r){const c=T(r);if(!i.length)return c;const I=i.map(k=>Ae(k.username)),x=new RegExp(`@(${I.join("|")})`,"gi");return c.replace(x,'<span class="mention">@$1</span>')}function f(){const r=document.getElementById("boardForm");if(!r)return;const c=document.getElementById("boardMsg"),I=document.getElementById("charCounter"),x=document.getElementById("mentionDropdown");c.addEventListener("input",()=>{I.textContent=`${c.value.length} / 500`,L(c,x)}),r.addEventListener("submit",async k=>{k.preventDefault();const A=c.value.trim();if(A)try{await g.board.post(A,s),c.value="",I.textContent="0 / 500",x.classList.add("hidden");const B=await p();w(B),v("Mensaje publicado")}catch(B){v(B.message,"error")}})}function E(){e.querySelectorAll(".reply-form").forEach(r=>{const c=parseInt(r.dataset.parent),I=r.querySelector(".reply-input"),x=`mentionDropdown-${c}`,k=document.getElementById(x);I==null||I.addEventListener("input",()=>{L(I,k)}),r.addEventListener("submit",async A=>{A.preventDefault();const B=I.value.trim();if(B)try{await g.board.reply(c,B),I.value="",k==null||k.classList.add("hidden");const O=await p();w(O),v("Respuesta enviada")}catch(O){v(O.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await g.board.pin(r.dataset.id);const c=await p();w(c),v("Mensaje fijado")}catch(c){v(c.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await g.board.pin(r.dataset.id);const c=await p();w(c),v("Mensaje desfijado")}catch(c){v(c.message,"error")}})})}function y(){e.querySelectorAll(".delete-msg").forEach(r=>{r.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await g.board.delete(r.dataset.id);const c=await p();w(c),v("Mensaje eliminado")}catch(c){v(c.message,"error")}})})}function w(r){const{pinned:c=[],messages:I=[]}=r,x=document.getElementById("boardPinned");if(x)x.innerHTML=_(c);else if(c.length){u(r);return}const k=document.getElementById("boardMessages");k&&(k.innerHTML=m(I)),E(),y()}e.addEventListener("click",async r=>{if(r.target.id==="prevPage"&&o>1){o--;const c=await p();w(c)}else if(r.target.id==="nextPage"&&o<d){o++;const c=await p();w(c)}});function L(r,c){if(!c||!i.length)return;const I=r.value,x=r.selectionStart,k=I.slice(0,x),A=k.match(/@(\w*)$/);if(!A){c.classList.add("hidden");return}const B=A[1].toLowerCase(),O=i.filter(P=>P.username.toLowerCase().startsWith(B)&&P.id!==(t==null?void 0:t.id)),X=[...$.isAdmin()&&"todos".startsWith(B)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...O.slice(0,6)];if(!X.length){c.classList.add("hidden");return}c.innerHTML=X.map(P=>P.description?`<div class="mention-item mention-item--broadcast" data-username="${T(P.username)}">
             <span class="mention-item__name">@${T(P.username)}</span>
             <span class="mention-item__desc">${T(P.description)}</span>
           </div>`:`<div class="mention-item" data-username="${T(P.username)}">${T(P.username)}</div>`).join(""),c.classList.remove("hidden"),c.querySelectorAll(".mention-item").forEach(P=>{P.addEventListener("mousedown",me=>{me.preventDefault();const ge=P.dataset.username,U=k.replace(/@(\w*)$/,`@${ge} `);if(r.value=U+I.slice(x),r.setSelectionRange(U.length,U.length),c.classList.add("hidden"),r.tagName==="TEXTAREA"){const K=document.getElementById("charCounter");K&&(K.textContent=`${r.value.length} / 500`)}})})}document.addEventListener("click",r=>{!r.target.closest(".board-form__input-wrap")&&!r.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(c=>c.classList.add("hidden"))},{capture:!0})}function T(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ae(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function qe(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=$.getUser(),o=i==null?void 0:i.is_admin,[d,p]=await Promise.all([o?g.leagues.adminAll():g.leagues.all(),$.isLoggedIn()&&!o?g.leagues.my():Promise.resolve({leagues:[]})]),u=new Set(p.leagues.map(l=>l.id)),_=o?d.leagues:d.leagues.filter(l=>!u.has(l.id));e.innerHTML=`
      <div class="container">
  ...
  `}const ze=[{key:"group",label:"Grupos"},{key:"r32",label:"Dieciseisavos"},{key:"r16",label:"Octavos"},{key:"quarters",label:"Cuartos"},{key:"semis",label:"Semis"},{key:"third",label:"3er y 4to"},{key:"final",label:"Final"}];async function Ve(e){if(!$.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const[{users:a},{groups:t}]=await Promise.all([g.auth.users(),g.matches.grouped()]),s=Je(t);e.innerHTML=`
      <div class="container">
  ...
  `}function Ke(e){const a=e.status==="finished",t=a&&e.home_score_90!=null?e.home_score_90:"",s=a&&e.away_score_90!=null?e.away_score_90:"",n=a&&e.result_90?e.result_90:"",i=a?'<span class="admin-match-badge admin-match-badge--done">Terminado</span>':'<span class="admin-match-badge admin-match-badge--pending">Pendiente</span>',o=We(e.match_datetime);return`
  ...
  `).join(""),(i=a.querySelector(".phase-nav__btn--active"))==null||i.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),a.querySelectorAll(".phase-nav__btn").forEach(o=>{o.addEventListener("click",()=>{a.querySelectorAll(".phase-nav__btn").forEach(p=>p.classList.remove("phase-nav__btn--active")),o.classList.add("phase-nav__btn--active");const d=n.find(p=>p.key===o.dataset.key);d&&(C=d,G(d.data,d.isGroup))})}),C=n[0],G(n[0].data,n[0].isGroup))}function G(e,a){const t=document.getElementById("phaseContent");if(!t)return;const s=na(e.matches);if(a){const n=ia(e.matches);t.innerHTML=`
    ...
    `}else t.innerHTML=`<div class="resultados-matches">${s}</div>`}function na(e){return!e||e.length===0?'<p class="empty">Sin partidos en esta fase.</p>':e.map(a=>{const t={scheduled:"Programado",live:"🔴 En juego",finished:"Finalizado"}[a.status]||a.status;let s;if(N){const n=a.home_score_90??"",i=a.away_score_90??"",o=a.result_90??"";s=`
  ...
  `}async function ra(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!$.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),S.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await g.leagues.joinByCode(t);v(`¡Te has unido a "${s.name}"!`),S.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){v("Ya eres miembro de esta liga");try{const{leagues:n}=await g.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){S.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function la(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function da(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=la(),{user:n,predictions:i}=await g.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
