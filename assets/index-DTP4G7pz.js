(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const we="https://pickgoal-backend.onrender.com/api";function Ie(){return localStorage.getItem("token")}async function u(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Ie();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${we}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const m={get:e=>u(e),post:(e,a)=>u(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>u(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>u(e,{method:"DELETE"}),auth:{register:e=>u("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>u("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>u("/auth/me"),forgotPassword:e=>u("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>u("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>u(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>u("/auth/users"),toggleAdmin:e=>u(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>u("/matches/grouped"),list:(e="")=>u(`/matches/${e}`),get:e=>u(`/matches/${e}`),today:()=>u("/matches/today"),setResult:(e,a,t,s=null)=>u(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>u("/matches/sync",{method:"POST"}),recalculate:()=>u("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>u(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>u(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>u("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>u(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>u(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>u("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>u("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>u("/leagues/all"),public:()=>u("/leagues/public"),my:()=>u("/leagues/my"),create:e=>u("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>u("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>u(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>u("/leagues/admin"),get:e=>u(`/leagues/${e}`),update:(e,a)=>u(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>u(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>u(`/leagues/${e}/members`),matchPredictions:(e,a)=>u(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>u("/home/summary")},board:{messages:(e=1,a=null)=>u(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>u(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>u("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>u(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>u(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>u(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>u("/notifications/vapid-public-key"),subscribe:e=>u("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>u("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>u(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>u("/v2/admin/jornadas"),createJornada:e=>u("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>u(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>u(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>u(`/v2/admin/jornada/${e}/publish`,{method:"POST"})},jornada:{info:()=>u("/v2/jornada/info"),current:()=>u("/v2/jornada/current"),list:()=>u("/v2/jornada/list"),predict:e=>u("/v2/jornada/predict",{method:"POST",body:JSON.stringify({predictions:e})}),history:()=>u("/v2/jornada/history")},duelo:{current:()=>u("/v2/duelo/current")},clasificacion:{division:e=>u(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>u("/v2/clasificacion/general"),allDivisions:()=>u("/v2/clasificacion/all-divisions")}};let C=null;const f={async init(){if(localStorage.getItem("token"))try{const{user:a}=await m.auth.me();C=a}catch{localStorage.removeItem("token")}},setUser(e,a){C=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){C=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return C},isLoggedIn(){return!!C},isAdmin(){return(C==null?void 0:C.is_admin)===!0}};let V=null;function p(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,V&&clearTimeout(V),V=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function je(){return`
  ...
  `}function ae(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function d(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",d),n==null||n.addEventListener("click",d),document.addEventListener("keydown",l=>{l.key==="Escape"&&d()},{once:!1}),i}function D(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function Se(e){if(!f.getUser()){ke(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await m.home.summary();if(s){e.innerHTML=`
  ...
  `}function Pe(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function me(e=null,a=!1){let t,s;if(a&&(e!=null&&e.jornada_number))s="Temporada 26/27 · En curso",t=`
      ...
      </div>`;else if(a)s="Temporada 26/27 · En curso",t='<div class="pg-league-card__countdown pg-league-card__countdown--soon">Temporada en curso</div>';else{const n=Pe("2026-08-15");s="Temporada 26/27 · Próximamente",t=n>0?`<div class="pg-league-card__countdown">
  ...
  `;const t=a.firstElementChild;document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("welcome-modal--open"));function s(n){t.classList.remove("welcome-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0}),n&&(window.location.hash=n)}document.getElementById("welcomeOverlay").addEventListener("click",()=>s()),document.getElementById("welcomeCta").addEventListener("click",()=>s(e)),document.addEventListener("keydown",function n(i){i.key==="Escape"&&(s(),document.removeEventListener("keydown",n))})}function Ce(e){e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:d}=await m.auth.register(n);f.setUser(d,i),p("¡Cuenta creada! Bienvenido a PickGoal");const l=sessionStorage.getItem("pendingInviteCode");if(l){sessionStorage.removeItem("pendingInviteCode");try{const{league:c}=await m.leagues.joinByCode(l);p(`¡Te has unido a "${c.name}"!`),E.navigate(`/ligas/${c.id}`)}catch{E.navigate("/ligas")}}else E.navigate("/campeon"),pe("/ligas")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function De(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function He(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(f.isLoggedIn()){const{leagues:_}=await m.leagues.my();if(_.length===0){e.innerHTML=je();return}}const s=De(),[{ranking:n},i]=await Promise.all([m.auth.ranking(s),f.isLoggedIn()?m.leagues.my():Promise.resolve({leagues:[]})]),d=f.getUser(),l=i.leagues.find(_=>_.id===s),c=document.getElementById("tablonBadge"),g=c&&!c.classList.contains("hidden"),y=g?c.textContent:"",v=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function b(o){const r=T(o);if(!i.length)return r;const $=i.map(L=>Ne(L.username)),S=new RegExp(`@(${$.join("|")})`,"gi");return r.replace(S,'<span class="mention">@$1</span>')}function h(){const o=document.getElementById("boardForm");if(!o)return;const r=document.getElementById("boardMsg"),$=document.getElementById("charCounter"),S=document.getElementById("mentionDropdown");r.addEventListener("input",()=>{$.textContent=`${r.value.length} / 500`,x(r,S)}),o.addEventListener("submit",async L=>{L.preventDefault();const M=r.value.trim();if(M)try{await m.board.post(M,s),r.value="",$.textContent="0 / 500",S.classList.add("hidden");const P=await c();I(P),p("Mensaje publicado")}catch(P){p(P.message,"error")}})}function w(){e.querySelectorAll(".reply-form").forEach(o=>{const r=parseInt(o.dataset.parent),$=o.querySelector(".reply-input"),S=`mentionDropdown-${r}`,L=document.getElementById(S);$==null||$.addEventListener("input",()=>{x($,L)}),o.addEventListener("submit",async M=>{M.preventDefault();const P=$.value.trim();if(P)try{await m.board.reply(r,P),$.value="",L==null||L.classList.add("hidden");const q=await c();I(q),p("Respuesta enviada")}catch(q){p(q.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(o=>{o.addEventListener("click",async()=>{try{await m.board.pin(o.dataset.id);const r=await c();I(r),p("Mensaje fijado")}catch(r){p(r.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(o=>{o.addEventListener("click",async()=>{try{await m.board.pin(o.dataset.id);const r=await c();I(r),p("Mensaje desfijado")}catch(r){p(r.message,"error")}})})}function B(){e.querySelectorAll(".delete-msg").forEach(o=>{o.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await m.board.delete(o.dataset.id);const r=await c();I(r),p("Mensaje eliminado")}catch(r){p(r.message,"error")}})})}function I(o){const{pinned:r=[],messages:$=[]}=o,S=document.getElementById("boardPinned");if(S)S.innerHTML=y(r);else if(r.length){g(o);return}const L=document.getElementById("boardMessages");L&&(L.innerHTML=_($)),w(),B()}e.addEventListener("click",async o=>{if(o.target.id==="prevPage"&&d>1){d--;const r=await c();I(r)}else if(o.target.id==="nextPage"&&d<l){d++;const r=await c();I(r)}});function x(o,r){if(!r||!i.length)return;const $=o.value,S=o.selectionStart,L=$.slice(0,S),M=L.match(/@(\w*)$/);if(!M){r.classList.add("hidden");return}const P=M[1].toLowerCase(),q=i.filter(k=>k.username.toLowerCase().startsWith(P)&&k.id!==(t==null?void 0:t.id)),Z=[...f.isAdmin()&&"todos".startsWith(P)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...q.slice(0,6)];if(!Z.length){r.classList.add("hidden");return}r.innerHTML=Z.map(k=>k.description?`<div class="mention-item mention-item--broadcast" data-username="${T(k.username)}">
             <span class="mention-item__name">@${T(k.username)}</span>
             <span class="mention-item__desc">${T(k.description)}</span>
           </div>`:`<div class="mention-item" data-username="${T(k.username)}">${T(k.username)}</div>`).join(""),r.classList.remove("hidden"),r.querySelectorAll(".mention-item").forEach(k=>{k.addEventListener("mousedown",Ee=>{Ee.preventDefault();const Le=k.dataset.username,G=L.replace(/@(\w*)$/,`@${Le} `);if(o.value=G+$.slice(S),o.setSelectionRange(G.length,G.length),r.classList.add("hidden"),o.tagName==="TEXTAREA"){const Q=document.getElementById("charCounter");Q&&(Q.textContent=`${o.value.length} / 500`)}})})}document.addEventListener("click",o=>{!o.target.closest(".board-form__input-wrap")&&!o.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(r=>r.classList.add("hidden"))},{capture:!0})}function T(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ne(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Ae(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=f.getUser(),d=i==null?void 0:i.is_admin,[l,c]=await Promise.all([d?m.leagues.adminAll():m.leagues.all(),f.isLoggedIn()&&!d?m.leagues.my():Promise.resolve({leagues:[]})]),g=new Set(c.leagues.map(v=>v.id)),y=d?l.leagues:l.leagues.filter(v=>!g.has(v.id));e.innerHTML=`
      <div class="container">
  ...
  `}function Oe(e){var s,n;const a=e.invite_link||"",t=document.getElementById("createLeaguePanel");t&&(t.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async d=>{d.preventDefault();const l=document.getElementById("btnSaveEdit");l.disabled=!0,l.textContent="Guardando…";const c={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(c.is_official=document.getElementById("editOfficial").checked);try{await m.leagues.update(a,c),p("Liga actualizada"),i(),E.navigate(`/ligas/${a}`)}catch(g){p(g.message,"error"),l.disabled=!1,l.textContent="Guardar cambios"}})}async function Je(e){var t,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=f.getUser();try{const n=(()=>{const h=localStorage.getItem("activeLeagueId");return h?parseInt(h):null})(),[i,d,l,c,g]=await Promise.all([m.predictions.mine(n),m.predictions.getChampion(n),m.leagues.my(),m.auth.me(),a!=null&&a.is_admin?m.leagues.adminAll():Promise.resolve({leagues:[]})]),y=i.predictions.reduce((h,w)=>h+w.total_points,0)+(((t=d.champion_prediction)==null?void 0:t.points_earned)||0),v=c.user,_=v.status,b=v.total_points_all_time;e.innerHTML=`
      <div class="container">
        ...
        <section class="section">
          ...
          ${i.predictions.length?`<div class="predictions-list">${i.predictions.map(ze).join("")}</div>`:'<p class="empty">Sin predicciones aún. <a href="#/quiniela">Ir a la quiniela</a></p>'}
        </section>
  ...
  `}function Fe(){window.location.hash="/"}async function Ge(e){if(!f.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await m.auth.users();e.innerHTML=`
      <div class="container">
    ...
    `,Ve(e),F(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function Ve(e){var s,n,i,d;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const l=document.getElementById("syncResult");l.textContent="Sincronizando…";try{await m.matches.sync(),l.textContent="✓ Sincronización completada",p("Sincronización completada")}catch(c){l.textContent=`Error: ${c.message}`,p(c.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async l=>{l.preventDefault();const c=document.getElementById("pushTitle").value.trim()||"Aviso",g=document.getElementById("pushBody").value.trim(),y=a.value,v=parseInt(document.getElementById("pushTargetId").value)||null,_=document.getElementById("pushResult"),b={title:`📣 PickGoal — ${c}`,body:g};y==="league"&&v&&(b.league_id=v),y==="user"&&v&&(b.user_id=v),_.textContent="Enviando…";try{const{sent:h}=await m.notifications.send(b);_.textContent=`✓ Enviada a ${h} suscripción(es)`,p(`Notificación enviada a ${h} suscripción(es)`)}catch(h){_.textContent=`Error: ${h.message}`,p(h.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const l=document.getElementById("btnCloseSeason"),c=document.getElementById("closeSeasonResult");l.disabled=!0,c.textContent="Cerrando…";try{const{message:g}=await m.post("/v2/admin/season/1/close");c.textContent=`✓ ${g||"Temporada cerrada"}`,p("Temporada cerrada")}catch(g){c.textContent=`Error: ${g.message}`,p(g.message,"error"),l.disabled=!1}}),(d=document.getElementById("usersTableBody"))==null||d.addEventListener("click",async l=>{const c=l.target.closest(".toggle-admin");if(!c)return;const g=parseInt(c.dataset.id);try{const{user:y}=await m.auth.toggleAdmin(g);c.closest("tr").querySelector(".admin-badge").textContent=y.is_admin?"Sí":"No",p(`${y.username} ${y.is_admin?"ahora es admin":"ya no es admin"}`)}catch(y){p(y.message,"error")}})}function We(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const Xe={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let j=[],z=null;async function F(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await m.adminV2.jornadas();a.innerHTML=Ye(t),Ze(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Ye(e){const t=ia(new Date);return`
    <div class="jv2-panel">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),d=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await m.auth.resetPassword(t,d),p("Contraseña actualizada. Ya puedes iniciar sesión."),E.navigate("/login")}catch(l){i.textContent=l.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function ra(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!f.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),E.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await m.leagues.joinByCode(t);p(`¡Te has unido a "${s.name}"!`),E.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){p("Ya eres miembro de esta liga");try{const{leagues:n}=await m.leagues.my(),i=n.find(d=>d.invite_code===t);if(i){E.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function la(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ca(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=la(),{user:n,predictions:i}=await m.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const R=20,ve=5;let H={},U=0,X=null;async function ma(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await m.jornada.list();if(!a.length){e.innerHTML=pa();return}_e(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function _e(e,a,t){var l,c;X=a[t];const{jornada:s,matches:n,units_used:i}=X;H={};for(const g of n)H[g.jornada_match_id]={predicted_result:((l=g.prediction)==null?void 0:l.predicted_result)??null,units:((c=g.prediction)==null?void 0:c.units_wagered)??0};U=i;const d=a.length>1?`<div class="jornada-tabs">
        ${a.map((g,y)=>`
  ...
  `,he(),_a(e,s.locked,a,t)}function pa(){return`
    <div class="container">
  ...
  `}function he(){const e=document.getElementById("unitsCounter");if(!e)return;const a=U>R;e.innerHTML=`
  ...
  `}function oe(){U=Object.values(H).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),he()}function _a(e,a,t,s){var n;e.querySelectorAll(".jornada-tab").forEach(i=>{i.addEventListener("click",()=>{const d=parseInt(i.dataset.idx);d!==s&&_e(e,t,d)})}),!a&&(e.querySelectorAll(".jornada-match").forEach(i=>{const d=parseInt(i.dataset.jmId);i.querySelectorAll('input[type="radio"]').forEach(c=>{c.addEventListener("change",()=>{H[d].predicted_result=c.value,oe()})});const l=i.querySelector(".jornada-units__input");l==null||l.addEventListener("input",()=>{let c=parseInt(l.value);isNaN(c)&&(c=0),c=Math.max(0,Math.min(ve,c)),H[d].units=c,oe()})}),(n=document.getElementById("jornadaSaveBtn"))==null||n.addEventListener("click",()=>ba(X.jornada.id)))}async function ba(e){const a=document.getElementById("jornadaSaveBtn"),t=Object.entries(H).filter(([,s])=>s.predicted_result).map(([s,n])=>({jornada_match_id:parseInt(s),predicted_result:n.predicted_result,units:n.units}));if(t.length===0){p("Selecciona al menos un resultado 1X2","error");return}if(U>R){p(`Superas el máximo de ${R} unidades`,"error");return}a.disabled=!0,a.textContent="…";try{await m.jornada.predict(t),p("Predicciones guardadas"),a.textContent="✓ Guardadas"}catch(s){p(s.message||"Error al guardar","error")}finally{a.disabled=!1,setTimeout(()=>{a&&(a.textContent="Guardar predicciones")},2e3)}}const de={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function ha(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:a}=await m.duelo.current(),t=f.getUser();if(!a){e.innerHTML=`
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function ya(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:a}=await m.clasificacion.general(),t=f.getUser();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Clasificación</h1>
    ...
    `,$a(t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${a.message}</p></div>`}}function $a(e){const a={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")}};function t(s){for(const[n,{btn:i,panel:d}]of Object.entries(a))i.classList.toggle("league-tab--active",n===s),d.classList.toggle("hidden",n!==s)}a.general.btn.addEventListener("click",()=>t("general")),a.miDivision.btn.addEventListener("click",()=>{t("miDivision"),a.miDivision.panel.dataset.loaded||(a.miDivision.panel.dataset.loaded="1",Ea(e))}),a.divisiones.btn.addEventListener("click",()=>{t("divisiones"),a.divisiones.panel.dataset.loaded||(a.divisiones.panel.dataset.loaded="1",La(e))})}async function Ea(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await m.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function La(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await m.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>wa(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function wa(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
  ...
  `}const re=e=>()=>{window.location.hash=e},Ia={"/":Se,"/login":Ce,"/register":Me,"/quiniela":re("/jornada"),"/resultados":re("/tabla-v2"),"/ranking":He,"/tablon":ge,"/ligas":Ae,"/ligas/:id":Ue,"/perfil":Je,"/campeon":Fe,"/admin":Ge,"/forgot-password":oa,"/reset-password":da,"/unirse":ra,"/jugador/:id":ca,"/jornada":ma,"/duelo":ha,"/tabla-v2":ya};function ja(e){for(const[a,t]of Object.entries(Ia)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(d,l)=>(s.push(l),"([^/]+)"))+"$"),i=e.match(n);if(i){const d={};return s.forEach((l,c)=>{d[l]=i[c+1]}),{handler:t,params:d}}}return null}const le=()=>document.getElementById("mainContent"),E={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=ja(a);if(!n){le().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:d}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2"].includes(a)&&!f.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!f.isAdmin()){this.navigate("/");return}const c=le();c.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(c,{params:d,query:s})}};let J=[],O=null,N=null;async function Sa(){document.documentElement.dataset.build="2026-08-07T15",await f.init(),E.init(),xa(),ka(),Ca()}function ye(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function ka(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!ye()&&(O=e,Ba())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),O=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function Ba(){if(ye()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
