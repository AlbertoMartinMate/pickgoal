(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Ye="https://pickgoal-backend.onrender.com/api";function Ze(){return localStorage.getItem("token")}async function m(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Ze();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Ye}${e}`,{cache:"no-store",...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const c={get:e=>m(e),post:(e,a)=>m(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>m(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>m(e,{method:"DELETE"}),auth:{register:e=>m("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>m("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>m("/auth/me"),forgotPassword:e=>m("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>m("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>m(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>m("/auth/account",{method:"DELETE"}),users:()=>m("/auth/users"),usersForMentions:()=>m("/auth/users/for-mentions"),toggleAdmin:e=>m(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>m(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>m("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>m("/matches/grouped"),list:(e="")=>m(`/matches/${e}`),get:e=>m(`/matches/${e}`),today:()=>m("/matches/today"),setResult:(e,a,t,s=null)=>m(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>m("/matches/sync",{method:"POST"}),recalculate:()=>m("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>m(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>m(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>m("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>m(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>m(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>m("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>m("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>m("/leagues/all"),public:()=>m("/leagues/public"),my:()=>m("/leagues/my"),create:e=>m("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>m("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>m(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>m("/leagues/admin"),get:e=>m(`/leagues/${e}`),update:(e,a)=>m(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>m(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>m(`/leagues/${e}/members`),matchPredictions:(e,a)=>m(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>m("/home/summary")},board:{messages:(e=1,a=null)=>m(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>m(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>m("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>m(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>m(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>m(`/board/${e}`,{method:"DELETE"}),mentions:e=>m(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>m("/notifications/vapid-public-key"),subscribe:e=>m("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>m("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:(e,a,t)=>m(`/v2/admin/partidos-disponibles?date_from=${encodeURIComponent(e)}&date_to=${encodeURIComponent(a)}${t&&t.length?`&competitions=${encodeURIComponent(t.join(","))}`:""}`),jornadas:()=>m("/v2/admin/jornadas"),createJornada:e=>m("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>m(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>m(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>m(`/v2/admin/jornada/${e}/publish`,{method:"POST"}),closeJornada:e=>m(`/v2/admin/jornada/${e}/close`,{method:"POST"}),jornadaMatches:e=>m(`/v2/admin/jornada/${e}/matches`),setResultado:(e,a)=>m(`/v2/admin/jornada-match/${e}/resultado`,{method:"POST",body:JSON.stringify(a)}),cancelMatch:e=>m(`/v2/admin/jornada-match/${e}/cancel`,{method:"POST"}),addManualMatch:(e,a)=>m(`/v2/admin/jornada/${e}/match/manual`,{method:"POST",body:JSON.stringify(a)}),deleteManualMatch:e=>m(`/v2/admin/jornada-match/${e}`,{method:"DELETE"}),generateBots:()=>m("/v2/admin/bots/generate",{method:"POST"}),weeklyChecklist:()=>m("/v2/admin/weekly-checklist")},jornada:{info:()=>m("/v2/jornada/info"),current:()=>m("/v2/jornada/current"),list:()=>m("/v2/jornada/list"),predict:e=>m("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>m("/v2/jornada/history"),myStats:()=>m("/v2/jornada/my-stats")},duelo:{list:()=>m("/v2/duelo/list"),current:e=>m(`/v2/duelo/current${e?`?jornada_id=${e}`:""}`),detail:e=>m(`/v2/duelo/current/detail${e?`?jornada_id=${e}`:""}`)},messages:{unread:()=>m("/messages/unread"),list:()=>m("/messages/"),get:e=>m(`/messages/${e}`),send:(e,a)=>m(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>m("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>m(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>m("/v2/clasificacion/general"),allDivisions:()=>m("/v2/clasificacion/all-divisions")}};let q=null;const E={async init(){if(localStorage.getItem("token"))try{const{user:a}=await c.auth.me();q=a}catch{localStorage.removeItem("token")}},setUser(e,a){q=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){q=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return q},isLoggedIn(){return!!q},isAdmin(){return(q==null?void 0:q.is_admin)===!0}};let le=null;function _(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,le&&clearTimeout(le),le=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function Qe(){return`
  ...
  `}function ee(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",r=>{r.key==="Escape"&&o()},{once:!1}),i}function L(e){const a=parseFloat(e);return isNaN(a)||e==null?"—":parseFloat(a.toFixed(2)).toString()}function P(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}const ea="/assets/icon-512-v2-CAowBaBi.png";async function aa(e){if(!E.getUser()){ta(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await c.home.summary();if(s){e.innerHTML=`
  ...
  `}const fe="pickgoal_welcome_shown";function qe(e="/jornada"){if(localStorage.getItem(fe))return;localStorage.setItem(fe,"1");const a=document.createElement("div");a.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await c.auth.register(n);E.setUser(o,i),_("¡Cuenta creada! Bienvenido a PickGoal");const r=sessionStorage.getItem("pendingInviteCode");if(r){sessionStorage.removeItem("pendingInviteCode");try{const{league:d}=await c.leagues.joinByCode(r);_(`¡Te has unido a "${d.name}"!`),S.navigate(`/ligas/${d.id}`)}catch{S.navigate("/ligas")}}else S.navigate("/"),qe("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function ca(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ua(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(E.isLoggedIn()){const{leagues:p}=await c.leagues.my();if(p.length===0){e.innerHTML=Qe();return}}const s=ca(),[{ranking:n},i]=await Promise.all([c.auth.ranking(s),E.isLoggedIn()?c.leagues.my():Promise.resolve({leagues:[]})]),o=E.getUser(),r=i.leagues.find(p=>p.id===s),d=document.getElementById("tablonBadge"),l=d&&!d.classList.contains("hidden"),h=l?d.textContent:"",v=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        ...
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(p=>{var j,b,u;const f=p.predictions_made??0,$=`${f}/${v}`,y=`${p.correct_results??0}/${f}`,w=`${p.exact_scores??0}/${f}`;return`
    ...
    `,y(),w(),I()}function v(u){return u.length?u.map(g=>`
    ...
    `).join(""):""}function p(u){return`
      <div class="board-reply ${u.is_deleted?"board-reply--deleted":""}" data-id="${u.id}">
        <div class="board-reply__header">
          ...
          <span class="board-reply__date">${P(u.created_at)}</span>
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function $(u){const g=D(u);if(!o.length)return g.replace(/@(\w+)/g,'<span class="mention">@$1</span>');const k=o.map(x=>ma(x.username)),B=new RegExp(`@(${k.join("|")})`,"gi");return g.replace(B,'<span class="mention">@$1</span>')}function y(){const u=document.getElementById("boardForm");if(!u)return;const g=document.getElementById("boardMsg"),k=document.getElementById("charCounter"),B=document.getElementById("mentionDropdown");g.addEventListener("input",()=>{k.textContent=`${g.value.length} / 500`,b(g,B)}),u.addEventListener("submit",async x=>{x.preventDefault();const A=g.value.trim();if(A)try{await c.board.post(A,n),g.value="",k.textContent="0 / 500",B.classList.add("hidden");const M=await l();j(M),_("Mensaje publicado")}catch(M){_(M.message,"error")}})}function w(){e.querySelectorAll(".reply-form").forEach(u=>{const g=parseInt(u.dataset.parent),k=u.querySelector(".reply-input"),B=`mentionDropdown-${g}`,x=document.getElementById(B);k==null||k.addEventListener("input",()=>{b(k,x)}),u.addEventListener("submit",async A=>{A.preventDefault();const M=k.value.trim();if(M)try{await c.board.reply(g,M),k.value="",x==null||x.classList.add("hidden");const U=await l();j(U),_("Respuesta enviada")}catch(U){_(U.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();j(g),_("Mensaje fijado")}catch(g){_(g.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();j(g),_("Mensaje desfijado")}catch(g){_(g.message,"error")}})})}function I(){e.querySelectorAll(".delete-msg").forEach(u=>{u.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await c.board.delete(u.dataset.id);const g=await l();j(g),_("Mensaje eliminado")}catch(g){_(g.message,"error")}})})}function j(u){const{pinned:g=[],messages:k=[]}=u,B=document.getElementById("boardPinned");if(B)B.innerHTML=v(g);else if(g.length){h(u);return}const x=document.getElementById("boardMessages");x&&(x.innerHTML=f(k)),w(),I()}e.addEventListener("click",async u=>{if(u.target.id==="prevPage"&&r>1){r--;const g=await l();j(g)}else if(u.target.id==="nextPage"&&r<d){r++;const g=await l();j(g)}});function b(u,g){if(!g||!o.length){console.log("[tablon] handleMentionInput: sin dropdown o members vacío",{dropdown:!!g,membersLen:o.length});return}const k=u.value,B=u.selectionStart,x=k.slice(0,B),A=x.match(/@(\w*)$/);if(!A){g.classList.add("hidden");return}const M=A[1].toLowerCase();console.log("[tablon] mention detected, query:",M);const U=o.filter(C=>C.username.toLowerCase().startsWith(M)&&C.id!==(s==null?void 0:s.id));console.log("[tablon] matches:",U.map(C=>C.username));const ge=[...E.isAdmin()&&"todos".startsWith(M)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...U.slice(0,6)];if(!ge.length){g.classList.add("hidden");return}g.innerHTML=ge.map(C=>C.description?`<div class="mention-item mention-item--broadcast" data-username="${D(C.username)}">
             <span class="mention-item__name">@${D(C.username)}</span>
             <span class="mention-item__desc">${D(C.description)}</span>
           </div>`:`<div class="mention-item" data-username="${D(C.username)}">${D(C.username)}</div>`).join(""),g.classList.remove("hidden"),g.querySelectorAll(".mention-item").forEach(C=>{C.addEventListener("mousedown",We=>{We.preventDefault();const Ke=C.dataset.username,de=x.replace(/@(\w*)$/,`@${Ke} `);if(u.value=de+k.slice(B),u.setSelectionRange(de.length,de.length),g.classList.add("hidden"),u.tagName==="TEXTAREA"){const be=document.getElementById("charCounter");be&&(be.textContent=`${u.value.length} / 500`)}})})}document.addEventListener("click",u=>{!u.target.closest(".board-form__input-wrap")&&!u.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(g=>g.classList.add("hidden"))},{capture:!0})}function D(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ma(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function pa(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=E.getUser(),o=i==null?void 0:i.is_admin,[r,d]=await Promise.all([o?c.leagues.adminAll():c.leagues.all(),E.isLoggedIn()&&!o?c.leagues.my():Promise.resolve({leagues:[]})]),l=new Set(d.leagues.map(v=>v.id)),h=o?r.leagues:r.leagues.filter(v=>!l.has(v.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&d.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${d.leagues.map(v=>ye(v,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${h.length?`<div class="leagues-grid">${h.map(v=>ye(v,!1,l,o)).join("")}</div>`:o?'<p class="empty">No hay ligas creadas aún.</p>':d.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(v=>{v.addEventListener("click",()=>S.navigate(`/ligas/${v.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(v=>{v.addEventListener("click",async p=>{p.stopPropagation();const f=parseInt(v.dataset.id);v.disabled=!0,v.textContent="…";try{const{league:$}=await c.leagues.join({league_id:f});_(`¡Te has unido a "${$.name}"!`),S.navigate(`/ligas/${$.id}`)}catch($){_($.message,"error"),v.disabled=!1,v.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(v=>{v.addEventListener("click",p=>{p.stopPropagation(),_("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var v,p;(v=document.getElementById("createLeaguePanel"))==null||v.classList.remove("hidden"),(p=document.getElementById("btnShowCreate"))==null||p.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var v,p;(v=document.getElementById("createLeaguePanel"))==null||v.classList.add("hidden"),(p=document.getElementById("btnShowCreate"))==null||p.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async v=>{v.preventDefault();const p=document.getElementById("inviteCode").value.trim().toUpperCase();if(p)try{const{league:f}=await c.leagues.join({invite_code:p});_(`Te has unido a "${f.name}"`),S.navigate(`/ligas/${f.id}`)}catch(f){_(f.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async v=>{var j;v.preventDefault();const p=document.getElementById("createBtn");p.disabled=!0,p.textContent="Creando…";const f=document.getElementById("leagueName").value.trim(),$=document.getElementById("leagueDesc").value.trim(),y=document.getElementById("leaguePrize").value.trim(),w=document.getElementById("isPublic").checked,I=((j=document.getElementById("isOfficial"))==null?void 0:j.checked)??!1;try{const{league:b}=await c.leagues.create({name:f,description:$,prize:y,is_public:w,is_official:I});va(b)}catch(b){_(b.message,"error"),p.disabled=!1,p.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function ye(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",o=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),_("Enlace copiado")}catch{_("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function _a(e,{params:a}){var s,n,i,o,r;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const d=await c.leagues.get(t),{league:l,ranking:h,is_member:v,is_admin_view:p}=d,f=E.getUser(),$=l.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        ${(v||f!=null&&f.is_admin)&&l.invite_link?`
        ...
        <div class="league-actions">
          ${v?'<button class="btn btn--danger btn--sm" id="btnLeave">Abandonar liga</button>':!(f!=null&&f.is_admin)&&f?'<button class="btn btn--primary" id="btnJoin">Unirse a esta liga</button>':""}
          ${f!=null&&f.is_admin||v&&f&&l.created_by===f.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const r=document.getElementById("btnSaveEdit");r.disabled=!0,r.textContent="Guardando…";const d={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(d.is_official=document.getElementById("editOfficial").checked);try{await c.leagues.update(a,d),_("Liga actualizada"),i(),S.navigate(`/ligas/${a}`)}catch(l){_(l.message,"error"),r.disabled=!1,r.textContent="Guardar cambios"}})}async function ba(e){var t,s,n,i,o,r;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=E.getUser();try{const[d,l,h]=await Promise.all([c.clasificacion.division(),c.auth.me(),a!=null&&a.is_admin?c.leagues.adminAll():Promise.resolve({leagues:[]})]),v=l.user,p=v.status,f=v.total_points_all_time,$=(t=d.standings)==null?void 0:t.find(y=>y.user_id===v.id);e.innerHTML=`
    ...
    </div>`}async function $a(e){var t,s;const a=e.querySelector("#predStatsWrap");if(a)try{const{total_predictions:n,correct_results:i,predictions:o}=await c.jornada.myStats();if(n===0){a.innerHTML='<p class="empty">Aún no tienes predicciones en esta temporada.</p>';return}const r=Math.round(i/n*100),d=50,l=+(2*Math.PI*d).toFixed(2),h=+(r/100*l).toFixed(2),v=+(l-h).toFixed(2);a.innerHTML=`
        ...
        <div class="pred-circle__chart">
          <svg viewBox="0 0 120 120" aria-hidden="true">
            ...
            <circle cx="60" cy="60" r="${d}" fill="none" stroke="#39FF14" stroke-width="12"
              stroke-dasharray="${h} ${v}" stroke-linecap="round"
        ...
        <div class="pred-item ${l.is_correct?"pred-item--correct":l.result_known?"pred-item--wrong":""}">
          ...
          <div class="pred-item__body">
            ...
            <div class="pred-item__row">
              ...
              ${l.actual_result?`<span class="pred-item__actual">Real: <strong>${l.actual_result}</strong> (${v})</span>`:'<span class="pred-item__actual">Sin resultado</span>'}
  ...
  `,document.body.appendChild(e),document.body.style.overflow="hidden",requestAnimationFrame(()=>e.classList.add("delete-modal--open"));const a=e.querySelector("#deleteConfirmInput"),t=e.querySelector("#deleteConfirmBtn"),s=e.querySelector("#deleteCancelBtn"),n=e.querySelector("#deleteOverlay"),i=e.querySelector("#deleteError");function o(){e.classList.remove("delete-modal--open"),document.body.style.overflow="",e.addEventListener("transitionend",()=>e.remove(),{once:!0})}a.addEventListener("input",()=>{t.disabled=a.value.trim()!=="CERRAR"}),s.addEventListener("click",o),n.addEventListener("click",o),t.addEventListener("click",async()=>{t.disabled=!0,t.textContent="Cerrando…",i.classList.add("hidden");try{await c.auth.deleteAccount(),o(),E.logout(),_("Cuenta cerrada. Hasta pronto."),window.location.hash="/"}catch(r){i.textContent=r.message||"Error al cerrar la cuenta",i.classList.remove("hidden"),t.disabled=!1,t.textContent="Cerrar mi cuenta"}})}function wa(){window.location.hash="/"}async function ja(e){if(!E.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await c.auth.users();e.innerHTML=`
    ...
    `,La(e),W(e),Sa(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function La(e){var s,n,i,o,r;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const d=document.getElementById("syncResult");d.textContent="Sincronizando…";try{await c.matches.sync(),d.textContent="✓ Sincronización completada",_("Sincronización completada")}catch(l){d.textContent=`Error: ${l.message}`,_(l.message,"error")}}),(n=document.getElementById("btnGenerateBots"))==null||n.addEventListener("click",async()=>{const d=document.getElementById("btnGenerateBots"),l=document.getElementById("generateBotsResult");d.disabled=!0,l.textContent="Generando…";try{const{message:h}=await c.adminV2.generateBots();l.textContent=`✓ ${h}`,_(h)}catch(h){l.textContent=`Error: ${h.message}`,_(h.message,"error")}finally{d.disabled=!1}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(i=document.getElementById("pushForm"))==null||i.addEventListener("submit",async d=>{d.preventDefault();const l=document.getElementById("pushTitle").value.trim()||"Aviso",h=document.getElementById("pushBody").value.trim(),v=a.value,p=parseInt(document.getElementById("pushTargetId").value)||null,f=document.getElementById("pushResult"),$={title:`📣 PickGoal — ${l}`,body:h};v==="league"&&p&&($.league_id=p),v==="user"&&p&&($.user_id=p),f.textContent="Enviando…";try{const{sent:y}=await c.notifications.send($);f.textContent=`✓ Enviada a ${y} suscripción(es)`,_(`Notificación enviada a ${y} suscripción(es)`)}catch(y){f.textContent=`Error: ${y.message}`,_(y.message,"error")}}),(o=document.getElementById("btnCloseSeason"))==null||o.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const d=document.getElementById("btnCloseSeason"),l=document.getElementById("closeSeasonResult");d.disabled=!0,l.textContent="Cerrando…";try{const{message:h}=await c.post("/v2/admin/season/1/close");l.textContent=`✓ ${h||"Temporada cerrada"}`,_("Temporada cerrada")}catch(h){l.textContent=`Error: ${h.message}`,_(h.message,"error"),d.disabled=!1}}),(r=document.getElementById("usersTableBody"))==null||r.addEventListener("click",async d=>{const l=d.target.closest(".toggle-admin");if(l){const v=parseInt(l.dataset.id);try{const{user:p}=await c.auth.toggleAdmin(v);l.closest("tr").querySelector(".admin-badge").textContent=p.is_admin?"Sí":"No",_(`${p.username} ${p.is_admin?"ahora es admin":"ya no es admin"}`)}catch(p){_(p.message,"error")}return}const h=d.target.closest(".toggle-mute");if(h){const v=parseInt(h.dataset.id);try{const{user:p}=await c.auth.toggleMute(v),f=h.closest("tr");f.querySelector(".mute-badge").textContent=p.is_muted?"Sí":"No",h.textContent=p.is_muted?"Activar":"Silenciar",_(`${p.username} ${p.is_muted?"silenciado":"activado"}`)}catch(p){_(p.message,"error")}}})}function ka(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}function Ca(){return Ae.map(e=>{const a=e.codes.map(s=>`<span class="jv2-comp-filter-chip">${He[s]||s}</span>`).join(""),t=`
  ...
  `}function Ta(e){var a,t,s,n,i,o;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{ne=null,T=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2DateFrom").value="",document.getElementById("jv2DateTo").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",ve()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",T=[],ne=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",Ma),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",qa),e.querySelectorAll(".jv2-results-btn").forEach(r=>{r.addEventListener("click",()=>Aa(r.dataset.id,r))}),e.querySelectorAll(".jv2-pub-btn").forEach(r=>{r.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${r.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){r.disabled=!0,r.textContent="Publicando…";try{const d=await c.adminV2.publishJornada(r.dataset.id);_(`Jornada ${r.dataset.num} publicada — push enviado a ${d.push_sent} suscriptores`),await W(document.getElementById("jornadasV2Section"))}catch(d){_(d.message,"error"),r.disabled=!1,r.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-close-btn").forEach(r=>{r.addEventListener("click",async()=>{if(confirm(`¿Cerrar jornada ${r.dataset.num}? Se calcularán los puntos y se resolverán los duelos. Esta acción es irreversible.`)){r.disabled=!0,r.textContent="Cerrando…";try{const d=await c.adminV2.closeJornada(r.dataset.id);_(d.message||`Jornada ${r.dataset.num} cerrada`),await W(document.getElementById("jornadasV2Section"))}catch(d){_(d.message,"error"),r.disabled=!1,r.textContent="Cerrar jornada"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(r=>{r.addEventListener("click",()=>Pa(r.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(r=>{r.addEventListener("click",async()=>{if(confirm(`¿Eliminar la jornada ${r.dataset.num}?`)&&confirm("¿Seguro? Esta acción eliminará la jornada y todos sus partidos")){r.disabled=!0,r.textContent="Eliminando…";try{await c.adminV2.deleteJornada(r.dataset.id),_("Jornada eliminada"),await W(document.getElementById("jornadasV2Section"))}catch(d){_(d.message,"error"),r.disabled=!1,r.textContent="🗑️ Eliminar"}}})}),(i=e.querySelector("#jv2DateStart"))==null||i.addEventListener("input",Ee),(o=e.querySelector("#jv2DateEnd"))==null||o.addEventListener("input",Ee),e.querySelectorAll(".jv2-group-check").forEach(r=>{r.addEventListener("click",d=>d.stopPropagation())})}function Ee(){var n,i;const e=(n=document.getElementById("jv2DateStart"))==null?void 0:n.value,a=(i=document.getElementById("jv2DateEnd"))==null?void 0:i.value,t=document.getElementById("jv2DateFrom"),s=document.getElementById("jv2DateTo");t&&e&&(t.value=e.slice(0,10)),s&&a&&(s.value=a.slice(0,10))}async function Pa(e){const{jornadas:a}=await c.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(ne=t.id,T=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),t.date_start&&(document.getElementById("jv2DateFrom").value=t.date_start.slice(0,10)),t.date_end&&(document.getElementById("jv2DateTo").value=t.date_end.slice(0,10)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",ve())}async function Ma(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2DateFrom").value,t=document.getElementById("jv2DateTo").value;if(!a||!t){_("Selecciona el rango de fechas (Desde / Hasta)","error");return}if(a>t){_('"Desde" no puede ser posterior a "Hasta"',"error");return}const s=Array.from(document.querySelectorAll(".jv2-group-check:checked")).map(i=>i.dataset.group),n=Ae.filter(i=>s.includes(i.key)).flatMap(i=>i.codes);if(n.length===0){_("Selecciona al menos un grupo de competiciones","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:i}=await c.adminV2.partidos(a,t,n);Da(i),document.getElementById("jv2MatchPicker").style.display="block"}catch(i){_(`Error: ${i.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function Da(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        <div class="jv2-comp-group__title">${He[s]||s}</div>
        ${n.map(i=>`
  ...
  `}function Ne(e,a){var t,s,n,i;(t=e.querySelector(".jv2-add-manual-btn"))==null||t.addEventListener("click",()=>{const o=e.querySelector(".jv2-manual-form");o.style.display=o.style.display==="none"?"block":"none"}),(s=e.querySelector(".jv2-manual-cancel-btn"))==null||s.addEventListener("click",()=>{e.querySelector(".jv2-manual-form").style.display="none"}),e.querySelectorAll(".jv2-manual-type").forEach(o=>{o.addEventListener("change",()=>{var l;const r=((l=e.querySelector(".jv2-manual-type:checked"))==null?void 0:l.value)==="12",d=e.querySelector(".jv2-manual-oddsx-wrap");d&&(d.style.display=r?"none":"")})}),(n=e.querySelector(".jv2-manual-save-btn"))==null||n.addEventListener("click",async()=>{var $;const o=e.querySelector(".jv2-manual-home").value.trim(),r=e.querySelector(".jv2-manual-away").value.trim(),d=e.querySelector(".jv2-manual-dt").value,l=(($=e.querySelector(".jv2-manual-type:checked"))==null?void 0:$.value)==="12",h=e.querySelector(".jv2-manual-odds1").value,v=e.querySelector(".jv2-manual-oddsx").value,p=e.querySelector(".jv2-manual-odds2").value;if(!o||!r){_("Introduce los dos equipos","error");return}if(!d){_("Introduce la fecha y hora","error");return}const f=e.querySelector(".jv2-manual-save-btn");f.disabled=!0,f.textContent="…";try{const y={home_team:o,away_team:r,match_datetime:new Date(d).toISOString(),no_draw:l};h&&(y.odds_1=parseFloat(h)),!l&&v&&(y.odds_x=parseFloat(v)),p&&(y.odds_2=parseFloat(p)),await c.adminV2.addManualMatch(a,y),_("Partido manual añadido"),await G(a)}catch(y){_(y.message,"error"),f.disabled=!1,f.textContent="Añadir"}}),(i=e.querySelector(".jv2-sync-btn"))==null||i.addEventListener("click",async o=>{const r=o.currentTarget;r.disabled=!0,r.textContent="⏳ Sincronizando…";try{await c.matches.sync(),_("Sincronización completada"),await G(a)}catch(d){_(d.message,"error"),r.disabled=!1,r.textContent="🔄 Sincronizar resultados ahora"}}),e.querySelectorAll(".jv2-save-result-btn").forEach(o=>{o.addEventListener("click",async()=>{var f,$,y,w;const r=o.dataset.jmId,d=e.querySelector(`.jv2-results-row[data-jm-id="${r}"]`),l=(f=d.querySelector('.jv2-score-input[data-side="home"]'))==null?void 0:f.value,h=($=d.querySelector('.jv2-score-input[data-side="away"]'))==null?void 0:$.value,v=((y=d.querySelector(".jv2-r90-select"))==null?void 0:y.value)||void 0,p=((w=d.querySelector(".jv2-result-type-select"))==null?void 0:w.value)||"90m";if(l===""||h===""){_("Introduce los dos marcadores","error");return}o.disabled=!0,o.textContent="…";try{const I={home_score:parseInt(l),away_score:parseInt(h),result_type:p};v&&(I.result_90=v),await c.adminV2.setResultado(r,I),_("Resultado guardado y puntos recalculados"),await G(a)}catch(I){_(I.message,"error"),o.disabled=!1,o.textContent="Guardar"}})}),e.querySelectorAll(".jv2-cancel-match-btn").forEach(o=>{o.addEventListener("click",async()=>{const{jmId:r,home:d,away:l}=o.dataset;if(confirm(`¿Cancelar el partido ${d} vs ${l}? Las unidades apostadas se devolverán a los usuarios.`)){o.disabled=!0,o.textContent="…";try{const{message:h}=await c.adminV2.cancelMatch(r);_(h),await G(a)}catch(h){_(h.message,"error"),o.disabled=!1,o.textContent="Cancelar"}}})}),e.querySelectorAll(".jv2-delete-manual-btn").forEach(o=>{o.addEventListener("click",async()=>{const{jmId:r,home:d,away:l}=o.dataset;if(confirm(`¿Eliminar el partido manual ${d} vs ${l}? Se borrarán todas las predicciones asociadas.`)){o.disabled=!0,o.textContent="…";try{const{message:h}=await c.adminV2.deleteManualMatch(r);_(h),await G(a)}catch(h){_(h.message,"error"),o.disabled=!1,o.textContent="🗑️ Eliminar"}}})})}async function G(e){const a=document.getElementById(`jv2-results-${e}`);if(!(!a||a.style.display==="none"))try{const{matches:t}=await c.adminV2.jornadaMatches(e);a.innerHTML=Oe(t,e),Ne(a,e)}catch(t){_(`Error recargando: ${t.message}`,"error")}}function Ra(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await c.auth.resetPassword(t,o),_("Contraseña actualizada. Ya puedes iniciar sesión."),S.navigate("/login")}catch(r){i.textContent=r.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function Fa(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!E.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),S.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await c.leagues.joinByCode(t);_(`¡Te has unido a "${s.name}"!`),S.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){_("Ya eres miembro de esta liga");try{const{leagues:n}=await c.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){S.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
      <div class="container">
        <div class="league-gate">
  ...
  `}const V=20,Re=5;let R={},N=0,ue=null,K=null;async function Ga(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await c.jornada.list();if(!a.length){e.innerHTML=Xa();return}Ue(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Ue(e,a,t){var l,h;K=a[t];const{jornada:s,matches:n,units_used:i}=K;R={};for(const v of n)R[v.jornada_match_id]={predicted_result:((l=v.prediction)==null?void 0:l.predicted_result)??null,units:((h=v.prediction)==null?void 0:h.units_wagered)??0};N=i;const o=n.filter(v=>!v.predict_locked);ue=o.length===1?o[0].jornada_match_id:null;const r=s.status==="finished",d=a.length>1?`<div class="jornada-tabs">
        ${a.map((v,p)=>{const f=v.jornada.status==="finished";return`
            <button class="jornada-tab ${p===t?"jornada-tab--active":""} ${f?"jornada-tab--finished":""}" data-idx="${p}">
              J${v.jornada.number} · ${te(v.jornada.date_start)}–${te(v.jornada.date_end)}
              ${f?'<span class="jornada-tab__badge">Finalizada</span>':""}
            </button>
          `}).join("")}
       </div>`:"";e.innerHTML=`
    <div class="container">
  ...
  `,Je(),ze(),et(e,a,t),ee(e),requestAnimationFrame(()=>{var v;(v=e.querySelector(".jornada-tab--active"))==null||v.scrollIntoView({block:"nearest",inline:"center"})})}function Xa(){return`
    <div class="container">
  ...
  `}function te(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function Wa(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function ce(e){return e!=null?e.toFixed(2):"—"}function Ka(e){return e.jm_status==="cancelled"?'<span class="tag tag--cancelled">Suspendido</span>':e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${Wa(e.opens_until)}</span>`}const Fe=new Set(["r32","r16","quarters","semis","third","final","no_draw"]);function Ya(e,a,t){const n={1:t.odds_1,X:t.odds_x,2:t.odds_2}[a];return n!=null?Math.round(e.units_wagered*parseFloat(n)*100)/100:e.points_earned??0}function Za(e){if(e.jm_status==="cancelled")return"";const a=e.prediction;if(e.status==="finished"&&e.result_90!=null){if(!a)return'<span class="jornada-pts-label jornada-pts-label--penalty">-1 pt ⚠️</span>';if(a.predicted_result===e.result_90){const n=Ya(a,e.result_90,e);return`<span class="jornada-pts-label jornada-pts-label--win">+${L(n)} pts</span>`}return'<span class="jornada-pts-label jornada-pts-label--loss">0 pts</span>'}if(!a||!a.units_wagered)return"";const s=e.predict_locked;return`<span class="jornada-pts-label jornada-pts-label--${s?"live":"pending"}">${a.units_wagered}u${s?" en juego":" apostadas"}</span>`}function Qa(e){const a=e.jm_status==="cancelled",t=e.predict_locked,s=R[e.jornada_match_id]??{predicted_result:null,units:0},n=Fe.has(e.phase);return`
  ...
  `}function Je(){const e=document.getElementById("unitsCounter");if(!e)return;const a=N>V;e.innerHTML=`
    <div class="units-counter__bar">
      <div class="units-counter__fill ${a?"units-counter__fill--over":""}" style="width:${Math.min(100,N/V*100)}%"></div>
    </div>
    <span class="units-counter__label ${a?"units-counter__label--over":""}">${N}/${V} unidades usadas</span>
  `}function ze(){if(!ue)return;const e=document.getElementById(`warning-${ue}`);if(!e)return;const a=V-N;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function we(){N=Object.values(R).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),Je(),ze()}function et(e,a,t){e.querySelectorAll(".jornada-tab").forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.idx);n!==t&&Ue(e,a,n)})}),e.querySelectorAll(".jornada-match").forEach(s=>{var o;const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(r=>{r.addEventListener("change",()=>{R[n].predicted_result=r.value,we()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let r=parseInt(i.value);isNaN(r)&&(r=0),r=Math.max(0,Math.min(Re,r)),R[n].units=r,we()}),(o=s.querySelector(".jornada-match__save-btn"))==null||o.addEventListener("click",()=>at(n))})}async function at(e){var i;const a=R[e],t=(i=K==null?void 0:K.matches)==null?void 0:i.find(o=>o.jornada_match_id===parseInt(e)),s=t&&Fe.has(t.phase);if(!a.predicted_result){_(s?"Selecciona el ganador (1 o 2)":"Selecciona un resultado 1X2","error");return}if(N>V){_(`Superas el máximo de ${V} unidades`,"error");return}const n=document.querySelector(`.jornada-match__save-btn[data-jm-id="${e}"]`);n&&(n.disabled=!0,n.textContent="…");try{await c.jornada.predict({jornada_match_id:e,predicted_result:a.predicted_result,units:a.units}),_("Predicción guardada"),n&&(n.textContent="✓ Guardada")}catch(o){_(o.message||"Error al guardar","error")}finally{n&&(n.disabled=!1,setTimeout(()=>{n&&(n.textContent="Guardar")},2e3))}}let se=null;function _e(){se&&(clearInterval(se),se=null)}const je={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}},tt={ganado:"🏆 Victoria",perdido:"💔 Derrota",empate:"🤝 Empate"};function Le(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}async function st(e){_e(),e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const[{duelos:a},t]=await Promise.all([c.duelo.list(),Promise.resolve(E.getUser())]);if(!a.length){e.innerHTML=`
        <div class="container">
    ...
    `,ee(e),requestAnimationFrame(()=>{var o;(o=e.querySelector(".jornada-tab--active"))==null||o.scrollIntoView({block:"nearest",inline:"center"})}),e.querySelectorAll(".jornada-tab").forEach(o=>{o.addEventListener("click",()=>{e.querySelectorAll(".jornada-tab").forEach(r=>r.classList.remove("jornada-tab--active")),o.classList.add("jornada-tab--active"),ke(e,a[parseInt(o.dataset.idx)],t)})}),await ke(e,a[n],t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando duelos: ${a.message}</p></div>`}}async function ke(e,a,t){var i;_e();const s=e.querySelector("#dueloContent");if(!s)return;s.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const n=a.jornada_status==="active"||a.jornada_status==="upcoming";try{const{duelo:o}=await c.duelo.current(a.jornada_id);if(n){if(!o){s.innerHTML=ot();return}if(s.innerHTML=nt(o,t),Ie(s,o.division_league_id,t.id),!a.is_bye){const r=((i=a.rival)==null?void 0:i.username)??"—";Se(a.jornada_id,t.username,r),se=setInterval(()=>Se(a.jornada_id,t.username,r),6e4)}}else s.innerHTML=it(a,o,t),Ie(s,a.division_league_id,t.id)}catch(o){s.innerHTML=`<p class="form__error">Error: ${o.message}</p>`}}function nt(e,a){var i;const t=je[e.status]??je.en_curso,s=e.rival?e.rival.username:a.username,n=!e.rival||e.rival.id===a.id;return`
  ...
  `}function it(e,a,t){var j;const s=((j=e.rival)==null?void 0:j.username)??(e.is_bye?"Descanso":"—"),n=tt[e.status],i=(a==null?void 0:a.matches)??[];let o=0,r=0,d=0,l=0;for(const b of i)b.jm_status!=="cancelled"&&(b.my_prediction?(d+=b.my_prediction.units_wagered,b.status==="finished"&&b.result_90!=null&&(r+=b.my_prediction.points_earned??0,b.my_prediction.predicted_result===b.result_90&&o++)):b.status==="finished"&&b.result_90!=null&&l++);const h=20-d,v=o>=10?10:o>=9?5:o>=8?2:0,p=o>=10;function f(b){if(!b.result_90)return"—";const g={1:b.odds_1,X:b.odds_x,2:b.odds_2}[b.result_90];return g!=null?parseFloat(g).toFixed(2):"—"}function $(b,u){return u?b?b.predicted_result===u?`<span class="pts-label pts-label--win">+${L(b.points_earned??0)} pts</span>`:'<span class="pts-label pts-label--loss">0 pts</span>':'<span class="pts-label pts-label--penalty">-1 pt</span>':"—"}const y=i.map(b=>{const u=b.my_prediction?`${b.my_prediction.predicted_result} · ${b.my_prediction.units_wagered}u`:"—",g=b.rival_prediction?`${b.rival_prediction.predicted_result} · ${b.rival_prediction.units_wagered}u`:b.started?"—":"?",k=b.result_90!=null?`${b.home_score_90??"?"}–${b.away_score_90??"?"} (${b.result_90})`:"—";return`
    ...
    <tr class="duelo-breakdown__footer-row">
      ...
      <td class="duelo-breakdown__pts duelo-breakdown__pts--bonus" colspan="2">+${v} pts</td>
    </tr>`:""}
  ...
  `}async function Se(e,a,t){const s=document.getElementById("dueloTracker");if(!s){_e();return}try{const{detail:n}=await c.duelo.detail(e);if(!n)return;s.innerHTML=rt(n,a,t)}catch{}}function rt(e,a,t){const{me:s,rival:n}=e;function i(o,r){return`
  ...
  `}function dt(e,a){var i;const t=(i=e.my_prediction)==null?void 0:i.predicted_result;let s,n;return e.started?e.rival_prediction?(s=e.rival_prediction.predicted_result,n=""):(s="—",n="duelo-pick__value--empty"):(s="?",n="duelo-pick__value--hidden"),`
  ...
  `}async function Ie(e,a,t){const s=e.querySelector("#divisionStandings");if(s)try{const{standings:n}=await c.clasificacion.division(a);if(!n.length){s.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}s.innerHTML=`
    ...
    `}catch(n){s.innerHTML=`<p class="form__error">Error cargando la clasificación: ${n.message}</p>`}}async function lt(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:t}=await c.clasificacion.general(),s=E.getUser();e.innerHTML=`
      <div class="container">
        <div class="page-title-row">
          <h1 class="page-title">Clasificación</h1>
          <button class="btn-info" id="btnPointsInfo" aria-label="Cómo funciona">ℹ️</button>
    ...
    `,ut(s,a.tab),ee(e),ct(),_t(e,s)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${t.message}</p></div>`}}async function ct(){const e=document.getElementById("tablonTabDot");if(!e)return;if(!E.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString();try{const{count:s}=await c.board.unread(null,t);console.log("[tablonDot] count:",s,"since:",t),e.classList.toggle("hidden",s===0)}catch(s){console.warn("[tablonDot] error:",s),e.classList.add("hidden")}}function ut(e,a){const t={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")},tablon:{btn:document.getElementById("tabTablon"),panel:document.getElementById("panelTablon")}};function s(i){for(const[o,{btn:r,panel:d}]of Object.entries(t))r.classList.toggle("league-tab--active",o===i),d.classList.toggle("hidden",o!==i)}t.general.btn.addEventListener("click",()=>s("general")),t.miDivision.btn.addEventListener("click",()=>{s("miDivision"),t.miDivision.panel.dataset.loaded||(t.miDivision.panel.dataset.loaded="1",mt(e))}),t.divisiones.btn.addEventListener("click",()=>{s("divisiones"),t.divisiones.panel.dataset.loaded||(t.divisiones.panel.dataset.loaded="1",pt(e))});function n(){var i;s("tablon"),localStorage.setItem("tablon_general_last_read",new Date().toISOString()),(i=document.getElementById("tablonTabDot"))==null||i.classList.add("hidden"),document.dispatchEvent(new CustomEvent("tablon:read")),t.tablon.panel.dataset.loaded||(t.tablon.panel.dataset.loaded="1",pe(t.tablon.panel,{forceGeneral:!0}))}t.tablon.btn.addEventListener("click",n),a==="tablon"&&n()}async function mt(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await c.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function pt(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await c.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>vt(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function vt(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
      ...
      <div class="div-accordion__body">
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${e.standings.map(s=>Ve(s,a)).join("")}
            </tbody>
          </table>
        </div>
      </div>
    </div>
  `}function ie(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function _t(e,a){let t=document.getElementById("userCtxMenu");t||(t=document.createElement("div"),t.id="userCtxMenu",t.className="user-ctx-menu hidden",t.innerHTML=`
  ...
  `}async function xe(e,{params:a={}}={}){const t=a.userId?parseInt(a.userId):null;t?await ht(e,t):await gt(e)}async function gt(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{conversations:a}=await c.messages.list();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">💬 Mensajes</h1>
        ${a.length===0?'<p class="empty">No tienes conversaciones aún. Pulsa el nombre de un jugador en la clasificación para enviar un mensaje.</p>':`<div class="mensajes-list">${a.map(bt).join("")}</div>`}
      </div>
    `,e.querySelectorAll(".mensajes-item").forEach(t=>{t.addEventListener("click",()=>{window.location.hash=`/mensajes/${t.dataset.userId}`})})}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function bt(e){return`
  ...
  `}async function ht(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=E.getUser();try{const{messages:n,partner:i}=await c.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
      <div class="container">
  ...
  `}function Y(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Be=e=>()=>{window.location.hash=e},ft={"/":aa,"/login":da,"/register":la,"/quiniela":Be("/jornada"),"/resultados":Be("/tabla-v2"),"/ranking":ua,"/tablon":pe,"/ligas":pa,"/ligas/:id":_a,"/perfil":ba,"/campeon":wa,"/admin":ja,"/forgot-password":Ra,"/reset-password":Ua,"/unirse":Fa,"/jugador/:id":za,"/jornada":Ga,"/duelo":st,"/tabla-v2":lt,"/mensajes":xe,"/mensajes/:userId":xe};function yt(e){for(const[a,t]of Object.entries(ft)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,r)=>(s.push(r),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((r,d)=>{o[r]=i[d+1]}),{handler:t,params:o}}}return null}const Te=()=>document.getElementById("mainContent"),S={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=yt(a);if(!n){Te().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2","/mensajes"].includes(a)&&!E.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!E.isAdmin()){this.navigate("/");return}const d=Te();d.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(d,{params:o,query:s})}};let X=[],z=null,F=null,oe=!1;async function $t(){document.documentElement.dataset.build="2026-09-20T12",await E.init(),S.init(),jt(),Et(),St()}function Ge(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Et(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!Ge()&&(z=e,wt())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),z=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function wt(){if(Ge()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `}function J(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}$t();
