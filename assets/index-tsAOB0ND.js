(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const de="https://pickgoal-backend.onrender.com/api";function le(){return localStorage.getItem("token")}async function _(e,a={}){const t={"Content-Type":"application/json",...a.headers},n=le();n&&(t.Authorization=`Bearer ${n}`);const s=await fetch(`${de}${e}`,{...a,headers:t}),i=await s.json().catch(()=>({}));if(!s.ok)throw{status:s.status,message:i.error||"Error desconocido"};return i}const p={get:e=>_(e),post:(e,a)=>_(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>_(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>_(e,{method:"DELETE"}),auth:{register:e=>_("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>_("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>_("/auth/me"),forgotPassword:e=>_("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>_("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>_(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>_("/auth/users"),toggleAdmin:e=>_(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>_("/matches/grouped"),list:(e="")=>_(`/matches/${e}`),get:e=>_(`/matches/${e}`),sync:()=>_("/matches/sync",{method:"POST"})},predictions:{mine:e=>_(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>_(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>_("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>_(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>_(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>_("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>_("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>_("/leagues/all"),public:()=>_("/leagues/public"),my:()=>_("/leagues/my"),create:e=>_("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>_("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>_(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>_("/leagues/admin"),get:e=>_(`/leagues/${e}`),update:(e,a)=>_(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>_(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>_(`/leagues/${e}/members`),matchPredictions:(e,a)=>_(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>_("/home/summary")},board:{messages:(e=1,a=null)=>_(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>_(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>_("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>_(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>_(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>_(`/board/${e}`,{method:"DELETE"})}};let T=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await p.auth.me();T=a}catch{localStorage.removeItem("token")}},setUser(e,a){T=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){T=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return T},isLoggedIn(){return!!T},isAdmin(){return(T==null?void 0:T.is_admin)===!0}};let U=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,U&&clearTimeout(U),U=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function Z(){return`
  ...
  `}function M(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function ce(e){if(!y.getUser()){pe(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,upcoming_matches:n}=await p.home.summary();if(t.length===0){ue(e);return}const s=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),i=[...t].sort((o,d)=>o.league_id===s?-1:d.league_id===s?1:0);e.innerHTML=`
      ...
      ${_e()}
    `,ve(e),e.querySelectorAll(".league-card[data-league-id]").forEach(o=>{o.style.cursor="pointer",o.addEventListener("click",d=>{d.target.closest("a")||E.navigate(`/ligas/${o.dataset.leagueId}`)})})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el inicio: ${t.message}</p></div>`}}function pe(e){e.innerHTML=`
    <section class="hero">
  ...
  `}function me(e){return`${e}º`}function ge(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `}function ve(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),n=e.querySelector("#pointsClose"),s=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}t==null||t.addEventListener("click",i),n==null||n.addEventListener("click",o),s==null||s.addEventListener("click",o),document.addEventListener("keydown",d=>{d.key==="Escape"&&o()},{once:!1})}function he(e){return e.length?`
  ...
  `:""}const z="pickgoal_welcome_shown";function ee(e="/ligas"){if(localStorage.getItem(z))return;localStorage.setItem(z,"1");const a=document.createElement("div");a.innerHTML=`
  ...
  `;const t=a.firstElementChild;document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("welcome-modal--open"));function n(s){t.classList.remove("welcome-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0}),s&&(window.location.hash=s)}document.getElementById("welcomeOverlay").addEventListener("click",()=>n()),document.getElementById("welcomeCta").addEventListener("click",()=>n(e)),document.addEventListener("keydown",function s(i){i.key==="Escape"&&(n(),document.removeEventListener("keydown",s))})}function be(e){e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),n=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",n.classList.add("hidden");const s={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await p.auth.register(s);y.setUser(o,i),v("¡Cuenta creada! Bienvenido a PickGoal");const d=sessionStorage.getItem("pendingInviteCode");if(d){sessionStorage.removeItem("pendingInviteCode");try{const{league:c}=await p.leagues.joinByCode(d);v(`¡Te has unido a "${c.name}"!`),E.navigate(`/ligas/${c.id}`)}catch{E.navigate("/ligas")}}else E.navigate("/campeon"),ee("/ligas")}catch(i){n.textContent=i.message||"Error al registrarse",n.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function ye(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function $e(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:m}=await p.leagues.my();if(m.length===0){e.innerHTML=Z();return}}const a=ye(),[{groups:t},n]=await Promise.all([p.matches.grouped(),y.isLoggedIn()?p.predictions.mine(a):Promise.resolve({predictions:[]})]),s={};for(const m of n.predictions)s[m.match_id]=m;const i=t.flatMap(m=>m.matches),o=new Map;for(const m of i){const u=V(m.match_datetime);o.has(u)||o.set(u,[]),o.get(u).push(m)}const d=[...o.keys()].sort(),c=V(new Date().toISOString()),g=d.find(m=>m>=c)??d[0];e.innerHTML=`
      <div class="container">
    ...
    `,Ee(d,g,o,s,a)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando los partidos: ${a.message}</p></div>`}}function Ee(e,a,t,n,s){var o;const i=document.getElementById("dateNav");i&&(i.innerHTML=e.map(d=>`
    <button class="date-nav__btn ${d===a?"date-nav__btn--active":""}" data-day="${d}">
      ${Le(d)}
    </button>
  `).join(""),(o=i.querySelector(".date-nav__btn--active"))==null||o.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),i.querySelectorAll(".date-nav__btn").forEach(d=>{d.addEventListener("click",()=>{i.querySelectorAll(".date-nav__btn").forEach(c=>c.classList.remove("date-nav__btn--active")),d.classList.add("date-nav__btn--active"),J(t.get(d.dataset.day)??[],n,s)})}),J(t.get(a)??[],n,s))}function J(e,a,t){const n=document.getElementById("matchesContent");if(n){if(e.length===0){n.innerHTML='<p class="empty">Sin partidos este día.</p>';return}n.innerHTML=`<div class="matches-grid">${e.map(s=>we(s,a[s.id])).join("")}</div>`,y.isLoggedIn()&&n.querySelectorAll(".prediction-form").forEach(s=>{Se(s,a,t)})}}function V(e){const a=new Date(e);return`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`}function Le(e){const[a,t,n]=e.split("-").map(Number);return new Date(a,t-1,n).toLocaleDateString("es-ES",{day:"numeric",month:"short"})}function we(e,a){const t=e.is_locked,n=a?`<span class="pts-badge">${a.total_points} pts</span>`:"",s={scheduled:"Programado",live:"🔴 En juego",finished:"Finalizado"}[e.status];return`
  ...
  `}function Ie(e,a){const t=!!a,n=(a==null?void 0:a.predicted_home)??0,s=(a==null?void 0:a.predicted_away)??0,i=(a==null?void 0:a.predicted_result)??"X",o=t?"prediction-form--saved":"prediction-form--unsaved",d=t?'<span class="pred-status pred-status--saved">✓ Guardado</span>':'<span class="pred-status pred-status--unsaved">Sin predicción</span>',c=t?"btn btn--saved btn--sm pred-save-btn":"btn btn--ghost btn--sm pred-save-btn",g=t?"✓ Guardado":"Guardar";return`
    <form class="prediction-form ${o}" data-match-id="${e.id}" data-saved="${t}">
      ...
      <button type="submit" class="${c}">${g}</button>
    </form>
  `}function Se(e,a,t){const n=parseInt(e.dataset.matchId),s=e.querySelector(".pred-save-btn"),i=e.querySelector(".pred-status");let o=e.dataset.saved==="true";function d(){e.classList.contains("prediction-form--dirty")||(e.classList.remove("prediction-form--saved","prediction-form--unsaved"),e.classList.add("prediction-form--dirty"),s.className="btn btn--primary btn--sm pred-save-btn",s.textContent="Guardar",i&&(i.className="pred-status pred-status--unsaved",i.textContent="Sin guardar"))}function c(){o=!0,e.classList.remove("prediction-form--unsaved","prediction-form--dirty"),e.classList.add("prediction-form--saved"),s.className="btn btn--saved btn--sm pred-save-btn",s.textContent="✓ Guardado",s.disabled=!1,i&&(i.className="pred-status pred-status--saved",i.textContent="✓ Guardado")}e.querySelectorAll("input").forEach(g=>{g.addEventListener("change",d),g.addEventListener("input",d)}),e.addEventListener("submit",async g=>{var h;g.preventDefault();const m=parseInt(e.querySelector("[name=predicted_home]").value),u=parseInt(e.querySelector("[name=predicted_away]").value),b=(h=e.querySelector("[name=predicted_result]:checked"))==null?void 0:h.value;if(!(isNaN(m)||isNaN(u)||!b)){s.disabled=!0,s.textContent="…";try{const{prediction:f}=await p.predictions.save({match_id:n,predicted_result:b,predicted_home:m,predicted_away:u,league_id:t??null});a[n]=f,v("Predicción guardada"),c()}catch(f){v(f.message||"Error al guardar","error"),s.disabled=!1,o?(s.className="btn btn--saved btn--sm pred-save-btn",s.textContent="✓ Guardado"):(s.className="btn btn--primary btn--sm pred-save-btn",s.textContent="Guardar")}}})}function xe(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Be(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:m}=await p.leagues.my();if(m.length===0){e.innerHTML=Z();return}}const a=xe(),[{ranking:t},n]=await Promise.all([p.auth.ranking(a),y.isLoggedIn()?p.leagues.my():Promise.resolve({leagues:[]})]),s=y.getUser(),i=n.leagues.find(m=>m.id===a),o=i?i.name:"Clasificación General",d=document.getElementById("tablonBadge"),c=d&&!d.classList.contains("hidden"),g=c?d.textContent:"";e.innerHTML=`
      <div class="container">
        <div class="ranking-header">
          <h1 class="page-title">${o}</h1>
          ${a?`
            <a href="#/tablon?liga=${a}" class="ranking-tablon-btn">
              💬 Tablón
              <span class="ranking-tablon-btn__badge${c?"":" hidden"}">${g}</span>
            </a>
          `:""}
        </div>
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${t.map(m=>{var u,b;return`
                <tr class="${s&&m.id===s.id?"ranking-table__row--me":""}">
                  <td class="ranking-table__pos" data-pos="${m.position}">${m.position}</td>
                  <td>
                    <a class="ranking-table__link" href="#/jugador/${m.id}">
                      <span class="status-emoji" title="${((u=m.status)==null?void 0:u.name)||""}">${((b=m.status)==null?void 0:b.emoji)||""}</span>${m.username}
                    </a>
                  </td>
                  <td>${m.country||"—"}</td>
                  <td class="ranking-table__pts">${m.total_points}</td>
                  <td class="ranking-table__stat">${m.correct_results}</td>
                  <td class="ranking-table__stat">${m.exact_scores}</td>
                </tr>
              `}).join("")}
            </tbody>
          </table>
    ...
    `}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}async function ae(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=y.getUser();let n=a.liga?parseInt(a.liga):null;if(n){localStorage.setItem(`tablon_last_read_${n}`,new Date().toISOString());const r=document.getElementById("tablonBadge");r&&(r.classList.add("hidden"),r.textContent="")}let s=null,i=[],o=1,d=1;try{if(!n&&t){const{leagues:r}=await p.leagues.my();r&&r.length&&(n=r[0].id,s=r[0].name)}else if(n)try{const{league:r}=await p.leagues.get(n);s=r.name}catch{}if(n&&t)try{const{members:r}=await p.leagues.members(n);i=r||[]}catch{}}catch{}async function c(){const r=await p.board.messages(o,n);return d=r.pages||1,r}try{const r=await c();g(r)}catch(r){e.innerHTML=`<div class="container"><p class="form__error">Error: ${r.message}</p></div>`}function g(r){const{pinned:l=[],messages:$=[]}=r;e.innerHTML=`
      <div class="container">
    ...
    `,f(),S(),x()}function m(r){return r.length?r.map(l=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function h(r){const l=q(r);if(!i.length)return l;const $=i.map(L=>Ce(L.username)),I=new RegExp(`@(${$.join("|")})`,"gi");return l.replace(I,'<span class="mention">@$1</span>')}function f(){const r=document.getElementById("boardForm");if(!r)return;const l=document.getElementById("boardMsg"),$=document.getElementById("charCounter"),I=document.getElementById("mentionDropdown");l.addEventListener("input",()=>{$.textContent=`${l.value.length} / 500`,C(l,I)}),r.addEventListener("submit",async L=>{L.preventDefault();const j=l.value.trim();if(j)try{await p.board.post(j,n),l.value="",$.textContent="0 / 500",I.classList.add("hidden");const k=await c();w(k),v("Mensaje publicado")}catch(k){v(k.message,"error")}})}function S(){e.querySelectorAll(".reply-form").forEach(r=>{const l=parseInt(r.dataset.parent),$=r.querySelector(".reply-input"),I=`mentionDropdown-${l}`,L=document.getElementById(I);$==null||$.addEventListener("input",()=>{C($,L)}),r.addEventListener("submit",async j=>{j.preventDefault();const k=$.value.trim();if(k)try{await p.board.reply(l,k),$.value="",L==null||L.classList.add("hidden");const H=await c();w(H),v("Respuesta enviada")}catch(H){v(H.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await p.board.pin(r.dataset.id);const l=await c();w(l),v("Mensaje fijado")}catch(l){v(l.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await p.board.pin(r.dataset.id);const l=await c();w(l),v("Mensaje desfijado")}catch(l){v(l.message,"error")}})})}function x(){e.querySelectorAll(".delete-msg").forEach(r=>{r.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await p.board.delete(r.dataset.id);const l=await c();w(l),v("Mensaje eliminado")}catch(l){v(l.message,"error")}})})}function w(r){const{pinned:l=[],messages:$=[]}=r,I=document.getElementById("boardPinned");if(I)I.innerHTML=m(l);else if(l.length){g(r);return}const L=document.getElementById("boardMessages");L&&(L.innerHTML=b($)),S(),x()}e.addEventListener("click",async r=>{if(r.target.id==="prevPage"&&o>1){o--;const l=await c();w(l)}else if(r.target.id==="nextPage"&&o<d){o++;const l=await c();w(l)}});function C(r,l){if(!l||!i.length)return;const $=r.value,I=r.selectionStart,L=$.slice(0,I),j=L.match(/@(\w*)$/);if(!j){l.classList.add("hidden");return}const k=j[1].toLowerCase(),H=i.filter(P=>P.username.toLowerCase().startsWith(k)&&P.id!==(t==null?void 0:t.id));if(!H.length){l.classList.add("hidden");return}l.innerHTML=H.slice(0,6).map(P=>`<div class="mention-item" data-username="${q(P.username)}">${q(P.username)}</div>`).join(""),l.classList.remove("hidden"),l.querySelectorAll(".mention-item").forEach(P=>{P.addEventListener("mousedown",oe=>{oe.preventDefault();const re=P.dataset.username,R=L.replace(/@(\w*)$/,`@${re} `);if(r.value=R+$.slice(I),r.setSelectionRange(R.length,R.length),l.classList.add("hidden"),r.tagName==="TEXTAREA"){const F=document.getElementById("charCounter");F&&(F.textContent=`${r.value.length} / 500`)}})})}document.addEventListener("click",r=>{!r.target.closest(".board-form__input-wrap")&&!r.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(l=>l.classList.add("hidden"))},{capture:!0})}function q(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ce(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function ke(e){var a,t,n,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=y.getUser(),o=i==null?void 0:i.is_admin,[d,c]=await Promise.all([o?p.leagues.adminAll():p.leagues.all(),y.isLoggedIn()&&!o?p.leagues.my():Promise.resolve({leagues:[]})]),g=new Set(c.leagues.map(u=>u.id)),m=o?d.leagues:d.leagues.filter(u=>!g.has(u.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&c.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${c.leagues.map(u=>X(u,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${m.length?`<div class="leagues-grid">${m.map(u=>X(u,!1,g,o)).join("")}</div>`:o?'<p class="empty">No hay ligas creadas aún.</p>':c.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(u=>{u.addEventListener("click",()=>E.navigate(`/ligas/${u.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(u=>{u.addEventListener("click",async b=>{b.stopPropagation();const h=parseInt(u.dataset.id);u.disabled=!0,u.textContent="…";try{const{league:f}=await p.leagues.join({league_id:h});v(`¡Te has unido a "${f.name}"!`),E.navigate(`/ligas/${f.id}`)}catch(f){v(f.message,"error"),u.disabled=!1,u.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(u=>{u.addEventListener("click",b=>{b.stopPropagation(),v("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var u,b;(u=document.getElementById("createLeaguePanel"))==null||u.classList.remove("hidden"),(b=document.getElementById("btnShowCreate"))==null||b.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var u,b;(u=document.getElementById("createLeaguePanel"))==null||u.classList.add("hidden"),(b=document.getElementById("btnShowCreate"))==null||b.classList.remove("hidden")}),(n=document.getElementById("joinCodeForm"))==null||n.addEventListener("submit",async u=>{u.preventDefault();const b=document.getElementById("inviteCode").value.trim().toUpperCase();if(b)try{const{league:h}=await p.leagues.join({invite_code:b});v(`Te has unido a "${h.name}"`),E.navigate(`/ligas/${h.id}`)}catch(h){v(h.message,"error")}}),(s=document.getElementById("createLeagueForm"))==null||s.addEventListener("submit",async u=>{var C;u.preventDefault();const b=document.getElementById("createBtn");b.disabled=!0,b.textContent="Creando…";const h=document.getElementById("leagueName").value.trim(),f=document.getElementById("leagueDesc").value.trim(),S=document.getElementById("leaguePrize").value.trim(),x=document.getElementById("isPublic").checked,w=((C=document.getElementById("isOfficial"))==null?void 0:C.checked)??!1;try{const{league:r}=await p.leagues.create({name:h,description:f,prize:S,is_public:x,is_official:w});Pe(r)}catch(r){v(r.message,"error"),b.disabled=!1,b.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function X(e,a=!1,t=new Set,n=!1){const s=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",o=n?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `}function Pe(e){var n,s;const a=e.invite_link||"",t=document.getElementById("createLeaguePanel");t&&(t.innerHTML=`
  ...
  `,(n=document.getElementById("btnCopyLink"))==null||n.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(s=document.getElementById("btnShare"))==null||s.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function Te(e,{params:a}){var n,s,i,o,d;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const c=await p.leagues.get(t),{league:g,ranking:m,is_member:u,is_admin_view:b}=c,h=y.getUser(),f=g.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";console.log("[liga-detalle] render tabs - user:",h==null?void 0:h.username,"is_admin:",h==null?void 0:h.is_admin,"is_member:",u),e.innerHTML=`
      <div class="container">
        ...
        ${(u||h!=null&&h.is_admin)&&g.invite_link?`
        ...
        <div class="league-actions">
          ...
          ${h!=null&&h.is_admin||u&&h&&g.created_by===h.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
    ...
    `,(n=document.getElementById("btnCopyInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(g.invite_link),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(s=document.getElementById("btnShareInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${g.name} en PickGoal`,url:g.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await p.leagues.leave(t),v("Has abandonado la liga"),E.navigate("/ligas")}catch(r){v(r.message,"error")}}),(o=document.getElementById("btnJoin"))==null||o.addEventListener("click",async()=>{try{await p.leagues.join({league_id:t}),v("¡Te has unido a la liga!"),E.navigate(`/ligas/${t}`)}catch(r){v(r.message,"error")}}),(d=document.getElementById("btnEditLeague"))==null||d.addEventListener("click",()=>{Me(g,t,h)});const S=document.getElementById("tabRanking"),x=document.getElementById("tabTablon"),w=document.getElementById("sectionRanking"),C=document.getElementById("sectionTablon");S&&x&&(S.addEventListener("click",()=>{S.classList.add("league-tab--active"),x.classList.remove("league-tab--active"),w.classList.remove("hidden"),C.classList.add("hidden")}),x.addEventListener("click",()=>{x.classList.add("league-tab--active"),S.classList.remove("league-tab--active"),w.classList.add("hidden"),C.classList.remove("hidden");const r=document.getElementById("tablonEmbed");r&&!r.dataset.loaded&&(r.dataset.loaded="1",ae(r,{query:{liga:String(t)}}))}))}catch(c){e.innerHTML=`<div class="container"><p class="form__error">Error: ${c.message}</p><a href="#/ligas">Volver</a></div>`}}function Me(e,a,t){const n=document.getElementById("editLeagueModal");n&&n.remove();const s=document.createElement("div");s.id="editLeagueModal",s.className="edit-league-modal",s.innerHTML=`
  ...
  `}const Y=new Date("2026-06-11T21:00:00Z"),Ae=["Argentina","Brasil","Francia","España","Inglaterra","Alemania","Portugal","Países Bajos","Italia","Bélgica","Uruguay","Colombia","México","Estados Unidos","Canadá","Marruecos","Senegal","Nigeria","Japón","Corea del Sur","Australia","Arabia Saudí","Irán","Qatar","Ecuador","Chile","Perú","Venezuela","Bolivia","Paraguay","Costa Rica","Honduras","Panamá","Jamaica","Trinidad y Tobago","Guatemala","Turquía","Polonia","Croacia","Serbia","República Checa","Eslovaquia","Austria","Suiza","Dinamarca","Suecia","Noruega","Escocia","Ucrania","Rumanía","Hungría","Grecia","Egipto","Camerún","Ghana","Costa de Marfil","Túnez","Argelia","China","India","Irak","Uzbekistán","Nueva Zelanda","Fiji"];function De(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function te(e){var a;if(!y.isLoggedIn()){e.innerHTML='<div class="container"><p class="notice"><a href="#/login">Inicia sesión</a> para predecir el campeón.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const t=De(),{champion_prediction:n}=await p.predictions.getChampion(t),s=new Date>=Y;let i;n&&s?i=`
    ...
    `,(a=document.getElementById("championForm"))==null||a.addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("champBtn"),c=document.getElementById("champError"),g=document.getElementById("teamSearch").value.trim();if(g){d.disabled=!0,d.textContent="Guardando…",c.classList.add("hidden");try{await p.predictions.saveChampion(g,t),v(`¡${g} guardado como campeón!`),te(e)}catch(m){c.textContent=m.message,c.classList.remove("hidden"),d.disabled=!1,d.textContent=d.dataset.label||"Confirmar predicción"}}})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error: ${t.message}</p></div>`}}function G(e){const a=e?"Actualizar predicción":"Confirmar predicción";return`
  ...
  `}async function Ne(e){if(!y.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await p.auth.users();e.innerHTML=`
      <div class="container">
    ...
    `,document.getElementById("btnSync").addEventListener("click",async()=>{const t=document.getElementById("syncResult");t.textContent="Sincronizando…";try{await p.matches.sync(),t.textContent="✓ Sincronización completada",v("Sincronización completada")}catch(n){t.textContent=`Error: ${n.message}`,v(n.message,"error")}}),document.getElementById("awardForm").addEventListener("submit",async t=>{t.preventDefault();const n=document.getElementById("winnerTeam").value.trim();if(n)try{const{message:s}=await p.predictions.awardChampion(n);v(s)}catch(s){v(s.message,"error")}}),document.getElementById("usersTableBody").addEventListener("click",async t=>{const n=t.target.closest(".toggle-admin");if(!n)return;const s=parseInt(n.dataset.id);try{const{user:i}=await p.auth.toggleAdmin(s);n.closest("tr").querySelector(".admin-badge").textContent=i.is_admin?"Sí":"No",v(`${i.username} ${i.is_admin?"ahora es admin":"ya no es admin"}`)}catch(i){v(i.message,"error")}})}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function Oe(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}async function Ye(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!y.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),E.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:n}=await p.leagues.joinByCode(t);v(`¡Te has unido a "${n.name}"!`),E.navigate(`/ligas/${n.id}`)}catch(n){if(n.status===409){v("Ya eres miembro de esta liga");try{const{leagues:s}=await p.leagues.my(),i=s.find(o=>o.invite_code===t);if(i){E.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function We(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ke(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const n=We(),{user:s,predictions:i}=await p.predictions.forUser(t,n);e.innerHTML=`
      <div class="container">
  ...
  `}const Ze={"/":ce,"/login":be,"/register":fe,"/quiniela":$e,"/resultados":Fe,"/ranking":Be,"/tablon":ae,"/ligas":ke,"/ligas/:id":Te,"/perfil":je,"/campeon":te,"/admin":Ne,"/forgot-password":Re,"/reset-password":Ue,"/unirse":Ye,"/jugador/:id":Ke};function ea(e){for(const[a,t]of Object.entries(Ze)){const n=[],s=new RegExp("^"+a.replace(/:([^/]+)/g,(o,d)=>(n.push(d),"([^/]+)"))+"$"),i=e.match(s);if(i){const o={};return n.forEach((d,c)=>{o[d]=i[c+1]}),{handler:t,params:o}}}return null}const K=()=>document.getElementById("mainContent"),E={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),n=Object.fromEntries(new URLSearchParams(t||"")),s=ea(a);if(!s){K().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=s;if(["/perfil","/campeon","/admin"].includes(a)&&!y.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!y.isAdmin()){this.navigate("/");return}const c=K();c.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(c,{params:o,query:n})}};let D=[],N=null,A=null;async function aa(){await y.init(),E.init(),na(),ta()}function se(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function ta(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!se()&&(N=e,sa())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),N=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function sa(){if(se()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("installBtn").addEventListener("click",async()=>{N&&(N.prompt(),await N.userChoice,N=null,e.remove())}),document.getElementById("installDismissBtn").addEventListener("click",()=>{sessionStorage.setItem("installBannerDismissed","1"),e.remove()})}function B(){var e,a,t,n;(e=document.getElementById("leagueDropdown"))==null||e.classList.add("hidden"),(a=document.getElementById("leagueBtn"))==null||a.classList.remove("navbar__dropdown-btn--open"),(t=document.getElementById("userDropdown"))==null||t.classList.add("hidden"),(n=document.getElementById("userBtn"))==null||n.classList.remove("navbar__dropdown-btn--open")}async function O(){const e=document.getElementById("tablonBadge");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("activeLeagueId");if(!t){e.classList.add("hidden");return}const n=localStorage.getItem(`tablon_last_read_${t}`)||new Date(0).toISOString();try{const{count:s}=await p.board.unread(parseInt(t),n);s>0?(e.textContent=s>99?"99+":String(s),e.classList.remove("hidden")):e.classList.add("hidden")}catch{e.classList.add("hidden")}}function na(){var e,a,t,n,s;document.addEventListener("auth:change",Q),window.addEventListener("hashchange",()=>{B(),ie(),setTimeout(O,200)}),document.addEventListener("click",B),(e=document.getElementById("leagueBtn"))==null||e.addEventListener("click",i=>{var c;i.stopPropagation();const o=document.getElementById("leagueDropdown"),d=o==null?void 0:o.classList.contains("hidden");B(),d&&(o==null||o.classList.remove("hidden"),(c=document.getElementById("leagueBtn"))==null||c.classList.add("navbar__dropdown-btn--open"))}),(a=document.getElementById("leagueDropdown"))==null||a.addEventListener("click",i=>{var d;i.stopPropagation();const o=i.target.closest("[data-league-id]");if(o){const c=String(o.dataset.leagueId);localStorage.setItem("activeLeagueId",c),B(),ne(D),O(),(d=y.getUser())!=null&&d.is_admin?E.navigate(`/ligas/${c}`):E.resolve();return}i.target.closest("a")&&B()}),(t=document.getElementById("userBtn"))==null||t.addEventListener("click",i=>{var c;i.stopPropagation();const o=document.getElementById("userDropdown"),d=o==null?void 0:o.classList.contains("hidden");B(),d&&(o==null||o.classList.remove("hidden"),(c=document.getElementById("userBtn"))==null||c.classList.add("navbar__dropdown-btn--open"))}),(n=document.getElementById("userDropdown"))==null||n.addEventListener("click",i=>{i.stopPropagation(),i.target.closest("#navProfileLink")&&B()}),(s=document.getElementById("navLogoutBtn"))==null||s.addEventListener("click",()=>{D=[],localStorage.removeItem("activeLeagueId"),B(),y.logout(),E.navigate("/")}),Q()}async function Q(){const e=document.getElementById("navAuthLinks"),a=document.getElementById("userBtn"),t=document.getElementById("navUsername"),n=document.getElementById("navLeague"),s=document.getElementById("bottomNav"),i=y.getUser();if(B(),i){e==null||e.classList.add("hidden"),t&&(t.textContent=i.username),n.style.visibility="visible",a.style.visibility="visible",s==null||s.classList.remove("hidden"),document.body.classList.add("has-bottom-nav");try{const{leagues:o}=i.is_admin?await p.leagues.adminAll():await p.leagues.my();D=o}catch{D=[]}ne(D),O(),A&&clearInterval(A),A=setInterval(O,5*60*1e3)}else e==null||e.classList.remove("hidden"),n.style.visibility="hidden",a.style.visibility="hidden",s==null||s.classList.add("hidden"),document.body.classList.remove("has-bottom-nav"),D=[],localStorage.removeItem("activeLeagueId"),A&&(clearInterval(A),A=null);ie()}function ne(e){const a=document.getElementById("leagueDropdown"),t=document.getElementById("navLeagueName");if(!a||!t)return;let n=localStorage.getItem("activeLeagueId"),s=e.find(o=>String(o.id)===String(n));!s&&e.length>0&&(s=e[0],localStorage.setItem("activeLeagueId",String(s.id))),s||localStorage.removeItem("activeLeagueId"),t.textContent=s?s.name:"Inicia Liga";const i=e.map(o=>`
  ...
  `}function ie(){const e=window.location.hash.slice(1).split("?")[0]||"/";document.querySelectorAll(".bottom-nav__item").forEach(a=>{const t=a.dataset.route,n=t==="/"?e==="/":e===t||e.startsWith(t+"/");a.classList.toggle("bottom-nav__item--active",n)})}aa();
