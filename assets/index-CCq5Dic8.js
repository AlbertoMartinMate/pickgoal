(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Ze="https://pickgoal-backend.onrender.com/api";function Qe(){return localStorage.getItem("token")}async function p(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Qe();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Ze}${e}`,{cache:"no-store",...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const c={get:e=>p(e),post:(e,a)=>p(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>p(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>p(e,{method:"DELETE"}),auth:{register:e=>p("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>p("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>p("/auth/me"),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>p("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>p(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>p("/auth/account",{method:"DELETE"}),users:()=>p("/auth/users"),usersForMentions:()=>p("/auth/users/for-mentions"),toggleAdmin:e=>p(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>p(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>p("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>p("/matches/grouped"),list:(e="")=>p(`/matches/${e}`),get:e=>p(`/matches/${e}`),today:()=>p("/matches/today"),setResult:(e,a,t,s=null)=>p(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>p("/matches/sync",{method:"POST"}),recalculate:()=>p("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>p(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>p(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>p("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>p(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>p(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>p("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>p("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>p("/leagues/all"),public:()=>p("/leagues/public"),my:()=>p("/leagues/my"),create:e=>p("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>p("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>p(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>p("/leagues/admin"),get:e=>p(`/leagues/${e}`),update:(e,a)=>p(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>p(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>p(`/leagues/${e}/members`),matchPredictions:(e,a)=>p(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>p("/home/summary")},board:{messages:(e=1,a=null)=>p(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>p(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>p("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>p(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>p(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>p(`/board/${e}`,{method:"DELETE"}),mentions:e=>p(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>p("/notifications/vapid-public-key"),subscribe:e=>p("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>p("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:(e,a,t)=>p(`/v2/admin/partidos-disponibles?date_from=${encodeURIComponent(e)}&date_to=${encodeURIComponent(a)}${t&&t.length?`&competitions=${encodeURIComponent(t.join(","))}`:""}`),jornadas:()=>p("/v2/admin/jornadas"),createJornada:e=>p("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>p(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>p(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>p(`/v2/admin/jornada/${e}/publish`,{method:"POST"}),closeJornada:e=>p(`/v2/admin/jornada/${e}/close`,{method:"POST"}),jornadaMatches:e=>p(`/v2/admin/jornada/${e}/matches`),setResultado:(e,a)=>p(`/v2/admin/jornada-match/${e}/resultado`,{method:"POST",body:JSON.stringify(a)}),cancelMatch:e=>p(`/v2/admin/jornada-match/${e}/cancel`,{method:"POST"}),addManualMatch:(e,a)=>p(`/v2/admin/jornada/${e}/match/manual`,{method:"POST",body:JSON.stringify(a)}),deleteManualMatch:e=>p(`/v2/admin/jornada-match/${e}`,{method:"DELETE"}),generateBots:()=>p("/v2/admin/bots/generate",{method:"POST"}),weeklyChecklist:()=>p("/v2/admin/weekly-checklist")},jornada:{info:()=>p("/v2/jornada/info"),current:()=>p("/v2/jornada/current"),list:()=>p("/v2/jornada/list"),predict:e=>p("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>p("/v2/jornada/history"),myStats:()=>p("/v2/jornada/my-stats")},duelo:{list:()=>p("/v2/duelo/list"),current:e=>p(`/v2/duelo/current${e?`?jornada_id=${e}`:""}`),detail:e=>p(`/v2/duelo/current/detail${e?`?jornada_id=${e}`:""}`)},messages:{unread:()=>p("/messages/unread"),list:()=>p("/messages/"),get:e=>p(`/messages/${e}`),send:(e,a)=>p(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>p("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>p(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>p("/v2/clasificacion/general"),allDivisions:()=>p("/v2/clasificacion/all-divisions")}};let H=null;const E={async init(){if(localStorage.getItem("token"))try{const{user:a}=await c.auth.me();H=a}catch{localStorage.removeItem("token")}},setUser(e,a){H=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){H=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return H},isLoggedIn(){return!!H},isAdmin(){return(H==null?void 0:H.is_admin)===!0}};let de=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,de&&clearTimeout(de),de=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function ea(){return`
  ...
  `}function Q(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",r=>{r.key==="Escape"&&o()},{once:!1}),i}function w(e){const a=parseFloat(e);return isNaN(a)||e==null?"—":parseFloat(a.toFixed(2)).toString()}function M(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}const aa="/assets/icon-512-v2-CAowBaBi.png";async function ta(e){if(!E.getUser()){sa(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await c.home.summary();if(s){e.innerHTML=`
    ...
    <div class="div-card">
      <div class="div-card__header">
        ...
        <div class="div-card__pts-block">
          <span class="div-card__pts-val">${w(e.pts_division)}</span>
      ...
      <div class="div-card__record">
        ...
        <div class="div-card__stat div-card__stat--general"><span>${w(e.pts_general)}</span><small>Pts total</small></div>
      </div>
    ...
    <div class="league-card league-card--finished" data-league-id="${e.league_id}">
      ...
      <div class="league-card__stats">
        <div class="league-card__stat">
          <span class="league-card__stat-val">${w(e.total_points)}</span>
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await c.auth.register(n);E.setUser(o,i),v("¡Cuenta creada! Bienvenido a PickGoal");const r=sessionStorage.getItem("pendingInviteCode");if(r){sessionStorage.removeItem("pendingInviteCode");try{const{league:d}=await c.leagues.joinByCode(r);v(`¡Te has unido a "${d.name}"!`),S.navigate(`/ligas/${d.id}`)}catch{S.navigate("/ligas")}}else S.navigate("/"),He("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function ua(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ma(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(E.isLoggedIn()){const{leagues:m}=await c.leagues.my();if(m.length===0){e.innerHTML=ea();return}}const s=ua(),[{ranking:n},i]=await Promise.all([c.auth.ranking(s),E.isLoggedIn()?c.leagues.my():Promise.resolve({leagues:[]})]),o=E.getUser(),r=i.leagues.find(m=>m.id===s),d=document.getElementById("tablonBadge"),l=d&&!d.classList.contains("hidden"),h=l?d.textContent:"",_=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        ...
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(m=>{var L,b,u;const f=m.predictions_made??0,$=`${f}/${_}`,y=`${m.correct_results??0}/${f}`,j=`${m.exact_scores??0}/${f}`;return`
                  <tr class="${o&&m.id===o.id?"ranking-table__row--me":""}">
                    ...
                    <td>
                      <a class="ranking-table__link" href="#/jugador/${m.id}">
                        <span class="status-emoji" title="${((L=m.status)==null?void 0:L.name)||""}">${((b=m.status)==null?void 0:b.emoji)||""}</span>${m.username}
                      </a>
                    </td>
                    <td class="ranking-table__stat ranking-table__status">${((u=m.status)==null?void 0:u.name)||"—"}</td>
    ...
    `,y(),j(),I()}function _(u){return u.length?u.map(g=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function $(u){const g=q(u);if(!o.length)return g.replace(/@(\w+)/g,'<span class="mention">@$1</span>');const k=o.map(x=>pa(x.username)),B=new RegExp(`@(${k.join("|")})`,"gi");return g.replace(B,'<span class="mention">@$1</span>')}function y(){const u=document.getElementById("boardForm");if(!u)return;const g=document.getElementById("boardMsg"),k=document.getElementById("charCounter"),B=document.getElementById("mentionDropdown");g.addEventListener("input",()=>{k.textContent=`${g.value.length} / 500`,b(g,B)}),u.addEventListener("submit",async x=>{x.preventDefault();const O=g.value.trim();if(O)try{await c.board.post(O,n),g.value="",k.textContent="0 / 500",B.classList.add("hidden");const D=await l();L(D),v("Mensaje publicado")}catch(D){v(D.message,"error")}})}function j(){e.querySelectorAll(".reply-form").forEach(u=>{const g=parseInt(u.dataset.parent),k=u.querySelector(".reply-input"),B=`mentionDropdown-${g}`,x=document.getElementById(B);k==null||k.addEventListener("input",()=>{b(k,x)}),u.addEventListener("submit",async O=>{O.preventDefault();const D=k.value.trim();if(D)try{await c.board.reply(g,D),k.value="",x==null||x.classList.add("hidden");const F=await l();L(F),v("Respuesta enviada")}catch(F){v(F.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();L(g),v("Mensaje fijado")}catch(g){v(g.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();L(g),v("Mensaje desfijado")}catch(g){v(g.message,"error")}})})}function I(){e.querySelectorAll(".delete-msg").forEach(u=>{u.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await c.board.delete(u.dataset.id);const g=await l();L(g),v("Mensaje eliminado")}catch(g){v(g.message,"error")}})})}function L(u){const{pinned:g=[],messages:k=[]}=u,B=document.getElementById("boardPinned");if(B)B.innerHTML=_(g);else if(g.length){h(u);return}const x=document.getElementById("boardMessages");x&&(x.innerHTML=f(k)),j(),I()}e.addEventListener("click",async u=>{if(u.target.id==="prevPage"&&r>1){r--;const g=await l();L(g)}else if(u.target.id==="nextPage"&&r<d){r++;const g=await l();L(g)}});function b(u,g){if(!g||!o.length){console.log("[tablon] handleMentionInput: sin dropdown o members vacío",{dropdown:!!g,membersLen:o.length});return}const k=u.value,B=u.selectionStart,x=k.slice(0,B),O=x.match(/@(\w*)$/);if(!O){g.classList.add("hidden");return}const D=O[1].toLowerCase();console.log("[tablon] mention detected, query:",D);const F=o.filter(C=>C.username.toLowerCase().startsWith(D)&&C.id!==(s==null?void 0:s.id));console.log("[tablon] matches:",F.map(C=>C.username));const ge=[...E.isAdmin()&&"todos".startsWith(D)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...F.slice(0,6)];if(!ge.length){g.classList.add("hidden");return}g.innerHTML=ge.map(C=>C.description?`<div class="mention-item mention-item--broadcast" data-username="${q(C.username)}">
             <span class="mention-item__name">@${q(C.username)}</span>
             <span class="mention-item__desc">${q(C.description)}</span>
           </div>`:`<div class="mention-item" data-username="${q(C.username)}">${q(C.username)}</div>`).join(""),g.classList.remove("hidden"),g.querySelectorAll(".mention-item").forEach(C=>{C.addEventListener("mousedown",Ke=>{Ke.preventDefault();const Ye=C.dataset.username,re=x.replace(/@(\w*)$/,`@${Ye} `);if(u.value=re+k.slice(B),u.setSelectionRange(re.length,re.length),g.classList.add("hidden"),u.tagName==="TEXTAREA"){const be=document.getElementById("charCounter");be&&(be.textContent=`${u.value.length} / 500`)}})})}document.addEventListener("click",u=>{!u.target.closest(".board-form__input-wrap")&&!u.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(g=>g.classList.add("hidden"))},{capture:!0})}function q(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function pa(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function _a(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=E.getUser(),o=i==null?void 0:i.is_admin,[r,d]=await Promise.all([o?c.leagues.adminAll():c.leagues.all(),E.isLoggedIn()&&!o?c.leagues.my():Promise.resolve({leagues:[]})]),l=new Set(d.leagues.map(_=>_.id)),h=o?r.leagues:r.leagues.filter(_=>!l.has(_.id));e.innerHTML=`
      <div class="container">
    ...
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(_=>{_.addEventListener("click",()=>S.navigate(`/ligas/${_.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(_=>{_.addEventListener("click",async m=>{m.stopPropagation();const f=parseInt(_.dataset.id);_.disabled=!0,_.textContent="…";try{const{league:$}=await c.leagues.join({league_id:f});v(`¡Te has unido a "${$.name}"!`),S.navigate(`/ligas/${$.id}`)}catch($){v($.message,"error"),_.disabled=!1,_.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(_=>{_.addEventListener("click",m=>{m.stopPropagation(),v("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var _,m;(_=document.getElementById("createLeaguePanel"))==null||_.classList.remove("hidden"),(m=document.getElementById("btnShowCreate"))==null||m.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var _,m;(_=document.getElementById("createLeaguePanel"))==null||_.classList.add("hidden"),(m=document.getElementById("btnShowCreate"))==null||m.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async _=>{_.preventDefault();const m=document.getElementById("inviteCode").value.trim().toUpperCase();if(m)try{const{league:f}=await c.leagues.join({invite_code:m});v(`Te has unido a "${f.name}"`),S.navigate(`/ligas/${f.id}`)}catch(f){v(f.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async _=>{var L;_.preventDefault();const m=document.getElementById("createBtn");m.disabled=!0,m.textContent="Creando…";const f=document.getElementById("leagueName").value.trim(),$=document.getElementById("leagueDesc").value.trim(),y=document.getElementById("leaguePrize").value.trim(),j=document.getElementById("isPublic").checked,I=((L=document.getElementById("isOfficial"))==null?void 0:L.checked)??!1;try{const{league:b}=await c.leagues.create({name:f,description:$,prize:y,is_public:j,is_official:I});va(b)}catch(b){v(b.message,"error"),m.disabled=!1,m.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function ye(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",o=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function ga(e,{params:a}){var s,n,i,o,r;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const d=await c.leagues.get(t),{league:l,ranking:h,is_member:_,is_admin_view:m}=d,f=E.getUser(),$=l.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
    ...
    `,(s=document.getElementById("btnCopyInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(l.invite_link),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShareInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${l.name} en PickGoal`,url:l.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await c.leagues.leave(t),v("Has abandonado la liga"),S.navigate("/ligas")}catch(b){v(b.message,"error")}}),(o=document.getElementById("btnJoin"))==null||o.addEventListener("click",async()=>{try{await c.leagues.join({league_id:t}),v("¡Te has unido a la liga!"),S.navigate(`/ligas/${t}`)}catch(b){v(b.message,"error")}}),(r=document.getElementById("btnEditLeague"))==null||r.addEventListener("click",()=>{ba(l,t,f)});const y=document.getElementById("tabRanking"),j=document.getElementById("tabTablon"),I=document.getElementById("sectionRanking"),L=document.getElementById("sectionTablon");y&&j&&(y.addEventListener("click",()=>{y.classList.add("league-tab--active"),j.classList.remove("league-tab--active"),I.classList.remove("hidden"),L.classList.add("hidden")}),j.addEventListener("click",()=>{j.classList.add("league-tab--active"),y.classList.remove("league-tab--active"),I.classList.add("hidden"),L.classList.remove("hidden");const b=document.getElementById("tablonEmbed");b&&!b.dataset.loaded&&(b.dataset.loaded="1",me(b,{query:{liga:String(t)}}))}))}catch(d){e.innerHTML=`<div class="container"><p class="form__error">Error: ${d.message}</p><a href="#/ligas">Volver</a></div>`}}function ba(e,a,t){const s=document.getElementById("editLeagueModal");s&&s.remove();const n=document.createElement("div");n.id="editLeagueModal",n.className="edit-league-modal",n.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const r=document.getElementById("btnSaveEdit");r.disabled=!0,r.textContent="Guardando…";const d={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(d.is_official=document.getElementById("editOfficial").checked);try{await c.leagues.update(a,d),v("Liga actualizada"),i(),S.navigate(`/ligas/${a}`)}catch(l){v(l.message,"error"),r.disabled=!1,r.textContent="Guardar cambios"}})}async function ha(e){var t,s,n,i,o,r;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=E.getUser();try{const[d,l,h]=await Promise.all([c.clasificacion.division(),c.auth.me(),a!=null&&a.is_admin?c.leagues.adminAll():Promise.resolve({leagues:[]})]),_=l.user,m=_.status,f=_.total_points_all_time,$=(t=d.standings)==null?void 0:t.find(y=>y.user_id===_.id);e.innerHTML=`
      <div class="container">
        ...
        <section class="profile-card section">
          ...
          <div class="profile-card__stats">
            ...
            <div class="stat">
              <span class="stat__value">${$?w($.pts_division):"—"}</span>
        ...
        <section class="section">
          ...
          ${$?`<div class="division-info">
                 ...
                 <div class="division-info__stats">
                   ...
                   <div class="division-info__stat">
                     <span>${w($.pts_division)}</span>
                     <small>pts división</small>
                   </div>
                   <div class="division-info__stat">
                     <span>${w($.pts_general)}</span>
    ...
    <div class="level-progress">
      <div class="level-progress__header">
        <span class="status-badge">${e.emoji} ${e.name}</span>
        <span class="level-progress__label">${w(a)} / ${e.next_threshold} pts → ${e.next_emoji||""} ${e.next_name}</span>
      </div>
    ...
    `,(t=a.querySelector("#predCircleBtn"))==null||t.addEventListener("click",()=>{$e(o)}),(s=a.querySelector("#predCircleBtn"))==null||s.addEventListener("keydown",m=>{(m.key==="Enter"||m.key===" ")&&$e(o)})}catch{a.innerHTML='<p class="empty">No se pudieron cargar las predicciones.</p>'}}function $e(e){var i,o;let a="all";const t=document.createElement("div");t.className="pred-modal",t.innerHTML=`
        ...
        <div class="pred-item ${l.is_correct?"pred-item--correct":l.result_known?"pred-item--wrong":""}">
          ...
          <div class="pred-item__body">
            ...
            <div class="pred-item__row">
              ...
              <span class="pred-item__pts ${l.is_correct?"pred-item__pts--ok":""}">${m}</span>
            </div>
          </div>
        </div>
  ...
  `}function Ba(){return Oe.map(e=>{const a=e.codes.map(s=>`<span class="jv2-comp-filter-chip">${Ae[s]||s}</span>`).join(""),t=`
  ...
  `}function Re(e,a){var t,s,n,i;(t=e.querySelector(".jv2-add-manual-btn"))==null||t.addEventListener("click",()=>{const o=e.querySelector(".jv2-manual-form");o.style.display=o.style.display==="none"?"block":"none"}),(s=e.querySelector(".jv2-manual-cancel-btn"))==null||s.addEventListener("click",()=>{e.querySelector(".jv2-manual-form").style.display="none"}),e.querySelectorAll(".jv2-manual-type").forEach(o=>{o.addEventListener("change",()=>{var l;const r=((l=e.querySelector(".jv2-manual-type:checked"))==null?void 0:l.value)==="12",d=e.querySelector(".jv2-manual-oddsx-wrap");d&&(d.style.display=r?"none":"")})}),(n=e.querySelector(".jv2-manual-save-btn"))==null||n.addEventListener("click",async()=>{var $;const o=e.querySelector(".jv2-manual-home").value.trim(),r=e.querySelector(".jv2-manual-away").value.trim(),d=e.querySelector(".jv2-manual-dt").value,l=(($=e.querySelector(".jv2-manual-type:checked"))==null?void 0:$.value)==="12",h=e.querySelector(".jv2-manual-odds1").value,_=e.querySelector(".jv2-manual-oddsx").value,m=e.querySelector(".jv2-manual-odds2").value;if(!o||!r){v("Introduce los dos equipos","error");return}if(!d){v("Introduce la fecha y hora","error");return}const f=e.querySelector(".jv2-manual-save-btn");f.disabled=!0,f.textContent="…";try{const y={home_team:o,away_team:r,match_datetime:new Date(d).toISOString(),no_draw:l};h&&(y.odds_1=parseFloat(h)),!l&&_&&(y.odds_x=parseFloat(_)),m&&(y.odds_2=parseFloat(m)),await c.adminV2.addManualMatch(a,y),v("Partido manual añadido"),await G(a)}catch(y){v(y.message,"error"),f.disabled=!1,f.textContent="Añadir"}}),(i=e.querySelector(".jv2-sync-btn"))==null||i.addEventListener("click",async o=>{const r=o.currentTarget;r.disabled=!0,r.textContent="⏳ Sincronizando…";try{await c.matches.sync(),v("Sincronización completada"),await G(a)}catch(d){v(d.message,"error"),r.disabled=!1,r.textContent="🔄 Sincronizar resultados ahora"}}),e.querySelectorAll(".jv2-save-result-btn").forEach(o=>{o.addEventListener("click",async()=>{var f,$,y,j;const r=o.dataset.jmId,d=e.querySelector(`.jv2-results-row[data-jm-id="${r}"]`),l=(f=d.querySelector('.jv2-score-input[data-side="home"]'))==null?void 0:f.value,h=($=d.querySelector('.jv2-score-input[data-side="away"]'))==null?void 0:$.value,_=((y=d.querySelector(".jv2-r90-select"))==null?void 0:y.value)||void 0,m=((j=d.querySelector(".jv2-result-type-select"))==null?void 0:j.value)||"90m";if(l===""||h===""){v("Introduce los dos marcadores","error");return}o.disabled=!0,o.textContent="…";try{const I={home_score:parseInt(l),away_score:parseInt(h),result_type:m};_&&(I.result_90=_),await c.adminV2.setResultado(r,I),v("Resultado guardado y puntos recalculados"),await G(a)}catch(I){v(I.message,"error"),o.disabled=!1,o.textContent="Guardar"}})}),e.querySelectorAll(".jv2-cancel-match-btn").forEach(o=>{o.addEventListener("click",async()=>{const{jmId:r,home:d,away:l}=o.dataset;if(confirm(`¿Cancelar el partido ${d} vs ${l}? Las unidades apostadas se devolverán a los usuarios.`)){o.disabled=!0,o.textContent="…";try{const{message:h}=await c.adminV2.cancelMatch(r);v(h),await G(a)}catch(h){v(h.message,"error"),o.disabled=!1,o.textContent="Cancelar"}}})}),e.querySelectorAll(".jv2-delete-manual-btn").forEach(o=>{o.addEventListener("click",async()=>{const{jmId:r,home:d,away:l}=o.dataset;if(confirm(`¿Eliminar el partido manual ${d} vs ${l}? Se borrarán todas las predicciones asociadas.`)){o.disabled=!0,o.textContent="…";try{const{message:h}=await c.adminV2.deleteManualMatch(r);v(h),await G(a)}catch(h){v(h.message,"error"),o.disabled=!1,o.textContent="🗑️ Eliminar"}}})})}async function G(e){const a=document.getElementById(`jv2-results-${e}`);if(!(!a||a.style.display==="none"))try{const{matches:t}=await c.adminV2.jornadaMatches(e);a.innerHTML=Ne(t,e),Re(a,e)}catch(t){v(`Error recargando: ${t.message}`,"error")}}function Ua(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `}const R=20,Ue=5;let P={},U=0,ce=null,we=null,ee=[];async function Wa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await c.jornada.list();if(!a.length){e.innerHTML=Xa();return}const t=[...a].sort((i,o)=>i.jornada.number-o.jornada.number),s=t.findIndex(i=>i.jornada.status==="active"||i.jornada.status==="upcoming"),n=s>=0?s:t.length-1;Fe(e,t,n)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Fe(e,a,t){var l,h;we=a[t];const{jornada:s,matches:n,units_used:i}=we;P={};for(const _ of n)P[_.jornada_match_id]={predicted_result:((l=_.prediction)==null?void 0:l.predicted_result)??null,units:((h=_.prediction)==null?void 0:h.units_wagered)??0};U=i;const o=n.filter(_=>!_.predict_locked);ee=o,ce=o.length===1?o[0].jornada_match_id:null;const r=s.status==="finished",d=a.length>1?`<div class="jornada-tabs">
        ${a.map((_,m)=>{const f=_.jornada.status==="finished",{pts:$,cls:y}=et(_);return`
            <button class="jornada-tab jornada-tab--stacked ${m===t?"jornada-tab--active":""} ${f?"jornada-tab--finished":""}" data-idx="${m}">
              <span class="jornada-tab__num">J${_.jornada.number}</span>
              <span class="jornada-tab__pts jornada-tab__pts--${y}">${w($)}pts</span>
    ...
    <div class="container">
      <div class="page-title-row">
        <h1 class="page-title">Jornada ${s.number} — del ${je(s.date_start)} al ${je(s.date_end)}</h1>
  ...
  `}function je(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function Ka(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function le(e){return e!=null?e.toFixed(2):"—"}function Ya(e){return e.jm_status==="cancelled"?'<span class="tag tag--cancelled">Suspendido</span>':e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${Ka(e.opens_until)}</span>`}const Za=new Set(["r32","r16","quarters","semis","third","final","no_draw"]);function Je(e,a,t){const n={1:t.odds_1,X:t.odds_x,2:t.odds_2}[a];return n!=null?Math.round(e.units_wagered*parseFloat(n)*100)/100:e.points_earned??0}function Qa(e){let a=0,t=0,s=0,n=0;for(const r of e.matches){if(r.jm_status==="cancelled")continue;const d=r.prediction,l=r.status==="finished"&&r.result_90!=null;if(d&&d.units_wagered&&(a+=d.units_wagered),l){if(!d){n+=1;continue}d.predicted_result===r.result_90&&(t+=Je(d,r.result_90,r));continue}d&&d.units_wagered&&(s+=d.units_wagered)}const i=Math.max(0,R-a),o=Math.max(0,t+s+i-n);return Math.round(o*100)/100}function et(e){const a=Qa(e),t=e.jornada.status;return{pts:a,cls:t==="finished"?"finished":t==="active"?"active":"upcoming"}}function at(e){if(e.jm_status==="cancelled")return"";const a=e.prediction;if(e.status==="finished"&&e.result_90!=null){if(!a)return'<span class="jornada-pts-label jornada-pts-label--penalty">-1 pt ⚠️</span>';if(a.predicted_result===e.result_90){const n=Je(a,e.result_90,e);return`<span class="jornada-pts-label jornada-pts-label--win">+${w(n)} pts</span>`}return'<span class="jornada-pts-label jornada-pts-label--loss">0 pts</span>'}if(!a||!a.units_wagered)return"";const s=e.predict_locked;return`<span class="jornada-pts-label jornada-pts-label--${s?"live":"pending"}">${a.units_wagered}u${s?" en juego":" apostadas"}</span>`}function tt(e){const a=e.jm_status==="cancelled",t=e.predict_locked,s=P[e.jornada_match_id]??{predicted_result:null,units:0},n=Za.has(e.phase);return`
    <div class="match-card jornada-match ${t?"match-card--locked":""} ${a?"match-card--cancelled":""}" data-jm-id="${e.jornada_match_id}">
      ...
      <div class="jornada-match__controls ${t?"jornada-match__controls--disabled":""}">
        ...
        <div class="jornada-units">
          ...
          <input type="number" id="units-${e.jornada_match_id}" class="jornada-units__input" min="0" max="${Ue}" value="${s.units}" ${t?"disabled":""} />
        </div>
      </div>
      ${t?"":`<div class="jornada-match__warning" id="warning-${e.jornada_match_id}"></div>`}
    </div>
  `}function ze(){const e=document.getElementById("unitsCounter");if(!e)return;const a=U>R;e.innerHTML=`
    <div class="units-counter__bar">
      <div class="units-counter__fill ${a?"units-counter__fill--over":""}" style="width:${Math.min(100,U/R*100)}%"></div>
    </div>
    <span class="units-counter__label ${a?"units-counter__label--over":""}">${U}/${R} unidades usadas</span>
  `}function Ve(){if(!ce)return;const e=document.getElementById(`warning-${ce}`);if(!e)return;const a=R-U;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function Le(){U=Object.values(P).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),ze(),Ve(),_e()}function st(e,a,t){var s;e.querySelectorAll(".jornada-tab").forEach(n=>{n.addEventListener("click",()=>{const i=parseInt(n.dataset.idx);i!==t&&Fe(e,a,i)})}),e.querySelectorAll(".jornada-match").forEach(n=>{const i=parseInt(n.dataset.jmId);n.querySelectorAll('input[type="radio"]').forEach(r=>{r.addEventListener("change",()=>{P[i].predicted_result=r.value,Le()})});const o=n.querySelector(".jornada-units__input");o==null||o.addEventListener("input",()=>{let r=parseInt(o.value);isNaN(r)&&(r=0),r=Math.max(0,Math.min(Ue,r)),P[i].units=r,Le()})}),(s=document.getElementById("jornadaSaveAllBtn"))==null||s.addEventListener("click",nt)}function _e(){const e=document.getElementById("jornadaSaveAllBtn");if(!e)return;const a=ee.filter(s=>{var n;return(n=P[s.jornada_match_id])==null?void 0:n.predicted_result}).length,t=ee.length;e.textContent=`💾 Guardar predicciones (${a}/${t} predichos)`}async function nt(){const e=ee.filter(i=>{var o;return!((o=P[i.jornada_match_id])!=null&&o.predicted_result)});if(e.length>0&&!confirm(`⚠️ Te quedan ${e.length} partido${e.length!==1?"s":""} sin predecir (−1 pt cada uno).

¿Guardar igualmente?`))return;if(U>R){v(`Superas el máximo de ${R} unidades`,"error");return}const a=ee.filter(i=>{var o;return(o=P[i.jornada_match_id])==null?void 0:o.predicted_result});if(!a.length){v("No hay predicciones que guardar","error");return}const t=document.getElementById("jornadaSaveAllBtn");t&&(t.disabled=!0,t.textContent="Guardando…");const n=(await Promise.allSettled(a.map(i=>c.jornada.predict({jornada_match_id:i.jornada_match_id,predicted_result:P[i.jornada_match_id].predicted_result,units:P[i.jornada_match_id].units})))).filter(i=>i.status==="rejected").length;n===0?v(`${a.length} predicción${a.length!==1?"es":""} guardadas ✓`):v(`${n} error${n!==1?"es":""} al guardar`,"error"),t&&(t.disabled=!1,_e())}let te=null;function ve(){te&&(clearInterval(te),te=null)}const ke={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}},it={ganado:"🏆 Victoria",perdido:"💔 Derrota",empate:"🤝 Empate"};function ot(e){return e.is_bye?{icon:"",cls:""}:e.jornada_status==="upcoming"?{icon:"",cls:""}:e.jornada_status==="active"?{icon:e.my_points>e.rival_points?"✓":e.my_points<e.rival_points?"✗":"=",cls:"live"}:e.status==="ganado"?{icon:"✓",cls:"win"}:e.status==="perdido"?{icon:"✗",cls:"loss"}:e.status==="empate"?{icon:"=",cls:"draw"}:{icon:"",cls:""}}async function rt(e){ve(),e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const[{duelos:a},t]=await Promise.all([c.duelo.list(),Promise.resolve(E.getUser())]);if(!a.length){e.innerHTML=`
        <div class="container">
      ...
      `;return}const s=a.findIndex(o=>o.jornada_status==="active"||o.jornada_status==="upcoming"),n=s>=0?s:a.length-1,i=a.map((o,r)=>{const{icon:d,cls:l}=ot(o),h=o.jornada_status!=="upcoming",_=o.jornada_status==="finished"?"finished":"active",m=`${w(o.my_points)}-${o.is_bye?"—":w(o.rival_points)}`;return`
        <button class="jornada-tab jornada-tab--stacked ${r===n?"jornada-tab--active":""}" data-idx="${r}">
          <span class="jornada-tab__num">J${o.jornada_number}</span>
          ${h?`
            <span class="jornada-tab__pts jornada-tab__pts--${_}">
              ${m}${d?` <span class="jornada-tab__result jornada-tab__result--${l}">${d}</span>`:""}
            </span>
          `:""}
        </button>
      `}).join("");e.innerHTML=`
    ...
    `,Q(e),requestAnimationFrame(()=>{var o;(o=e.querySelector(".jornada-tab--active"))==null||o.scrollIntoView({block:"nearest",inline:"center"})}),e.querySelectorAll(".jornada-tab").forEach(o=>{o.addEventListener("click",()=>{e.querySelectorAll(".jornada-tab").forEach(r=>r.classList.remove("jornada-tab--active")),o.classList.add("jornada-tab--active"),Se(e,a[parseInt(o.dataset.idx)],t)})}),await Se(e,a[n],t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando duelos: ${a.message}</p></div>`}}async function Se(e,a,t){var i;ve();const s=e.querySelector("#dueloContent");if(!s)return;s.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const n=a.jornada_status==="active"||a.jornada_status==="upcoming";try{const{duelo:o}=await c.duelo.current(a.jornada_id);if(n){if(!o){s.innerHTML=ct();return}if(s.innerHTML=dt(o,t),xe(s,o.division_league_id,t.id),!a.is_bye){const r=((i=a.rival)==null?void 0:i.username)??"—";Ie(a.jornada_id,t.username,r),te=setInterval(()=>Ie(a.jornada_id,t.username,r),6e4)}}else s.innerHTML=lt(a,o,t),xe(s,a.division_league_id,t.id)}catch(o){s.innerHTML=`<p class="form__error">Error: ${o.message}</p>`}}function dt(e,a){var i;const t=ke[e.status]??ke.en_curso,s=e.rival?e.rival.username:a.username,n=!e.rival||e.rival.id===a.id;return`
    <div class="duelo-card">
      ...
      <div class="duelo-card__matchup">
        <div class="duelo-card__player">
          ...
          <span class="duelo-card__pts">${w(e.my_points)}</span>
        </div>
        <span class="duelo-card__vs">VS</span>
        <div class="duelo-card__player">
          <span class="duelo-card__name">${n?"Descanso":s}</span>
          <span class="duelo-card__pts">${n?"—":w(e.rival_points)}</span>
        </div>
      </div>
    </div>
  ...
  `}function lt(e,a,t){var L;const s=((L=e.rival)==null?void 0:L.username)??(e.is_bye?"Descanso":"—"),n=it[e.status],i=(a==null?void 0:a.matches)??[];let o=0,r=0,d=0,l=0;for(const b of i)b.jm_status!=="cancelled"&&(b.my_prediction?(d+=b.my_prediction.units_wagered,b.status==="finished"&&b.result_90!=null&&(r+=b.my_prediction.points_earned??0,b.my_prediction.predicted_result===b.result_90&&o++)):b.status==="finished"&&b.result_90!=null&&l++);const h=20-d,_=o>=10?10:o>=9?5:o>=8?2:0,m=o>=10;function f(b){if(!b.result_90)return"—";const g={1:b.odds_1,X:b.odds_x,2:b.odds_2}[b.result_90];return g!=null?parseFloat(g).toFixed(2):"—"}function $(b,u){return u?b?b.predicted_result===u?`<span class="pts-label pts-label--win">+${w(b.points_earned??0)} pts</span>`:'<span class="pts-label pts-label--loss">0 pts</span>':'<span class="pts-label pts-label--penalty">-1 pt</span>':"—"}const y=i.map(b=>{const u=b.my_prediction?`${b.my_prediction.predicted_result} · ${b.my_prediction.units_wagered}u`:"—",g=b.rival_prediction?`${b.rival_prediction.predicted_result} · ${b.rival_prediction.units_wagered}u`:b.started?"—":"?",k=b.result_90!=null?`${b.home_score_90??"?"}–${b.away_score_90??"?"} (${b.result_90})`:"—";return`
      <tr>
    ...
    <tr class="duelo-breakdown__footer-row">
      ...
      <td class="duelo-breakdown__pts" colspan="2">+${w(r)} pts</td>
    </tr>
    <tr class="duelo-breakdown__footer-row">
      <td colspan="5" class="duelo-breakdown__total-label">Sin apostar (${h}u)</td>
      <td class="duelo-breakdown__pts" colspan="2">+${w(h)} pts</td>
    </tr>
    ${l>0?`
    <tr class="duelo-breakdown__footer-row">
    ...
    <tr class="duelo-breakdown__footer-row duelo-breakdown__footer-row--total">
      ...
      <td class="duelo-breakdown__total-pts" colspan="2">${w(e.my_points)} pts</td>
    </tr>
  `,I=i.length>0?`
    <h2 class="section-title">Partido a partido</h2>
    ...
    <div class="duelo-card duelo-card--finished">
      ...
      <div class="duelo-card__matchup">
        ...
        <div class="duelo-card__player">
          ...
          <span class="duelo-card__pts">${e.is_bye?"—":w(e.rival_points)}</span>
        </div>
      </div>
    </div>
  ...
  `}async function Ie(e,a,t){const s=document.getElementById("dueloTracker");if(!s){ve();return}try{const{detail:n}=await c.duelo.detail(e);if(!n)return;s.innerHTML=ut(n,a,t)}catch{}}function ut(e,a,t){const{me:s,rival:n}=e;function i(o,r){return`
      <div class="duelo-tracker__col">
        <div class="duelo-tracker__player">${o}</div>
        <div class="duelo-tracker__pts">${w(r.estimated_points)}</div>
        <div class="duelo-tracker__rows">
          <div class="duelo-tracker__row">
            ...
            <span class="duelo-tracker__val">${w(r.points_earned)}</span>
          </div>
          <div class="duelo-tracker__row">
            <span class="duelo-tracker__icon">⏳</span>
    ...
    <div class="duelo-tracker__inner">
      ...
      ${i(t,n??{points_earned:0,units_at_stake:0,units_unbet:null,estimated_points:0})}
    </div>
  ...
  `}async function xe(e,a,t){const s=e.querySelector("#divisionStandings");if(s)try{const{standings:n}=await c.clasificacion.division(a);if(!n.length){s.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}s.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
          ...
          <tbody>
            ${n.map(i=>`
              <tr class="${i.user_id===t?"ranking-table__row--me":""}">
                ...
                <td class="ranking-table__pts">${w(i.pts_division)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
                  ...
                  <tbody>
                    ${t.map(n=>{var i,o;return`
                      <tr class="${s&&n.user_id===s.id?"ranking-table__row--me":""}">
                        ...
                        <td class="ranking-table__stat">${w(n.pts_jornada_actual)}</td>
                        <td class="ranking-table__pts">${w(n.pts_general)}</td>
                      </tr>
                    `}).join("")}
                  </tbody>
                </table>
  ...
  `}function ne(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ft(e,a){let t=document.getElementById("userCtxMenu");t||(t=document.createElement("div"),t.id="userCtxMenu",t.className="user-ctx-menu hidden",t.innerHTML=`
    ...
    <tr class="${t?"ranking-table__row--me":""}" style="${s}">
      ...
      <td class="ranking-table__pts">${w(e.pts_division)}</td>
    </tr>
  `}async function Ce(e,{params:a={}}={}){const t=a.userId?parseInt(a.userId):null;t?await Et(e,t):await yt(e)}async function yt(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{conversations:a}=await c.messages.list();e.innerHTML=`
      <div class="container">
  ...
  `}async function Et(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=E.getUser();try{const{messages:n,partner:i}=await c.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
      <div class="container">
        ...
        <div class="chat-messages" id="chatMessages">
          ${n.length===0?'<p class="empty" style="text-align:center">Empieza la conversación.</p>':n.map(r=>Be(r,t)).join("")}
        </div>
    ...
    `;const o=document.getElementById("chatMessages");o&&(o.scrollTop=o.scrollHeight),(s=document.getElementById("chatForm"))==null||s.addEventListener("submit",async r=>{r.preventDefault();const d=document.getElementById("chatMsg"),l=d.value.trim();if(!l)return;const h=r.target.querySelector('button[type="submit"]');h.disabled=!0;try{const{message:_}=await c.messages.send(a,l);d.value="";const m=document.getElementById("chatMessages"),f=m==null?void 0:m.querySelector(".empty");f&&f.remove(),m==null||m.insertAdjacentHTML("beforeend",Be(_,t)),m&&(m.scrollTop=m.scrollHeight)}catch(_){v(_.message,"error")}finally{h.disabled=!1}})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function Be(e,a){return`
  ...
  `}function K(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Te=e=>()=>{window.location.hash=e},wt={"/":ta,"/login":la,"/register":ca,"/quiniela":Te("/jornada"),"/resultados":Te("/tabla-v2"),"/ranking":ma,"/tablon":me,"/ligas":_a,"/ligas/:id":ga,"/perfil":ha,"/campeon":ja,"/admin":La,"/forgot-password":Ua,"/reset-password":Fa,"/unirse":Ja,"/jugador/:id":Va,"/jornada":Wa,"/duelo":rt,"/tabla-v2":pt,"/mensajes":Ce,"/mensajes/:userId":Ce};function jt(e){for(const[a,t]of Object.entries(wt)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,r)=>(s.push(r),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((r,d)=>{o[r]=i[d+1]}),{handler:t,params:o}}}return null}const Pe=()=>document.getElementById("mainContent"),S={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=jt(a);if(!n){Pe().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2","/mensajes"].includes(a)&&!E.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!E.isAdmin()){this.navigate("/");return}const d=Pe();d.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(d,{params:o,query:s})}};let W=[],V=null,J=null,ie=!1;async function Lt(){document.documentElement.dataset.build="2026-09-22T14",await E.init(),S.init(),It(),kt(),Bt()}function We(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function kt(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!We()&&(V=e,St())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),V=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function St(){if(We()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
      ...
      `).join("")+'<a class="notif-panel__link" href="#/mensajes">Ver todos los mensajes →</a>',n=a.length===0?'<p class="notif-panel__empty">Aún no hay mensajes en el tablón</p>':a.map(i=>{const o=t.has(i.id);return`
          <div class="notif-item${o?" notif-item--notable":""}" data-nav="/tabla-v2?tab=tablon">
            ...
            <div class="notif-item__content">
              ...
              <p class="notif-item__text">${z((i.message||"").slice(0,80))}${(i.message||"").length>80?"…":""}</p>
            </div>
          </div>
  ...
  `}function z(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}Lt();
