(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Je="https://pickgoal-backend.onrender.com/api";function Fe(){return localStorage.getItem("token")}async function m(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Fe();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Je}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const c={get:e=>m(e),post:(e,a)=>m(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>m(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>m(e,{method:"DELETE"}),auth:{register:e=>m("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>m("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>m("/auth/me"),forgotPassword:e=>m("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>m("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>m(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>m("/auth/account",{method:"DELETE"}),users:()=>m("/auth/users"),usersForMentions:()=>m("/auth/users/for-mentions"),toggleAdmin:e=>m(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>m(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>m("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>m("/matches/grouped"),list:(e="")=>m(`/matches/${e}`),get:e=>m(`/matches/${e}`),today:()=>m("/matches/today"),setResult:(e,a,t,s=null)=>m(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>m("/matches/sync",{method:"POST"}),recalculate:()=>m("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>m(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>m(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>m("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>m(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>m(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>m("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>m("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>m("/leagues/all"),public:()=>m("/leagues/public"),my:()=>m("/leagues/my"),create:e=>m("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>m("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>m(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>m("/leagues/admin"),get:e=>m(`/leagues/${e}`),update:(e,a)=>m(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>m(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>m(`/leagues/${e}/members`),matchPredictions:(e,a)=>m(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>m("/home/summary")},board:{messages:(e=1,a=null)=>m(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>m(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>m("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>m(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>m(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>m(`/board/${e}`,{method:"DELETE"}),mentions:e=>m(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>m("/notifications/vapid-public-key"),subscribe:e=>m("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>m("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>m(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>m("/v2/admin/jornadas"),createJornada:e=>m("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>m(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>m(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>m(`/v2/admin/jornada/${e}/publish`,{method:"POST"}),jornadaMatches:e=>m(`/v2/admin/jornada/${e}/matches`),setResultado:(e,a)=>m(`/v2/admin/jornada-match/${e}/resultado`,{method:"POST",body:JSON.stringify(a)}),cancelMatch:e=>m(`/v2/admin/jornada-match/${e}/cancel`,{method:"POST"})},jornada:{info:()=>m("/v2/jornada/info"),current:()=>m("/v2/jornada/current"),list:()=>m("/v2/jornada/list"),predict:e=>m("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>m("/v2/jornada/history"),myStats:()=>m("/v2/jornada/my-stats")},duelo:{current:()=>m("/v2/duelo/current"),detail:()=>m("/v2/duelo/current/detail")},messages:{unread:()=>m("/messages/unread"),list:()=>m("/messages/"),get:e=>m(`/messages/${e}`),send:(e,a)=>m(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>m("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>m(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>m("/v2/clasificacion/general"),allDivisions:()=>m("/v2/clasificacion/all-divisions")}};let H=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await c.auth.me();H=a}catch{localStorage.removeItem("token")}},setUser(e,a){H=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){H=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return H},isLoggedIn(){return!!H},isAdmin(){return(H==null?void 0:H.is_admin)===!0}};let oe=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,oe&&clearTimeout(oe),oe=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function ze(){return`
  ...
  `}function Z(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function r(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",r),n==null||n.addEventListener("click",r),document.addEventListener("keydown",o=>{o.key==="Escape"&&r()},{once:!1}),i}function k(e){const a=parseFloat(e);return isNaN(a)||e==null?"—":parseFloat(a.toFixed(2)).toString()}function T(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}const Ve="/assets/icon-512-v2-CAowBaBi.png";async function Ge(e){if(!y.getUser()){We(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await c.home.summary();if(s){e.innerHTML=`
        ...
        ${Y()}
      `,Z(e);return}if(!t||t.length===0){Xe(e);return}const i=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),r=[...t].sort((o,d)=>o.league_id===i?-1:d.league_id===i?1:0);e.innerHTML=`
      <div class="home-dashboard container">
        <div class="home-dashboard__topbar">
          <button class="btn btn--ghost btn--sm" id="btnPointsInfo">📊 Sistema de puntos</button>
        </div>
  ...
  `}function Ye(e){const a={promotion:"⬆️ Zona ascenso",relegation:"⬇️ Zona descenso",mid:""},t=a[e.zone]?`<span class="div-card__zone div-card__zone--${e.zone}">${a[e.zone]}</span>`:"";return`
    <div class="div-card">
  ...
  `}function Ze(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function Ce(e=null,a=!1){let t,s;if(a&&(e!=null&&e.jornada_number))s="Temporada 26/27 · En curso",t=`
      ...
      </div>`;else if(a)s="Temporada 26/27 · En curso",t='<div class="pg-league-card__countdown pg-league-card__countdown--soon">Temporada en curso</div>';else{const n=Ze("2026-08-15");s="Temporada 26/27 · Próximamente",t=n>0?`<div class="pg-league-card__countdown">
  ...
  `}function Ke(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `}const _e="pickgoal_welcome_shown";function xe(e="/jornada"){if(localStorage.getItem(_e))return;localStorage.setItem(_e,"1");const a=document.createElement("div");a.innerHTML=`
  ...
  `;const t=a.firstElementChild;document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("welcome-modal--open"));function s(n){t.classList.remove("welcome-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0}),n&&(window.location.hash=n)}document.getElementById("welcomeOverlay").addEventListener("click",()=>s()),document.getElementById("welcomeCta").addEventListener("click",()=>s(e)),document.addEventListener("keydown",function n(i){i.key==="Escape"&&(s(),document.removeEventListener("keydown",n))})}function ea(e){e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:r}=await c.auth.register(n);y.setUser(r,i),v("¡Cuenta creada! Bienvenido a PickGoal");const o=sessionStorage.getItem("pendingInviteCode");if(o){sessionStorage.removeItem("pendingInviteCode");try{const{league:d}=await c.leagues.joinByCode(o);v(`¡Te has unido a "${d.name}"!`),S.navigate(`/ligas/${d.id}`)}catch{S.navigate("/ligas")}}else S.navigate("/"),xe("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function ta(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function sa(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:_}=await c.leagues.my();if(_.length===0){e.innerHTML=ze();return}}const s=ta(),[{ranking:n},i]=await Promise.all([c.auth.ranking(s),y.isLoggedIn()?c.leagues.my():Promise.resolve({leagues:[]})]),r=y.getUser(),o=i.leagues.find(_=>_.id===s),d=document.getElementById("tablonBadge"),l=d&&!d.classList.contains("hidden"),b=l?d.textContent:"",p=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
    ...
    `,E(),j(),M()}function p(u){return u.length?u.map(g=>`
    ...
    `).join(""):""}function _(u){return`
      <div class="board-reply ${u.is_deleted?"board-reply--deleted":""}" data-id="${u.id}">
        <div class="board-reply__header">
          ...
          <span class="board-reply__date">${T(u.created_at)}</span>
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function f(u){const g=D(u);if(!r.length)return g.replace(/@(\w+)/g,'<span class="mention">@$1</span>');const w=r.map(I=>na(I.username)),B=new RegExp(`@(${w.join("|")})`,"gi");return g.replace(B,'<span class="mention">@$1</span>')}function E(){const u=document.getElementById("boardForm");if(!u)return;const g=document.getElementById("boardMsg"),w=document.getElementById("charCounter"),B=document.getElementById("mentionDropdown");g.addEventListener("input",()=>{w.textContent=`${g.value.length} / 500`,$(g,B)}),u.addEventListener("submit",async I=>{I.preventDefault();const A=g.value.trim();if(A)try{await c.board.post(A,n),g.value="",w.textContent="0 / 500",B.classList.add("hidden");const P=await l();L(P),v("Mensaje publicado")}catch(P){v(P.message,"error")}})}function j(){e.querySelectorAll(".reply-form").forEach(u=>{const g=parseInt(u.dataset.parent),w=u.querySelector(".reply-input"),B=`mentionDropdown-${g}`,I=document.getElementById(B);w==null||w.addEventListener("input",()=>{$(w,I)}),u.addEventListener("submit",async A=>{A.preventDefault();const P=w.value.trim();if(P)try{await c.board.reply(g,P),w.value="",I==null||I.classList.add("hidden");const U=await l();L(U),v("Respuesta enviada")}catch(U){v(U.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();L(g),v("Mensaje fijado")}catch(g){v(g.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(u=>{u.addEventListener("click",async()=>{try{await c.board.pin(u.dataset.id);const g=await l();L(g),v("Mensaje desfijado")}catch(g){v(g.message,"error")}})})}function M(){e.querySelectorAll(".delete-msg").forEach(u=>{u.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await c.board.delete(u.dataset.id);const g=await l();L(g),v("Mensaje eliminado")}catch(g){v(g.message,"error")}})})}function L(u){const{pinned:g=[],messages:w=[]}=u,B=document.getElementById("boardPinned");if(B)B.innerHTML=p(g);else if(g.length){b(u);return}const I=document.getElementById("boardMessages");I&&(I.innerHTML=h(w)),j(),M()}e.addEventListener("click",async u=>{if(u.target.id==="prevPage"&&o>1){o--;const g=await l();L(g)}else if(u.target.id==="nextPage"&&o<d){o++;const g=await l();L(g)}});function $(u,g){if(!g||!r.length){console.log("[tablon] handleMentionInput: sin dropdown o members vacío",{dropdown:!!g,membersLen:r.length});return}const w=u.value,B=u.selectionStart,I=w.slice(0,B),A=I.match(/@(\w*)$/);if(!A){g.classList.add("hidden");return}const P=A[1].toLowerCase();console.log("[tablon] mention detected, query:",P);const U=r.filter(C=>C.username.toLowerCase().startsWith(P)&&C.id!==(s==null?void 0:s.id));console.log("[tablon] matches:",U.map(C=>C.username));const pe=[...y.isAdmin()&&"todos".startsWith(P)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...U.slice(0,6)];if(!pe.length){g.classList.add("hidden");return}g.innerHTML=pe.map(C=>C.description?`<div class="mention-item mention-item--broadcast" data-username="${D(C.username)}">
             <span class="mention-item__name">@${D(C.username)}</span>
             <span class="mention-item__desc">${D(C.description)}</span>
           </div>`:`<div class="mention-item" data-username="${D(C.username)}">${D(C.username)}</div>`).join(""),g.classList.remove("hidden"),g.querySelectorAll(".mention-item").forEach(C=>{C.addEventListener("mousedown",Re=>{Re.preventDefault();const Ue=C.dataset.username,ie=I.replace(/@(\w*)$/,`@${Ue} `);if(u.value=ie+w.slice(B),u.setSelectionRange(ie.length,ie.length),g.classList.add("hidden"),u.tagName==="TEXTAREA"){const ge=document.getElementById("charCounter");ge&&(ge.textContent=`${u.value.length} / 500`)}})})}document.addEventListener("click",u=>{!u.target.closest(".board-form__input-wrap")&&!u.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(g=>g.classList.add("hidden"))},{capture:!0})}function D(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function na(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function ia(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=y.getUser(),r=i==null?void 0:i.is_admin,[o,d]=await Promise.all([r?c.leagues.adminAll():c.leagues.all(),y.isLoggedIn()&&!r?c.leagues.my():Promise.resolve({leagues:[]})]),l=new Set(d.leagues.map(p=>p.id)),b=r?o.leagues:o.leagues.filter(p=>!l.has(p.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!r&&d.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${d.leagues.map(p=>be(p,!0)).join("")}</div>
          </section>
        `:""}
  ...
  `}function oa(e){var s,n;const a=e.invite_link||"",t=document.getElementById("createLeaguePanel");t&&(t.innerHTML=`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function ra(e,{params:a}){var s,n,i,r,o;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const d=await c.leagues.get(t),{league:l,ranking:b,is_member:p,is_admin_view:_}=d,h=y.getUser(),f=l.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
    ...
    `,(s=document.getElementById("btnCopyInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(l.invite_link),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShareInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${l.name} en PickGoal`,url:l.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await c.leagues.leave(t),v("Has abandonado la liga"),S.navigate("/ligas")}catch($){v($.message,"error")}}),(r=document.getElementById("btnJoin"))==null||r.addEventListener("click",async()=>{try{await c.leagues.join({league_id:t}),v("¡Te has unido a la liga!"),S.navigate(`/ligas/${t}`)}catch($){v($.message,"error")}}),(o=document.getElementById("btnEditLeague"))==null||o.addEventListener("click",()=>{da(l,t,h)});const E=document.getElementById("tabRanking"),j=document.getElementById("tabTablon"),M=document.getElementById("sectionRanking"),L=document.getElementById("sectionTablon");E&&j&&(E.addEventListener("click",()=>{E.classList.add("league-tab--active"),j.classList.remove("league-tab--active"),M.classList.remove("hidden"),L.classList.add("hidden")}),j.addEventListener("click",()=>{j.classList.add("league-tab--active"),E.classList.remove("league-tab--active"),M.classList.add("hidden"),L.classList.remove("hidden");const $=document.getElementById("tablonEmbed");$&&!$.dataset.loaded&&($.dataset.loaded="1",ue($,{query:{liga:String(t)}}))}))}catch(d){e.innerHTML=`<div class="container"><p class="form__error">Error: ${d.message}</p><a href="#/ligas">Volver</a></div>`}}function da(e,a,t){const s=document.getElementById("editLeagueModal");s&&s.remove();const n=document.createElement("div");n.id="editLeagueModal",n.className="edit-league-modal",n.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async r=>{r.preventDefault();const o=document.getElementById("btnSaveEdit");o.disabled=!0,o.textContent="Guardando…";const d={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(d.is_official=document.getElementById("editOfficial").checked);try{await c.leagues.update(a,d),v("Liga actualizada"),i(),S.navigate(`/ligas/${a}`)}catch(l){v(l.message,"error"),o.disabled=!1,o.textContent="Guardar cambios"}})}async function la(e){var t,s,n,i,r,o;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=y.getUser();try{const[d,l,b]=await Promise.all([c.clasificacion.division(),c.auth.me(),a!=null&&a.is_admin?c.leagues.adminAll():Promise.resolve({leagues:[]})]),p=l.user,_=p.status,h=p.total_points_all_time,f=(t=d.standings)==null?void 0:t.find(E=>E.user_id===p.id);e.innerHTML=`
    ...
    `).join("")}catch{a.innerHTML='<p class="empty">Sin menciones recientes.</p>'}}function ma(e,a){if(e.next_threshold===null)return`
    ...
    `,(t=a.querySelector("#predCircleBtn"))==null||t.addEventListener("click",()=>{he(r)}),(s=a.querySelector("#predCircleBtn"))==null||s.addEventListener("keydown",_=>{(_.key==="Enter"||_.key===" ")&&he(r)})}catch{a.innerHTML='<p class="empty">No se pudieron cargar las predicciones.</p>'}}function he(e){var i,r;let a="all";const t=document.createElement("div");t.className="pred-modal",t.innerHTML=`
  ...
  `}const fa={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let x=[],ee=null;async function ae(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await c.adminV2.jornadas();a.innerHTML=ya(t),Ea(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function ya(e){const t=Ta(new Date);return`
    <div class="jv2-panel">
      ...
      <div class="jv2-list">
        ${e.length===0?'<p class="admin-section__desc">No hay jornadas creadas.</p>':e.map($a).join("")}
      </div>
  ...
  `}function Ea(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{ee=null,x=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",me()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",x=[],ee=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",wa),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",Sa),e.querySelectorAll(".jv2-results-btn").forEach(i=>{i.addEventListener("click",()=>Ia(i.dataset.id,i))}),e.querySelectorAll(".jv2-pub-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${i.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){i.disabled=!0,i.textContent="Publicando…";try{const r=await c.adminV2.publishJornada(i.dataset.id);v(`Jornada ${i.dataset.num} publicada — push enviado a ${r.push_sent} suscriptores`),await ae(document.getElementById("jornadasV2Section"))}catch(r){v(r.message,"error"),i.disabled=!1,i.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>La(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await c.adminV2.deleteJornada(i.dataset.id),v("Jornada eliminada"),ae(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(r){v(r.message,"error")}})})}async function La(e){const{jornadas:a}=await c.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(ee=t.id,x=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",me())}async function wa(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){v("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await c.adminV2.partidos(a);ja(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){v(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function ja(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        <div class="jv2-comp-group__title">${fa[s]||s}</div>
        ${n.map(i=>`
          <label class="jv2-match-item">
            ...
            <span class="jv2-match-item__date">${ka(i.match_datetime)}</span>
          </label>
        `).join("")}
      </div>
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(x.length>=10){s.checked=!1,v("Máximo 10 partidos","error");return}x.push(n)}else x=x.filter(i=>i.api_id!==n.api_id);me()})})}function me(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=x.length),a&&(a.style.display=x.length>0&&x.length!==10?"inline":"none")}async function Sa(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){v("Completa número y fechas","error");return}if(x.length!==10){v("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:x},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await c.adminV2.updateJornada(s,n),v(`Jornada ${e} actualizada`)):(await c.adminV2.createJornada(n),v(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",x=[],ee=null,await ae(document.getElementById("jornadasV2Section"))}catch(r){v(r.message,"error")}finally{i.disabled=!1}}function ka(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}async function Ia(e,a){const t=document.getElementById(`jv2-results-${e}`);if(t){if(t.style.display!=="none"){t.style.display="none",a.textContent="Resultados";return}a.disabled=!0,a.textContent="Cargando…";try{const{matches:s}=await c.adminV2.jornadaMatches(e);t.innerHTML=Be(s,e),t.style.display="block",Te(t,e),a.textContent="Ocultar"}catch(s){v(`Error: ${s.message}`,"error"),a.textContent="Resultados"}finally{a.disabled=!1}}}function Ca(e){if(e.jm_status==="cancelled")return'<span class="admin-match-badge admin-match-badge--cancelled">🔴 Suspendido</span>';if(e.jm_status==="finished")return`<span class="admin-match-badge admin-match-badge--done">🟢 Finalizado${e.home_score_90!=null&&e.away_score_90!=null?` ${e.home_score_90}–${e.away_score_90}`:""}</span>`;const a=Date.now(),t=new Date(e.match_datetime).getTime(),s=t+2*60*60*1e3;return a>=t&&a<=s?'<span class="admin-match-badge admin-match-badge--live">🔵 En juego</span>':a>s?'<span class="admin-match-badge admin-match-badge--stale">⚠️ ¿Ya se jugó? Introduce el resultado manualmente</span>':'<span class="admin-match-badge admin-match-badge--pending">🟡 Pendiente</span>'}function xa(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"—"}function Be(e,a){const t=[...e].sort((s,n)=>new Date(n.match_datetime)-new Date(s.match_datetime));return`
      ...
      ${t.map(s=>{const n=s.jm_status==="cancelled";return`
          <div class="jv2-results-row ${n?"jv2-results-row--cancelled":""}" data-jm-id="${s.jornada_match_id}">
            <div class="jv2-results-row__meta">
              <span class="jv2-results-row__datetime">${xa(s.match_datetime)}</span>
  ...
  `}function Te(e,a){var t;(t=e.querySelector(".jv2-sync-btn"))==null||t.addEventListener("click",async s=>{const n=s.currentTarget;n.disabled=!0,n.textContent="⏳ Sincronizando…";try{await c.matches.sync(),v("Sincronización completada"),await re(a)}catch(i){v(i.message,"error"),n.disabled=!1,n.textContent="🔄 Sincronizar resultados ahora"}}),e.querySelectorAll(".jv2-save-result-btn").forEach(s=>{s.addEventListener("click",async()=>{var l,b,p;const n=s.dataset.jmId,i=e.querySelector(`.jv2-results-row[data-jm-id="${n}"]`),r=(l=i.querySelector('.jv2-score-input[data-side="home"]'))==null?void 0:l.value,o=(b=i.querySelector('.jv2-score-input[data-side="away"]'))==null?void 0:b.value,d=((p=i.querySelector(".jv2-r90-select"))==null?void 0:p.value)||void 0;if(r===""||o===""){v("Introduce los dos marcadores","error");return}s.disabled=!0,s.textContent="…";try{const _={home_score:parseInt(r),away_score:parseInt(o)};d&&(_.result_90=d),await c.adminV2.setResultado(n,_),v("Resultado guardado y puntos recalculados"),await re(a)}catch(_){v(_.message,"error"),s.disabled=!1,s.textContent="Guardar"}})}),e.querySelectorAll(".jv2-cancel-match-btn").forEach(s=>{s.addEventListener("click",async()=>{const{jmId:n,home:i,away:r}=s.dataset;if(confirm(`¿Cancelar el partido ${i} vs ${r}? Las unidades apostadas se devolverán a los usuarios.`)){s.disabled=!0,s.textContent="…";try{const{message:o}=await c.adminV2.cancelMatch(n);v(o),await re(a)}catch(o){v(o.message,"error"),s.disabled=!1,s.textContent="Cancelar"}}})})}async function re(e){const a=document.getElementById(`jv2-results-${e}`);if(!(!a||a.style.display==="none"))try{const{matches:t}=await c.adminV2.jornadaMatches(e);a.innerHTML=Be(t,e),Te(a,e)}catch(t){v(`Error recargando: ${t.message}`,"error")}}function Ba(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function Ta(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(Ba(a)).padStart(2,"0");return`${t}-W${s}`}function Pa(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),r=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await c.auth.resetPassword(t,r),v("Contraseña actualizada. Ya puedes iniciar sesión."),S.navigate("/login")}catch(o){i.textContent=o.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function Da(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!y.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),S.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await c.leagues.joinByCode(t);v(`¡Te has unido a "${s.name}"!`),S.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){v("Ya eres miembro de esta liga");try{const{leagues:n}=await c.leagues.my(),i=n.find(r=>r.invite_code===t);if(i){S.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function Ha(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function qa(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=Ha(),{user:n,predictions:i}=await c.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const V=20,Pe=5;let R={},O=0,le=null,fe=null;async function Na(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await c.jornada.list();if(!a.length){e.innerHTML=Oa();return}Me(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Me(e,a,t){var d,l;fe=a[t];const{jornada:s,matches:n,units_used:i}=fe;R={};for(const b of n)R[b.jornada_match_id]={predicted_result:((d=b.prediction)==null?void 0:d.predicted_result)??null,units:((l=b.prediction)==null?void 0:l.units_wagered)??0};O=i;const r=n.filter(b=>!b.predict_locked);le=r.length===1?r[0].jornada_match_id:null;const o=a.length>1?`<div class="jornada-tabs">
        ${a.map((b,p)=>`
  ...
  `,De(),He(),Fa(e,a,t),Z(e)}function Oa(){return`
    <div class="container">
  ...
  `}function K(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function Ra(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function de(e){return e!=null?e.toFixed(2):"—"}function Ua(e){return e.jm_status==="cancelled"?'<span class="tag tag--cancelled">Suspendido</span>':e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${Ra(e.opens_until)}</span>`}function Ja(e){const a=e.jm_status==="cancelled",t=e.predict_locked,s=R[e.jornada_match_id]??{predicted_result:null,units:0};return`
    <div class="match-card jornada-match ${t?"match-card--locked":""} ${a?"match-card--cancelled":""}" data-jm-id="${e.jornada_match_id}">
      ...
      <div class="jornada-match__controls ${t?"jornada-match__controls--disabled":""}">
        ...
        <div class="jornada-units">
          ...
          <input type="number" id="units-${e.jornada_match_id}" class="jornada-units__input" min="0" max="${Pe}" value="${s.units}" ${t?"disabled":""} />
        </div>
      </div>
      ${t?"":`
  ...
  `}function De(){const e=document.getElementById("unitsCounter");if(!e)return;const a=O>V;e.innerHTML=`
  ...
  `}function He(){if(!le)return;const e=document.getElementById(`warning-${le}`);if(!e)return;const a=V-O;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function ye(){O=Object.values(R).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),De(),He()}function Fa(e,a,t){e.querySelectorAll(".jornada-tab").forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.idx);n!==t&&Me(e,a,n)})}),e.querySelectorAll(".jornada-match").forEach(s=>{var r;const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(o=>{o.addEventListener("change",()=>{R[n].predicted_result=o.value,ye()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let o=parseInt(i.value);isNaN(o)&&(o=0),o=Math.max(0,Math.min(Pe,o)),R[n].units=o,ye()}),(r=s.querySelector(".jornada-match__save-btn"))==null||r.addEventListener("click",()=>za(n))})}async function za(e){const a=R[e];if(!a.predicted_result){v("Selecciona un resultado 1X2","error");return}if(O>V){v(`Superas el máximo de ${V} unidades`,"error");return}const t=document.querySelector(`.jornada-match__save-btn[data-jm-id="${e}"]`);t&&(t.disabled=!0,t.textContent="…");try{await c.jornada.predict({jornada_match_id:e,predicted_result:a.predicted_result,units:a.units}),v("Predicción guardada"),t&&(t.textContent="✓ Guardada")}catch(s){v(s.message||"Error al guardar","error")}finally{t&&(t.disabled=!1,setTimeout(()=>{t&&(t.textContent="Guardar")},2e3))}}let Q=null;function qe(){Q&&(clearInterval(Q),Q=null)}const $e={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function Va(e){var a;qe(),e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:t}=await c.duelo.current(),s=y.getUser();if(!t){e.innerHTML=`
        <div class="container">
      ...
      `;return}const n=$e[t.status]??$e.en_curso,i=t.rival?t.rival.username:s.username,r=!t.rival||t.rival.id===s.id;e.innerHTML=`
      <div class="container">
        <div class="page-title-row">
          <h1 class="page-title">Tu duelo esta jornada</h1>
          <button class="btn-info" id="btnPointsInfo" aria-label="Cómo funciona">ℹ️</button>
        ...
        <div class="duelo-card">
          ...
          <div class="duelo-card__matchup">
            <div class="duelo-card__player">
              ...
              <span class="duelo-card__pts">${k(t.my_points)}</span>
            </div>
            <span class="duelo-card__vs">VS</span>
            <div class="duelo-card__player">
              <span class="duelo-card__name">${r?"Descanso":i}</span>
              <span class="duelo-card__pts">${r?"—":k(t.rival_points)}</span>
            </div>
          </div>
        </div>
    ...
    `,Z(e),Xa(t.division_league_id,s.id),r||(Ee(s.username,i),Q=setInterval(()=>Ee(s.username,i),6e4))}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${t.message}</p></div>`}}function Ga(e,a){var i;const t=(i=e.my_prediction)==null?void 0:i.predicted_result;let s,n;return e.started?e.rival_prediction?(s=e.rival_prediction.predicted_result,n=""):(s="—",n="duelo-pick__value--empty"):(s="?",n="duelo-pick__value--hidden"),`
  ...
  `}async function Ee(e,a){const t=document.getElementById("dueloTracker");if(!t){qe();return}try{const{detail:s}=await c.duelo.detail();if(!s)return;t.innerHTML=Wa(s,e,a)}catch{}}function Wa(e,a,t){const{me:s,rival:n}=e;function i(r,o,d){const l=d||o.units_unbet!=null?o.units_unbet:null;return`
  ...
  `}async function Xa(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await c.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function Ya(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:t}=await c.clasificacion.general(),s=y.getUser();e.innerHTML=`
      <div class="container">
        <div class="page-title-row">
          <h1 class="page-title">Clasificación</h1>
          <button class="btn-info" id="btnPointsInfo" aria-label="Cómo funciona">ℹ️</button>
    ...
    `,Ka(s,a.tab),Z(e),Za(),tt(e,s)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${t.message}</p></div>`}}async function Za(){const e=document.getElementById("tablonTabDot");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString();try{const{count:s}=await c.board.unread(null,t);console.log("[tablonDot] count:",s,"since:",t),e.classList.toggle("hidden",s===0)}catch(s){console.warn("[tablonDot] error:",s),e.classList.add("hidden")}}function Ka(e,a){const t={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")},tablon:{btn:document.getElementById("tabTablon"),panel:document.getElementById("panelTablon")}};function s(i){for(const[r,{btn:o,panel:d}]of Object.entries(t))o.classList.toggle("league-tab--active",r===i),d.classList.toggle("hidden",r!==i)}t.general.btn.addEventListener("click",()=>s("general")),t.miDivision.btn.addEventListener("click",()=>{s("miDivision"),t.miDivision.panel.dataset.loaded||(t.miDivision.panel.dataset.loaded="1",Qa(e))}),t.divisiones.btn.addEventListener("click",()=>{s("divisiones"),t.divisiones.panel.dataset.loaded||(t.divisiones.panel.dataset.loaded="1",et(e))});function n(){var i;s("tablon"),localStorage.setItem("tablon_general_last_read",new Date().toISOString()),(i=document.getElementById("tablonTabDot"))==null||i.classList.add("hidden"),document.dispatchEvent(new CustomEvent("tablon:read")),t.tablon.panel.dataset.loaded||(t.tablon.panel.dataset.loaded="1",ue(t.tablon.panel,{forceGeneral:!0}))}t.tablon.btn.addEventListener("click",n),a==="tablon"&&n()}async function Qa(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await c.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function et(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await c.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>at(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function at(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
      ...
      <div class="div-accordion__body">
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${e.standings.map(s=>Ae(s,a)).join("")}
            </tbody>
          </table>
        </div>
      </div>
    </div>
  `}function te(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function tt(e,a){let t=document.getElementById("userCtxMenu");t||(t=document.createElement("div"),t.id="userCtxMenu",t.className="user-ctx-menu hidden",t.innerHTML=`
  ...
  `}async function Le(e,{params:a={}}={}){const t=a.userId?parseInt(a.userId):null;t?await it(e,t):await st(e)}async function st(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{conversations:a}=await c.messages.list();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">💬 Mensajes</h1>
        ${a.length===0?'<p class="empty">No tienes conversaciones aún. Pulsa el nombre de un jugador en la clasificación para enviar un mensaje.</p>':`<div class="mensajes-list">${a.map(nt).join("")}</div>`}
      </div>
    `,e.querySelectorAll(".mensajes-item").forEach(t=>{t.addEventListener("click",()=>{window.location.hash=`/mensajes/${t.dataset.userId}`})})}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function nt(e){return`
  ...
  `}async function it(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=y.getUser();try{const{messages:n,partner:i}=await c.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
      <div class="container">
        ...
        <div class="chat-messages" id="chatMessages">
          ${n.length===0?'<p class="empty" style="text-align:center">Empieza la conversación.</p>':n.map(o=>we(o,t)).join("")}
        </div>
  ...
  `}function W(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const je=e=>()=>{window.location.hash=e},ot={"/":Ge,"/login":ea,"/register":aa,"/quiniela":je("/jornada"),"/resultados":je("/tabla-v2"),"/ranking":sa,"/tablon":ue,"/ligas":ia,"/ligas/:id":ra,"/perfil":la,"/campeon":va,"/admin":_a,"/forgot-password":Pa,"/reset-password":Ma,"/unirse":Da,"/jugador/:id":qa,"/jornada":Na,"/duelo":Va,"/tabla-v2":Ya,"/mensajes":Le,"/mensajes/:userId":Le};function rt(e){for(const[a,t]of Object.entries(ot)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(r,o)=>(s.push(o),"([^/]+)"))+"$"),i=e.match(n);if(i){const r={};return s.forEach((o,d)=>{r[o]=i[d+1]}),{handler:t,params:r}}}return null}const Se=()=>document.getElementById("mainContent"),S={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=rt(a);if(!n){Se().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:r}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2","/mensajes"].includes(a)&&!y.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!y.isAdmin()){this.navigate("/");return}const d=Se();d.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(d,{params:r,query:s})}};let G=[],z=null,J=null,se=!1;async function dt(){document.documentElement.dataset.build="2026-08-13T20",await y.init(),S.init(),ut(),lt(),gt()}function Ne(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function lt(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!Ne()&&(z=e,ct())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),z=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function ct(){if(Ne()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `}function F(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}dt();
