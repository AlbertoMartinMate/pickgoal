(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const ce="https://pickgoal-backend.onrender.com/api";function ue(){return localStorage.getItem("token")}async function h(e,a={}){const t={"Content-Type":"application/json",...a.headers},n=ue();n&&(t.Authorization=`Bearer ${n}`);const s=await fetch(`${ce}${e}`,{...a,headers:t}),i=await s.json().catch(()=>({}));if(!s.ok)throw{status:s.status,message:i.error||"Error desconocido"};return i}const p={get:e=>h(e),post:(e,a)=>h(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>h(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>h(e,{method:"DELETE"}),auth:{register:e=>h("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>h("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>h("/auth/me"),forgotPassword:e=>h("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>h("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>h(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>h("/auth/users"),toggleAdmin:e=>h(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>h("/matches/grouped"),list:(e="")=>h(`/matches/${e}`),get:e=>h(`/matches/${e}`),today:()=>h("/matches/today"),setResult:(e,a,t)=>h(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t})}),sync:()=>h("/matches/sync",{method:"POST"}),recalculate:()=>h("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>h(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>h(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>h("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>h(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>h(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>h("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>h("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>h("/leagues/all"),public:()=>h("/leagues/public"),my:()=>h("/leagues/my"),create:e=>h("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>h("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>h(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>h("/leagues/admin"),get:e=>h(`/leagues/${e}`),update:(e,a)=>h(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>h(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>h(`/leagues/${e}/members`),matchPredictions:(e,a)=>h(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>h("/home/summary")},board:{messages:(e=1,a=null)=>h(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>h(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>h("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>h(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>h(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>h(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>h("/notifications/vapid-public-key"),subscribe:e=>h("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>h("/notifications/send",{method:"POST",body:JSON.stringify(e)})}};let T=null;const $={async init(){if(localStorage.getItem("token"))try{const{user:a}=await p.auth.me();T=a}catch{localStorage.removeItem("token")}},setUser(e,a){T=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){T=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return T},isLoggedIn(){return!!T},isAdmin(){return(T==null?void 0:T.is_admin)===!0}};let R=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,R&&clearTimeout(R),R=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function te(){return`
  ...
  `}function M(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function pe(e){if(!$.getUser()){me(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,upcoming_matches:n}=await p.home.summary();if(t.length===0){ge(e);return}const s=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),i=[...t].sort((o,d)=>o.league_id===s?-1:d.league_id===s?1:0);e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),n=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",n.classList.add("hidden");const s={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await p.auth.register(s);$.setUser(o,i),v("¡Cuenta creada! Bienvenido a PickGoal");const d=sessionStorage.getItem("pendingInviteCode");if(d){sessionStorage.removeItem("pendingInviteCode");try{const{league:g}=await p.leagues.joinByCode(d);v(`¡Te has unido a "${g.name}"!`),I.navigate(`/ligas/${g.id}`)}catch{I.navigate("/ligas")}}else I.navigate("/campeon"),se("/ligas")}catch(i){n.textContent=i.message||"Error al registrarse",n.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function V(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ee(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{let n=null;if($.isLoggedIn()){const{leagues:y}=await p.leagues.my();if(y.length===0){e.innerHTML=te();return}const L=V(),S=y.find(r=>r.id===L);n=S?S.name:((a=y[0])==null?void 0:a.name)??null}const s=V(),[{groups:i},o,d]=await Promise.all([p.matches.grouped(),$.isLoggedIn()?p.predictions.mine(s):Promise.resolve({predictions:[]}),$.isLoggedIn()?p.predictions.getChampion(s):Promise.resolve({champion_prediction:null})]),g={};for(const y of o.predictions)g[y.match_id]=y;const u=i.flatMap(y=>y.matches),_=new Map;for(const y of u){const L=W(y.match_datetime);_.has(L)||_.set(L,[]),_.get(L).push(y)}const c=[..._.keys()].sort(),m=W(new Date().toISOString()),b=c.find(y=>y>=m)??c[0],f=((t=d.champion_prediction)==null?void 0:t.team_name)??null,E=$.isLoggedIn()?f?`<p class="champion-banner champion-banner--set">🏆 Tu campeón: <a href="#/campeon" style="color:inherit;font-weight:bold;">${f}</a></p>`:'<p class="champion-banner champion-banner--missing">⚠️ <a href="#/campeon">¡Elige tu campeón antes del inicio del torneo!</a></p>':"";e.innerHTML=`
    ...
    `,we(c,b,_,g,s)}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error cargando los partidos: ${n.message}</p></div>`}}function we(e,a,t,n,s){var o;const i=document.getElementById("dateNav");i&&(i.innerHTML=e.map(d=>`
    <button class="date-nav__btn ${d===a?"date-nav__btn--active":""}" data-day="${d}">
      ${Le(d)}
    </button>
  `).join(""),(o=i.querySelector(".date-nav__btn--active"))==null||o.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),i.querySelectorAll(".date-nav__btn").forEach(d=>{d.addEventListener("click",()=>{i.querySelectorAll(".date-nav__btn").forEach(g=>g.classList.remove("date-nav__btn--active")),d.classList.add("date-nav__btn--active"),X(t.get(d.dataset.day)??[],n,s)})}),X(t.get(a)??[],n,s))}function X(e,a,t){const n=document.getElementById("matchesContent");if(n){if(e.length===0){n.innerHTML='<p class="empty">Sin partidos este día.</p>';return}n.innerHTML=`<div class="matches-grid">${e.map(s=>Ie(s,a[s.id])).join("")}</div>`,$.isLoggedIn()&&n.querySelectorAll(".prediction-form").forEach(s=>{xe(s,a,t)})}}function W(e){const a=new Date(e);return`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`}function Le(e){const[a,t,n]=e.split("-").map(Number);return new Date(a,t-1,n).toLocaleDateString("es-ES",{day:"numeric",month:"short"})}function Ie(e,a){const t=e.is_locked,n=a?`<span class="pts-badge">${a.total_points} pts</span>`:"",s={scheduled:"Programado",live:"🔴 En juego",finished:"Finalizado"}[e.status];return`
    <div class="match-card ${t?"match-card--locked":""}" data-match-id="${e.id}">
      ...
      ${!t&&$.isLoggedIn()?Se(e,a):t&&a?`<div class="prediction-result">
               Tu predicción: <strong>${a.predicted_home}-${a.predicted_away}</strong>
               (${a.predicted_result}) · ${a.total_points} pts
             </div>`:""}
    </div>
  `}function Se(e,a){const t=!!a,n=(a==null?void 0:a.predicted_home)??0,s=(a==null?void 0:a.predicted_away)??0,i=(a==null?void 0:a.predicted_result)??"X",o=t?"prediction-form--saved":"prediction-form--unsaved",d=t?'<span class="pred-status pred-status--saved">✓ Guardado</span>':'<span class="pred-status pred-status--unsaved">Sin predicción</span>',g=t?"btn btn--saved btn--sm pred-save-btn":"btn btn--ghost btn--sm pred-save-btn",u=t?"✓ Guardado":"Guardar";return`
    <form class="prediction-form ${o}" data-match-id="${e.id}" data-saved="${t}">
      ...
      <button type="submit" class="${g}">${u}</button>
    </form>
  `}function xe(e,a,t){const n=parseInt(e.dataset.matchId),s=e.querySelector(".pred-save-btn"),i=e.querySelector(".pred-status");let o=e.dataset.saved==="true";function d(){e.classList.contains("prediction-form--dirty")||(e.classList.remove("prediction-form--saved","prediction-form--unsaved"),e.classList.add("prediction-form--dirty"),s.className="btn btn--primary btn--sm pred-save-btn",s.textContent="Guardar",i&&(i.className="pred-status pred-status--unsaved",i.textContent="Sin guardar"))}function g(){o=!0,e.classList.remove("prediction-form--unsaved","prediction-form--dirty"),e.classList.add("prediction-form--saved"),s.className="btn btn--saved btn--sm pred-save-btn",s.textContent="✓ Guardado",s.disabled=!1,i&&(i.className="pred-status pred-status--saved",i.textContent="✓ Guardado")}e.querySelectorAll("input").forEach(u=>{u.addEventListener("change",d),u.addEventListener("input",d)}),e.addEventListener("submit",async u=>{var b;u.preventDefault();const _=parseInt(e.querySelector("[name=predicted_home]").value),c=parseInt(e.querySelector("[name=predicted_away]").value),m=(b=e.querySelector("[name=predicted_result]:checked"))==null?void 0:b.value;if(!(isNaN(_)||isNaN(c)||!m)){s.disabled=!0,s.textContent="…";try{const{prediction:f}=await p.predictions.save({match_id:n,predicted_result:m,predicted_home:_,predicted_away:c,league_id:t??null});a[n]=f,v("Predicción guardada"),g()}catch(f){v(f.message||"Error al guardar","error"),s.disabled=!1,o?(s.className="btn btn--saved btn--sm pred-save-btn",s.textContent="✓ Guardado"):(s.className="btn btn--primary btn--sm pred-save-btn",s.textContent="Guardar")}}})}function ke(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Pe(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if($.isLoggedIn()){const{leagues:m}=await p.leagues.my();if(m.length===0){e.innerHTML=te();return}}const n=ke(),[{ranking:s},i]=await Promise.all([p.auth.ranking(n),$.isLoggedIn()?p.leagues.my():Promise.resolve({leagues:[]})]),o=$.getUser(),d=i.leagues.find(m=>m.id===n),g=document.getElementById("tablonBadge"),u=g&&!g.classList.contains("hidden"),_=u?g.textContent:"",c=((a=s[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        ...
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${s.map(m=>{var S,r,l;const b=m.predictions_made??0,f=`${b}/${c}`,E=`${m.correct_results??0}/${b}`,y=`${m.exact_scores??0}/${b}`;return`
                  <tr class="${o&&m.id===o.id?"ranking-table__row--me":""}">
                    ...
                    <td>
                      <a class="ranking-table__link" href="#/jugador/${m.id}">
                        <span class="status-emoji" title="${((S=m.status)==null?void 0:S.name)||""}">${((r=m.status)==null?void 0:r.emoji)||""}</span>${m.username}
                      </a>
                    </td>
                    <td class="ranking-table__stat ranking-table__status">${((l=m.status)==null?void 0:l.name)||"—"}</td>
    ...
    `,(t=e.querySelector(".ranking-tablon-btn"))==null||t.addEventListener("click",()=>{I.navigate(`/tablon?liga=${n}`)})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}async function ne(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=$.getUser();let n=a.liga?parseInt(a.liga):null;if(n){localStorage.setItem(`tablon_last_read_${n}`,new Date().toISOString());const r=document.getElementById("tablonBadge");r&&(r.classList.add("hidden"),r.textContent="")}let s=null,i=[],o=1,d=1;try{if(!n&&t){const{leagues:r}=await p.leagues.my();r&&r.length&&(n=r[0].id,s=r[0].name)}else if(n)try{const{league:r}=await p.leagues.get(n);s=r.name}catch{}if(n&&t)try{const{members:r}=await p.leagues.members(n);i=r||[]}catch{}}catch{}async function g(){const r=await p.board.messages(o,n);return d=r.pages||1,r}try{const r=await g();u(r)}catch(r){e.innerHTML=`<div class="container"><p class="form__error">Error: ${r.message}</p></div>`}function u(r){const{pinned:l=[],messages:w=[]}=r;e.innerHTML=`
      <div class="container">
    ...
    `,f(),E(),y()}function _(r){return r.length?r.map(l=>`
      <div class="board-message board-message--pinned" data-id="${l.id}">
        <div class="board-message__header">
          ...
          <strong class="board-message__author">${B(l.username)}</strong>
        ...
        <p class="board-message__text">${b(l.message)}</p>

        ${l.replies&&l.replies.length?`<div class="board-replies">
               ${l.replies.map(w=>c(w)).join("")}
             </div>`:""}
    ...
    `}function m(r){return r.length?r.map(l=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function b(r){const l=B(r);if(!i.length)return l;const w=i.map(x=>Ce(x.username)),k=new RegExp(`@(${w.join("|")})`,"gi");return l.replace(k,'<span class="mention">@$1</span>')}function f(){const r=document.getElementById("boardForm");if(!r)return;const l=document.getElementById("boardMsg"),w=document.getElementById("charCounter"),k=document.getElementById("mentionDropdown");l.addEventListener("input",()=>{w.textContent=`${l.value.length} / 500`,S(l,k)}),r.addEventListener("submit",async x=>{x.preventDefault();const j=l.value.trim();if(j)try{await p.board.post(j,n),l.value="",w.textContent="0 / 500",k.classList.add("hidden");const C=await g();L(C),v("Mensaje publicado")}catch(C){v(C.message,"error")}})}function E(){e.querySelectorAll(".reply-form").forEach(r=>{const l=parseInt(r.dataset.parent),w=r.querySelector(".reply-input"),k=`mentionDropdown-${l}`,x=document.getElementById(k);w==null||w.addEventListener("input",()=>{S(w,x)}),r.addEventListener("submit",async j=>{j.preventDefault();const C=w.value.trim();if(C)try{await p.board.reply(l,C),w.value="",x==null||x.classList.add("hidden");const N=await g();L(N),v("Respuesta enviada")}catch(N){v(N.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await p.board.pin(r.dataset.id);const l=await g();L(l),v("Mensaje fijado")}catch(l){v(l.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await p.board.pin(r.dataset.id);const l=await g();L(l),v("Mensaje desfijado")}catch(l){v(l.message,"error")}})})}function y(){e.querySelectorAll(".delete-msg").forEach(r=>{r.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await p.board.delete(r.dataset.id);const l=await g();L(l),v("Mensaje eliminado")}catch(l){v(l.message,"error")}})})}function L(r){const{pinned:l=[],messages:w=[]}=r,k=document.getElementById("boardPinned");if(k)k.innerHTML=_(l);else if(l.length){u(r);return}const x=document.getElementById("boardMessages");x&&(x.innerHTML=m(w)),E(),y()}e.addEventListener("click",async r=>{if(r.target.id==="prevPage"&&o>1){o--;const l=await g();L(l)}else if(r.target.id==="nextPage"&&o<d){o++;const l=await g();L(l)}});function S(r,l){if(!l||!i.length)return;const w=r.value,k=r.selectionStart,x=w.slice(0,k),j=x.match(/@(\w*)$/);if(!j){l.classList.add("hidden");return}const C=j[1].toLowerCase(),N=i.filter(P=>P.username.toLowerCase().startsWith(C)&&P.id!==(t==null?void 0:t.id)),F=[...$.isAdmin()&&"todos".startsWith(C)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...N.slice(0,6)];if(!F.length){l.classList.add("hidden");return}l.innerHTML=F.map(P=>P.description?`<div class="mention-item mention-item--broadcast" data-username="${B(P.username)}">
             <span class="mention-item__name">@${B(P.username)}</span>
             <span class="mention-item__desc">${B(P.description)}</span>
           </div>`:`<div class="mention-item" data-username="${B(P.username)}">${B(P.username)}</div>`).join(""),l.classList.remove("hidden"),l.querySelectorAll(".mention-item").forEach(P=>{P.addEventListener("mousedown",le=>{le.preventDefault();const de=P.dataset.username,O=x.replace(/@(\w*)$/,`@${de} `);if(r.value=O+w.slice(k),r.setSelectionRange(O.length,O.length),l.classList.add("hidden"),r.tagName==="TEXTAREA"){const z=document.getElementById("charCounter");z&&(z.textContent=`${r.value.length} / 500`)}})})}document.addEventListener("click",r=>{!r.target.closest(".board-form__input-wrap")&&!r.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(l=>l.classList.add("hidden"))},{capture:!0})}function B(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ce(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Be(e){var a,t,n,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=$.getUser(),o=i==null?void 0:i.is_admin,[d,g]=await Promise.all([o?p.leagues.adminAll():p.leagues.all(),$.isLoggedIn()&&!o?p.leagues.my():Promise.resolve({leagues:[]})]),u=new Set(g.leagues.map(c=>c.id)),_=o?d.leagues:d.leagues.filter(c=>!u.has(c.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&g.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${g.leagues.map(c=>K(c,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${_.length?`<div class="leagues-grid">${_.map(c=>K(c,!1,u,o)).join("")}</div>`:o?'<p class="empty">No hay ligas creadas aún.</p>':g.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(c=>{c.addEventListener("click",()=>I.navigate(`/ligas/${c.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(c=>{c.addEventListener("click",async m=>{m.stopPropagation();const b=parseInt(c.dataset.id);c.disabled=!0,c.textContent="…";try{const{league:f}=await p.leagues.join({league_id:b});v(`¡Te has unido a "${f.name}"!`),I.navigate(`/ligas/${f.id}`)}catch(f){v(f.message,"error"),c.disabled=!1,c.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(c=>{c.addEventListener("click",m=>{m.stopPropagation(),v("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var c,m;(c=document.getElementById("createLeaguePanel"))==null||c.classList.remove("hidden"),(m=document.getElementById("btnShowCreate"))==null||m.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var c,m;(c=document.getElementById("createLeaguePanel"))==null||c.classList.add("hidden"),(m=document.getElementById("btnShowCreate"))==null||m.classList.remove("hidden")}),(n=document.getElementById("joinCodeForm"))==null||n.addEventListener("submit",async c=>{c.preventDefault();const m=document.getElementById("inviteCode").value.trim().toUpperCase();if(m)try{const{league:b}=await p.leagues.join({invite_code:m});v(`Te has unido a "${b.name}"`),I.navigate(`/ligas/${b.id}`)}catch(b){v(b.message,"error")}}),(s=document.getElementById("createLeagueForm"))==null||s.addEventListener("submit",async c=>{var S;c.preventDefault();const m=document.getElementById("createBtn");m.disabled=!0,m.textContent="Creando…";const b=document.getElementById("leagueName").value.trim(),f=document.getElementById("leagueDesc").value.trim(),E=document.getElementById("leaguePrize").value.trim(),y=document.getElementById("isPublic").checked,L=((S=document.getElementById("isOfficial"))==null?void 0:S.checked)??!1;try{const{league:r}=await p.leagues.create({name:b,description:f,prize:E,is_public:y,is_official:L});Te(r)}catch(r){v(r.message,"error"),m.disabled=!1,m.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function K(e,a=!1,t=new Set,n=!1){const s=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",o=n?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `,(n=document.getElementById("btnCopyLink"))==null||n.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(s=document.getElementById("btnShare"))==null||s.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function Me(e,{params:a}){var n,s,i,o,d;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const g=await p.leagues.get(t),{league:u,ranking:_,is_member:c,is_admin_view:m}=g,b=$.getUser(),f=u.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
    ...
    `,(n=document.getElementById("btnCopyInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(u.invite_link),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(s=document.getElementById("btnShareInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${u.name} en PickGoal`,url:u.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await p.leagues.leave(t),v("Has abandonado la liga"),I.navigate("/ligas")}catch(r){v(r.message,"error")}}),(o=document.getElementById("btnJoin"))==null||o.addEventListener("click",async()=>{try{await p.leagues.join({league_id:t}),v("¡Te has unido a la liga!"),I.navigate(`/ligas/${t}`)}catch(r){v(r.message,"error")}}),(d=document.getElementById("btnEditLeague"))==null||d.addEventListener("click",()=>{je(u,t,b)});const E=document.getElementById("tabRanking"),y=document.getElementById("tabTablon"),L=document.getElementById("sectionRanking"),S=document.getElementById("sectionTablon");E&&y&&(E.addEventListener("click",()=>{E.classList.add("league-tab--active"),y.classList.remove("league-tab--active"),L.classList.remove("hidden"),S.classList.add("hidden")}),y.addEventListener("click",()=>{y.classList.add("league-tab--active"),E.classList.remove("league-tab--active"),L.classList.add("hidden"),S.classList.remove("hidden");const r=document.getElementById("tablonEmbed");r&&!r.dataset.loaded&&(r.dataset.loaded="1",ne(r,{query:{liga:String(t)}}))}))}catch(g){e.innerHTML=`<div class="container"><p class="form__error">Error: ${g.message}</p><a href="#/ligas">Volver</a></div>`}}function je(e,a,t){const n=document.getElementById("editLeagueModal");n&&n.remove();const s=document.createElement("div");s.id="editLeagueModal",s.className="edit-league-modal",s.innerHTML=`
  ...
  `,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("edit-league-modal--open"));const i=()=>{s.classList.remove("edit-league-modal--open"),s.addEventListener("transitionend",()=>s.remove(),{once:!0})};s.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("btnSaveEdit");d.disabled=!0,d.textContent="Guardando…";const g={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(g.is_official=document.getElementById("editOfficial").checked);try{await p.leagues.update(a,g),v("Liga actualizada"),i(),I.navigate(`/ligas/${a}`)}catch(u){v(u.message,"error"),d.disabled=!1,d.textContent="Guardar cambios"}})}async function He(e){var t,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=$.getUser();try{const s=(()=>{const f=localStorage.getItem("activeLeagueId");return f?parseInt(f):null})(),[i,o,d,g,u]=await Promise.all([p.predictions.mine(s),p.predictions.getChampion(s),p.leagues.my(),p.auth.me(),a!=null&&a.is_admin?p.leagues.adminAll():Promise.resolve({leagues:[]})]),_=i.predictions.reduce((f,E)=>f+E.total_points,0)+(((t=o.champion_prediction)==null?void 0:t.points_earned)||0),c=g.user,m=c.status,b=c.total_points_all_time;e.innerHTML=`
    ...
    `,(n=e.querySelector("#btnLogoutPerfil"))==null||n.addEventListener("click",()=>{$.logout(),window.location.hash="/"})}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error: ${s.message}</p></div>`}}function Ae(e,a){if(e.next_threshold===null)return`
  ...
  `}const Y=new Date("2026-06-11T21:00:00Z"),Ne=["Argentina","Brasil","Francia","España","Inglaterra","Alemania","Portugal","Países Bajos","Italia","Bélgica","Uruguay","Colombia","México","Estados Unidos","Canadá","Marruecos","Senegal","Nigeria","Japón","Corea del Sur","Australia","Arabia Saudí","Irán","Qatar","Ecuador","Chile","Perú","Venezuela","Bolivia","Paraguay","Costa Rica","Honduras","Panamá","Jamaica","Trinidad y Tobago","Guatemala","Turquía","Polonia","Croacia","Serbia","República Checa","Eslovaquia","Austria","Suiza","Dinamarca","Suecia","Noruega","Escocia","Ucrania","Rumanía","Hungría","Grecia","Egipto","Camerún","Ghana","Costa de Marfil","Túnez","Argelia","China","India","Irak","Uzbekistán","Nueva Zelanda","Fiji"];function De(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ie(e){var a;if(!$.isLoggedIn()){e.innerHTML='<div class="container"><p class="notice"><a href="#/login">Inicia sesión</a> para predecir el campeón.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const t=De(),{champion_prediction:n}=await p.predictions.getChampion(t),s=new Date>=Y;let i;n&&s?i=`
    ...
    `,(a=document.getElementById("championForm"))==null||a.addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("champBtn"),g=document.getElementById("champError"),u=document.getElementById("teamSearch").value.trim();if(u){d.disabled=!0,d.textContent="Guardando…",g.classList.add("hidden");try{await p.predictions.saveChampion(u,t),v(`¡${u} guardado como campeón!`),ie(e)}catch(_){g.textContent=_.message,g.classList.remove("hidden"),d.disabled=!1,d.textContent=d.dataset.label||"Confirmar predicción"}}})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error: ${t.message}</p></div>`}}function G(e){const a=e?"Actualizar predicción":"Confirmar predicción";return`
  ...
  `}const Oe=[{key:"group",label:"Grupos"},{key:"r32",label:"Dieciseisavos"},{key:"r16",label:"Octavos"},{key:"quarters",label:"Cuartos"},{key:"semis",label:"Semis"},{key:"third",label:"3er y 4to"},{key:"final",label:"Final"}];async function Re(e){if(!$.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const[{users:a},{groups:t}]=await Promise.all([p.auth.users(),p.matches.grouped()]),n=Ge(t);e.innerHTML=`
      <div class="container">
    ...
    `,Je(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function Ge(e){const a={};for(const t of e){const n=t.phase;a[n]||(a[n]=[]),a[n].push(...t.matches)}return a}function Ue(e){const a=Oe.filter(s=>{var i;return(i=e[s.key])==null?void 0:i.length});if(!a.length)return'<p class="admin-section__desc">No hay partidos cargados.</p>';const t=a.map((s,i)=>`
  ...
  `}function Fe(e){const a=e.status==="finished",t=a&&e.home_score_90!=null?e.home_score_90:"",n=a&&e.away_score_90!=null?e.away_score_90:"",s=a?'<span class="admin-match-badge admin-match-badge--done">Terminado</span>':'<span class="admin-match-badge admin-match-badge--pending">Pendiente</span>',i=ze(e.match_datetime);return`
  ...
  `}function ze(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}function Je(e){var n,s,i,o,d,g;(n=document.getElementById("btnSync"))==null||n.addEventListener("click",async()=>{const u=document.getElementById("syncResult");u.textContent="Sincronizando…";try{await p.matches.sync(),u.textContent="✓ Sincronización completada",v("Sincronización completada")}catch(_){u.textContent=`Error: ${_.message}`,v(_.message,"error")}}),(s=document.getElementById("awardForm"))==null||s.addEventListener("submit",async u=>{u.preventDefault();const _=document.getElementById("winnerTeam").value.trim();if(_)try{const{message:c}=await p.predictions.awardChampion(_);v(c)}catch(c){v(c.message,"error")}}),e.querySelectorAll(".admin-result-tab").forEach(u=>{u.addEventListener("click",()=>{var _;e.querySelectorAll(".admin-result-tab").forEach(c=>c.classList.remove("admin-result-tab--active")),e.querySelectorAll(".admin-result-panel").forEach(c=>c.classList.add("admin-result-panel--hidden")),u.classList.add("admin-result-tab--active"),(_=e.querySelector(`.admin-result-panel[data-phase="${u.dataset.phase}"]`))==null||_.classList.remove("admin-result-panel--hidden")})}),(i=document.getElementById("resultPanels"))==null||i.addEventListener("click",async u=>{const _=u.target.closest(".admin-match-row__save");if(!_)return;const c=_.closest(".admin-match-row"),m=parseInt(c.dataset.id),b=c.querySelectorAll(".admin-match-row__input"),f=b[0].value,E=b[1].value;if(f===""||E===""){v("Introduce ambos marcadores","error");return}_.disabled=!0;try{await p.matches.setResult(m,parseInt(f),parseInt(E));const y=c.querySelector(".admin-match-badge");y&&(y.className="admin-match-badge admin-match-badge--done",y.textContent="Terminado"),v(`Resultado ${f}-${E} guardado`)}catch(y){v(y.message,"error")}finally{_.disabled=!1}}),(o=document.getElementById("btnRecalcAll"))==null||o.addEventListener("click",async()=>{const u=document.getElementById("btnRecalcAll"),_=document.getElementById("recalcResult");u.disabled=!0,_.textContent="Recalculando…";try{const{message:c}=await p.matches.recalculate();_.textContent=`✓ ${c}`,v(c)}catch(c){_.textContent=`Error: ${c.message}`,v(c.message,"error")}finally{u.disabled=!1}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(d=document.getElementById("pushForm"))==null||d.addEventListener("submit",async u=>{u.preventDefault();const _=document.getElementById("pushTitle").value.trim()||"Aviso",c=document.getElementById("pushBody").value.trim(),m=a.value,b=parseInt(document.getElementById("pushTargetId").value)||null,f=document.getElementById("pushResult"),E={title:`📣 PickGoal — ${_}`,body:c};m==="league"&&b&&(E.league_id=b),m==="user"&&b&&(E.user_id=b),f.textContent="Enviando…";try{const{sent:y}=await p.notifications.send(E);f.textContent=`✓ Enviada a ${y} suscripción(es)`,v(`Notificación enviada a ${y} suscripción(es)`)}catch(y){f.textContent=`Error: ${y.message}`,v(y.message,"error")}}),(g=document.getElementById("usersTableBody"))==null||g.addEventListener("click",async u=>{const _=u.target.closest(".toggle-admin");if(!_)return;const c=parseInt(_.dataset.id);try{const{user:m}=await p.auth.toggleAdmin(c);_.closest("tr").querySelector(".admin-badge").textContent=m.is_admin?"Sí":"No",v(`${m.username} ${m.is_admin?"ahora es admin":"ya no es admin"}`)}catch(m){v(m.message,"error")}})}function Ve(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async n=>{n.preventDefault();const s=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;s.disabled=!0,s.textContent="Guardando…",i.classList.add("hidden");try{await p.auth.resetPassword(t,o),v("Contraseña actualizada. Ya puedes iniciar sesión."),I.navigate("/login")}catch(d){i.textContent=d.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{s.disabled=!1,s.textContent="Guardar contraseña"}})}const Ke={r32:"Dieciseisavos",r16:"Octavos",quarters:"Cuartos",semis:"Semis",third:"3º y 4º",final:"Final"};async function Ye(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{groups:a}=await p.matches.grouped();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Resultados — Mundial 2026</h1>
        <nav class="phase-nav" id="phaseNav"></nav>
        <div id="phaseContent"></div>
      </div>
    `,Qe(a)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando los partidos: ${a.message}</p></div>`}}function Qe(e){var i;const a=document.getElementById("phaseNav");if(!a)return;const t=e.filter(o=>o.phase==="group"),n=e.filter(o=>o.phase!=="group"),s=[...t.map(o=>({key:`group_${o.group_name}`,label:`Grupo ${o.group_name}`,data:o,isGroup:!0})),...n.map(o=>({key:o.phase,label:Ke[o.phase]||o.label,data:o,isGroup:!1}))];s.length!==0&&(a.innerHTML=s.map((o,d)=>`
    <button class="phase-nav__btn ${d===0?"phase-nav__btn--active":""}" data-key="${o.key}">
      ${o.label}
    </button>
  `).join(""),(i=a.querySelector(".phase-nav__btn--active"))==null||i.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),a.querySelectorAll(".phase-nav__btn").forEach((o,d)=>{o.addEventListener("click",()=>{a.querySelectorAll(".phase-nav__btn").forEach(u=>u.classList.remove("phase-nav__btn--active")),o.classList.add("phase-nav__btn--active");const g=s.find(u=>u.key===o.dataset.key);g&&Q(g.data,g.isGroup)})}),Q(s[0].data,s[0].isGroup))}function Q(e,a){const t=document.getElementById("phaseContent");if(!t)return;const n=Ze(e.matches);if(a){const s=ea(e.matches);t.innerHTML=`
    ...
    `}else t.innerHTML=`<div class="resultados-matches">${n}</div>`}function Ze(e){return!e||e.length===0?'<p class="empty">Sin partidos en esta fase.</p>':e.map(a=>{const t={scheduled:"Programado",live:"🔴 En juego",finished:"Finalizado"}[a.status]||a.status,n=a.status!=="scheduled"?`<span class="res-score">${a.home_score_90??"?"} - ${a.away_score_90??"?"}</span>`:'<span class="res-score res-score--pending">vs</span>';return`
    ...
    `}).join("")}function ea(e){const a={};for(const t of e)if(a[t.home_team]||(a[t.home_team]={name:t.home_team,pj:0,g:0,e:0,p:0,gf:0,gc:0,pts:0}),a[t.away_team]||(a[t.away_team]={name:t.away_team,pj:0,g:0,e:0,p:0,gf:0,gc:0,pts:0}),t.status==="finished"&&t.home_score_90!==null&&t.away_score_90!==null){const n=a[t.home_team],s=a[t.away_team];n.pj++,s.pj++,n.gf+=t.home_score_90,n.gc+=t.away_score_90,s.gf+=t.away_score_90,s.gc+=t.home_score_90,t.home_score_90>t.away_score_90?(n.g++,n.pts+=3,s.p++):t.home_score_90<t.away_score_90?(s.g++,s.pts+=3,n.p++):(n.e++,n.pts++,s.e++,s.pts++)}return Object.values(a).sort((t,n)=>{if(n.pts!==t.pts)return n.pts-t.pts;const s=n.gf-n.gc,i=t.gf-t.gc;return s!==i?s-i:n.gf-t.gf})}function aa(e){return e.length===0?'<p class="empty">Sin datos de clasificación.</p>':`
  ...
  `}async function ta(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!$.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),I.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:n}=await p.leagues.joinByCode(t);v(`¡Te has unido a "${n.name}"!`),I.navigate(`/ligas/${n.id}`)}catch(n){if(n.status===409){v("Ya eres miembro de esta liga");try{const{leagues:s}=await p.leagues.my(),i=s.find(o=>o.invite_code===t);if(i){I.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
      <div class="container">
        <div class="league-gate">
    ...
    `}}function sa(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function na(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const n=sa(),{user:s,predictions:i}=await p.predictions.forUser(t,n);e.innerHTML=`
      <div class="container">
  ...
  `}const oa={"/":pe,"/login":ye,"/register":$e,"/quiniela":Ee,"/resultados":Ye,"/ranking":Pe,"/tablon":ne,"/ligas":Be,"/ligas/:id":Me,"/perfil":He,"/campeon":ie,"/admin":Re,"/forgot-password":Xe,"/reset-password":We,"/unirse":ta,"/jugador/:id":na};function ra(e){for(const[a,t]of Object.entries(oa)){const n=[],s=new RegExp("^"+a.replace(/:([^/]+)/g,(o,d)=>(n.push(d),"([^/]+)"))+"$"),i=e.match(s);if(i){const o={};return n.forEach((d,g)=>{o[d]=i[g+1]}),{handler:t,params:o}}}return null}const Z=()=>document.getElementById("mainContent"),I={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),n=Object.fromEntries(new URLSearchParams(t||"")),s=ra(a);if(!s){Z().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=s;if(["/perfil","/campeon","/admin"].includes(a)&&!$.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!$.isAdmin()){this.navigate("/");return}const g=Z();g.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(g,{params:o,query:n})}};let D=[],q=null,H=null;async function la(){await $.init(),I.init(),ua(),da(),ga()}function oe(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function da(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!oe()&&(q=e,ca())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),q=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function ca(){if(oe()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("installBtn").addEventListener("click",async()=>{q&&(q.prompt(),await q.userChoice,q=null,e.remove())}),document.getElementById("installDismissBtn").addEventListener("click",()=>{sessionStorage.setItem("installBannerDismissed","1"),e.remove()})}function A(){var e,a;(e=document.getElementById("userDropdown"))==null||e.classList.add("hidden"),(a=document.getElementById("userBtn"))==null||a.classList.remove("navbar__dropdown-btn--open")}async function U(){const e=document.getElementById("tablonBadge");if(!e)return;if(!$.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("activeLeagueId");if(!t){e.classList.add("hidden");return}const n=localStorage.getItem(`tablon_last_read_${t}`)||new Date(0).toISOString();try{const{count:s}=await p.board.unread(parseInt(t),n);s>0?(e.textContent=s>99?"99+":String(s),e.classList.remove("hidden")):e.classList.add("hidden")}catch{e.classList.add("hidden")}}function ua(){var e,a,t;document.addEventListener("auth:change",ee),window.addEventListener("hashchange",()=>{A(),re(),setTimeout(U,200)}),document.addEventListener("click",A),(e=document.getElementById("userBtn"))==null||e.addEventListener("click",n=>{var o;n.stopPropagation();const s=document.getElementById("userDropdown"),i=s==null?void 0:s.classList.contains("hidden");A(),i&&(s==null||s.classList.remove("hidden"),(o=document.getElementById("userBtn"))==null||o.classList.add("navbar__dropdown-btn--open"))}),(a=document.getElementById("userDropdown"))==null||a.addEventListener("click",n=>{n.stopPropagation(),n.target.closest("#navProfileLink")&&A()}),(t=document.getElementById("navLogoutBtn"))==null||t.addEventListener("click",()=>{D=[],localStorage.removeItem("activeLeagueId"),A(),$.logout(),I.navigate("/")}),ee()}async function ee(){const e=document.getElementById("navAuthLinks"),a=document.getElementById("userBtn"),t=document.getElementById("navUsername"),n=document.getElementById("bottomNav"),s=$.getUser();if(A(),s){e==null||e.classList.add("hidden"),t&&(t.textContent=s.username),a.style.visibility="visible",n==null||n.classList.remove("hidden"),document.body.classList.add("has-bottom-nav");try{const{leagues:i}=s.is_admin?await p.leagues.adminAll():await p.leagues.my();D=i}catch{D=[]}pa(D),U(),H&&clearInterval(H),H=setInterval(U,5*60*1e3)}else e==null||e.classList.remove("hidden"),a.style.visibility="hidden",n==null||n.classList.add("hidden"),document.body.classList.remove("has-bottom-nav"),D=[],localStorage.removeItem("activeLeagueId"),H&&(clearInterval(H),H=null);re()}function pa(e){const a=localStorage.getItem("activeLeagueId");a&&e.some(n=>String(n.id)===String(a))||(e.length>0?localStorage.setItem("activeLeagueId",String(e[0].id)):localStorage.removeItem("activeLeagueId"))}function re(){const e=window.location.hash.slice(1).split("?")[0]||"/";document.querySelectorAll(".bottom-nav__item").forEach(a=>{const t=a.dataset.route,n=t==="/"?e==="/":e===t||e.startsWith(t+"/");a.classList.toggle("bottom-nav__item--active",n)})}function ma(e){const a="=".repeat((4-e.length%4)%4),t=(e+a).replace(/-/g,"+").replace(/_/g,"/"),n=atob(t);return Uint8Array.from([...n].map(s=>s.charCodeAt(0)))}async function ga(){if(!(!("serviceWorker"in navigator)||!("PushManager"in window)))try{const e=await navigator.serviceWorker.register("/sw.js");document.addEventListener("auth:change",async a=>{a.detail&&await ae(e)}),$.getUser()&&await ae(e)}catch{}}async function ae(e){try{if(await Notification.requestPermission()!=="granted")return;const t=await e.pushManager.getSubscription();if(t){await p.notifications.subscribe(t.toJSON());return}const{public_key:n}=await p.notifications.vapidPublicKey();if(!n)return;const s=await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:ma(n)});await p.notifications.subscribe(s.toJSON())}catch{}}la();
