(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const z="https://pickgoal-backend.onrender.com/api";function R(){return localStorage.getItem("token")}async function u(e,a={}){const t={"Content-Type":"application/json",...a.headers},n=R();n&&(t.Authorization=`Bearer ${n}`);const s=await fetch(`${z}${e}`,{...a,headers:t}),i=await s.json().catch(()=>({}));if(!s.ok)throw{status:s.status,message:i.error||"Error desconocido"};return i}const p={get:e=>u(e),post:(e,a)=>u(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>u(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>u(e,{method:"DELETE"}),auth:{register:e=>u("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>u("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>u("/auth/me"),forgotPassword:e=>u("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>u("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>u(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>u("/auth/users"),toggleAdmin:e=>u(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>u("/matches/grouped"),list:(e="")=>u(`/matches/${e}`),get:e=>u(`/matches/${e}`),sync:()=>u("/matches/sync",{method:"POST"})},predictions:{mine:e=>u(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>u(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>u("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>u(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>u(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>u("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>u("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>u("/leagues/all"),public:()=>u("/leagues/public"),my:()=>u("/leagues/my"),create:e=>u("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>u("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>u(`/leagues/join/${encodeURIComponent(e)}`),get:e=>u(`/leagues/${e}`),leave:e=>u(`/leagues/${e}/leave`,{method:"DELETE"}),matchPredictions:(e,a)=>u(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>u("/home/summary")},board:{messages:(e=1)=>u(`/board/?page=${e}`),post:e=>u("/board/",{method:"POST",body:JSON.stringify({message:e})}),delete:e=>u(`/board/${e}`,{method:"DELETE"})}};let $=null;const v={async init(){if(localStorage.getItem("token"))try{const{user:a}=await p.auth.me();$=a}catch{localStorage.removeItem("token")}},setUser(e,a){$=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){$=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return $},isLoggedIn(){return!!$},isAdmin(){return($==null?void 0:$.is_admin)===!0}};let C=null;function m(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,C&&clearTimeout(C),C=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function N(){return`
  ...
  `}function L(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function J(e){if(!v.getUser()){V(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,upcoming_matches:n}=await p.home.summary();if(t.length===0){X(e);return}const s=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),i=[...t].sort((o,r)=>o.league_id===s?-1:r.league_id===s?1:0);e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),n=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",n.classList.add("hidden");const s={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await p.auth.register(s);v.setUser(o,i),m("¡Cuenta creada! Bienvenido a PickGoal");const r=sessionStorage.getItem("pendingInviteCode");if(r){sessionStorage.removeItem("pendingInviteCode");try{const{league:d}=await p.leagues.joinByCode(r);m(`¡Te has unido a "${d.name}"!`),b.navigate(`/ligas/${d.id}`)}catch{b.navigate("/ligas")}}else b.navigate("/campeon"),D("/ligas")}catch(i){n.textContent=i.message||"Error al registrarse",n.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function te(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function se(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(v.isLoggedIn()){const{leagues:l}=await p.leagues.my();if(l.length===0){e.innerHTML=N();return}}const a=te(),[{groups:t},n]=await Promise.all([p.matches.grouped(),v.isLoggedIn()?p.predictions.mine(a):Promise.resolve({predictions:[]})]),s={};for(const l of n.predictions)s[l.match_id]=l;const i=t.flatMap(l=>l.matches),o=new Map;for(const l of i){const g=T(l.match_datetime);o.has(g)||o.set(g,[]),o.get(g).push(l)}const r=[...o.keys()].sort(),d=T(new Date().toISOString()),c=r.find(l=>l>=d)??r[0];e.innerHTML=`
      <div class="container">
  ...
  `}function re(e,a){const t=!!a,n=(a==null?void 0:a.predicted_home)??0,s=(a==null?void 0:a.predicted_away)??0,i=(a==null?void 0:a.predicted_result)??"X",o=t?"prediction-form--saved":"prediction-form--unsaved",r=t?'<span class="pred-status pred-status--saved">✓ Guardado</span>':'<span class="pred-status pred-status--unsaved">Sin predicción</span>',d=t?"btn btn--saved btn--sm pred-save-btn":"btn btn--ghost btn--sm pred-save-btn",c=t?"✓ Guardado":"Guardar";return`
    <form class="prediction-form ${o}" data-match-id="${e.id}" data-saved="${t}">
      ...
      <button type="submit" class="${d}">${c}</button>
    </form>
  `}function le(e,a,t){const n=parseInt(e.dataset.matchId),s=e.querySelector(".pred-save-btn"),i=e.querySelector(".pred-status");let o=e.dataset.saved==="true";function r(){e.classList.contains("prediction-form--dirty")||(e.classList.remove("prediction-form--saved","prediction-form--unsaved"),e.classList.add("prediction-form--dirty"),s.className="btn btn--primary btn--sm pred-save-btn",s.textContent="Guardar",i&&(i.className="pred-status pred-status--unsaved",i.textContent="Sin guardar"))}function d(){o=!0,e.classList.remove("prediction-form--unsaved","prediction-form--dirty"),e.classList.add("prediction-form--saved"),s.className="btn btn--saved btn--sm pred-save-btn",s.textContent="✓ Guardado",s.disabled=!1,i&&(i.className="pred-status pred-status--saved",i.textContent="✓ Guardado")}e.querySelectorAll("input").forEach(c=>{c.addEventListener("change",r),c.addEventListener("input",r)}),e.addEventListener("submit",async c=>{var h;c.preventDefault();const l=parseInt(e.querySelector("[name=predicted_home]").value),g=parseInt(e.querySelector("[name=predicted_away]").value),_=(h=e.querySelector("[name=predicted_result]:checked"))==null?void 0:h.value;if(!(isNaN(l)||isNaN(g)||!_)){s.disabled=!0,s.textContent="…";try{const{prediction:f}=await p.predictions.save({match_id:n,predicted_result:_,predicted_home:l,predicted_away:g,league_id:t??null});a[n]=f,m("Predicción guardada"),d()}catch(f){m(f.message||"Error al guardar","error"),s.disabled=!1,o?(s.className="btn btn--saved btn--sm pred-save-btn",s.textContent="✓ Guardado"):(s.className="btn btn--primary btn--sm pred-save-btn",s.textContent="Guardar")}}})}function de(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ce(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(v.isLoggedIn()){const{leagues:r}=await p.leagues.my();if(r.length===0){e.innerHTML=N();return}}const a=de(),[{ranking:t},n]=await Promise.all([p.auth.ranking(a),v.isLoggedIn()?p.leagues.my():Promise.resolve({leagues:[]})]),s=v.getUser(),i=n.leagues.find(r=>r.id===a),o=i?i.name:"Clasificación General";e.innerHTML=`
      <div class="container">
                ...
                <tr class="${s&&r.id===s.id?"ranking-table__row--me":""}">
                  ...
                  <td>
                    <a class="ranking-table__link" href="#/jugador/${r.id}">
                      <span class="status-emoji" title="${((d=r.status)==null?void 0:d.name)||""}">${((c=r.status)==null?void 0:c.emoji)||""}</span>${r.username}
                    </a>
                  </td>
                  <td>${r.country||"—"}</td>
    ...
    `}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}async function pe(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';let a=1,t=1;async function n(){const{messages:r,pages:d}=await p.board.messages(a);return t=d,r}try{const r=await n();s(r)}catch(r){e.innerHTML=`<div class="container"><p class="form__error">Error: ${r.message}</p></div>`}function s(r){var c,l,g;const d=v.getUser();e.innerHTML=`
      <div class="container">
    ...
    `,(c=document.getElementById("boardForm"))==null||c.addEventListener("submit",async _=>{_.preventDefault();const h=document.getElementById("boardMsg"),f=h.value.trim();if(f)try{await p.board.post(f),h.value="";const I=await n();document.getElementById("boardMessages").innerHTML=i(I,d),o(d),m("Mensaje publicado")}catch(I){m(I.message,"error")}}),(l=document.getElementById("prevPage"))==null||l.addEventListener("click",async()=>{a--;const _=await n();document.getElementById("boardMessages").innerHTML=i(_,d),o(d)}),(g=document.getElementById("nextPage"))==null||g.addEventListener("click",async()=>{a++;const _=await n();document.getElementById("boardMessages").innerHTML=i(_,d),o(d)}),o(d)}function i(r,d){return r.length?r.map(c=>`
      <div class="board-message ${c.is_deleted?"board-message--deleted":""}" data-id="${c.id}">
        <div class="board-message__header">
          ...
          ${!c.is_deleted&&d&&(d.id===c.user_id||d.is_admin)?`<button class="btn btn--danger btn--xs delete-msg" data-id="${c.id}">✕</button>`:""}
        </div>
        <p class="board-message__text">${ue(c.message)}</p>
      </div>
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function o(r){e.querySelectorAll(".delete-msg").forEach(d=>{d.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await p.board.delete(d.dataset.id);const c=await n();document.getElementById("boardMessages").innerHTML=i(c,r),o(r),m("Mensaje eliminado")}catch(c){m(c.message,"error")}})})}}function ue(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}async function me(e){var a,t,n,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const[i,o]=await Promise.all([p.leagues.all(),v.isLoggedIn()?p.leagues.my():Promise.resolve({leagues:[]})]),r=v.getUser(),d=new Set(o.leagues.map(l=>l.id)),c=i.leagues.filter(l=>!d.has(l.id));e.innerHTML=`
      <div class="container">
  ...
  `,(n=document.getElementById("btnCopyLink"))==null||n.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),m("Enlace copiado")}catch{m("No se pudo copiar","error")}}),(s=document.getElementById("btnShare"))==null||s.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function _e(e,{params:a}){var n,s,i,o;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:r,ranking:d,is_member:c}=await p.leagues.get(t),l=v.getUser(),g=r.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        ${c?'<button class="btn btn--danger btn--sm" id="btnLeave">Abandonar liga</button>':l?'<button class="btn btn--primary" id="btnJoin">Unirse a esta liga</button>':""}
  ...
  `}const j=new Date("2026-06-11T21:00:00Z"),fe=["Argentina","Brasil","Francia","España","Inglaterra","Alemania","Portugal","Países Bajos","Italia","Bélgica","Uruguay","Colombia","México","Estados Unidos","Canadá","Marruecos","Senegal","Nigeria","Japón","Corea del Sur","Australia","Arabia Saudí","Irán","Qatar","Ecuador","Chile","Perú","Venezuela","Bolivia","Paraguay","Costa Rica","Honduras","Panamá","Jamaica","Trinidad y Tobago","Guatemala","Turquía","Polonia","Croacia","Serbia","República Checa","Eslovaquia","Austria","Suiza","Dinamarca","Suecia","Noruega","Escocia","Ucrania","Rumanía","Hungría","Grecia","Egipto","Camerún","Ghana","Costa de Marfil","Túnez","Argelia","China","India","Irak","Uzbekistán","Nueva Zelanda","Fiji"];function ye(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function O(e){var a;if(!v.isLoggedIn()){e.innerHTML='<div class="container"><p class="notice"><a href="#/login">Inicia sesión</a> para predecir el campeón.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const t=ye(),{champion_prediction:n}=await p.predictions.getChampion(t),s=new Date>=j;let i;n&&s?i=`
    ...
    `,(a=document.getElementById("championForm"))==null||a.addEventListener("submit",async o=>{o.preventDefault();const r=document.getElementById("champBtn"),d=document.getElementById("champError"),c=document.getElementById("teamSearch").value.trim();if(c){r.disabled=!0,r.textContent="Guardando…",d.classList.add("hidden");try{await p.predictions.saveChampion(c,t),m(`¡${c} guardado como campeón!`),O(e)}catch(l){d.textContent=l.message,d.classList.remove("hidden"),r.disabled=!1,r.textContent=r.dataset.label||"Confirmar predicción"}}})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error: ${t.message}</p></div>`}}function B(e){const a=e?"Actualizar predicción":"Confirmar predicción";return`
  ...
  `}const He={"/":J,"/login":ee,"/register":ae,"/quiniela":se,"/resultados":Se,"/ranking":ce,"/tablon":pe,"/ligas":me,"/ligas/:id":_e,"/perfil":ve,"/campeon":O,"/admin":$e,"/forgot-password":we,"/reset-password":Le,"/unirse":ke,"/jugador/:id":Me};function qe(e){for(const[a,t]of Object.entries(He)){const n=[],s=new RegExp("^"+a.replace(/:([^/]+)/g,(o,r)=>(n.push(r),"([^/]+)"))+"$"),i=e.match(s);if(i){const o={};return n.forEach((r,d)=>{o[r]=i[d+1]}),{handler:t,params:o}}}return null}const q=()=>document.getElementById("mainContent"),b={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),n=Object.fromEntries(new URLSearchParams(t||"")),s=qe(a);if(!s){q().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=s;if(["/perfil","/campeon","/admin"].includes(a)&&!v.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!v.isAdmin()){this.navigate("/");return}const d=q();d.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(d,{params:o,query:n})}};let E=[],w=null;async function Ae(){await v.init(),b.init(),Ue(),De()}function Ne(){return window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function De(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!Ne()&&(w=e,Oe())}),window.addEventListener("appinstalled",()=>{var e;w=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function Oe(){if(sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `}function G(){const e=window.location.hash.slice(1).split("?")[0]||"/";document.querySelectorAll(".bottom-nav__item").forEach(a=>{const t=a.dataset.route,n=t==="/"?e==="/":e===t||e.startsWith(t+"/");a.classList.toggle("bottom-nav__item--active",n)})}Ae();
