(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Pe="https://pickgoal-backend.onrender.com/api";function Te(){return localStorage.getItem("token")}async function v(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Te();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Pe}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const u={get:e=>v(e),post:(e,a)=>v(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>v(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>v(e,{method:"DELETE"}),auth:{register:e=>v("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>v("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>v("/auth/me"),forgotPassword:e=>v("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>v("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>v(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>v("/auth/users"),toggleAdmin:e=>v(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>v("/matches/grouped"),list:(e="")=>v(`/matches/${e}`),get:e=>v(`/matches/${e}`),today:()=>v("/matches/today"),setResult:(e,a,t,s=null)=>v(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>v("/matches/sync",{method:"POST"}),recalculate:()=>v("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>v(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>v(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>v("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>v(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>v(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>v("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>v("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>v("/leagues/all"),public:()=>v("/leagues/public"),my:()=>v("/leagues/my"),create:e=>v("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>v("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>v(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>v("/leagues/admin"),get:e=>v(`/leagues/${e}`),update:(e,a)=>v(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>v(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>v(`/leagues/${e}/members`),matchPredictions:(e,a)=>v(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>v("/home/summary")},board:{messages:(e=1,a=null)=>v(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>v(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>v("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>v(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>v(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>v(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>v("/notifications/vapid-public-key"),subscribe:e=>v("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>v("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>v(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>v("/v2/admin/jornadas"),createJornada:e=>v("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>v(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>v(`/v2/admin/jornada/${e}`,{method:"DELETE"})},jornada:{current:()=>v("/v2/jornada/current"),predict:e=>v("/v2/jornada/predict",{method:"POST",body:JSON.stringify({predictions:e})}),history:()=>v("/v2/jornada/history")},duelo:{current:()=>v("/v2/duelo/current")},clasificacion:{division:e=>v(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>v("/v2/clasificacion/general")}};let H=null;const $={async init(){if(localStorage.getItem("token"))try{const{user:a}=await u.auth.me();H=a}catch{localStorage.removeItem("token")}},setUser(e,a){H=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){H=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return H},isLoggedIn(){return!!H},isAdmin(){return(H==null?void 0:H.is_admin)===!0}};let W=null;function m(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,W&&clearTimeout(W),W=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function ve(){return`
  ...
  `}function be(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",d=>{d.key==="Escape"&&o()},{once:!1}),i}function P(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function Me(e){if(!$.getUser()){He(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,upcoming_matches:s}=await u.home.summary();if(t.length===0){De(e);return}const n=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),i=[...t].sort((o,d)=>o.league_id===n?-1:d.league_id===n?1:0);e.innerHTML=`
  ...
  `}function Ve(e,a){const t=!!a,s=(a==null?void 0:a.predicted_home)??0,n=(a==null?void 0:a.predicted_away)??0,i=(a==null?void 0:a.predicted_result)??"X",o=t?"prediction-form--saved":"prediction-form--unsaved",d=t?'<span class="pred-status pred-status--saved">✓ Guardado</span>':'<span class="pred-status pred-status--unsaved">Sin predicción</span>',g=t?"btn btn--saved btn--sm pred-save-btn":"btn btn--ghost btn--sm pred-save-btn",p=t?"✓ Guardado":"Guardar",h=Ue.has(e.phase);return`
  ...
  `}function Xe(e,a,t,s){return e==="1"?a>t:e==="2"?t>a:e==="X"?s?a!==t:a===t:!0}function We(e,a,t){const s=parseInt(e.dataset.matchId),n=e.querySelector(".pred-save-btn"),i=e.querySelector(".pred-status");let o=e.dataset.saved==="true";function d(){e.classList.contains("prediction-form--dirty")||(e.classList.remove("prediction-form--saved","prediction-form--unsaved"),e.classList.add("prediction-form--dirty"),n.className="btn btn--primary btn--sm pred-save-btn",n.textContent="Guardar",i&&(i.className="pred-status pred-status--unsaved",i.textContent="Sin guardar"))}function g(){o=!0,e.classList.remove("prediction-form--unsaved","prediction-form--dirty"),e.classList.add("prediction-form--saved"),n.className="btn btn--saved btn--sm pred-save-btn",n.textContent="✓ Guardado",n.disabled=!1,i&&(i.className="pred-status pred-status--saved",i.textContent="✓ Guardado")}e.querySelectorAll("input").forEach(p=>{p.addEventListener("change",d),p.addEventListener("input",d)}),e.addEventListener("submit",async p=>{var f;p.preventDefault();const h=parseInt(e.querySelector("[name=predicted_home]").value),l=parseInt(e.querySelector("[name=predicted_away]").value),_=(f=e.querySelector("[name=predicted_result]:checked"))==null?void 0:f.value;if(isNaN(h)||isNaN(l)||!_)return;const b=e.dataset.isKnockout==="1";if(!Xe(_,h,l,b)){m("El marcador no coincide con el resultado 1X2 seleccionado","error");return}n.disabled=!0,n.textContent="…";try{const{prediction:E}=await u.predictions.save({match_id:s,predicted_result:_,predicted_home:h,predicted_away:l,league_id:t??null});a[s]=E,m("Predicción guardada"),g()}catch(E){m(E.message||"Error al guardar","error"),n.disabled=!1,o?(n.className="btn btn--saved btn--sm pred-save-btn",n.textContent="✓ Guardado"):(n.className="btn btn--primary btn--sm pred-save-btn",n.textContent="Guardar")}})}function Ke(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ye(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if($.isLoggedIn()){const{leagues:_}=await u.leagues.my();if(_.length===0){e.innerHTML=ve();return}}const s=Ke(),[{ranking:n},i]=await Promise.all([u.auth.ranking(s),$.isLoggedIn()?u.leagues.my():Promise.resolve({leagues:[]})]),o=$.getUser(),d=i.leagues.find(_=>_.id===s),g=document.getElementById("tablonBadge"),p=g&&!g.classList.contains("hidden"),h=p?g.textContent:"",l=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        ...
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(_=>{var L,r,c;const b=_.predictions_made??0,f=`${b}/${l}`,E=`${_.correct_results??0}/${b}`,y=`${_.exact_scores??0}/${b}`;return`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function b(r){const c=M(r);if(!i.length)return c;const I=i.map(j=>Qe(j.username)),x=new RegExp(`@(${I.join("|")})`,"gi");return c.replace(x,'<span class="mention">@$1</span>')}function f(){const r=document.getElementById("boardForm");if(!r)return;const c=document.getElementById("boardMsg"),I=document.getElementById("charCounter"),x=document.getElementById("mentionDropdown");c.addEventListener("input",()=>{I.textContent=`${c.value.length} / 500`,L(c,x)}),r.addEventListener("submit",async j=>{j.preventDefault();const D=c.value.trim();if(D)try{await u.board.post(D,s),c.value="",I.textContent="0 / 500",x.classList.add("hidden");const T=await g();w(T),m("Mensaje publicado")}catch(T){m(T.message,"error")}})}function E(){e.querySelectorAll(".reply-form").forEach(r=>{const c=parseInt(r.dataset.parent),I=r.querySelector(".reply-input"),x=`mentionDropdown-${c}`,j=document.getElementById(x);I==null||I.addEventListener("input",()=>{L(I,j)}),r.addEventListener("submit",async D=>{D.preventDefault();const T=I.value.trim();if(T)try{await u.board.reply(c,T),I.value="",j==null||j.classList.add("hidden");const G=await g();w(G),m("Respuesta enviada")}catch(G){m(G.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await u.board.pin(r.dataset.id);const c=await g();w(c),m("Mensaje fijado")}catch(c){m(c.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await u.board.pin(r.dataset.id);const c=await g();w(c),m("Mensaje desfijado")}catch(c){m(c.message,"error")}})})}function y(){e.querySelectorAll(".delete-msg").forEach(r=>{r.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await u.board.delete(r.dataset.id);const c=await g();w(c),m("Mensaje eliminado")}catch(c){m(c.message,"error")}})})}function w(r){const{pinned:c=[],messages:I=[]}=r,x=document.getElementById("boardPinned");if(x)x.innerHTML=h(c);else if(c.length){p(r);return}const j=document.getElementById("boardMessages");j&&(j.innerHTML=_(I)),E(),y()}e.addEventListener("click",async r=>{if(r.target.id==="prevPage"&&o>1){o--;const c=await g();w(c)}else if(r.target.id==="nextPage"&&o<d){o++;const c=await g();w(c)}});function L(r,c){if(!c||!i.length)return;const I=r.value,x=r.selectionStart,j=I.slice(0,x),D=j.match(/@(\w*)$/);if(!D){c.classList.add("hidden");return}const T=D[1].toLowerCase(),G=i.filter(C=>C.username.toLowerCase().startsWith(T)&&C.id!==(t==null?void 0:t.id)),te=[...$.isAdmin()&&"todos".startsWith(T)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...G.slice(0,6)];if(!te.length){c.classList.add("hidden");return}c.innerHTML=te.map(C=>C.description?`<div class="mention-item mention-item--broadcast" data-username="${M(C.username)}">
             <span class="mention-item__name">@${M(C.username)}</span>
             <span class="mention-item__desc">${M(C.description)}</span>
           </div>`:`<div class="mention-item" data-username="${M(C.username)}">${M(C.username)}</div>`).join(""),c.classList.remove("hidden"),c.querySelectorAll(".mention-item").forEach(C=>{C.addEventListener("mousedown",Ce=>{Ce.preventDefault();const Be=C.dataset.username,X=j.replace(/@(\w*)$/,`@${Be} `);if(r.value=X+I.slice(x),r.setSelectionRange(X.length,X.length),c.classList.add("hidden"),r.tagName==="TEXTAREA"){const se=document.getElementById("charCounter");se&&(se.textContent=`${r.value.length} / 500`)}})})}document.addEventListener("click",r=>{!r.target.closest(".board-form__input-wrap")&&!r.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(c=>c.classList.add("hidden"))},{capture:!0})}function M(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Qe(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Ze(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=$.getUser(),o=i==null?void 0:i.is_admin,[d,g]=await Promise.all([o?u.leagues.adminAll():u.leagues.all(),$.isLoggedIn()&&!o?u.leagues.my():Promise.resolve({leagues:[]})]),p=new Set(g.leagues.map(l=>l.id)),h=o?d.leagues:d.leagues.filter(l=>!p.has(l.id));e.innerHTML=`
      <div class="container">
  ...
  `}function ma(e){const a=e.status==="finished",t=a&&e.home_score_90!=null?e.home_score_90:"",s=a&&e.away_score_90!=null?e.away_score_90:"",n=a&&e.result_90?e.result_90:"",i=a?'<span class="admin-match-badge admin-match-badge--done">Terminado</span>':'<span class="admin-match-badge admin-match-badge--pending">Pendiente</span>',o=Le(e.match_datetime);return`
  ...
  `}const _a={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League"};let k=[],z=null;async function ee(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await u.adminV2.jornadas();a.innerHTML=va(t),ba(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function va(e){const a=new Date;a.getFullYear(),String(Ie(a)).padStart(2,"0");const t=wa(a);return`
    <div class="jv2-panel">
  ...
  `).join(""),(i=a.querySelector(".phase-nav__btn--active"))==null||i.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),a.querySelectorAll(".phase-nav__btn").forEach(o=>{o.addEventListener("click",()=>{a.querySelectorAll(".phase-nav__btn").forEach(g=>g.classList.remove("phase-nav__btn--active")),o.classList.add("phase-nav__btn--active");const d=n.find(g=>g.key===o.dataset.key);d&&(B=d,V(d.data,d.isGroup))})}),B=n[0],V(n[0].data,n[0].isGroup))}function V(e,a){const t=document.getElementById("phaseContent");if(!t)return;const s=xa(e.matches);if(a){const n=Ca(e.matches);t.innerHTML=`
    ...
    `}).join("")}function Ca(e){const a={};for(const t of e)if(a[t.home_team]||(a[t.home_team]={name:t.home_team,pj:0,g:0,e:0,p:0,gf:0,gc:0,pts:0}),a[t.away_team]||(a[t.away_team]={name:t.away_team,pj:0,g:0,e:0,p:0,gf:0,gc:0,pts:0}),t.status==="finished"&&t.home_score_90!==null&&t.away_score_90!==null){const s=a[t.home_team],n=a[t.away_team];s.pj++,n.pj++,s.gf+=t.home_score_90,s.gc+=t.away_score_90,n.gf+=t.away_score_90,n.gc+=t.home_score_90,t.home_score_90>t.away_score_90?(s.g++,s.pts+=3,n.p++):t.home_score_90<t.away_score_90?(n.g++,n.pts+=3,s.p++):(s.e++,s.pts++,n.e++,n.pts++)}return Object.values(a).sort((t,s)=>{if(s.pts!==t.pts)return s.pts-t.pts;const n=s.gf-s.gc,i=t.gf-t.gc;return n!==i?n-i:s.gf-t.gf})}function Ba(e){return e.length===0?'<p class="empty">Sin datos de clasificación.</p>':`
  ...
  `}function ue(){U=Object.values(q).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),je()}function Na(e,a){var t;a||(e.querySelectorAll(".jornada-match").forEach(s=>{const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(o=>{o.addEventListener("change",()=>{q[n].predicted_result=o.value,ue()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let o=parseInt(i.value);isNaN(o)&&(o=0),o=Math.max(0,Math.min(Se,o)),q[n].units=o,ue()})}),(t=document.getElementById("jornadaSaveBtn"))==null||t.addEventListener("click",Oa))}async function Oa(){const e=document.getElementById("jornadaSaveBtn"),a=Object.entries(q).filter(([,t])=>t.predicted_result).map(([t,s])=>({jornada_match_id:parseInt(t),predicted_result:s.predicted_result,units:s.units}));if(a.length===0){m("Selecciona al menos un resultado 1X2","error");return}if(U>J){m(`Superas el máximo de ${J} unidades`,"error");return}e.disabled=!0,e.textContent="…";try{await u.jornada.predict(a),m("Predicciones guardadas"),e.textContent="✓ Guardadas"}catch(t){m(t.message||"Error al guardar","error")}finally{e.disabled=!1,setTimeout(()=>{e&&(e.textContent="Guardar predicciones")},2e3)}}const me={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function Ra(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:a}=await u.duelo.current(),t=$.getUser();if(!a){e.innerHTML=`
    ...
    `,Ua(a.division_league_id,t.id)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${a.message}</p></div>`}}async function Ua(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await u.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function Ga(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:a}=await u.clasificacion.general(),t=$.getUser();e.innerHTML=`
      <div class="container">
    ...
    `}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${a.message}</p></div>`}}const Fa={"/":Me,"/login":Oe,"/register":Re,"/quiniela":Ge,"/resultados":ja,"/ranking":Ye,"/tablon":Ee,"/ligas":Ze,"/ligas/:id":aa,"/perfil":sa,"/campeon":we,"/admin":la,"/forgot-password":La,"/reset-password":Ia,"/unirse":Pa,"/jugador/:id":Ma,"/jornada":Da,"/duelo":Ra,"/tabla-v2":Ga};function Ja(e){for(const[a,t]of Object.entries(Fa)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,d)=>(s.push(d),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((d,g)=>{o[d]=i[g+1]}),{handler:t,params:o}}}return null}const pe=()=>document.getElementById("mainContent"),S={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=Ja(a);if(!n){pe().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/campeon","/admin","/jornada","/duelo","/tabla-v2"].includes(a)&&!$.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!$.isAdmin()){this.navigate("/");return}const g=pe();g.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(g,{params:o,query:s})}};let F=[],R=null,A=null;async function za(){await $.init(),S.init(),Wa(),Va(),Qa()}function ke(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Va(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!ke()&&(R=e,Xa())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),R=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function Xa(){if(ke()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
