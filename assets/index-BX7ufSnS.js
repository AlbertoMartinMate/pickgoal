(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Te="https://pickgoal-backend.onrender.com/api";function Pe(){return localStorage.getItem("token")}async function u(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Pe();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Te}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const c={get:e=>u(e),post:(e,a)=>u(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>u(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>u(e,{method:"DELETE"}),auth:{register:e=>u("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>u("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>u("/auth/me"),forgotPassword:e=>u("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>u("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>u(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>u("/auth/account",{method:"DELETE"}),users:()=>u("/auth/users"),usersForMentions:()=>u("/auth/users/for-mentions"),toggleAdmin:e=>u(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>u(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>u("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>u("/matches/grouped"),list:(e="")=>u(`/matches/${e}`),get:e=>u(`/matches/${e}`),today:()=>u("/matches/today"),setResult:(e,a,t,s=null)=>u(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>u("/matches/sync",{method:"POST"}),recalculate:()=>u("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>u(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>u(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>u("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>u(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>u(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>u("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>u("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>u("/leagues/all"),public:()=>u("/leagues/public"),my:()=>u("/leagues/my"),create:e=>u("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>u("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>u(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>u("/leagues/admin"),get:e=>u(`/leagues/${e}`),update:(e,a)=>u(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>u(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>u(`/leagues/${e}/members`),matchPredictions:(e,a)=>u(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>u("/home/summary")},board:{messages:(e=1,a=null)=>u(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>u(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>u("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>u(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>u(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>u(`/board/${e}`,{method:"DELETE"}),mentions:e=>u(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>u("/notifications/vapid-public-key"),subscribe:e=>u("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>u("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>u(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>u("/v2/admin/jornadas"),createJornada:e=>u("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>u(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>u(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>u(`/v2/admin/jornada/${e}/publish`,{method:"POST"})},jornada:{info:()=>u("/v2/jornada/info"),current:()=>u("/v2/jornada/current"),list:()=>u("/v2/jornada/list"),predict:e=>u("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>u("/v2/jornada/history")},duelo:{current:()=>u("/v2/duelo/current")},messages:{unread:()=>u("/messages/unread"),list:()=>u("/messages/"),get:e=>u(`/messages/${e}`),send:(e,a)=>u(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>u("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>u(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>u("/v2/clasificacion/general"),allDivisions:()=>u("/v2/clasificacion/all-divisions")}};let D=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await c.auth.me();D=a}catch{localStorage.removeItem("token")}},setUser(e,a){D=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){D=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return D},isLoggedIn(){return!!D},isAdmin(){return(D==null?void 0:D.is_admin)===!0}};let K=null;function g(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,K&&clearTimeout(K),K=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function Me(){return`
  ...
  `}function re(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",d=>{d.key==="Escape"&&o()},{once:!1}),i}function M(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function De(e){if(!y.getUser()){He(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await c.home.summary();if(s){e.innerHTML=`
        ...
        ${de()}
      `,re(e);return}if(!t||t.length===0){Ae(e);return}const i=(()=>{const d=localStorage.getItem("activeLeagueId");return d?parseInt(d):null})(),o=[...t].sort((d,m)=>d.league_id===i?-1:m.league_id===i?1:0);e.innerHTML=`
      <div class="home-dashboard container">
        <div class="home-dashboard__topbar">
          <button class="btn btn--ghost btn--sm" id="btnPointsInfo">📊 Sistema de puntos</button>
        </div>
      ...
      ${de()}
    `,re(e),e.querySelectorAll(".league-card[data-league-id]").forEach(d=>{d.style.cursor="pointer",d.addEventListener("click",m=>{m.target.closest("[data-go-ranking]")||m.target.closest("a")||(localStorage.setItem("activeLeagueId",d.dataset.leagueId),j.navigate(`/ligas/${d.dataset.leagueId}`))})}),e.querySelectorAll("[data-go-ranking]").forEach(d=>{d.addEventListener("click",m=>{m.stopPropagation(),localStorage.setItem("activeLeagueId",d.dataset.goRanking),j.navigate("/ranking")})})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el inicio: ${t.message}</p></div>`}}async function He(e){const t=new Date>=new Date("2026-08-15T00:00:00Z");let s=null;if(t)try{s=await c.jornada.info()}catch{}e.innerHTML=`
    <section class="hero">
  ...
  `}function Ne(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function $e(e=null,a=!1){let t,s;if(a&&(e!=null&&e.jornada_number))s="Temporada 26/27 · En curso",t=`
      ...
      </div>`;else if(a)s="Temporada 26/27 · En curso",t='<div class="pg-league-card__countdown pg-league-card__countdown--soon">Temporada en curso</div>';else{const n=Ne("2026-08-15");s="Temporada 26/27 · Próximamente",t=n>0?`<div class="pg-league-card__countdown">
  ...
  `}function Oe(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `}const ce="pickgoal_welcome_shown";function Ee(e="/jornada"){if(localStorage.getItem(ce))return;localStorage.setItem(ce,"1");const a=document.createElement("div");a.innerHTML=`
  ...
  `;const t=a.firstElementChild;document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("welcome-modal--open"));function s(n){t.classList.remove("welcome-modal--open"),document.body.style.overflow="",t.addEventListener("transitionend",()=>t.remove(),{once:!0}),n&&(window.location.hash=n)}document.getElementById("welcomeOverlay").addEventListener("click",()=>s()),document.getElementById("welcomeCta").addEventListener("click",()=>s(e)),document.addEventListener("keydown",function n(i){i.key==="Escape"&&(s(),document.removeEventListener("keydown",n))})}function Re(e){e.innerHTML=`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await c.auth.register(n);y.setUser(o,i),g("¡Cuenta creada! Bienvenido a PickGoal");const d=sessionStorage.getItem("pendingInviteCode");if(d){sessionStorage.removeItem("pendingInviteCode");try{const{league:m}=await c.leagues.joinByCode(d);g(`¡Te has unido a "${m.name}"!`),j.navigate(`/ligas/${m.id}`)}catch{j.navigate("/ligas")}}else j.navigate("/"),Ee("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function ze(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Fe(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:v}=await c.leagues.my();if(v.length===0){e.innerHTML=Me();return}}const s=ze(),[{ranking:n},i]=await Promise.all([c.auth.ranking(s),y.isLoggedIn()?c.leagues.my():Promise.resolve({leagues:[]})]),o=y.getUser(),d=i.leagues.find(v=>v.id===s),m=document.getElementById("tablonBadge"),_=m&&!m.classList.contains("hidden"),h=_?m.textContent:"",p=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
    ...
    `,(t=e.querySelector(".ranking-tablon-btn"))==null||t.addEventListener("click",()=>{j.navigate(`/tablon?liga=${s}`)})}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error: ${s.message}</p></div>`}}async function se(e,{query:a={},forceGeneral:t=!1}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const s=y.getUser();let n=t?null:a.liga?parseInt(a.liga):null;if(t)localStorage.setItem("tablon_general_last_read",new Date().toISOString()),document.dispatchEvent(new CustomEvent("tablon:read"));else if(n){localStorage.setItem(`tablon_last_read_${n}`,new Date().toISOString());const r=document.getElementById("tablonBadge");r&&(r.classList.add("hidden"),r.textContent="")}let i=null,o=[],d=1,m=1;if(t&&s)try{const{users:r}=await c.auth.usersForMentions();o=r||[],console.log("[tablon] usuarios cargados:",o.length)}catch(r){console.warn("[tablon] error cargando usuarios:",r)}if(!t)try{if(!n&&s){const{leagues:r}=await c.leagues.my();r&&r.length&&(n=r[0].id,i=r[0].name)}else if(n)try{const{league:r}=await c.leagues.get(n);i=r.name}catch{}if(n&&s)try{const{members:r}=await c.leagues.members(n);o=r||[]}catch{}}catch{}async function _(){const r=await c.board.messages(d,n);return m=r.pages||1,r}try{const r=await _();h(r)}catch(r){e.innerHTML=`<div class="container"><p class="form__error">Error: ${r.message}</p></div>`}function h(r){const{pinned:l=[],messages:w=[]}=r;e.innerHTML=`
      <div class="container">
        ...
        <section class="board-section">
          ...
          ${m>1?`<div class="pagination">
                 <button class="btn btn--ghost btn--sm" id="prevPage" ${d<=1?"disabled":""}>← Anterior</button>
                 <span>Página ${d} / ${m}</span>
                 <button class="btn btn--ghost btn--sm" id="nextPage" ${d>=m?"disabled":""}>Siguiente →</button>
               </div>`:""}
        </section>
      </div>
    `,L(),E(),S()}function p(r){return r.length?r.map(l=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function $(r){const l=P(r);if(!o.length)return l.replace(/@(\w+)/g,'<span class="mention">@$1</span>');const w=o.map(k=>Ge(k.username)),C=new RegExp(`@(${w.join("|")})`,"gi");return l.replace(C,'<span class="mention">@$1</span>')}function L(){const r=document.getElementById("boardForm");if(!r)return;const l=document.getElementById("boardMsg"),w=document.getElementById("charCounter"),C=document.getElementById("mentionDropdown");l.addEventListener("input",()=>{w.textContent=`${l.value.length} / 500`,f(l,C)}),r.addEventListener("submit",async k=>{k.preventDefault();const H=l.value.trim();if(H)try{await c.board.post(H,n),l.value="",w.textContent="0 / 500",C.classList.add("hidden");const T=await _();I(T),g("Mensaje publicado")}catch(T){g(T.message,"error")}})}function E(){e.querySelectorAll(".reply-form").forEach(r=>{const l=parseInt(r.dataset.parent),w=r.querySelector(".reply-input"),C=`mentionDropdown-${l}`,k=document.getElementById(C);w==null||w.addEventListener("input",()=>{f(w,k)}),r.addEventListener("submit",async H=>{H.preventDefault();const T=w.value.trim();if(T)try{await c.board.reply(l,T),w.value="",k==null||k.classList.add("hidden");const O=await _();I(O),g("Respuesta enviada")}catch(O){g(O.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await c.board.pin(r.dataset.id);const l=await _();I(l),g("Mensaje fijado")}catch(l){g(l.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await c.board.pin(r.dataset.id);const l=await _();I(l),g("Mensaje desfijado")}catch(l){g(l.message,"error")}})})}function S(){e.querySelectorAll(".delete-msg").forEach(r=>{r.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await c.board.delete(r.dataset.id);const l=await _();I(l),g("Mensaje eliminado")}catch(l){g(l.message,"error")}})})}function I(r){const{pinned:l=[],messages:w=[]}=r,C=document.getElementById("boardPinned");if(C)C.innerHTML=p(l);else if(l.length){h(r);return}const k=document.getElementById("boardMessages");k&&(k.innerHTML=b(w)),E(),S()}e.addEventListener("click",async r=>{if(r.target.id==="prevPage"&&d>1){d--;const l=await _();I(l)}else if(r.target.id==="nextPage"&&d<m){d++;const l=await _();I(l)}});function f(r,l){if(!l||!o.length){console.log("[tablon] handleMentionInput: sin dropdown o members vacío",{dropdown:!!l,membersLen:o.length});return}const w=r.value,C=r.selectionStart,k=w.slice(0,C),H=k.match(/@(\w*)$/);if(!H){l.classList.add("hidden");return}const T=H[1].toLowerCase();console.log("[tablon] mention detected, query:",T);const O=o.filter(x=>x.username.toLowerCase().startsWith(T)&&x.id!==(s==null?void 0:s.id));console.log("[tablon] matches:",O.map(x=>x.username));const ie=[...y.isAdmin()&&"todos".startsWith(T)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...O.slice(0,6)];if(!ie.length){l.classList.add("hidden");return}l.innerHTML=ie.map(x=>x.description?`<div class="mention-item mention-item--broadcast" data-username="${P(x.username)}">
             <span class="mention-item__name">@${P(x.username)}</span>
             <span class="mention-item__desc">${P(x.description)}</span>
           </div>`:`<div class="mention-item" data-username="${P(x.username)}">${P(x.username)}</div>`).join(""),l.classList.remove("hidden"),l.querySelectorAll(".mention-item").forEach(x=>{x.addEventListener("mousedown",Be=>{Be.preventDefault();const Ce=x.dataset.username,Z=k.replace(/@(\w*)$/,`@${Ce} `);if(r.value=Z+w.slice(C),r.setSelectionRange(Z.length,Z.length),l.classList.add("hidden"),r.tagName==="TEXTAREA"){const oe=document.getElementById("charCounter");oe&&(oe.textContent=`${r.value.length} / 500`)}})})}document.addEventListener("click",r=>{!r.target.closest(".board-form__input-wrap")&&!r.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(l=>l.classList.add("hidden"))},{capture:!0})}function P(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ge(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Ve(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=y.getUser(),o=i==null?void 0:i.is_admin,[d,m]=await Promise.all([o?c.leagues.adminAll():c.leagues.all(),y.isLoggedIn()&&!o?c.leagues.my():Promise.resolve({leagues:[]})]),_=new Set(m.leagues.map(p=>p.id)),h=o?d.leagues:d.leagues.filter(p=>!_.has(p.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&m.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${m.leagues.map(p=>ue(p,!0)).join("")}</div>
          </section>
        `:""}
  ...
  `}function We(e){var s,n;const a=e.invite_link||"",t=document.getElementById("createLeaguePanel");t&&(t.innerHTML=`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),g("Enlace copiado")}catch{g("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function Xe(e,{params:a}){var s,n,i,o,d;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const m=await c.leagues.get(t),{league:_,ranking:h,is_member:p,is_admin_view:v}=m,b=y.getUser(),$=_.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
    ...
    `,(s=document.getElementById("btnCopyInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(_.invite_link),g("Enlace copiado")}catch{g("No se pudo copiar","error")}}),(n=document.getElementById("btnShareInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${_.name} en PickGoal`,url:_.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await c.leagues.leave(t),g("Has abandonado la liga"),j.navigate("/ligas")}catch(f){g(f.message,"error")}}),(o=document.getElementById("btnJoin"))==null||o.addEventListener("click",async()=>{try{await c.leagues.join({league_id:t}),g("¡Te has unido a la liga!"),j.navigate(`/ligas/${t}`)}catch(f){g(f.message,"error")}}),(d=document.getElementById("btnEditLeague"))==null||d.addEventListener("click",()=>{Ye(_,t,b)});const L=document.getElementById("tabRanking"),E=document.getElementById("tabTablon"),S=document.getElementById("sectionRanking"),I=document.getElementById("sectionTablon");L&&E&&(L.addEventListener("click",()=>{L.classList.add("league-tab--active"),E.classList.remove("league-tab--active"),S.classList.remove("hidden"),I.classList.add("hidden")}),E.addEventListener("click",()=>{E.classList.add("league-tab--active"),L.classList.remove("league-tab--active"),S.classList.add("hidden"),I.classList.remove("hidden");const f=document.getElementById("tablonEmbed");f&&!f.dataset.loaded&&(f.dataset.loaded="1",se(f,{query:{liga:String(t)}}))}))}catch(m){e.innerHTML=`<div class="container"><p class="form__error">Error: ${m.message}</p><a href="#/ligas">Volver</a></div>`}}function Ye(e,a,t){const s=document.getElementById("editLeagueModal");s&&s.remove();const n=document.createElement("div");n.id="editLeagueModal",n.className="edit-league-modal",n.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("btnSaveEdit");d.disabled=!0,d.textContent="Guardando…";const m={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(m.is_official=document.getElementById("editOfficial").checked);try{await c.leagues.update(a,m),g("Liga actualizada"),i(),j.navigate(`/ligas/${a}`)}catch(_){g(_.message,"error"),d.disabled=!1,d.textContent="Guardar cambios"}})}async function Ze(e){var t,s,n,i,o,d;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=y.getUser();try{const[m,_,h,p]=await Promise.all([c.predictions.mine(null),c.clasificacion.division(),c.auth.me(),a!=null&&a.is_admin?c.leagues.adminAll():Promise.resolve({leagues:[]})]),v=h.user,b=v.status,$=v.total_points_all_time,L=(t=_.standings)==null?void 0:t.find(E=>E.user_id===v.id);e.innerHTML=`
      <div class="container">
        ...
        <section class="profile-card section">
          ...
          <div class="profile-card__stats">
            <div class="stat">
              <span class="stat__value">${m.predictions.length}</span>
        ...
        ${m.predictions.length>0?`
          <section class="section">
            ...
            <div class="predictions-list">${m.predictions.map(ea).join("")}</div>
          </section>
        `:""}
    ...
    `).join("")}catch{a.innerHTML='<p class="empty">Sin conversaciones aún.</p>'}}function Qe(e,a){if(e.next_threshold===null)return`
  ...
  `}function aa(){const e=document.createElement("div");e.className="delete-modal",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.body.style.overflow="hidden",requestAnimationFrame(()=>e.classList.add("delete-modal--open"));const a=e.querySelector("#deleteConfirmInput"),t=e.querySelector("#deleteConfirmBtn"),s=e.querySelector("#deleteCancelBtn"),n=e.querySelector("#deleteOverlay"),i=e.querySelector("#deleteError");function o(){e.classList.remove("delete-modal--open"),document.body.style.overflow="",e.addEventListener("transitionend",()=>e.remove(),{once:!0})}a.addEventListener("input",()=>{t.disabled=a.value.trim()!=="CERRAR"}),s.addEventListener("click",o),n.addEventListener("click",o),t.addEventListener("click",async()=>{t.disabled=!0,t.textContent="Cerrando…",i.classList.add("hidden");try{await c.auth.deleteAccount(),o(),y.logout(),g("Cuenta cerrada. Hasta pronto."),window.location.hash="/"}catch(d){i.textContent=d.message||"Error al cerrar la cuenta",i.classList.remove("hidden"),t.disabled=!1,t.textContent="Cerrar mi cuenta"}})}function ta(){window.location.hash="/"}async function sa(e){if(!y.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await c.auth.users();e.innerHTML=`
    ...
    `,na(e),X(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function na(e){var s,n,i,o;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const d=document.getElementById("syncResult");d.textContent="Sincronizando…";try{await c.matches.sync(),d.textContent="✓ Sincronización completada",g("Sincronización completada")}catch(m){d.textContent=`Error: ${m.message}`,g(m.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async d=>{d.preventDefault();const m=document.getElementById("pushTitle").value.trim()||"Aviso",_=document.getElementById("pushBody").value.trim(),h=a.value,p=parseInt(document.getElementById("pushTargetId").value)||null,v=document.getElementById("pushResult"),b={title:`📣 PickGoal — ${m}`,body:_};h==="league"&&p&&(b.league_id=p),h==="user"&&p&&(b.user_id=p),v.textContent="Enviando…";try{const{sent:$}=await c.notifications.send(b);v.textContent=`✓ Enviada a ${$} suscripción(es)`,g(`Notificación enviada a ${$} suscripción(es)`)}catch($){v.textContent=`Error: ${$.message}`,g($.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const d=document.getElementById("btnCloseSeason"),m=document.getElementById("closeSeasonResult");d.disabled=!0,m.textContent="Cerrando…";try{const{message:_}=await c.post("/v2/admin/season/1/close");m.textContent=`✓ ${_||"Temporada cerrada"}`,g("Temporada cerrada")}catch(_){m.textContent=`Error: ${_.message}`,g(_.message,"error"),d.disabled=!1}}),(o=document.getElementById("usersTableBody"))==null||o.addEventListener("click",async d=>{const m=d.target.closest(".toggle-admin");if(m){const h=parseInt(m.dataset.id);try{const{user:p}=await c.auth.toggleAdmin(h);m.closest("tr").querySelector(".admin-badge").textContent=p.is_admin?"Sí":"No",g(`${p.username} ${p.is_admin?"ahora es admin":"ya no es admin"}`)}catch(p){g(p.message,"error")}return}const _=d.target.closest(".toggle-mute");if(_){const h=parseInt(_.dataset.id);try{const{user:p}=await c.auth.toggleMute(h),v=_.closest("tr");v.querySelector(".mute-badge").textContent=p.is_muted?"Sí":"No",_.textContent=p.is_muted?"Activar":"Silenciar",g(`${p.username} ${p.is_muted?"silenciado":"activado"}`)}catch(p){g(p.message,"error")}}})}function ia(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const oa={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let B=[],W=null;async function X(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await c.adminV2.jornadas();a.innerHTML=da(t),la(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function da(e){const t=_a(new Date);return`
    <div class="jv2-panel">
      ...
      <div class="jv2-list">
        ${e.length===0?'<p class="admin-section__desc">No hay jornadas creadas.</p>':e.map(ra).join("")}
      </div>
  ...
  `}function la(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{W=null,B=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",ne()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",B=[],W=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",ua),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",pa),e.querySelectorAll(".jv2-pub-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${i.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){i.disabled=!0,i.textContent="Publicando…";try{const o=await c.adminV2.publishJornada(i.dataset.id);g(`Jornada ${i.dataset.num} publicada — push enviado a ${o.push_sent} suscriptores`),await X(document.getElementById("jornadasV2Section"))}catch(o){g(o.message,"error"),i.disabled=!1,i.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>ca(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await c.adminV2.deleteJornada(i.dataset.id),g("Jornada eliminada"),X(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(o){g(o.message,"error")}})})}async function ca(e){const{jornadas:a}=await c.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(W=t.id,B=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",ne())}async function ua(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){g("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await c.adminV2.partidos(a);ma(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){g(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function ma(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        ...
        ${n.map(i=>`
          <label class="jv2-match-item">
            ...
            <span class="jv2-match-item__date">${ga(i.match_datetime)}</span>
          </label>
        `).join("")}
      </div>
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(B.length>=10){s.checked=!1,g("Máximo 10 partidos","error");return}B.push(n)}else B=B.filter(i=>i.api_id!==n.api_id);ne()})})}function ne(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=B.length),a&&(a.style.display=B.length>0&&B.length!==10?"inline":"none")}async function pa(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){g("Completa número y fechas","error");return}if(B.length!==10){g("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:B},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await c.adminV2.updateJornada(s,n),g(`Jornada ${e} actualizada`)):(await c.adminV2.createJornada(n),g(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",B=[],W=null,await X(document.getElementById("jornadasV2Section"))}catch(o){g(o.message,"error")}finally{i.disabled=!1}}function ga(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}function va(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function _a(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(va(a)).padStart(2,"0");return`${t}-W${s}`}function ba(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await c.auth.resetPassword(t,o),g("Contraseña actualizada. Ya puedes iniciar sesión."),j.navigate("/login")}catch(d){i.textContent=d.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function fa(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!y.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),j.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await c.leagues.joinByCode(t);g(`¡Te has unido a "${s.name}"!`),j.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){g("Ya eres miembro de esta liga");try{const{leagues:n}=await c.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){j.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
      <div class="container">
        <div class="league-gate">
    ...
    `}}function ya(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function $a(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=ya(),{user:n,predictions:i}=await c.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const J=20,Le=5;let N={},q=0,ae=null,me=null;async function La(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await c.jornada.list();if(!a.length){e.innerHTML=wa();return}we(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function we(e,a,t){var m,_;me=a[t];const{jornada:s,matches:n,units_used:i}=me;N={};for(const h of n)N[h.jornada_match_id]={predicted_result:((m=h.prediction)==null?void 0:m.predicted_result)??null,units:((_=h.prediction)==null?void 0:_.units_wagered)??0};q=i;const o=n.filter(h=>!h.predict_locked);ae=o.length===1?o[0].jornada_match_id:null;const d=a.length>1?`<div class="jornada-tabs">
        ${a.map((h,p)=>`
          <button class="jornada-tab ${p===t?"jornada-tab--active":""}" data-idx="${p}">
            J${h.jornada.number} · ${V(h.jornada.date_start)}–${V(h.jornada.date_end)}
          </button>
        `).join("")}
       </div>`:"";e.innerHTML=`
    <div class="container">
      <h1 class="page-title">Jornada ${s.number} — del ${V(s.date_start)} al ${V(s.date_end)}</h1>
      ${d}
      ${s.locked?'<p class="notice">⚠️ El plazo de predicción ha cerrado (ya empezó el primer partido).</p>':s.first_match_datetime?`<p class="notice notice--info">Abierto hasta ${Ia(s.first_match_datetime)}</p>`:""}
      <div class="units-counter" id="unitsCounter"></div>
      <div class="jornada-matches">
        ${n.map(ka).join("")}
      </div>
    </div>
  `,je(),Ie(),xa(e,a,t)}function wa(){return`
    <div class="container">
  ...
  `}function V(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function ja(e){return new Date(e).toLocaleTimeString("es-ES",{hour:"2-digit",minute:"2-digit"})}function Ia(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function ee(e){return e!=null?e.toFixed(2):"—"}function Sa(e){return e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${ja(e.opens_until)}</span>`}function ka(e){const a=e.predict_locked,t=N[e.jornada_match_id]??{predicted_result:null,units:0};return`
    <div class="match-card jornada-match ${a?"match-card--locked":""}" data-jm-id="${e.jornada_match_id}">
      ...
      <div class="jornada-odds">
        <span class="jornada-odds__item"><b>1</b> (${ee(e.odds_1)})</span>
        <span class="jornada-odds__item"><b>X</b> (${ee(e.odds_x)})</span>
        <span class="jornada-odds__item"><b>2</b> (${ee(e.odds_2)})</span>
      </div>
      <div class="jornada-match__controls ${a?"jornada-match__controls--disabled":""}">
        ...
        <div class="jornada-units">
          ...
          <input type="number" id="units-${e.jornada_match_id}" class="jornada-units__input" min="0" max="${Le}" value="${t.units}" ${a?"disabled":""} />
        </div>
      </div>
      ${a?"":`
  ...
  `}function je(){const e=document.getElementById("unitsCounter");if(!e)return;const a=q>J;e.innerHTML=`
    <div class="units-counter__bar">
      <div class="units-counter__fill ${a?"units-counter__fill--over":""}" style="width:${Math.min(100,q/J*100)}%"></div>
    </div>
    <span class="units-counter__label ${a?"units-counter__label--over":""}">${q}/${J} unidades usadas</span>
  `}function Ie(){if(!ae)return;const e=document.getElementById(`warning-${ae}`);if(!e)return;const a=J-q;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function pe(){q=Object.values(N).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),je(),Ie()}function xa(e,a,t){e.querySelectorAll(".jornada-tab").forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.idx);n!==t&&we(e,a,n)})}),e.querySelectorAll(".jornada-match").forEach(s=>{var o;const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(d=>{d.addEventListener("change",()=>{N[n].predicted_result=d.value,pe()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let d=parseInt(i.value);isNaN(d)&&(d=0),d=Math.max(0,Math.min(Le,d)),N[n].units=d,pe()}),(o=s.querySelector(".jornada-match__save-btn"))==null||o.addEventListener("click",()=>Ba(n))})}async function Ba(e){const a=N[e];if(!a.predicted_result){g("Selecciona un resultado 1X2","error");return}if(q>J){g(`Superas el máximo de ${J} unidades`,"error");return}const t=document.querySelector(`.jornada-match__save-btn[data-jm-id="${e}"]`);t&&(t.disabled=!0,t.textContent="…");try{await c.jornada.predict({jornada_match_id:e,predicted_result:a.predicted_result,units:a.units}),g("Predicción guardada"),t&&(t.textContent="✓ Guardada")}catch(s){g(s.message||"Error al guardar","error")}finally{t&&(t.disabled=!1,setTimeout(()=>{t&&(t.textContent="Guardar")},2e3))}}const ge={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function Ca(e){var a;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:t}=await c.duelo.current(),s=y.getUser();if(!t){e.innerHTML=`
        <div class="container">
      ...
      `;return}const n=ge[t.status]??ge.en_curso,i=t.rival?t.rival.username:s.username,o=!t.rival||t.rival.id===s.id;e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Tu duelo esta jornada</h1>
    ...
    `,Pa(t.division_league_id,s.id)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${t.message}</p></div>`}}function Ta(e,a){var i;const t=(i=e.my_prediction)==null?void 0:i.predicted_result;let s,n;return e.started?e.rival_prediction?(s=e.rival_prediction.predicted_result,n=""):(s="—",n="duelo-pick__value--empty"):(s="?",n="duelo-pick__value--hidden"),`
  ...
  `}async function Pa(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await c.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function Ma(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:a}=await c.clasificacion.general(),t=y.getUser();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Clasificación</h1>
                    ...
                    ${a.map(s=>{var n,i;return`
                      <tr class="${t&&s.user_id===t.id?"ranking-table__row--me":""}">
                        ...
                        <td>
                          ...
                          ${s.is_bot||t&&s.user_id===t.id?Y(s.username):`<button class="user-link" data-user-id="${s.user_id}">${Y(s.username)}</button>`}
                        </td>
    ...
    `,Ha(t),Da(),Oa(e,t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${a.message}</p></div>`}}async function Da(){const e=document.getElementById("tablonTabDot");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString();try{const{count:s}=await c.board.unread(null,t);console.log("[tablonDot] count:",s,"since:",t),e.classList.toggle("hidden",s===0)}catch(s){console.warn("[tablonDot] error:",s),e.classList.add("hidden")}}function Ha(e){const a={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")},tablon:{btn:document.getElementById("tabTablon"),panel:document.getElementById("panelTablon")}};function t(s){for(const[n,{btn:i,panel:o}]of Object.entries(a))i.classList.toggle("league-tab--active",n===s),o.classList.toggle("hidden",n!==s)}a.general.btn.addEventListener("click",()=>t("general")),a.miDivision.btn.addEventListener("click",()=>{t("miDivision"),a.miDivision.panel.dataset.loaded||(a.miDivision.panel.dataset.loaded="1",Aa(e))}),a.divisiones.btn.addEventListener("click",()=>{t("divisiones"),a.divisiones.panel.dataset.loaded||(a.divisiones.panel.dataset.loaded="1",qa(e))}),a.tablon.btn.addEventListener("click",()=>{var s;t("tablon"),localStorage.setItem("tablon_general_last_read",new Date().toISOString()),(s=document.getElementById("tablonTabDot"))==null||s.classList.add("hidden"),document.dispatchEvent(new CustomEvent("tablon:read")),a.tablon.panel.dataset.loaded||(a.tablon.panel.dataset.loaded="1",se(a.tablon.panel,{forceGeneral:!0}))})}async function Aa(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await c.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function qa(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await c.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>Na(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Na(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
      ...
      <div class="div-accordion__body">
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${e.standings.map(s=>Se(s,a)).join("")}
            </tbody>
          </table>
        </div>
      </div>
    </div>
  `}function Y(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Oa(e,a){let t=document.getElementById("userCtxMenu");t||(t=document.createElement("div"),t.id="userCtxMenu",t.className="user-ctx-menu hidden",t.innerHTML=`
    ...
    <tr class="${t?"ranking-table__row--me":""}" style="${s}">
      ...
      <td>${t||e.is_bot?Y(e.username):`<button class="user-link" data-user-id="${e.user_id}">${Y(e.username)}</button>`}</td>
  ...
  `}async function ve(e,{params:a={}}={}){const t=a.userId?parseInt(a.userId):null;t?await Ja(e,t):await Ua(e)}async function Ua(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{conversations:a}=await c.messages.list();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">💬 Mensajes</h1>
        ${a.length===0?'<p class="empty">No tienes conversaciones aún. Pulsa el nombre de un jugador en la clasificación para enviar un mensaje.</p>':`<div class="mensajes-list">${a.map(Ra).join("")}</div>`}
      </div>
    `,e.querySelectorAll(".mensajes-item").forEach(t=>{t.addEventListener("click",()=>{window.location.hash=`/mensajes/${t.dataset.userId}`})})}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function Ra(e){return`
    <div class="mensajes-item" data-user-id="${e.user_id}" style="cursor:pointer">
      <div class="mensajes-item__avatar">${F(e.username[0].toUpperCase())}</div>
      <div class="mensajes-item__info">
        <div class="mensajes-item__header">
          <strong class="mensajes-item__name">${F(e.username)}</strong>
          ${e.unread_count>0?`<span class="mensajes-item__badge">${e.unread_count}</span>`:""}
        </div>
        <p class="mensajes-item__preview">${F(e.last_message)}</p>
      </div>
    </div>
  `}async function Ja(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=y.getUser();try{const{messages:n,partner:i}=await c.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
      <div class="container">
        <div class="chat-header">
          <a href="#/mensajes" class="btn btn--ghost btn--sm">← Volver</a>
          <h2 class="chat-header__name">${F((i==null?void 0:i.username)||"Usuario")}</h2>
        </div>

        <div class="chat-messages" id="chatMessages">
          ${n.length===0?'<p class="empty" style="text-align:center">Empieza la conversación.</p>':n.map(d=>_e(d,t)).join("")}
        </div>
    ...
    `;const o=document.getElementById("chatMessages");o&&(o.scrollTop=o.scrollHeight),(s=document.getElementById("chatForm"))==null||s.addEventListener("submit",async d=>{d.preventDefault();const m=document.getElementById("chatMsg"),_=m.value.trim();if(!_)return;const h=d.target.querySelector('button[type="submit"]');h.disabled=!0;try{const{message:p}=await c.messages.send(a,_);m.value="";const v=document.getElementById("chatMessages"),b=v==null?void 0:v.querySelector(".empty");b&&b.remove(),v==null||v.insertAdjacentHTML("beforeend",_e(p,t)),v&&(v.scrollTop=v.scrollHeight)}catch(p){g(p.message,"error")}finally{h.disabled=!1}})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function _e(e,a){return`
    <div class="chat-message ${a&&e.sender_id===a.id?"chat-message--sent":"chat-message--received"}">
      <div class="chat-message__bubble">${F(e.message)}</div>
      <div class="chat-message__time">${M(e.created_at)}</div>
    </div>
  `}function F(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const be=e=>()=>{window.location.hash=e},za={"/":De,"/login":Re,"/register":Je,"/quiniela":be("/jornada"),"/resultados":be("/tabla-v2"),"/ranking":Fe,"/tablon":se,"/ligas":Ve,"/ligas/:id":Xe,"/perfil":Ze,"/campeon":ta,"/admin":sa,"/forgot-password":ba,"/reset-password":ha,"/unirse":fa,"/jugador/:id":$a,"/jornada":La,"/duelo":Ca,"/tabla-v2":Ma,"/mensajes":ve,"/mensajes/:userId":ve};function Fa(e){for(const[a,t]of Object.entries(za)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,d)=>(s.push(d),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((d,m)=>{o[d]=i[m+1]}),{handler:t,params:o}}}return null}const he=()=>document.getElementById("mainContent"),j={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=Fa(a);if(!n){he().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2","/mensajes"].includes(a)&&!y.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!y.isAdmin()){this.navigate("/");return}const m=he();m.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(m,{params:o,query:s})}};let z=[],R=null,U=null;async function Ga(){document.documentElement.dataset.build="2026-08-09T08",await y.init(),j.init(),Xa(),Va(),Ka()}function ke(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Va(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!ke()&&(R=e,Wa())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),R=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function Wa(){if(ke()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("installBtn").addEventListener("click",async()=>{R&&(R.prompt(),await R.userChoice,R=null,e.remove())}),document.getElementById("installDismissBtn").addEventListener("click",()=>{sessionStorage.setItem("installBannerDismissed","1"),e.remove()})}function A(){var e,a;(e=document.getElementById("userDropdown"))==null||e.classList.add("hidden"),(a=document.getElementById("userBtn"))==null||a.classList.remove("navbar__dropdown-btn--open")}async function G(){const e=document.getElementById("perfilBadge"),a=document.getElementById("navMensajesDot");if(!y.getUser()){e==null||e.classList.add("hidden"),a==null||a.classList.add("hidden");return}try{const s=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString(),[n,i]=await Promise.all([c.board.mentions(s).catch(m=>(console.warn("[perfilBadge] mentions error:",m),{count:0})),c.messages.unread().catch(m=>(console.warn("[perfilBadge] pm unread error:",m),{count:0}))]),o=n.count||0,d=i.count||0;console.log("[perfilBadge] mentions:",o,"pm:",d),e==null||e.classList.toggle("hidden",o+d===0),a==null||a.classList.toggle("hidden",d===0)}catch(s){console.warn("[perfilBadge] error:",s),e==null||e.classList.add("hidden"),a==null||a.classList.add("hidden")}}async function te(){const e=document.getElementById("tablonBadge");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("activeLeagueId");if(!t){e.classList.add("hidden");return}const s=localStorage.getItem(`tablon_last_read_${t}`)||new Date(0).toISOString();try{const{count:n}=await c.board.unread(parseInt(t),s);n>0?(e.textContent=n>99?"99+":String(n),e.classList.remove("hidden")):e.classList.add("hidden")}catch{e.classList.add("hidden")}}function Xa(){var e,a,t,s;document.addEventListener("auth:change",fe),window.addEventListener("hashchange",()=>{A(),xe(),setTimeout(te,200),setTimeout(G,200)}),document.addEventListener("tablon:read",()=>{G()}),document.addEventListener("messages:read",()=>{G()}),document.addEventListener("click",A),(e=document.getElementById("userBtn"))==null||e.addEventListener("click",n=>{var d;n.stopPropagation();const i=document.getElementById("userDropdown"),o=i==null?void 0:i.classList.contains("hidden");A(),o&&(i==null||i.classList.remove("hidden"),(d=document.getElementById("userBtn"))==null||d.classList.add("navbar__dropdown-btn--open"))}),(a=document.getElementById("userDropdown"))==null||a.addEventListener("click",n=>{n.stopPropagation(),n.target.closest("#navProfileLink")&&A()}),(t=document.getElementById("navMensajesLink"))==null||t.addEventListener("click",async n=>{var i,o;n.preventDefault(),A(),(i=document.getElementById("navMensajesDot"))==null||i.classList.add("hidden"),(o=document.getElementById("perfilBadge"))==null||o.classList.add("hidden");try{await c.messages.markAllRead()}catch{}document.dispatchEvent(new CustomEvent("messages:read")),window.location.hash="/mensajes"}),(s=document.getElementById("navLogoutBtn"))==null||s.addEventListener("click",()=>{z=[],localStorage.removeItem("activeLeagueId"),A(),y.logout(),j.navigate("/")}),fe()}async function fe(){var i;const e=document.getElementById("navAuthLinks"),a=document.getElementById("userBtn"),t=document.getElementById("navUsername"),s=document.getElementById("bottomNav"),n=y.getUser();if(A(),n){e==null||e.classList.add("hidden"),t&&(t.textContent=n.username),a.style.visibility="visible",s==null||s.classList.remove("hidden"),document.body.classList.add("has-bottom-nav"),(i=document.getElementById("navAdminLink"))==null||i.classList.toggle("hidden",!n.is_admin);try{const{leagues:o}=n.is_admin?await c.leagues.adminAll():await c.leagues.my();z=o}catch{z=[]}Ya(z),te(),G(),U&&clearInterval(U),U=setInterval(()=>{te(),G()},5*60*1e3)}else e==null||e.classList.remove("hidden"),a.style.visibility="hidden",s==null||s.classList.add("hidden"),document.body.classList.remove("has-bottom-nav"),z=[],localStorage.removeItem("activeLeagueId"),U&&(clearInterval(U),U=null);xe()}function Ya(e){const a=localStorage.getItem("activeLeagueId");a&&e.some(s=>String(s.id)===String(a))||(e.length>0?localStorage.setItem("activeLeagueId",String(e[0].id)):localStorage.removeItem("activeLeagueId"))}function xe(){const e=window.location.hash.slice(1).split("?")[0]||"/";document.querySelectorAll(".bottom-nav__item").forEach(a=>{const t=a.dataset.route,s=t==="/"?e==="/":e===t||e.startsWith(t+"/");a.classList.toggle("bottom-nav__item--active",s)})}function Za(e){const a="=".repeat((4-e.length%4)%4),t=(e+a).replace(/-/g,"+").replace(/_/g,"/"),s=atob(t);return Uint8Array.from([...s].map(n=>n.charCodeAt(0)))}async function Ka(){if(!(!("serviceWorker"in navigator)||!("PushManager"in window)))try{const e=await navigator.serviceWorker.register("/sw.js");document.addEventListener("auth:change",async a=>{a.detail&&await ye(e)}),y.getUser()&&await ye(e)}catch{}}async function ye(e){try{if(await Notification.requestPermission()!=="granted")return;const t=await e.pushManager.getSubscription();if(t){await c.notifications.subscribe(t.toJSON());return}const{public_key:s}=await c.notifications.vapidPublicKey();if(!s)return;const n=await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Za(s)});await c.notifications.subscribe(n.toJSON())}catch{}}Ga();
