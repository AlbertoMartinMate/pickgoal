(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Ce="https://pickgoal-backend.onrender.com/api";function Be(){return localStorage.getItem("token")}async function g(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Be();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Ce}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const u={get:e=>g(e),post:(e,a)=>g(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>g(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>g(e,{method:"DELETE"}),auth:{register:e=>g("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>g("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>g("/auth/me"),forgotPassword:e=>g("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>g("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>g(`/auth/ranking${e?`?league_id=${e}`:""}`),users:()=>g("/auth/users"),toggleAdmin:e=>g(`/auth/users/${e}/toggle-admin`,{method:"PATCH"})},matches:{grouped:()=>g("/matches/grouped"),list:(e="")=>g(`/matches/${e}`),get:e=>g(`/matches/${e}`),today:()=>g("/matches/today"),setResult:(e,a,t,s=null)=>g(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>g("/matches/sync",{method:"POST"}),recalculate:()=>g("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>g(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>g(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>g("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>g(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>g(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>g("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>g("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>g("/leagues/all"),public:()=>g("/leagues/public"),my:()=>g("/leagues/my"),create:e=>g("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>g("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>g(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>g("/leagues/admin"),get:e=>g(`/leagues/${e}`),update:(e,a)=>g(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>g(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>g(`/leagues/${e}/members`),matchPredictions:(e,a)=>g(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>g("/home/summary")},board:{messages:(e=1,a=null)=>g(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>g(`/board/unread?league_id=${e}&since=${encodeURIComponent(a)}`),post:(e,a=null)=>g("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>g(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>g(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>g(`/board/${e}`,{method:"DELETE"})},notifications:{vapidPublicKey:()=>g("/notifications/vapid-public-key"),subscribe:e=>g("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>g("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>g(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>g("/v2/admin/jornadas"),createJornada:e=>g("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>g(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>g(`/v2/admin/jornada/${e}`,{method:"DELETE"})},jornada:{current:()=>g("/v2/jornada/current"),predict:e=>g("/v2/jornada/predict",{method:"POST",body:JSON.stringify({predictions:e})}),history:()=>g("/v2/jornada/history")},duelo:{current:()=>g("/v2/duelo/current")},clasificacion:{division:e=>g(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>g("/v2/clasificacion/general")}};let H=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await u.auth.me();H=a}catch{localStorage.removeItem("token")}},setUser(e,a){H=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){H=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return H},isLoggedIn(){return!!H},isAdmin(){return(H==null?void 0:H.is_admin)===!0}};let W=null;function m(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,W&&clearTimeout(W),W=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function ve(){return`
  ...
  `}function be(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",d=>{d.key==="Escape"&&o()},{once:!1}),i}function T(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function Te(e){if(!y.getUser()){Pe(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,upcoming_matches:s}=await u.home.summary();if(t.length===0){Me(e);return}const n=(()=>{const o=localStorage.getItem("activeLeagueId");return o?parseInt(o):null})(),i=[...t].sort((o,d)=>o.league_id===n?-1:d.league_id===n?1:0);e.innerHTML=`
  ...
  `,ye(e)}function He(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function fe(){const e=He("2026-08-15");return`
  ...
  `}function ye(e){var a;(a=e.querySelector("#btnWaitlist"))==null||a.addEventListener("click",()=>{m("¡Ya estás dentro! Te avisaremos cuando empiece la temporada 🎉")})}function De(e){const a=e.next_to_predict?`<div class="league-card__next">
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await u.auth.register(n);y.setUser(o,i),m("¡Cuenta creada! Bienvenido a PickGoal");const d=sessionStorage.getItem("pendingInviteCode");if(d){sessionStorage.removeItem("pendingInviteCode");try{const{league:c}=await u.leagues.joinByCode(d);m(`¡Te has unido a "${c.name}"!`),I.navigate(`/ligas/${c.id}`)}catch{I.navigate("/ligas")}}else I.navigate("/campeon"),$e("/ligas")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}const Oe=new Set(["r32","r16","quarters","semis","third","final"]);let Q=null;function ie(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ue(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{let s=null;if(y.isLoggedIn()){const{leagues:$}=await u.leagues.my();if($.length===0){e.innerHTML=ve();return}const w=ie(),S=$.find(r=>r.id===w);s=S?S.name:((a=$[0])==null?void 0:a.name)??null}const n=ie(),[{groups:i},o,d]=await Promise.all([u.matches.grouped(),y.isLoggedIn()?u.predictions.mine(n):Promise.resolve({predictions:[]}),y.isLoggedIn()?u.predictions.getChampion(n):Promise.resolve({champion_prediction:null})]),c={};for(const $ of o.predictions)c[$.match_id]=$;const _=i.flatMap($=>$.matches),b=new Map;for(const $ of _){const w=re($.match_datetime);b.has(w)||b.set(w,[]),b.get(w).push($)}const p=[...b.keys()].sort(),v=re(new Date().toISOString()),h=p.find($=>$>=v)??p[0],f=((t=d.champion_prediction)==null?void 0:t.team_name)??null,L=y.isLoggedIn()?f?`<p class="champion-banner champion-banner--set">🏆 Tu campeón: <a href="#/campeon" style="color:inherit;font-weight:bold;">${f}</a></p>`:'<p class="champion-banner champion-banner--missing">⚠️ <a href="#/campeon">¡Elige tu campeón antes del inicio del torneo!</a></p>':"";e.innerHTML=`
      ...
      ${he()}
    `,Q=be(e),Ge(p,h,b,c,n)}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error cargando los partidos: ${s.message}</p></div>`}}function Ge(e,a,t,s,n){var o;const i=document.getElementById("dateNav");i&&(i.innerHTML=e.map(d=>`
    <button class="date-nav__btn ${d===a?"date-nav__btn--active":""}" data-day="${d}">
      ${Re(d)}
    </button>
  `).join(""),(o=i.querySelector(".date-nav__btn--active"))==null||o.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),i.querySelectorAll(".date-nav__btn").forEach(d=>{d.addEventListener("click",()=>{i.querySelectorAll(".date-nav__btn").forEach(c=>c.classList.remove("date-nav__btn--active")),d.classList.add("date-nav__btn--active"),oe(t.get(d.dataset.day)??[],s,n)})}),oe(t.get(a)??[],s,n))}function oe(e,a,t){const s=document.getElementById("matchesContent");if(s){if(e.length===0){s.innerHTML='<p class="empty">Sin partidos este día.</p>';return}s.innerHTML=`<div class="matches-grid">${e.map(n=>Fe(n,a[n.id])).join("")}</div>`,Q&&s.querySelectorAll(".knockout-info-btn").forEach(n=>{n.addEventListener("click",i=>{i.stopPropagation(),Q()})}),y.isLoggedIn()&&s.querySelectorAll(".prediction-form").forEach(n=>{Ve(n,a,t)})}}function re(e){const a=new Date(e);return`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`}function Re(e){const[a,t,s]=e.split("-").map(Number);return new Date(a,t-1,s).toLocaleDateString("es-ES",{day:"numeric",month:"short"})}function Fe(e,a){const t=e.is_locked,s=a?`<span class="pts-badge">${a.total_points} pts</span>`:"",n={scheduled:"Programado",live:"🔴 En juego",finished:"Finalizado"}[e.status];return`
    <div class="match-card ${t?"match-card--locked":""}" data-match-id="${e.id}">
      ...
      ${!t&&y.isLoggedIn()?Je(e,a):t&&a?`<div class="prediction-result">
               Tu predicción: <strong>${a.predicted_home}-${a.predicted_away}</strong>
               (${a.predicted_result}) · ${a.total_points} pts
             </div>`:""}
    </div>
  `}function Je(e,a){const t=!!a,s=(a==null?void 0:a.predicted_home)??0,n=(a==null?void 0:a.predicted_away)??0,i=(a==null?void 0:a.predicted_result)??"X",o=t?"prediction-form--saved":"prediction-form--unsaved",d=t?'<span class="pred-status pred-status--saved">✓ Guardado</span>':'<span class="pred-status pred-status--unsaved">Sin predicción</span>',c=t?"btn btn--saved btn--sm pred-save-btn":"btn btn--ghost btn--sm pred-save-btn",_=t?"✓ Guardado":"Guardar",b=Oe.has(e.phase);return`
    <form class="prediction-form ${o}" data-match-id="${e.id}" data-saved="${t}" data-is-knockout="${b?"1":"0"}">
      ${d}
      <div class="result-selector">
        ${["1","X","2"].map(p=>`
          <label class="result-selector__option">
            <input type="radio" name="predicted_result" value="${p}" ${i===p?"checked":""} required />
            ${p}
          </label>
        `).join("")}
      </div>
      ${b?'<span class="pred-hint">(90 min)</span>':""}
      ...
      <button type="submit" class="${c}">${_}</button>
    </form>
  `}function ze(e,a,t,s){return e==="1"?a>t:e==="2"?t>a:e==="X"?s?a!==t:a===t:!0}function Ve(e,a,t){const s=parseInt(e.dataset.matchId),n=e.querySelector(".pred-save-btn"),i=e.querySelector(".pred-status");let o=e.dataset.saved==="true";function d(){e.classList.contains("prediction-form--dirty")||(e.classList.remove("prediction-form--saved","prediction-form--unsaved"),e.classList.add("prediction-form--dirty"),n.className="btn btn--primary btn--sm pred-save-btn",n.textContent="Guardar",i&&(i.className="pred-status pred-status--unsaved",i.textContent="Sin guardar"))}function c(){o=!0,e.classList.remove("prediction-form--unsaved","prediction-form--dirty"),e.classList.add("prediction-form--saved"),n.className="btn btn--saved btn--sm pred-save-btn",n.textContent="✓ Guardado",n.disabled=!1,i&&(i.className="pred-status pred-status--saved",i.textContent="✓ Guardado")}e.querySelectorAll("input").forEach(_=>{_.addEventListener("change",d),_.addEventListener("input",d)}),e.addEventListener("submit",async _=>{var f;_.preventDefault();const b=parseInt(e.querySelector("[name=predicted_home]").value),p=parseInt(e.querySelector("[name=predicted_away]").value),v=(f=e.querySelector("[name=predicted_result]:checked"))==null?void 0:f.value;if(isNaN(b)||isNaN(p)||!v)return;const h=e.dataset.isKnockout==="1";if(!ze(v,b,p,h)){m("El marcador no coincide con el resultado 1X2 seleccionado","error");return}n.disabled=!0,n.textContent="…";try{const{prediction:L}=await u.predictions.save({match_id:s,predicted_result:v,predicted_home:b,predicted_away:p,league_id:t??null});a[s]=L,m("Predicción guardada"),c()}catch(L){m(L.message||"Error al guardar","error"),n.disabled=!1,o?(n.className="btn btn--saved btn--sm pred-save-btn",n.textContent="✓ Guardado"):(n.className="btn btn--primary btn--sm pred-save-btn",n.textContent="Guardar")}})}function Xe(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function We(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:v}=await u.leagues.my();if(v.length===0){e.innerHTML=ve();return}}const s=Xe(),[{ranking:n},i]=await Promise.all([u.auth.ranking(s),y.isLoggedIn()?u.leagues.my():Promise.resolve({leagues:[]})]),o=y.getUser(),d=i.leagues.find(v=>v.id===s),c=document.getElementById("tablonBadge"),_=c&&!c.classList.contains("hidden"),b=_?c.textContent:"",p=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        <div class="ranking-header">
          ...
          ${s?`
            <button class="ranking-tablon-btn" data-league-id="${s}">
              💬 Tablón
              <span class="ranking-tablon-btn__badge${_?"":" hidden"}">${b}</span>
            </button>
          `:""}
        </div>
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(v=>{var S,r,l;const h=v.predictions_made??0,f=`${h}/${p}`,L=`${v.correct_results??0}/${h}`,$=`${v.exact_scores??0}/${h}`;return`
                  <tr class="${o&&v.id===o.id?"ranking-table__row--me":""}">
                    ...
                    <td class="ranking-table__stat ranking-table__status">${((l=v.status)==null?void 0:l.name)||"—"}</td>
    ...
    `,(t=e.querySelector(".ranking-tablon-btn"))==null||t.addEventListener("click",()=>{I.navigate(`/tablon?liga=${s}`)})}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error: ${s.message}</p></div>`}}async function Ee(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=y.getUser();let s=a.liga?parseInt(a.liga):null;if(s){localStorage.setItem(`tablon_last_read_${s}`,new Date().toISOString());const r=document.getElementById("tablonBadge");r&&(r.classList.add("hidden"),r.textContent="")}let n=null,i=[],o=1,d=1;try{if(!s&&t){const{leagues:r}=await u.leagues.my();r&&r.length&&(s=r[0].id,n=r[0].name)}else if(s)try{const{league:r}=await u.leagues.get(s);n=r.name}catch{}if(s&&t)try{const{members:r}=await u.leagues.members(s);i=r||[]}catch{}}catch{}async function c(){const r=await u.board.messages(o,s);return d=r.pages||1,r}try{const r=await c();_(r)}catch(r){e.innerHTML=`<div class="container"><p class="form__error">Error: ${r.message}</p></div>`}function _(r){const{pinned:l=[],messages:E=[]}=r;e.innerHTML=`
      <div class="container">
    ...
    `,f(),L(),$()}function b(r){return r.length?r.map(l=>`
      <div class="board-message board-message--pinned" data-id="${l.id}">
        <div class="board-message__header">
          ...
          <strong class="board-message__author">${M(l.username)}</strong>
    ...
    `}function v(r){return r.length?r.map(l=>`
    ...
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function h(r){const l=M(r);if(!i.length)return l;const E=i.map(j=>Ke(j.username)),x=new RegExp(`@(${E.join("|")})`,"gi");return l.replace(x,'<span class="mention">@$1</span>')}function f(){const r=document.getElementById("boardForm");if(!r)return;const l=document.getElementById("boardMsg"),E=document.getElementById("charCounter"),x=document.getElementById("mentionDropdown");l.addEventListener("input",()=>{E.textContent=`${l.value.length} / 500`,S(l,x)}),r.addEventListener("submit",async j=>{j.preventDefault();const D=l.value.trim();if(D)try{await u.board.post(D,s),l.value="",E.textContent="0 / 500",x.classList.add("hidden");const P=await c();w(P),m("Mensaje publicado")}catch(P){m(P.message,"error")}})}function L(){e.querySelectorAll(".reply-form").forEach(r=>{const l=parseInt(r.dataset.parent),E=r.querySelector(".reply-input"),x=`mentionDropdown-${l}`,j=document.getElementById(x);E==null||E.addEventListener("input",()=>{S(E,j)}),r.addEventListener("submit",async D=>{D.preventDefault();const P=E.value.trim();if(P)try{await u.board.reply(l,P),E.value="",j==null||j.classList.add("hidden");const R=await c();w(R),m("Respuesta enviada")}catch(R){m(R.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await u.board.pin(r.dataset.id);const l=await c();w(l),m("Mensaje fijado")}catch(l){m(l.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(r=>{r.addEventListener("click",async()=>{try{await u.board.pin(r.dataset.id);const l=await c();w(l),m("Mensaje desfijado")}catch(l){m(l.message,"error")}})})}function $(){e.querySelectorAll(".delete-msg").forEach(r=>{r.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await u.board.delete(r.dataset.id);const l=await c();w(l),m("Mensaje eliminado")}catch(l){m(l.message,"error")}})})}function w(r){const{pinned:l=[],messages:E=[]}=r,x=document.getElementById("boardPinned");if(x)x.innerHTML=b(l);else if(l.length){_(r);return}const j=document.getElementById("boardMessages");j&&(j.innerHTML=v(E)),L(),$()}e.addEventListener("click",async r=>{if(r.target.id==="prevPage"&&o>1){o--;const l=await c();w(l)}else if(r.target.id==="nextPage"&&o<d){o++;const l=await c();w(l)}});function S(r,l){if(!l||!i.length)return;const E=r.value,x=r.selectionStart,j=E.slice(0,x),D=j.match(/@(\w*)$/);if(!D){l.classList.add("hidden");return}const P=D[1].toLowerCase(),R=i.filter(C=>C.username.toLowerCase().startsWith(P)&&C.id!==(t==null?void 0:t.id)),te=[...y.isAdmin()&&"todos".startsWith(P)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...R.slice(0,6)];if(!te.length){l.classList.add("hidden");return}l.innerHTML=te.map(C=>C.description?`<div class="mention-item mention-item--broadcast" data-username="${M(C.username)}">
             <span class="mention-item__name">@${M(C.username)}</span>
             <span class="mention-item__desc">${M(C.description)}</span>
           </div>`:`<div class="mention-item" data-username="${M(C.username)}">${M(C.username)}</div>`).join(""),l.classList.remove("hidden"),l.querySelectorAll(".mention-item").forEach(C=>{C.addEventListener("mousedown",ke=>{ke.preventDefault();const xe=C.dataset.username,X=j.replace(/@(\w*)$/,`@${xe} `);if(r.value=X+E.slice(x),r.setSelectionRange(X.length,X.length),l.classList.add("hidden"),r.tagName==="TEXTAREA"){const se=document.getElementById("charCounter");se&&(se.textContent=`${r.value.length} / 500`)}})})}document.addEventListener("click",r=>{!r.target.closest(".board-form__input-wrap")&&!r.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(l=>l.classList.add("hidden"))},{capture:!0})}function M(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ke(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Ye(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=y.getUser(),o=i==null?void 0:i.is_admin,[d,c]=await Promise.all([o?u.leagues.adminAll():u.leagues.all(),y.isLoggedIn()&&!o?u.leagues.my():Promise.resolve({leagues:[]})]),_=new Set(c.leagues.map(p=>p.id)),b=o?d.leagues:d.leagues.filter(p=>!_.has(p.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&c.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${c.leagues.map(p=>de(p,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${b.length?`<div class="leagues-grid">${b.map(p=>de(p,!1,_,o)).join("")}</div>`:o?'<p class="empty">No hay ligas creadas aún.</p>':c.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(p=>{p.addEventListener("click",()=>I.navigate(`/ligas/${p.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(p=>{p.addEventListener("click",async v=>{v.stopPropagation();const h=parseInt(p.dataset.id);p.disabled=!0,p.textContent="…";try{const{league:f}=await u.leagues.join({league_id:h});m(`¡Te has unido a "${f.name}"!`),I.navigate(`/ligas/${f.id}`)}catch(f){m(f.message,"error"),p.disabled=!1,p.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(p=>{p.addEventListener("click",v=>{v.stopPropagation(),m("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var p,v;(p=document.getElementById("createLeaguePanel"))==null||p.classList.remove("hidden"),(v=document.getElementById("btnShowCreate"))==null||v.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var p,v;(p=document.getElementById("createLeaguePanel"))==null||p.classList.add("hidden"),(v=document.getElementById("btnShowCreate"))==null||v.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async p=>{p.preventDefault();const v=document.getElementById("inviteCode").value.trim().toUpperCase();if(v)try{const{league:h}=await u.leagues.join({invite_code:v});m(`Te has unido a "${h.name}"`),I.navigate(`/ligas/${h.id}`)}catch(h){m(h.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async p=>{var S;p.preventDefault();const v=document.getElementById("createBtn");v.disabled=!0,v.textContent="Creando…";const h=document.getElementById("leagueName").value.trim(),f=document.getElementById("leagueDesc").value.trim(),L=document.getElementById("leaguePrize").value.trim(),$=document.getElementById("isPublic").checked,w=((S=document.getElementById("isOfficial"))==null?void 0:S.checked)??!1;try{const{league:r}=await u.leagues.create({name:h,description:f,prize:L,is_public:$,is_official:w});Qe(r)}catch(r){m(r.message,"error"),v.disabled=!1,v.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function de(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",o=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),m("Enlace copiado")}catch{m("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function Ze(e,{params:a}){var s,n,i,o,d;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const c=await u.leagues.get(t),{league:_,ranking:b,is_member:p,is_admin_view:v}=c,h=y.getUser(),f=_.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        ${(p||h!=null&&h.is_admin)&&_.invite_link?`
        ...
        <div class="league-actions">
          ...
          ${h!=null&&h.is_admin||p&&h&&_.created_by===h.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
    ...
    `,(s=document.getElementById("btnCopyInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(_.invite_link),m("Enlace copiado")}catch{m("No se pudo copiar","error")}}),(n=document.getElementById("btnShareInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${_.name} en PickGoal`,url:_.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await u.leagues.leave(t),m("Has abandonado la liga"),I.navigate("/ligas")}catch(r){m(r.message,"error")}}),(o=document.getElementById("btnJoin"))==null||o.addEventListener("click",async()=>{try{await u.leagues.join({league_id:t}),m("¡Te has unido a la liga!"),I.navigate(`/ligas/${t}`)}catch(r){m(r.message,"error")}}),(d=document.getElementById("btnEditLeague"))==null||d.addEventListener("click",()=>{ea(_,t,h)});const L=document.getElementById("tabRanking"),$=document.getElementById("tabTablon"),w=document.getElementById("sectionRanking"),S=document.getElementById("sectionTablon");L&&$&&(L.addEventListener("click",()=>{L.classList.add("league-tab--active"),$.classList.remove("league-tab--active"),w.classList.remove("hidden"),S.classList.add("hidden")}),$.addEventListener("click",()=>{$.classList.add("league-tab--active"),L.classList.remove("league-tab--active"),w.classList.add("hidden"),S.classList.remove("hidden");const r=document.getElementById("tablonEmbed");r&&!r.dataset.loaded&&(r.dataset.loaded="1",Ee(r,{query:{liga:String(t)}}))}))}catch(c){e.innerHTML=`<div class="container"><p class="form__error">Error: ${c.message}</p><a href="#/ligas">Volver</a></div>`}}function ea(e,a,t){const s=document.getElementById("editLeagueModal");s&&s.remove();const n=document.createElement("div");n.id="editLeagueModal",n.className="edit-league-modal",n.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("btnSaveEdit");d.disabled=!0,d.textContent="Guardando…";const c={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(c.is_official=document.getElementById("editOfficial").checked);try{await u.leagues.update(a,c),m("Liga actualizada"),i(),I.navigate(`/ligas/${a}`)}catch(_){m(_.message,"error"),d.disabled=!1,d.textContent="Guardar cambios"}})}async function aa(e){var t,s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=y.getUser();try{const n=(()=>{const f=localStorage.getItem("activeLeagueId");return f?parseInt(f):null})(),[i,o,d,c,_]=await Promise.all([u.predictions.mine(n),u.predictions.getChampion(n),u.leagues.my(),u.auth.me(),a!=null&&a.is_admin?u.leagues.adminAll():Promise.resolve({leagues:[]})]),b=i.predictions.reduce((f,L)=>f+L.total_points,0)+(((t=o.champion_prediction)==null?void 0:t.points_earned)||0),p=c.user,v=p.status,h=p.total_points_all_time;e.innerHTML=`
      <div class="container">
        ...
        <section class="section">
          ...
          ${i.predictions.length?`<div class="predictions-list">${i.predictions.map(sa).join("")}</div>`:'<p class="empty">Sin predicciones aún. <a href="#/quiniela">Ir a la quiniela</a></p>'}
        </section>
    ...
    `,(s=e.querySelector("#btnLogoutPerfil"))==null||s.addEventListener("click",()=>{y.logout(),window.location.hash="/"})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function ta(e,a){if(e.next_threshold===null)return`
  ...
  `}const le=new Date("2026-06-11T21:00:00Z"),na=["Argentina","Brasil","Francia","España","Inglaterra","Alemania","Portugal","Países Bajos","Italia","Bélgica","Uruguay","Colombia","México","Estados Unidos","Canadá","Marruecos","Senegal","Nigeria","Japón","Corea del Sur","Australia","Arabia Saudí","Irán","Qatar","Ecuador","Chile","Perú","Venezuela","Bolivia","Paraguay","Costa Rica","Honduras","Panamá","Jamaica","Trinidad y Tobago","Guatemala","Turquía","Polonia","Croacia","Serbia","República Checa","Eslovaquia","Austria","Suiza","Dinamarca","Suecia","Noruega","Escocia","Ucrania","Rumanía","Hungría","Grecia","Egipto","Camerún","Ghana","Costa de Marfil","Túnez","Argelia","China","India","Irak","Uzbekistán","Nueva Zelanda","Fiji"];function ia(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Le(e){var a;if(!y.isLoggedIn()){e.innerHTML='<div class="container"><p class="notice"><a href="#/login">Inicia sesión</a> para predecir el campeón.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const t=ia(),{champion_prediction:s}=await u.predictions.getChampion(t),n=new Date>=le;let i;s&&n?i=`
    ...
    `,(a=document.getElementById("championForm"))==null||a.addEventListener("submit",async o=>{o.preventDefault();const d=document.getElementById("champBtn"),c=document.getElementById("champError"),_=document.getElementById("teamSearch").value.trim();if(_){d.disabled=!0,d.textContent="Guardando…",c.classList.add("hidden");try{await u.predictions.saveChampion(_,t),m(`¡${_} guardado como campeón!`),Le(e)}catch(b){c.textContent=b.message,c.classList.remove("hidden"),d.disabled=!1,d.textContent=d.dataset.label||"Confirmar predicción"}}})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error: ${t.message}</p></div>`}}function K(e){const a=e?"Actualizar predicción":"Confirmar predicción";return`
  ...
  `}async function oa(e){if(!y.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await u.auth.users();e.innerHTML=`
      <div class="container">
    ...
    `,ra(e),ee(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function ra(e){var s,n,i,o;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const d=document.getElementById("syncResult");d.textContent="Sincronizando…";try{await u.matches.sync(),d.textContent="✓ Sincronización completada",m("Sincronización completada")}catch(c){d.textContent=`Error: ${c.message}`,m(c.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async d=>{d.preventDefault();const c=document.getElementById("pushTitle").value.trim()||"Aviso",_=document.getElementById("pushBody").value.trim(),b=a.value,p=parseInt(document.getElementById("pushTargetId").value)||null,v=document.getElementById("pushResult"),h={title:`📣 PickGoal — ${c}`,body:_};b==="league"&&p&&(h.league_id=p),b==="user"&&p&&(h.user_id=p),v.textContent="Enviando…";try{const{sent:f}=await u.notifications.send(h);v.textContent=`✓ Enviada a ${f} suscripción(es)`,m(`Notificación enviada a ${f} suscripción(es)`)}catch(f){v.textContent=`Error: ${f.message}`,m(f.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const d=document.getElementById("btnCloseSeason"),c=document.getElementById("closeSeasonResult");d.disabled=!0,c.textContent="Cerrando…";try{const{message:_}=await u.post("/v2/admin/season/1/close");c.textContent=`✓ ${_||"Temporada cerrada"}`,m("Temporada cerrada")}catch(_){c.textContent=`Error: ${_.message}`,m(_.message,"error"),d.disabled=!1}}),(o=document.getElementById("usersTableBody"))==null||o.addEventListener("click",async d=>{const c=d.target.closest(".toggle-admin");if(!c)return;const _=parseInt(c.dataset.id);try{const{user:b}=await u.auth.toggleAdmin(_);c.closest("tr").querySelector(".admin-badge").textContent=b.is_admin?"Sí":"No",m(`${b.username} ${b.is_admin?"ahora es admin":"ya no es admin"}`)}catch(b){m(b.message,"error")}})}function da(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const la={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League"};let k=[],z=null;async function ee(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await u.adminV2.jornadas();a.innerHTML=ca(t),pa(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function ca(e){const t=fa(new Date);return`
    <div class="jv2-panel">
      ...
      <div class="jv2-list">
        ${e.length===0?'<p class="admin-section__desc">No hay jornadas creadas.</p>':e.map(ua).join("")}
      </div>
  ...
  `}function pa(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{z=null,k=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",ae()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",k=[],z=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",ga),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",va),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>ma(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await u.adminV2.deleteJornada(i.dataset.id),m("Jornada eliminada"),ee(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(o){m(o.message,"error")}})})}async function ma(e){const{jornadas:a}=await u.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(z=t.id,k=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",ae())}async function ga(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){m("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await u.adminV2.partidos(a);_a(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){m(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function _a(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        <div class="jv2-comp-group__title">${la[s]||s}</div>
        ${n.map(i=>`
    ...
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(k.length>=10){s.checked=!1,m("Máximo 10 partidos","error");return}k.push(n)}else k=k.filter(i=>i.api_id!==n.api_id);ae()})})}function ae(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=k.length),a&&(a.style.display=k.length>0&&k.length!==10?"inline":"none")}async function va(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){m("Completa número y fechas","error");return}if(k.length!==10){m("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:k},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await u.adminV2.updateJornada(s,n),m(`Jornada ${e} actualizada`)):(await u.adminV2.createJornada(n),m(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",k=[],z=null,await ee(document.getElementById("jornadasV2Section"))}catch(o){m(o.message,"error")}finally{i.disabled=!1}}function ha(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}function ba(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function fa(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(ba(a)).padStart(2,"0");return`${t}-W${s}`}function ya(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await u.auth.resetPassword(t,o),m("Contraseña actualizada. Ya puedes iniciar sesión."),I.navigate("/login")}catch(d){i.textContent=d.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}const Ea={r32:"Dieciseisavos",r16:"Octavos",quarters:"Cuartos",semis:"Semis",third:"3º y 4º",final:"Final"};let O=!1,B=null;async function La(e){O=!1,B=null,e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{groups:a}=await u.matches.grouped(),t=y.isAdmin();e.innerHTML=`
    ...
    `,t&&document.getElementById("btnEditResults").addEventListener("click",()=>{O=!O;const s=document.getElementById("btnEditResults");O?(s.textContent="✅ Editando — salir",s.classList.add("btn--warning")):(s.textContent="✏️ Editar resultados",s.classList.remove("btn--warning")),B&&V(B.data,B.isGroup)}),document.getElementById("phaseContent").addEventListener("click",async s=>{var b;const n=s.target.closest(".res-match__save");if(!n)return;const i=parseInt(n.dataset.id),o=n.closest(".res-match"),d=o.querySelector(".res-match__input-home").value,c=o.querySelector(".res-match__input-away").value,_=((b=o.querySelector(".res-match__result90"))==null?void 0:b.value)||null;if(d===""||c===""){m("Introduce ambos marcadores","error");return}n.disabled=!0;try{if(await u.matches.setResult(i,parseInt(d),parseInt(c),_),m(`${d} - ${c} guardado`),B){const p=B.data.matches.find(v=>v.id===i);p&&(p.home_score_90=parseInt(d),p.away_score_90=parseInt(c),p.status="finished"),V(B.data,B.isGroup)}}catch(p){m(p.message,"error"),n.disabled=!1}}),wa(a)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando los partidos: ${a.message}</p></div>`}}function wa(e){var i;const a=document.getElementById("phaseNav");if(!a)return;const t=e.filter(o=>o.phase==="group"),s=e.filter(o=>o.phase!=="group"),n=[...t.map(o=>({key:`group_${o.group_name}`,label:`Grupo ${o.group_name}`,data:o,isGroup:!0})),...s.map(o=>({key:o.phase,label:Ea[o.phase]||o.label,data:o,isGroup:!1}))];n.length!==0&&(a.innerHTML=n.map((o,d)=>`
    <button class="phase-nav__btn ${d===0?"phase-nav__btn--active":""}" data-key="${o.key}">
      ${o.label}
    </button>
  `).join(""),(i=a.querySelector(".phase-nav__btn--active"))==null||i.scrollIntoView({inline:"center",behavior:"instant",block:"nearest"}),a.querySelectorAll(".phase-nav__btn").forEach(o=>{o.addEventListener("click",()=>{a.querySelectorAll(".phase-nav__btn").forEach(c=>c.classList.remove("phase-nav__btn--active")),o.classList.add("phase-nav__btn--active");const d=n.find(c=>c.key===o.dataset.key);d&&(B=d,V(d.data,d.isGroup))})}),B=n[0],V(n[0].data,n[0].isGroup))}function V(e,a){const t=document.getElementById("phaseContent");if(!t)return;const s=Ia(e.matches);if(a){const n=Sa(e.matches);t.innerHTML=`
    ...
    `}else t.innerHTML=`<div class="resultados-matches">${s}</div>`}function Ia(e){return!e||e.length===0?'<p class="empty">Sin partidos en esta fase.</p>':e.map(a=>{const t={scheduled:"Programado",live:"🔴 En juego",finished:"Finalizado"}[a.status]||a.status;let s;if(O){const n=a.home_score_90??"",i=a.away_score_90??"",o=a.result_90??"";s=`
      ...
      <div class="res-match ${a.status==="finished"?"res-match--finished":""} ${a.status==="live"?"res-match--live":""} ${O?"res-match--editing":""}">
        <div class="res-match__meta">
          ...
          <span class="res-match__date">${T(a.match_datetime)}</span>
        </div>
    ...
    `}).join("")}function Sa(e){const a={};for(const t of e)if(a[t.home_team]||(a[t.home_team]={name:t.home_team,pj:0,g:0,e:0,p:0,gf:0,gc:0,pts:0}),a[t.away_team]||(a[t.away_team]={name:t.away_team,pj:0,g:0,e:0,p:0,gf:0,gc:0,pts:0}),t.status==="finished"&&t.home_score_90!==null&&t.away_score_90!==null){const s=a[t.home_team],n=a[t.away_team];s.pj++,n.pj++,s.gf+=t.home_score_90,s.gc+=t.away_score_90,n.gf+=t.away_score_90,n.gc+=t.home_score_90,t.home_score_90>t.away_score_90?(s.g++,s.pts+=3,n.p++):t.home_score_90<t.away_score_90?(n.g++,n.pts+=3,s.p++):(s.e++,s.pts++,n.e++,n.pts++)}return Object.values(a).sort((t,s)=>{if(s.pts!==t.pts)return s.pts-t.pts;const n=s.gf-s.gc,i=t.gf-t.gc;return n!==i?n-i:s.gf-t.gf})}function ja(e){return e.length===0?'<p class="empty">Sin datos de clasificación.</p>':`
  ...
  `}async function ka(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!y.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),I.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await u.leagues.joinByCode(t);m(`¡Te has unido a "${s.name}"!`),I.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){m("Ya eres miembro de esta liga");try{const{leagues:n}=await u.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){I.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
    ...
    `}}function xa(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ca(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=xa(),{user:n,predictions:i}=await u.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const J=20,we=5;let N={},G=0;async function Ta(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=await u.jornada.current();if(!s.jornada){e.innerHTML=Pa(s.next_jornada);return}const{jornada:n,matches:i,units_used:o}=s;N={};for(const d of i)N[d.jornada_match_id]={predicted_result:((a=d.prediction)==null?void 0:a.predicted_result)??null,units:((t=d.prediction)==null?void 0:t.units_wagered)??0};G=o,e.innerHTML=`
      <div class="container">
    ...
    `,Ie(),Ha(e,n.locked)}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la jornada: ${s.message}</p></div>`}}function Pa(e){return`
    <div class="container">
      <div class="jornada-empty">
        ...
        ${e?`<p class="jornada-empty__text">Próxima jornada: <strong>Jornada ${e.number}</strong> — ${T(e.date_start)}</p>`:'<p class="jornada-empty__text">Todavía no hay una próxima jornada programada.</p>'}
      </div>
    </div>
  `}function ce(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function Y(e){return e!=null?e.toFixed(2):"—"}function Ma(e){const a=e.status!=="scheduled"||new Date(e.match_datetime)<=new Date,t=N[e.jornada_match_id]??{predicted_result:null,units:0};return`
    <div class="match-card jornada-match ${a?"match-card--locked":""}" data-jm-id="${e.jornada_match_id}">
      ...
      <div class="jornada-match__controls ${a?"jornada-match__controls--disabled":""}">
        ...
        <div class="jornada-units">
          ...
          <input type="number" id="units-${e.jornada_match_id}" class="jornada-units__input" min="0" max="${we}" value="${t.units}" ${a?"disabled":""} />
        </div>
      </div>
    </div>
  `}function Ie(){const e=document.getElementById("unitsCounter");if(!e)return;const a=G>J;e.innerHTML=`
  ...
  `}function ue(){G=Object.values(N).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),Ie()}function Ha(e,a){var t;a||(e.querySelectorAll(".jornada-match").forEach(s=>{const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(o=>{o.addEventListener("change",()=>{N[n].predicted_result=o.value,ue()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let o=parseInt(i.value);isNaN(o)&&(o=0),o=Math.max(0,Math.min(we,o)),N[n].units=o,ue()})}),(t=document.getElementById("jornadaSaveBtn"))==null||t.addEventListener("click",Da))}async function Da(){const e=document.getElementById("jornadaSaveBtn"),a=Object.entries(N).filter(([,t])=>t.predicted_result).map(([t,s])=>({jornada_match_id:parseInt(t),predicted_result:s.predicted_result,units:s.units}));if(a.length===0){m("Selecciona al menos un resultado 1X2","error");return}if(G>J){m(`Superas el máximo de ${J} unidades`,"error");return}e.disabled=!0,e.textContent="…";try{await u.jornada.predict(a),m("Predicciones guardadas"),e.textContent="✓ Guardadas"}catch(t){m(t.message||"Error al guardar","error")}finally{e.disabled=!1,setTimeout(()=>{e&&(e.textContent="Guardar predicciones")},2e3)}}const pe={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function Na(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:a}=await u.duelo.current(),t=y.getUser();if(!a){e.innerHTML=`
        <div class="container">
    ...
    `,qa(a.division_league_id,t.id)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${a.message}</p></div>`}}async function qa(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await u.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function Aa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:a}=await u.clasificacion.general(),t=y.getUser();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Clasificación</h1>
    ...
    `,Oa(t)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${a.message}</p></div>`}}function Oa(e){const a=document.getElementById("tabGeneral"),t=document.getElementById("tabMiDivision"),s=document.getElementById("panelGeneral"),n=document.getElementById("panelMiDivision");!a||!t||(a.addEventListener("click",()=>{a.classList.add("league-tab--active"),t.classList.remove("league-tab--active"),s.classList.remove("hidden"),n.classList.add("hidden")}),t.addEventListener("click",()=>{t.classList.add("league-tab--active"),a.classList.remove("league-tab--active"),n.classList.remove("hidden"),s.classList.add("hidden"),n.dataset.loaded||(n.dataset.loaded="1",Ua(e))}))}async function Ua(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await u.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error cargando la clasificación: ${t.message}</p>`}}const Ga={"/":Te,"/login":qe,"/register":Ae,"/quiniela":Ue,"/resultados":La,"/ranking":We,"/tablon":Ee,"/ligas":Ye,"/ligas/:id":Ze,"/perfil":aa,"/campeon":Le,"/admin":oa,"/forgot-password":ya,"/reset-password":$a,"/unirse":ka,"/jugador/:id":Ca,"/jornada":Ta,"/duelo":Na,"/tabla-v2":Aa};function Ra(e){for(const[a,t]of Object.entries(Ga)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,d)=>(s.push(d),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((d,c)=>{o[d]=i[c+1]}),{handler:t,params:o}}}return null}const me=()=>document.getElementById("mainContent"),I={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=Ra(a);if(!n){me().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/campeon","/admin","/jornada","/duelo","/tabla-v2"].includes(a)&&!y.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!y.isAdmin()){this.navigate("/");return}const c=me();c.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(c,{params:o,query:s})}};let F=[],U=null,q=null;async function Fa(){document.documentElement.dataset.build="2026-08-07T13",await y.init(),I.init(),Va(),Ja(),Ka()}function Se(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Ja(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!Se()&&(U=e,za())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),U=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function za(){if(Se()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("installBtn").addEventListener("click",async()=>{U&&(U.prompt(),await U.userChoice,U=null,e.remove())}),document.getElementById("installDismissBtn").addEventListener("click",()=>{sessionStorage.setItem("installBannerDismissed","1"),e.remove()})}function A(){var e,a;(e=document.getElementById("userDropdown"))==null||e.classList.add("hidden"),(a=document.getElementById("userBtn"))==null||a.classList.remove("navbar__dropdown-btn--open")}async function Z(){const e=document.getElementById("tablonBadge");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("activeLeagueId");if(!t){e.classList.add("hidden");return}const s=localStorage.getItem(`tablon_last_read_${t}`)||new Date(0).toISOString();try{const{count:n}=await u.board.unread(parseInt(t),s);n>0?(e.textContent=n>99?"99+":String(n),e.classList.remove("hidden")):e.classList.add("hidden")}catch{e.classList.add("hidden")}}function Va(){var e,a,t;document.addEventListener("auth:change",ge),window.addEventListener("hashchange",()=>{A(),je(),setTimeout(Z,200)}),document.addEventListener("click",A),(e=document.getElementById("userBtn"))==null||e.addEventListener("click",s=>{var o;s.stopPropagation();const n=document.getElementById("userDropdown"),i=n==null?void 0:n.classList.contains("hidden");A(),i&&(n==null||n.classList.remove("hidden"),(o=document.getElementById("userBtn"))==null||o.classList.add("navbar__dropdown-btn--open"))}),(a=document.getElementById("userDropdown"))==null||a.addEventListener("click",s=>{s.stopPropagation(),s.target.closest("#navProfileLink")&&A()}),(t=document.getElementById("navLogoutBtn"))==null||t.addEventListener("click",()=>{F=[],localStorage.removeItem("activeLeagueId"),A(),y.logout(),I.navigate("/")}),ge()}async function ge(){const e=document.getElementById("navAuthLinks"),a=document.getElementById("userBtn"),t=document.getElementById("navUsername"),s=document.getElementById("bottomNav"),n=y.getUser();if(A(),n){e==null||e.classList.add("hidden"),t&&(t.textContent=n.username),a.style.visibility="visible",s==null||s.classList.remove("hidden"),document.body.classList.add("has-bottom-nav");try{const{leagues:i}=n.is_admin?await u.leagues.adminAll():await u.leagues.my();F=i}catch{F=[]}Xa(F),Z(),q&&clearInterval(q),q=setInterval(Z,5*60*1e3)}else e==null||e.classList.remove("hidden"),a.style.visibility="hidden",s==null||s.classList.add("hidden"),document.body.classList.remove("has-bottom-nav"),F=[],localStorage.removeItem("activeLeagueId"),q&&(clearInterval(q),q=null);je()}function Xa(e){const a=localStorage.getItem("activeLeagueId");a&&e.some(s=>String(s.id)===String(a))||(e.length>0?localStorage.setItem("activeLeagueId",String(e[0].id)):localStorage.removeItem("activeLeagueId"))}function je(){const e=window.location.hash.slice(1).split("?")[0]||"/";document.querySelectorAll(".bottom-nav__item").forEach(a=>{const t=a.dataset.route,s=t==="/"?e==="/":e===t||e.startsWith(t+"/");a.classList.toggle("bottom-nav__item--active",s)})}function Wa(e){const a="=".repeat((4-e.length%4)%4),t=(e+a).replace(/-/g,"+").replace(/_/g,"/"),s=atob(t);return Uint8Array.from([...s].map(n=>n.charCodeAt(0)))}async function Ka(){if(!(!("serviceWorker"in navigator)||!("PushManager"in window)))try{const e=await navigator.serviceWorker.register("/sw.js");document.addEventListener("auth:change",async a=>{a.detail&&await _e(e)}),y.getUser()&&await _e(e)}catch{}}async function _e(e){try{if(await Notification.requestPermission()!=="granted")return;const t=await e.pushManager.getSubscription();if(t){await u.notifications.subscribe(t.toJSON());return}const{public_key:s}=await u.notifications.vapidPublicKey();if(!s)return;const n=await e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Wa(s)});await u.notifications.subscribe(n.toJSON())}catch{}}Fa();
