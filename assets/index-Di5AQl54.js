(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const He="https://pickgoal-backend.onrender.com/api";function qe(){return localStorage.getItem("token")}async function p(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=qe();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${He}${e}`,{...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const u={get:e=>p(e),post:(e,a)=>p(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>p(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>p(e,{method:"DELETE"}),auth:{register:e=>p("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>p("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>p("/auth/me"),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>p("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>p(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>p("/auth/account",{method:"DELETE"}),users:()=>p("/auth/users"),usersForMentions:()=>p("/auth/users/for-mentions"),toggleAdmin:e=>p(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>p(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>p("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>p("/matches/grouped"),list:(e="")=>p(`/matches/${e}`),get:e=>p(`/matches/${e}`),today:()=>p("/matches/today"),setResult:(e,a,t,s=null)=>p(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>p("/matches/sync",{method:"POST"}),recalculate:()=>p("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>p(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>p(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>p("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>p(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>p(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>p("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>p("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>p("/leagues/all"),public:()=>p("/leagues/public"),my:()=>p("/leagues/my"),create:e=>p("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>p("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>p(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>p("/leagues/admin"),get:e=>p(`/leagues/${e}`),update:(e,a)=>p(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>p(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>p(`/leagues/${e}/members`),matchPredictions:(e,a)=>p(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>p("/home/summary")},board:{messages:(e=1,a=null)=>p(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>p(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>p("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>p(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>p(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>p(`/board/${e}`,{method:"DELETE"}),mentions:e=>p(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>p("/notifications/vapid-public-key"),subscribe:e=>p("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>p("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:e=>p(`/v2/admin/partidos-disponibles?semana=${encodeURIComponent(e)}`),jornadas:()=>p("/v2/admin/jornadas"),createJornada:e=>p("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>p(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>p(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>p(`/v2/admin/jornada/${e}/publish`,{method:"POST"})},jornada:{info:()=>p("/v2/jornada/info"),current:()=>p("/v2/jornada/current"),list:()=>p("/v2/jornada/list"),predict:e=>p("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>p("/v2/jornada/history"),myStats:()=>p("/v2/jornada/my-stats")},duelo:{current:()=>p("/v2/duelo/current")},messages:{unread:()=>p("/messages/unread"),list:()=>p("/messages/"),get:e=>p(`/messages/${e}`),send:(e,a)=>p(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>p("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>p(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>p("/v2/clasificacion/general"),allDivisions:()=>p("/v2/clasificacion/all-divisions")}};let D=null;const y={async init(){if(localStorage.getItem("token"))try{const{user:a}=await u.auth.me();D=a}catch{localStorage.removeItem("token")}},setUser(e,a){D=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){D=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return D},isLoggedIn(){return!!D},isAdmin(){return(D==null?void 0:D.is_admin)===!0}};let ae=null;function v(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,ae&&clearTimeout(ae),ae=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function Ae(){return`
  ...
  `}function ue(e){const a=e.querySelector("#pointsModal"),t=e.querySelector("#btnPointsInfo"),s=e.querySelector("#pointsClose"),n=e.querySelector("#pointsOverlay");function i(){a.classList.add("points-modal--open"),document.body.style.overflow="hidden"}function o(){a.classList.remove("points-modal--open"),document.body.style.overflow=""}return t==null||t.addEventListener("click",i),s==null||s.addEventListener("click",o),n==null||n.addEventListener("click",o),document.addEventListener("keydown",r=>{r.key==="Escape"&&o()},{once:!1}),i}function B(e){return e?new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function Ne(e){if(!y.getUser()){Oe(e);return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{leagues_summary:t,division_summary:s,upcoming_matches:n}=await u.home.summary();if(s){e.innerHTML=`
        ...
        ${ce()}
      `,ue(e);return}if(!t||t.length===0){Ue(e);return}const i=(()=>{const r=localStorage.getItem("activeLeagueId");return r?parseInt(r):null})(),o=[...t].sort((r,d)=>r.league_id===i?-1:d.league_id===i?1:0);e.innerHTML=`
      <div class="home-dashboard container">
        <div class="home-dashboard__topbar">
          <button class="btn btn--ghost btn--sm" id="btnPointsInfo">📊 Sistema de puntos</button>
        </div>
      ...
      ${ce()}
    `,ue(e),e.querySelectorAll(".league-card[data-league-id]").forEach(r=>{r.style.cursor="pointer",r.addEventListener("click",d=>{d.target.closest("[data-go-ranking]")||d.target.closest("a")||(localStorage.setItem("activeLeagueId",r.dataset.leagueId),I.navigate(`/ligas/${r.dataset.leagueId}`))})}),e.querySelectorAll("[data-go-ranking]").forEach(r=>{r.addEventListener("click",d=>{d.stopPropagation(),localStorage.setItem("activeLeagueId",r.dataset.goRanking),I.navigate("/ranking")})})}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el inicio: ${t.message}</p></div>`}}async function Oe(e){const t=new Date>=new Date("2026-08-15T00:00:00Z");let s=null;if(t)try{s=await u.jornada.info()}catch{}e.innerHTML=`
    <section class="hero">
  ...
  `}function Re(e){const a={promotion:"⬆️ Zona ascenso",relegation:"⬇️ Zona descenso",mid:""},t=a[e.zone]?`<span class="div-card__zone div-card__zone--${e.zone}">${a[e.zone]}</span>`:"";return`
    <div class="div-card">
  ...
  `}function Fe(e){const a=new Date,t=new Date(e),s=Math.ceil((t-a)/(1e3*60*60*24));return Math.max(0,s)}function je(e=null,a=!1){let t,s;if(a&&(e!=null&&e.jornada_number))s="Temporada 26/27 · En curso",t=`
      ...
      </div>`;else if(a)s="Temporada 26/27 · En curso",t='<div class="pg-league-card__countdown pg-league-card__countdown--soon">Temporada en curso</div>';else{const n=Fe("2026-08-15");s="Temporada 26/27 · Próximamente",t=n>0?`<div class="pg-league-card__countdown">
  ...
  `,document.getElementById("loginForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("loginBtn"),s=document.getElementById("loginError"),n=document.getElementById("identifier").value.trim(),i=document.getElementById("password").value;t.disabled=!0,t.textContent="Entrando…",s.classList.add("hidden");try{const{token:o,user:r}=await u.auth.login({identifier:n,password:i});y.setUser(r,o),v(`¡Bienvenido, ${r.username}!`),I.navigate("/"),Ie("/")}catch(o){s.textContent=o.message||"Error al iniciar sesión",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Entrar"}})}function Ve(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await u.auth.register(n);y.setUser(o,i),v("¡Cuenta creada! Bienvenido a PickGoal");const r=sessionStorage.getItem("pendingInviteCode");if(r){sessionStorage.removeItem("pendingInviteCode");try{const{league:d}=await u.leagues.joinByCode(r);v(`¡Te has unido a "${d.name}"!`),I.navigate(`/ligas/${d.id}`)}catch{I.navigate("/ligas")}}else I.navigate("/"),Ie("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function We(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Xe(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(y.isLoggedIn()){const{leagues:_}=await u.leagues.my();if(_.length===0){e.innerHTML=Ae();return}}const s=We(),[{ranking:n},i]=await Promise.all([u.auth.ranking(s),y.isLoggedIn()?u.leagues.my():Promise.resolve({leagues:[]})]),o=y.getUser(),r=i.leagues.find(_=>_.id===s),d=document.getElementById("tablonBadge"),l=d&&!d.classList.contains("hidden"),h=l?d.textContent:"",g=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        ...
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(_=>{var L,$,c;const b=_.predictions_made??0,f=`${b}/${g}`,E=`${_.correct_results??0}/${b}`,j=`${_.exact_scores??0}/${b}`;return`
    ...
    `,(t=e.querySelector(".ranking-tablon-btn"))==null||t.addEventListener("click",()=>{I.navigate(`/tablon?liga=${s}`)})}catch(s){e.innerHTML=`<div class="container"><p class="form__error">Error: ${s.message}</p></div>`}}async function oe(e,{query:a={},forceGeneral:t=!1}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const s=y.getUser();let n=t?null:a.liga?parseInt(a.liga):null;if(t)localStorage.setItem("tablon_general_last_read",new Date().toISOString()),document.dispatchEvent(new CustomEvent("tablon:read"));else if(n){localStorage.setItem(`tablon_last_read_${n}`,new Date().toISOString());const c=document.getElementById("tablonBadge");c&&(c.classList.add("hidden"),c.textContent="")}let i=null,o=[],r=1,d=1;if(t&&s)try{const{users:c}=await u.auth.usersForMentions();o=c||[],console.log("[tablon] usuarios cargados:",o.length)}catch(c){console.warn("[tablon] error cargando usuarios:",c)}if(!t)try{if(!n&&s){const{leagues:c}=await u.leagues.my();c&&c.length&&(n=c[0].id,i=c[0].name)}else if(n)try{const{league:c}=await u.leagues.get(n);i=c.name}catch{}if(n&&s)try{const{members:c}=await u.leagues.members(n);o=c||[]}catch{}}catch{}async function l(){const c=await u.board.messages(r,n);return d=c.pages||1,c}try{const c=await l();h(c)}catch(c){e.innerHTML=`<div class="container"><p class="form__error">Error: ${c.message}</p></div>`}function h(c){const{pinned:m=[],messages:w=[]}=c;e.innerHTML=`
      <div class="container">
        ...
        ${m.length?`<section class="board-section">
        ...
        <section class="board-section">
          ${m.length?'<h2 class="board-section__title">💬 Mensajes</h2>':""}
    ...
    `,E(),j(),M()}function g(c){return c.length?c.map(m=>`
      <div class="board-message board-message--pinned" data-id="${m.id}">
        <div class="board-message__header">
          <span class="board-message__pin-badge">📌</span>
          <strong class="board-message__author">${P(m.username)}</strong>
          <span class="board-message__date">${B(m.created_at)}</span>
          ${s!=null&&s.is_admin&&!m.is_deleted?`<button class="btn btn--ghost btn--xs unpin-msg" data-id="${m.id}" title="Desfijar">📌✕</button>`:""}
          ${!m.is_deleted&&s&&(s.id===m.user_id||s.is_admin)?`<button class="btn btn--danger btn--xs delete-msg" data-id="${m.id}">✕</button>`:""}
        </div>
        <p class="board-message__text">${f(m.message)}</p>

        ${m.replies&&m.replies.length?`<div class="board-replies">
               ${m.replies.map(w=>_(w)).join("")}
             </div>`:""}

        ${s&&!m.is_deleted?`<form class="reply-form" id="replyForm-${m.id}" data-parent="${m.id}">
               <div class="reply-form__input-wrap">
                 <input class="form__input reply-input" type="text"
                   placeholder="Responder…" maxlength="500"
                   id="replyInput-${m.id}" />
                 <div class="mention-dropdown hidden" id="mentionDropdown-${m.id}"></div>
               </div>
               <button class="btn btn--outline btn--sm" type="submit">Enviar</button>
             </form>`:""}
      </div>
    `).join(""):""}function _(c){return`
      <div class="board-reply ${c.is_deleted?"board-reply--deleted":""}" data-id="${c.id}">
        <div class="board-reply__header">
          <strong class="board-reply__author">${P(c.username)}</strong>
          <span class="board-reply__date">${B(c.created_at)}</span>
          ${!c.is_deleted&&s&&(s.id===c.user_id||s.is_admin)?`<button class="btn btn--danger btn--xs delete-msg" data-id="${c.id}">✕</button>`:""}
        </div>
        <p class="board-reply__text">${f(c.message)}</p>
      </div>
    `}function b(c){return c.length?c.map(m=>`
      <div class="board-message ${m.is_deleted?"board-message--deleted":""}" data-id="${m.id}">
        <div class="board-message__header">
          <strong class="board-message__author">${P(m.username)}</strong>
          <span class="board-message__date">${B(m.created_at)}</span>
          ${s!=null&&s.is_admin&&!m.is_deleted?`<button class="btn btn--ghost btn--xs pin-msg" data-id="${m.id}" title="Fijar">📌</button>`:""}
          ${!m.is_deleted&&s&&(s.id===m.user_id||s.is_admin)?`<button class="btn btn--danger btn--xs delete-msg" data-id="${m.id}">✕</button>`:""}
        </div>
        <p class="board-message__text">${f(m.message)}</p>
      </div>
    `).join(""):'<p class="empty">Sin mensajes aún. ¡Sé el primero!</p>'}function f(c){const m=P(c);if(!o.length)return m.replace(/@(\w+)/g,'<span class="mention">@$1</span>');const w=o.map(S=>Ye(S.username)),C=new RegExp(`@(${w.join("|")})`,"gi");return m.replace(C,'<span class="mention">@$1</span>')}function E(){const c=document.getElementById("boardForm");if(!c)return;const m=document.getElementById("boardMsg"),w=document.getElementById("charCounter"),C=document.getElementById("mentionDropdown");m.addEventListener("input",()=>{w.textContent=`${m.value.length} / 500`,$(m,C)}),c.addEventListener("submit",async S=>{S.preventDefault();const q=m.value.trim();if(q)try{await u.board.post(q,n),m.value="",w.textContent="0 / 500",C.classList.add("hidden");const T=await l();L(T),v("Mensaje publicado")}catch(T){v(T.message,"error")}})}function j(){e.querySelectorAll(".reply-form").forEach(c=>{const m=parseInt(c.dataset.parent),w=c.querySelector(".reply-input"),C=`mentionDropdown-${m}`,S=document.getElementById(C);w==null||w.addEventListener("input",()=>{$(w,S)}),c.addEventListener("submit",async q=>{q.preventDefault();const T=w.value.trim();if(T)try{await u.board.reply(m,T),w.value="",S==null||S.classList.add("hidden");const U=await l();L(U),v("Respuesta enviada")}catch(U){v(U.message,"error")}})}),e.querySelectorAll(".pin-msg").forEach(c=>{c.addEventListener("click",async()=>{try{await u.board.pin(c.dataset.id);const m=await l();L(m),v("Mensaje fijado")}catch(m){v(m.message,"error")}})}),e.querySelectorAll(".unpin-msg").forEach(c=>{c.addEventListener("click",async()=>{try{await u.board.pin(c.dataset.id);const m=await l();L(m),v("Mensaje desfijado")}catch(m){v(m.message,"error")}})})}function M(){e.querySelectorAll(".delete-msg").forEach(c=>{c.addEventListener("click",async()=>{if(confirm("¿Eliminar este mensaje?"))try{await u.board.delete(c.dataset.id);const m=await l();L(m),v("Mensaje eliminado")}catch(m){v(m.message,"error")}})})}function L(c){const{pinned:m=[],messages:w=[]}=c,C=document.getElementById("boardPinned");if(C)C.innerHTML=g(m);else if(m.length){h(c);return}const S=document.getElementById("boardMessages");S&&(S.innerHTML=b(w)),j(),M()}e.addEventListener("click",async c=>{if(c.target.id==="prevPage"&&r>1){r--;const m=await l();L(m)}else if(c.target.id==="nextPage"&&r<d){r++;const m=await l();L(m)}});function $(c,m){if(!m||!o.length){console.log("[tablon] handleMentionInput: sin dropdown o members vacío",{dropdown:!!m,membersLen:o.length});return}const w=c.value,C=c.selectionStart,S=w.slice(0,C),q=S.match(/@(\w*)$/);if(!q){m.classList.add("hidden");return}const T=q[1].toLowerCase();console.log("[tablon] mention detected, query:",T);const U=o.filter(k=>k.username.toLowerCase().startsWith(T)&&k.id!==(s==null?void 0:s.id));console.log("[tablon] matches:",U.map(k=>k.username));const de=[...y.isAdmin()&&"todos".startsWith(T)?[{username:"todos",description:"Notificar a todos los miembros"}]:[],...U.slice(0,6)];if(!de.length){m.classList.add("hidden");return}m.innerHTML=de.map(k=>k.description?`<div class="mention-item mention-item--broadcast" data-username="${P(k.username)}">
             <span class="mention-item__name">@${P(k.username)}</span>
             <span class="mention-item__desc">${P(k.description)}</span>
           </div>`:`<div class="mention-item" data-username="${P(k.username)}">${P(k.username)}</div>`).join(""),m.classList.remove("hidden"),m.querySelectorAll(".mention-item").forEach(k=>{k.addEventListener("mousedown",Pe=>{Pe.preventDefault();const De=k.dataset.username,ee=S.replace(/@(\w*)$/,`@${De} `);if(c.value=ee+w.slice(C),c.setSelectionRange(ee.length,ee.length),m.classList.add("hidden"),c.tagName==="TEXTAREA"){const le=document.getElementById("charCounter");le&&(le.textContent=`${c.value.length} / 500`)}})})}document.addEventListener("click",c=>{!c.target.closest(".board-form__input-wrap")&&!c.target.closest(".reply-form__input-wrap")&&document.querySelectorAll(".mention-dropdown").forEach(m=>m.classList.add("hidden"))},{capture:!0})}function P(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ye(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}async function Ze(e){var a,t,s,n;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const i=y.getUser(),o=i==null?void 0:i.is_admin,[r,d]=await Promise.all([o?u.leagues.adminAll():u.leagues.all(),y.isLoggedIn()&&!o?u.leagues.my():Promise.resolve({leagues:[]})]),l=new Set(d.leagues.map(g=>g.id)),h=o?r.leagues:r.leagues.filter(g=>!l.has(g.id));e.innerHTML=`
      <div class="container">
        ...
        ${i&&!o&&d.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${d.leagues.map(g=>ge(g,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${h.length?`<div class="leagues-grid">${h.map(g=>ge(g,!1,l,o)).join("")}</div>`:o?'<p class="empty">No hay ligas creadas aún.</p>':d.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(g=>{g.addEventListener("click",()=>I.navigate(`/ligas/${g.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(g=>{g.addEventListener("click",async _=>{_.stopPropagation();const b=parseInt(g.dataset.id);g.disabled=!0,g.textContent="…";try{const{league:f}=await u.leagues.join({league_id:b});v(`¡Te has unido a "${f.name}"!`),I.navigate(`/ligas/${f.id}`)}catch(f){v(f.message,"error"),g.disabled=!1,g.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(g=>{g.addEventListener("click",_=>{_.stopPropagation(),v("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var g,_;(g=document.getElementById("createLeaguePanel"))==null||g.classList.remove("hidden"),(_=document.getElementById("btnShowCreate"))==null||_.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var g,_;(g=document.getElementById("createLeaguePanel"))==null||g.classList.add("hidden"),(_=document.getElementById("btnShowCreate"))==null||_.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async g=>{g.preventDefault();const _=document.getElementById("inviteCode").value.trim().toUpperCase();if(_)try{const{league:b}=await u.leagues.join({invite_code:_});v(`Te has unido a "${b.name}"`),I.navigate(`/ligas/${b.id}`)}catch(b){v(b.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async g=>{var L;g.preventDefault();const _=document.getElementById("createBtn");_.disabled=!0,_.textContent="Creando…";const b=document.getElementById("leagueName").value.trim(),f=document.getElementById("leagueDesc").value.trim(),E=document.getElementById("leaguePrize").value.trim(),j=document.getElementById("isPublic").checked,M=((L=document.getElementById("isOfficial"))==null?void 0:L.checked)??!1;try{const{league:$}=await u.leagues.create({name:b,description:f,prize:E,is_public:j,is_official:M});Ke($)}catch($){v($.message,"error"),_.disabled=!1,_.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function ge(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",o=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `}function Ke(e){var s,n;const a=e.invite_link||"",t=document.getElementById("createLeaguePanel");t&&(t.innerHTML=`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function Qe(e,{params:a}){var s,n,i,o,r;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const d=await u.leagues.get(t),{league:l,ranking:h,is_member:g,is_admin_view:_}=d,b=y.getUser(),f=l.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        ${(g||b!=null&&b.is_admin)&&l.invite_link?`
        ...
        <div class="league-actions">
          ${g?'<button class="btn btn--danger btn--sm" id="btnLeave">Abandonar liga</button>':!(b!=null&&b.is_admin)&&b?'<button class="btn btn--primary" id="btnJoin">Unirse a esta liga</button>':""}
          ${b!=null&&b.is_admin||g&&b&&l.created_by===b.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
        ...
        <section class="section" id="sectionRanking">
          <table class="ranking-table">
            ...
            <tbody>
              ${h.map($=>`
                <tr class="${b&&$.id===b.id?"ranking-table__row--me":""}">
                  <td>${$.position}</td>
                  <td>${$.username}</td>
                  <td>${$.country||"—"}</td>
    ...
    `,(s=document.getElementById("btnCopyInvite"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(l.invite_link),v("Enlace copiado")}catch{v("No se pudo copiar","error")}}),(n=document.getElementById("btnShareInvite"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${l.name} en PickGoal`,url:l.invite_link})}catch{}}),(i=document.getElementById("btnLeave"))==null||i.addEventListener("click",async()=>{if(confirm("¿Seguro que quieres abandonar esta liga?"))try{await u.leagues.leave(t),v("Has abandonado la liga"),I.navigate("/ligas")}catch($){v($.message,"error")}}),(o=document.getElementById("btnJoin"))==null||o.addEventListener("click",async()=>{try{await u.leagues.join({league_id:t}),v("¡Te has unido a la liga!"),I.navigate(`/ligas/${t}`)}catch($){v($.message,"error")}}),(r=document.getElementById("btnEditLeague"))==null||r.addEventListener("click",()=>{ea(l,t,b)});const E=document.getElementById("tabRanking"),j=document.getElementById("tabTablon"),M=document.getElementById("sectionRanking"),L=document.getElementById("sectionTablon");E&&j&&(E.addEventListener("click",()=>{E.classList.add("league-tab--active"),j.classList.remove("league-tab--active"),M.classList.remove("hidden"),L.classList.add("hidden")}),j.addEventListener("click",()=>{j.classList.add("league-tab--active"),E.classList.remove("league-tab--active"),M.classList.add("hidden"),L.classList.remove("hidden");const $=document.getElementById("tablonEmbed");$&&!$.dataset.loaded&&($.dataset.loaded="1",oe($,{query:{liga:String(t)}}))}))}catch(d){e.innerHTML=`<div class="container"><p class="form__error">Error: ${d.message}</p><a href="#/ligas">Volver</a></div>`}}function ea(e,a,t){const s=document.getElementById("editLeagueModal");s&&s.remove();const n=document.createElement("div");n.id="editLeagueModal",n.className="edit-league-modal",n.innerHTML=`
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const r=document.getElementById("btnSaveEdit");r.disabled=!0,r.textContent="Guardando…";const d={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(d.is_official=document.getElementById("editOfficial").checked);try{await u.leagues.update(a,d),v("Liga actualizada"),i(),I.navigate(`/ligas/${a}`)}catch(l){v(l.message,"error"),r.disabled=!1,r.textContent="Guardar cambios"}})}async function aa(e){var t,s,n,i,o,r;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=y.getUser();try{const[d,l,h]=await Promise.all([u.clasificacion.division(),u.auth.me(),a!=null&&a.is_admin?u.leagues.adminAll():Promise.resolve({leagues:[]})]),g=l.user,_=g.status,b=g.total_points_all_time,f=(t=d.standings)==null?void 0:t.find(E=>E.user_id===g.id);e.innerHTML=`
    ...
    `).join("")}catch{a.innerHTML='<p class="empty">Sin conversaciones aún.</p>'}}async function sa(e){const a=e.querySelector("#mencionesTablon");if(a)try{const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString(),{messages:s}=await u.board.mentions(t);if(!s||!s.length){a.innerHTML='<p class="empty">Sin menciones recientes.</p>';return}a.innerHTML=s.slice(0,5).map(n=>`
    ...
    `).join("")}catch{a.innerHTML='<p class="empty">Sin menciones recientes.</p>'}}function na(e,a){if(e.next_threshold===null)return`
    ...
    </div>`}async function ia(e){var t,s;const a=e.querySelector("#predStatsWrap");if(a)try{const{total_predictions:n,correct_results:i,predictions:o}=await u.jornada.myStats();if(n===0){a.innerHTML='<p class="empty">Aún no tienes predicciones en esta temporada.</p>';return}const r=Math.round(i/n*100),d=50,l=+(2*Math.PI*d).toFixed(2),h=+(r/100*l).toFixed(2),g=+(l-h).toFixed(2);a.innerHTML=`
        ...
        <div class="pred-circle__chart">
          <svg viewBox="0 0 120 120" aria-hidden="true">
            ...
            <circle cx="60" cy="60" r="${d}" fill="none" stroke="#39FF14" stroke-width="12"
              stroke-dasharray="${h} ${g}" stroke-linecap="round"
  ...
  `,document.body.appendChild(e),document.body.style.overflow="hidden",requestAnimationFrame(()=>e.classList.add("delete-modal--open"));const a=e.querySelector("#deleteConfirmInput"),t=e.querySelector("#deleteConfirmBtn"),s=e.querySelector("#deleteCancelBtn"),n=e.querySelector("#deleteOverlay"),i=e.querySelector("#deleteError");function o(){e.classList.remove("delete-modal--open"),document.body.style.overflow="",e.addEventListener("transitionend",()=>e.remove(),{once:!0})}a.addEventListener("input",()=>{t.disabled=a.value.trim()!=="CERRAR"}),s.addEventListener("click",o),n.addEventListener("click",o),t.addEventListener("click",async()=>{t.disabled=!0,t.textContent="Cerrando…",i.classList.add("hidden");try{await u.auth.deleteAccount(),o(),y.logout(),v("Cuenta cerrada. Hasta pronto."),window.location.hash="/"}catch(r){i.textContent=r.message||"Error al cerrar la cuenta",i.classList.remove("hidden"),t.disabled=!1,t.textContent="Cerrar mi cuenta"}})}function ra(){window.location.hash="/"}async function da(e){if(!y.isAdmin()){e.innerHTML='<div class="container"><p class="form__error">Acceso denegado.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{users:a}=await u.auth.users();e.innerHTML=`
    ...
    `,la(e),Z(e)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function la(e){var s,n,i,o;(s=document.getElementById("btnSync"))==null||s.addEventListener("click",async()=>{const r=document.getElementById("syncResult");r.textContent="Sincronizando…";try{await u.matches.sync(),r.textContent="✓ Sincronización completada",v("Sincronización completada")}catch(d){r.textContent=`Error: ${d.message}`,v(d.message,"error")}});const a=document.getElementById("pushTarget"),t=document.getElementById("pushTargetIdGroup");a==null||a.addEventListener("change",()=>{t.classList.toggle("hidden",a.value==="all")}),(n=document.getElementById("pushForm"))==null||n.addEventListener("submit",async r=>{r.preventDefault();const d=document.getElementById("pushTitle").value.trim()||"Aviso",l=document.getElementById("pushBody").value.trim(),h=a.value,g=parseInt(document.getElementById("pushTargetId").value)||null,_=document.getElementById("pushResult"),b={title:`📣 PickGoal — ${d}`,body:l};h==="league"&&g&&(b.league_id=g),h==="user"&&g&&(b.user_id=g),_.textContent="Enviando…";try{const{sent:f}=await u.notifications.send(b);_.textContent=`✓ Enviada a ${f} suscripción(es)`,v(`Notificación enviada a ${f} suscripción(es)`)}catch(f){_.textContent=`Error: ${f.message}`,v(f.message,"error")}}),(i=document.getElementById("btnCloseSeason"))==null||i.addEventListener("click",async()=>{if(!confirm("¿Cerrar la temporada actual? Esta acción es irreversible."))return;const r=document.getElementById("btnCloseSeason"),d=document.getElementById("closeSeasonResult");r.disabled=!0,d.textContent="Cerrando…";try{const{message:l}=await u.post("/v2/admin/season/1/close");d.textContent=`✓ ${l||"Temporada cerrada"}`,v("Temporada cerrada")}catch(l){d.textContent=`Error: ${l.message}`,v(l.message,"error"),r.disabled=!1}}),(o=document.getElementById("usersTableBody"))==null||o.addEventListener("click",async r=>{const d=r.target.closest(".toggle-admin");if(d){const h=parseInt(d.dataset.id);try{const{user:g}=await u.auth.toggleAdmin(h);d.closest("tr").querySelector(".admin-badge").textContent=g.is_admin?"Sí":"No",v(`${g.username} ${g.is_admin?"ahora es admin":"ya no es admin"}`)}catch(g){v(g.message,"error")}return}const l=r.target.closest(".toggle-mute");if(l){const h=parseInt(l.dataset.id);try{const{user:g}=await u.auth.toggleMute(h),_=l.closest("tr");_.querySelector(".mute-badge").textContent=g.is_muted?"Sí":"No",l.textContent=g.is_muted?"Activar":"Silenciar",v(`${g.username} ${g.is_muted?"silenciado":"activado"}`)}catch(g){v(g.message,"error")}}})}function ca(e){return`
    <tr>
      <td>${e.id}</td>
      <td>${e.username}</td>
      <td>${e.email}</td>
  ...
  `}const ua={PD:"🇪🇸 LaLiga",PL:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League",CL:"⭐ Champions League",SA:"🇮🇹 Serie A",BL1:"🇩🇪 Bundesliga",FL1:"🇫🇷 Ligue 1",PPL:"🇵🇹 Primeira Liga"};let x=[],Y=null;async function Z(e){const a=document.getElementById("jornadasV2Content");if(a)try{const{jornadas:t}=await u.adminV2.jornadas();a.innerHTML=ma(t),ga(a)}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function ma(e){const t=$a(new Date);return`
    <div class="jv2-panel">
      ...
      <div class="jv2-list">
        ${e.length===0?'<p class="admin-section__desc">No hay jornadas creadas.</p>':e.map(pa).join("")}
      </div>
  ...
  `}function ga(e){var a,t,s,n;(a=e.querySelector("#btnNuevaJornada"))==null||a.addEventListener("click",()=>{Y=null,x=[],document.getElementById("jv2FormTitle").textContent="Nueva jornada",document.getElementById("jv2EditId").value="",document.getElementById("jv2Number").value="",document.getElementById("jv2DateStart").value="",document.getElementById("jv2DateEnd").value="",document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",re()}),(t=e.querySelector("#btnCancelarJornada"))==null||t.addEventListener("click",()=>{document.getElementById("jv2Form").style.display="none",x=[],Y=null}),(s=e.querySelector("#btnBuscarPartidos"))==null||s.addEventListener("click",_a),(n=e.querySelector("#btnGuardarJornada"))==null||n.addEventListener("click",ha),e.querySelectorAll(".jv2-pub-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Publicar jornada ${i.dataset.num}? Se calcularán cuotas, se asignarán duelos y se notificará a los usuarios.`)){i.disabled=!0,i.textContent="Publicando…";try{const o=await u.adminV2.publishJornada(i.dataset.id);v(`Jornada ${i.dataset.num} publicada — push enviado a ${o.push_sent} suscriptores`),await Z(document.getElementById("jornadasV2Section"))}catch(o){v(o.message,"error"),i.disabled=!1,i.textContent="Publicar"}}})}),e.querySelectorAll(".jv2-edit-btn").forEach(i=>{i.addEventListener("click",()=>va(i.dataset.id))}),e.querySelectorAll(".jv2-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(confirm(`¿Eliminar jornada ${i.dataset.num}?`))try{await u.adminV2.deleteJornada(i.dataset.id),v("Jornada eliminada"),Z(document.querySelector("#jornadasV2Content").parentElement.parentElement)}catch(o){v(o.message,"error")}})})}async function va(e){const{jornadas:a}=await u.adminV2.jornadas(),t=a.find(s=>String(s.id)===String(e));t&&(Y=t.id,x=[],document.getElementById("jv2FormTitle").textContent=`Editar jornada ${t.number}`,document.getElementById("jv2EditId").value=t.id,document.getElementById("jv2Number").value=t.number,t.date_start&&(document.getElementById("jv2DateStart").value=t.date_start.slice(0,16)),t.date_end&&(document.getElementById("jv2DateEnd").value=t.date_end.slice(0,16)),document.getElementById("jv2MatchPicker").style.display="none",document.getElementById("jv2Form").style.display="block",re())}async function _a(){const e=document.getElementById("btnBuscarPartidos"),a=document.getElementById("jv2Week").value;if(!a){v("Selecciona una semana","error");return}e.disabled=!0,e.textContent="Buscando…";try{const{matches:t}=await u.adminV2.partidos(a);ba(t),document.getElementById("jv2MatchPicker").style.display="block"}catch(t){v(`Error: ${t.message}`,"error")}finally{e.disabled=!1,e.textContent="Buscar partidos"}}function ba(e){const a=document.getElementById("jv2MatchList");if(Object.values(e).flat().length===0){a.innerHTML='<p class="admin-section__desc">No hay partidos disponibles para esta semana.</p>';return}a.innerHTML=Object.entries(e).map(([s,n])=>n.length?`
      <div class="jv2-comp-group">
        <div class="jv2-comp-group__title">${ua[s]||s}</div>
        ${n.map(i=>`
          <label class="jv2-match-item">
            ...
            <span class="jv2-match-item__date">${fa(i.match_datetime)}</span>
          </label>
        `).join("")}
      </div>
    `:"").join(""),a.querySelectorAll(".jv2-match-check").forEach(s=>{s.addEventListener("change",()=>{const n=JSON.parse(s.dataset.match);if(s.checked){if(x.length>=10){s.checked=!1,v("Máximo 10 partidos","error");return}x.push(n)}else x=x.filter(i=>i.api_id!==n.api_id);re()})})}function re(){const e=document.getElementById("jv2Count"),a=document.getElementById("jv2CountWarn");e&&(e.textContent=x.length),a&&(a.style.display=x.length>0&&x.length!==10?"inline":"none")}async function ha(){const e=parseInt(document.getElementById("jv2Number").value),a=document.getElementById("jv2DateStart").value,t=document.getElementById("jv2DateEnd").value,s=document.getElementById("jv2EditId").value;if(!e||!a||!t){v("Completa número y fechas","error");return}if(x.length!==10){v("Selecciona exactamente 10 partidos","error");return}const n={number:e,date_start:new Date(a).toISOString(),date_end:new Date(t).toISOString(),matches:x},i=document.getElementById("btnGuardarJornada");i.disabled=!0;try{s?(await u.adminV2.updateJornada(s,n),v(`Jornada ${e} actualizada`)):(await u.adminV2.createJornada(n),v(`Jornada ${e} guardada como borrador`)),document.getElementById("jv2Form").style.display="none",x=[],Y=null,await Z(document.getElementById("jornadasV2Section"))}catch(o){v(o.message,"error")}finally{i.disabled=!1}}function fa(e){return e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"}):"—"}function ya(e){const a=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),t=a.getUTCDay()||7;a.setUTCDate(a.getUTCDate()+4-t);const s=new Date(Date.UTC(a.getUTCFullYear(),0,1));return Math.ceil(((a-s)/864e5+1)/7)}function $a(e){const a=new Date(e);a.setDate(a.getDate()+7);const t=a.getFullYear(),s=String(ya(a)).padStart(2,"0");return`${t}-W${s}`}function Ea(e){e.innerHTML=`
    <div class="auth-container container">
      <div class="auth-card">
  ...
  `,document.getElementById("resetForm").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("resetBtn"),i=document.getElementById("resetError"),o=document.getElementById("password").value;n.disabled=!0,n.textContent="Guardando…",i.classList.add("hidden");try{await u.auth.resetPassword(t,o),v("Contraseña actualizada. Ya puedes iniciar sesión."),I.navigate("/login")}catch(r){i.textContent=r.message||"Error al restablecer la contraseña",i.classList.remove("hidden")}finally{n.disabled=!1,n.textContent="Guardar contraseña"}})}async function wa(e,{query:a}){const t=(a.codigo||"").trim().toUpperCase();if(!t){e.innerHTML='<div class="container"><p class="form__error">Enlace de invitación inválido.</p><a href="#/ligas">Ver ligas</a></div>';return}if(!y.isLoggedIn()){sessionStorage.setItem("pendingInviteCode",t),I.navigate("/register");return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{league:s}=await u.leagues.joinByCode(t);v(`¡Te has unido a "${s.name}"!`),I.navigate(`/ligas/${s.id}`)}catch(s){if(s.status===409){v("Ya eres miembro de esta liga");try{const{leagues:n}=await u.leagues.my(),i=n.find(o=>o.invite_code===t);if(i){I.navigate(`/ligas/${i.id}`);return}}catch{}}e.innerHTML=`
      <div class="container">
        <div class="league-gate">
    ...
    `}}function ja(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function Ia(e,{params:a}){const t=parseInt(a.id);if(!t){e.innerHTML='<div class="container"><p class="form__error">Usuario no válido.</p></div>';return}e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const s=ja(),{user:n,predictions:i}=await u.predictions.forUser(t,s);e.innerHTML=`
      <div class="container">
  ...
  `}const z=20,Se=5;let O={},N=0,se=null,_e=null;async function ka(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await u.jornada.list();if(!a.length){e.innerHTML=xa();return}ke(e,a,0)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function ke(e,a,t){var d,l;_e=a[t];const{jornada:s,matches:n,units_used:i}=_e;O={};for(const h of n)O[h.jornada_match_id]={predicted_result:((d=h.prediction)==null?void 0:d.predicted_result)??null,units:((l=h.prediction)==null?void 0:l.units_wagered)??0};N=i;const o=n.filter(h=>!h.predict_locked);se=o.length===1?o[0].jornada_match_id:null;const r=a.length>1?`<div class="jornada-tabs">
        ${a.map((h,g)=>`
  ...
  `,xe(),Ce(),Pa(e,a,t)}function xa(){return`
    <div class="container">
  ...
  `}function X(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function Ca(e){return new Date(e).toLocaleTimeString("es-ES",{hour:"2-digit",minute:"2-digit"})}function Ba(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function te(e){return e!=null?e.toFixed(2):"—"}function Ta(e){return e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${Ca(e.opens_until)}</span>`}function Ma(e){const a=e.predict_locked,t=O[e.jornada_match_id]??{predicted_result:null,units:0};return`
  ...
  `}function xe(){const e=document.getElementById("unitsCounter");if(!e)return;const a=N>z;e.innerHTML=`
    <div class="units-counter__bar">
      <div class="units-counter__fill ${a?"units-counter__fill--over":""}" style="width:${Math.min(100,N/z*100)}%"></div>
    </div>
    <span class="units-counter__label ${a?"units-counter__label--over":""}">${N}/${z} unidades usadas</span>
  `}function Ce(){if(!se)return;const e=document.getElementById(`warning-${se}`);if(!e)return;const a=z-N;e.innerHTML=a>0?`<p class="notice">Te quedan ${a} unidades — es tu último partido.</p>`:""}function be(){N=Object.values(O).reduce((e,a)=>e+(a.predicted_result?a.units:0),0),xe(),Ce()}function Pa(e,a,t){e.querySelectorAll(".jornada-tab").forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.idx);n!==t&&ke(e,a,n)})}),e.querySelectorAll(".jornada-match").forEach(s=>{var o;const n=parseInt(s.dataset.jmId);s.querySelectorAll('input[type="radio"]').forEach(r=>{r.addEventListener("change",()=>{O[n].predicted_result=r.value,be()})});const i=s.querySelector(".jornada-units__input");i==null||i.addEventListener("input",()=>{let r=parseInt(i.value);isNaN(r)&&(r=0),r=Math.max(0,Math.min(Se,r)),O[n].units=r,be()}),(o=s.querySelector(".jornada-match__save-btn"))==null||o.addEventListener("click",()=>Da(n))})}async function Da(e){const a=O[e];if(!a.predicted_result){v("Selecciona un resultado 1X2","error");return}if(N>z){v(`Superas el máximo de ${z} unidades`,"error");return}const t=document.querySelector(`.jornada-match__save-btn[data-jm-id="${e}"]`);t&&(t.disabled=!0,t.textContent="…");try{await u.jornada.predict({jornada_match_id:e,predicted_result:a.predicted_result,units:a.units}),v("Predicción guardada"),t&&(t.textContent="✓ Guardada")}catch(s){v(s.message||"Error al guardar","error")}finally{t&&(t.disabled=!1,setTimeout(()=>{t&&(t.textContent="Guardar")},2e3))}}const he={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}};async function Ha(e){var a;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{duelo:t}=await u.duelo.current(),s=y.getUser();if(!t){e.innerHTML=`
        <div class="container">
      ...
      `;return}const n=he[t.status]??he.en_curso,i=t.rival?t.rival.username:s.username,o=!t.rival||t.rival.id===s.id;e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Tu duelo esta jornada</h1>
    ...
    `,Aa(t.division_league_id,s.id)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando el duelo: ${t.message}</p></div>`}}function qa(e,a){var i;const t=(i=e.my_prediction)==null?void 0:i.predicted_result;let s,n;return e.started?e.rival_prediction?(s=e.rival_prediction.predicted_result,n=""):(s="—",n="duelo-pick__value--empty"):(s="?",n="duelo-pick__value--hidden"),`
  ...
  `}async function Aa(e,a){const t=document.getElementById("divisionStandings");if(t)try{const{standings:s}=await u.clasificacion.division(e);if(s.length===0){t.innerHTML='<p class="empty">Sin clasificación disponible.</p>';return}t.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
            <tr>
    ...
    `}catch(s){t.innerHTML=`<p class="form__error">Error cargando la clasificación: ${s.message}</p>`}}async function Na(e,{query:a={}}={}){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{standings:t}=await u.clasificacion.general(),s=y.getUser();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">Clasificación</h1>
    ...
    `,Ua(s,a.tab),Oa(),za(e,s)}catch(t){e.innerHTML=`<div class="container"><p class="form__error">Error cargando la clasificación: ${t.message}</p></div>`}}async function Oa(){const e=document.getElementById("tablonTabDot");if(!e)return;if(!y.getUser()){e.classList.add("hidden");return}const t=localStorage.getItem("tablon_general_last_read")||new Date(0).toISOString();try{const{count:s}=await u.board.unread(null,t);console.log("[tablonDot] count:",s,"since:",t),e.classList.toggle("hidden",s===0)}catch(s){console.warn("[tablonDot] error:",s),e.classList.add("hidden")}}function Ua(e,a){const t={general:{btn:document.getElementById("tabGeneral"),panel:document.getElementById("panelGeneral")},miDivision:{btn:document.getElementById("tabMiDivision"),panel:document.getElementById("panelMiDivision")},divisiones:{btn:document.getElementById("tabDivisiones"),panel:document.getElementById("panelDivisiones")},tablon:{btn:document.getElementById("tabTablon"),panel:document.getElementById("panelTablon")}};function s(i){for(const[o,{btn:r,panel:d}]of Object.entries(t))r.classList.toggle("league-tab--active",o===i),d.classList.toggle("hidden",o!==i)}t.general.btn.addEventListener("click",()=>s("general")),t.miDivision.btn.addEventListener("click",()=>{s("miDivision"),t.miDivision.panel.dataset.loaded||(t.miDivision.panel.dataset.loaded="1",Ra(e))}),t.divisiones.btn.addEventListener("click",()=>{s("divisiones"),t.divisiones.panel.dataset.loaded||(t.divisiones.panel.dataset.loaded="1",Fa(e))});function n(){var i;s("tablon"),localStorage.setItem("tablon_general_last_read",new Date().toISOString()),(i=document.getElementById("tablonTabDot"))==null||i.classList.add("hidden"),document.dispatchEvent(new CustomEvent("tablon:read")),t.tablon.panel.dataset.loaded||(t.tablon.panel.dataset.loaded="1",oe(t.tablon.panel,{forceGeneral:!0}))}t.tablon.btn.addEventListener("click",n),a==="tablon"&&n()}async function Ra(e){const a=document.getElementById("panelMiDivision");if(a)try{const{standings:t}=await u.clasificacion.division();if(t.length===0){a.innerHTML='<p class="empty">Todavía no perteneces a ninguna división.</p>';return}a.innerHTML=`
      <div class="ranking-table-wrapper">
        <table class="ranking-table">
          <thead>
    ...
    `}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}async function Fa(e){const a=document.getElementById("panelDivisiones");if(a)try{const{divisions:t}=await u.clasificacion.allDivisions();if(!t.length){a.innerHTML='<p class="empty">No hay divisiones activas.</p>';return}a.innerHTML=t.map(s=>Ja(s,e)).join(""),a.querySelectorAll(".div-accordion__header").forEach(s=>{s.addEventListener("click",()=>{const i=s.nextElementSibling.classList.toggle("hidden");s.querySelector(".div-accordion__chevron").textContent=i?"▶":"▼"})})}catch(t){a.innerHTML=`<p class="form__error">Error: ${t.message}</p>`}}function Ja(e,a){const t=e.standings.some(s=>a&&s.user_id===a.id);return`
  ...
  `}async function fe(e,{params:a={}}={}){const t=a.userId?parseInt(a.userId):null;t?await Wa(e,t):await Ga(e)}async function Ga(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{conversations:a}=await u.messages.list();e.innerHTML=`
      <div class="container">
        <h1 class="page-title">💬 Mensajes</h1>
        ${a.length===0?'<p class="empty">No tienes conversaciones aún. Pulsa el nombre de un jugador en la clasificación para enviar un mensaje.</p>':`<div class="mensajes-list">${a.map(Va).join("")}</div>`}
      </div>
    `,e.querySelectorAll(".mensajes-item").forEach(t=>{t.addEventListener("click",()=>{window.location.hash=`/mensajes/${t.dataset.userId}`})})}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error: ${a.message}</p></div>`}}function Va(e){return`
  ...
  `}async function Wa(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=y.getUser();try{const{messages:n,partner:i}=await u.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
      <div class="container">
        ...
        <div class="chat-messages" id="chatMessages">
          ${n.length===0?'<p class="empty" style="text-align:center">Empieza la conversación.</p>':n.map(r=>ye(r,t)).join("")}
        </div>
    ...
    `;const o=document.getElementById("chatMessages");o&&(o.scrollTop=o.scrollHeight),(s=document.getElementById("chatForm"))==null||s.addEventListener("submit",async r=>{r.preventDefault();const d=document.getElementById("chatMsg"),l=d.value.trim();if(!l)return;const h=r.target.querySelector('button[type="submit"]');h.disabled=!0;try{const{message:g}=await u.messages.send(a,l);d.value="";const _=document.getElementById("chatMessages"),b=_==null?void 0:_.querySelector(".empty");b&&b.remove(),_==null||_.insertAdjacentHTML("beforeend",ye(g,t)),_&&(_.scrollTop=_.scrollHeight)}catch(g){v(g.message,"error")}finally{h.disabled=!1}})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function ye(e,a){return`
  ...
  `}function V(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const $e=e=>()=>{window.location.hash=e},Xa={"/":Ne,"/login":Ge,"/register":Ve,"/quiniela":$e("/jornada"),"/resultados":$e("/tabla-v2"),"/ranking":Xe,"/tablon":oe,"/ligas":Ze,"/ligas/:id":Qe,"/perfil":aa,"/campeon":ra,"/admin":da,"/forgot-password":Ea,"/reset-password":La,"/unirse":wa,"/jugador/:id":Ia,"/jornada":ka,"/duelo":Ha,"/tabla-v2":Na,"/mensajes":fe,"/mensajes/:userId":fe};function Ya(e){for(const[a,t]of Object.entries(Xa)){const s=[],n=new RegExp("^"+a.replace(/:([^/]+)/g,(o,r)=>(s.push(r),"([^/]+)"))+"$"),i=e.match(n);if(i){const o={};return s.forEach((r,d)=>{o[r]=i[d+1]}),{handler:t,params:o}}}return null}const Ee=()=>document.getElementById("mainContent"),I={init(){window.addEventListener("hashchange",()=>this.resolve()),this.resolve()},navigate(e){window.location.hash=e},resolve(){const e=window.location.hash.slice(1)||"/",[a,t]=e.split("?"),s=Object.fromEntries(new URLSearchParams(t||"")),n=Ya(a);if(!n){Ee().innerHTML='<div class="error-page"><h2>Página no encontrada</h2><a href="#/">Volver al inicio</a></div>';return}const{handler:i,params:o}=n;if(["/perfil","/admin","/jornada","/duelo","/tabla-v2","/mensajes"].includes(a)&&!y.isLoggedIn()){this.navigate("/login");return}if(a==="/admin"&&!y.isAdmin()){this.navigate("/");return}const d=Ee();d.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>',i(d,{params:o,query:s})}};let G=[],J=null,R=null,Q=!1;async function Za(){document.documentElement.dataset.build="2026-08-09T11",await y.init(),I.init(),et(),Ka(),st()}function Te(){return localStorage.getItem("pwa_installed")==="true"||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0}function Ka(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),!Te()&&(J=e,Qa())}),window.addEventListener("appinstalled",()=>{var e;localStorage.setItem("pwa_installed","true"),J=null,(e=document.getElementById("installBanner"))==null||e.remove()})}function Qa(){if(Te()||sessionStorage.getItem("installBannerDismissed"))return;const e=document.createElement("div");e.id="installBanner",e.className="install-banner",e.innerHTML=`
  ...
  `}function F(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}Za();
