(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Ze="https://pickgoal-backend.onrender.com/api";function Qe(){return localStorage.getItem("token")}async function m(e,a={}){const t={"Content-Type":"application/json",...a.headers},s=Qe();s&&(t.Authorization=`Bearer ${s}`);const n=await fetch(`${Ze}${e}`,{cache:"no-store",...a,headers:t}),i=await n.json().catch(()=>({}));if(!n.ok)throw{status:n.status,message:i.error||"Error desconocido"};return i}const c={get:e=>m(e),post:(e,a)=>m(e,{method:"POST",body:JSON.stringify(a)}),patch:(e,a)=>m(e,{method:"PATCH",body:JSON.stringify(a)}),delete:e=>m(e,{method:"DELETE"}),auth:{register:e=>m("/auth/register",{method:"POST",body:JSON.stringify(e)}),login:e=>m("/auth/login",{method:"POST",body:JSON.stringify(e)}),me:()=>m("/auth/me"),forgotPassword:e=>m("/auth/forgot-password",{method:"POST",body:JSON.stringify({email:e})}),resetPassword:(e,a)=>m("/auth/reset-password",{method:"POST",body:JSON.stringify({token:e,password:a})}),ranking:e=>m(`/auth/ranking${e?`?league_id=${e}`:""}`),deleteAccount:()=>m("/auth/account",{method:"DELETE"}),users:()=>m("/auth/users"),usersForMentions:()=>m("/auth/users/for-mentions"),toggleAdmin:e=>m(`/auth/users/${e}/toggle-admin`,{method:"PATCH"}),toggleMute:e=>m(`/auth/users/${e}/toggle-mute`,{method:"PATCH"}),updateEmail:e=>m("/auth/me/email",{method:"PATCH",body:JSON.stringify({email:e})})},matches:{grouped:()=>m("/matches/grouped"),list:(e="")=>m(`/matches/${e}`),get:e=>m(`/matches/${e}`),today:()=>m("/matches/today"),setResult:(e,a,t,s=null)=>m(`/matches/${e}/result`,{method:"PATCH",body:JSON.stringify({home_score:a,away_score:t,...s?{result_90:s}:{}})}),sync:()=>m("/matches/sync",{method:"POST"}),recalculate:()=>m("/matches/recalculate",{method:"POST"})},predictions:{mine:e=>m(`/predictions/${e?`?league_id=${e}`:""}`),forMatch:(e,a)=>m(`/predictions/match/${e}${a?`?league_id=${a}`:""}`),save:e=>m("/predictions/",{method:"POST",body:JSON.stringify(e)}),forUser:(e,a)=>m(`/predictions/user/${e}${a?`?league_id=${a}`:""}`),getChampion:e=>m(`/predictions/champion${e?`?league_id=${e}`:""}`),saveChampion:(e,a)=>m("/predictions/champion",{method:"POST",body:JSON.stringify({team_name:e,league_id:a??null})}),awardChampion:e=>m("/predictions/champion/award",{method:"POST",body:JSON.stringify({team_name:e})})},leagues:{all:()=>m("/leagues/all"),public:()=>m("/leagues/public"),my:()=>m("/leagues/my"),create:e=>m("/leagues/",{method:"POST",body:JSON.stringify(e)}),join:e=>m("/leagues/join",{method:"POST",body:JSON.stringify(e)}),joinByCode:e=>m(`/leagues/join/${encodeURIComponent(e)}`),adminAll:()=>m("/leagues/admin"),get:e=>m(`/leagues/${e}`),update:(e,a)=>m(`/leagues/${e}`,{method:"PUT",body:JSON.stringify(a)}),leave:e=>m(`/leagues/${e}/leave`,{method:"DELETE"}),members:e=>m(`/leagues/${e}/members`),matchPredictions:(e,a)=>m(`/leagues/${e}/predictions/${a}`)},home:{summary:()=>m("/home/summary")},board:{messages:(e=1,a=null)=>m(`/board/?page=${e}${a?`&league_id=${a}`:""}`),unread:(e,a)=>m(`/board/unread?${e?`league_id=${e}&`:""}since=${encodeURIComponent(a)}`),post:(e,a=null)=>m("/board/",{method:"POST",body:JSON.stringify({message:e,league_id:a})}),pin:e=>m(`/board/${e}/pin`,{method:"POST"}),reply:(e,a)=>m(`/board/${e}/reply`,{method:"POST",body:JSON.stringify({message:a})}),delete:e=>m(`/board/${e}`,{method:"DELETE"}),mentions:e=>m(`/board/mentions?since=${encodeURIComponent(e)}`)},notifications:{vapidPublicKey:()=>m("/notifications/vapid-public-key"),subscribe:e=>m("/notifications/subscribe",{method:"POST",body:JSON.stringify(e)}),send:e=>m("/notifications/send",{method:"POST",body:JSON.stringify(e)})},adminV2:{partidos:(e,a,t)=>m(`/v2/admin/partidos-disponibles?date_from=${encodeURIComponent(e)}&date_to=${encodeURIComponent(a)}${t&&t.length?`&competitions=${encodeURIComponent(t.join(","))}`:""}`),jornadas:()=>m("/v2/admin/jornadas"),createJornada:e=>m("/v2/admin/jornada",{method:"POST",body:JSON.stringify(e)}),updateJornada:(e,a)=>m(`/v2/admin/jornada/${e}`,{method:"PUT",body:JSON.stringify(a)}),deleteJornada:e=>m(`/v2/admin/jornada/${e}`,{method:"DELETE"}),publishJornada:e=>m(`/v2/admin/jornada/${e}/publish`,{method:"POST"}),closeJornada:e=>m(`/v2/admin/jornada/${e}/close`,{method:"POST"}),jornadaMatches:e=>m(`/v2/admin/jornada/${e}/matches`),setResultado:(e,a)=>m(`/v2/admin/jornada-match/${e}/resultado`,{method:"POST",body:JSON.stringify(a)}),cancelMatch:e=>m(`/v2/admin/jornada-match/${e}/cancel`,{method:"POST"}),addManualMatch:(e,a)=>m(`/v2/admin/jornada/${e}/match/manual`,{method:"POST",body:JSON.stringify(a)}),deleteManualMatch:e=>m(`/v2/admin/jornada-match/${e}`,{method:"DELETE"}),generateBots:()=>m("/v2/admin/bots/generate",{method:"POST"}),weeklyChecklist:()=>m("/v2/admin/weekly-checklist")},jornada:{info:()=>m("/v2/jornada/info"),current:()=>m("/v2/jornada/current"),list:()=>m("/v2/jornada/list"),predict:e=>m("/v2/jornada/predict",{method:"POST",body:JSON.stringify(e)}),history:()=>m("/v2/jornada/history"),myStats:()=>m("/v2/jornada/my-stats")},duelo:{list:()=>m("/v2/duelo/list"),current:e=>m(`/v2/duelo/current${e?`?jornada_id=${e}`:""}`),detail:e=>m(`/v2/duelo/current/detail${e?`?jornada_id=${e}`:""}`)},messages:{unread:()=>m("/messages/unread"),list:()=>m("/messages/"),get:e=>m(`/messages/${e}`),send:(e,a)=>m(`/messages/${e}`,{method:"POST",body:JSON.stringify({message:a})}),markAllRead:()=>m("/messages/mark-all-read",{method:"PATCH"})},clasificacion:{division:e=>m(`/v2/clasificacion/division${e?`?league_id=${e}`:""}`),general:()=>m("/v2/clasificacion/general"),allDivisions:()=>m("/v2/clasificacion/all-divisions")}};let H=null;const E={async init(){if(localStorage.getItem("token"))try{const{user:a}=await c.auth.me();H=a}catch{localStorage.removeItem("token")}},setUser(e,a){H=e,localStorage.setItem("token",a),document.dispatchEvent(new CustomEvent("auth:change",{detail:e}))},logout(){H=null,localStorage.removeItem("token"),document.dispatchEvent(new CustomEvent("auth:change",{detail:null}))},getUser(){return H},isLoggedIn(){return!!H},isAdmin(){return(H==null?void 0:H.is_admin)===!0}};let de=null;function _(e,a="success"){let t=document.getElementById("toast");t||(t=document.createElement("div"),t.id="toast",document.body.appendChild(t)),t.textContent=e,t.className=`toast toast--${a} toast--visible`,de&&clearTimeout(de),de=setTimeout(()=>{t.classList.remove("toast--visible")},3e3)}function ea(){return`
  ...
  `,document.getElementById("registerForm").addEventListener("submit",async a=>{a.preventDefault();const t=document.getElementById("registerBtn"),s=document.getElementById("registerError");t.disabled=!0,t.textContent="Creando cuenta…",s.classList.add("hidden");const n={username:document.getElementById("username").value.trim(),email:document.getElementById("email").value.trim(),country:document.getElementById("country").value.trim(),password:document.getElementById("password").value};try{const{token:i,user:o}=await c.auth.register(n);E.setUser(o,i),_("¡Cuenta creada! Bienvenido a PickGoal");const r=sessionStorage.getItem("pendingInviteCode");if(r){sessionStorage.removeItem("pendingInviteCode");try{const{league:d}=await c.leagues.joinByCode(r);_(`¡Te has unido a "${d.name}"!`),S.navigate(`/ligas/${d.id}`)}catch{S.navigate("/ligas")}}else S.navigate("/"),Ae("/")}catch(i){s.textContent=i.message||"Error al registrarse",s.classList.remove("hidden")}finally{t.disabled=!1,t.textContent="Crear cuenta"}})}function ua(){const e=localStorage.getItem("activeLeagueId");return e?parseInt(e):null}async function ma(e){var a,t;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{if(E.isLoggedIn()){const{leagues:v}=await c.leagues.my();if(v.length===0){e.innerHTML=ea();return}}const s=ua(),[{ranking:n},i]=await Promise.all([c.auth.ranking(s),E.isLoggedIn()?c.leagues.my():Promise.resolve({leagues:[]})]),o=E.getUser(),r=i.leagues.find(v=>v.id===s),d=document.getElementById("tablonBadge"),l=d&&!d.classList.contains("hidden"),h=l?d.textContent:"",p=((a=n[0])==null?void 0:a.matches_played)??0;e.innerHTML=`
      ...
      <div class="container">
        ...
        <div class="ranking-table-wrapper">
          <table class="ranking-table">
            ...
            <tbody>
              ${n.map(v=>{var L,b,u;const f=v.predictions_made??0,$=`${f}/${p}`,y=`${v.correct_results??0}/${f}`,j=`${v.exact_scores??0}/${f}`;return`
                  <tr class="${o&&v.id===o.id?"ranking-table__row--me":""}">
                    ...
                    <td>
                      <a class="ranking-table__link" href="#/jugador/${v.id}">
                        <span class="status-emoji" title="${((L=v.status)==null?void 0:L.name)||""}">${((b=v.status)==null?void 0:b.emoji)||""}</span>${v.username}
                      </a>
                    </td>
                    <td class="ranking-table__stat ranking-table__status">${((u=v.status)==null?void 0:u.name)||"—"}</td>
    ...
    `,y(),j(),I()}function p(u){return u.length?u.map(g=>`
      ...
      <div class="container">
        ...
        ${i&&!o&&d.leagues.length>0?`
          <section class="section">
            <h2>Mis ligas</h2>
            <div class="leagues-grid">${d.leagues.map(p=>$e(p,!0)).join("")}</div>
          </section>
        `:""}
        ...
        <section class="section">
          ...
          ${h.length?`<div class="leagues-grid">${h.map(p=>$e(p,!1,l,o)).join("")}</div>`:o?'<p class="empty">No hay ligas creadas aún.</p>':d.leagues.length>0?'<p class="empty">Ya participas en todas las ligas disponibles.</p>':'<p class="empty">No hay ligas aún. ¡Crea la primera!</p>'}
        </section>
      </div>
    `,e.querySelectorAll('.league-card[data-navigate="true"]').forEach(p=>{p.addEventListener("click",()=>S.navigate(`/ligas/${p.dataset.id}`))}),e.querySelectorAll(".btn-join-league").forEach(p=>{p.addEventListener("click",async v=>{v.stopPropagation();const f=parseInt(p.dataset.id);p.disabled=!0,p.textContent="…";try{const{league:$}=await c.leagues.join({league_id:f});_(`¡Te has unido a "${$.name}"!`),S.navigate(`/ligas/${$.id}`)}catch($){_($.message,"error"),p.disabled=!1,p.textContent="Unirse"}})}),e.querySelectorAll(".btn-private-info").forEach(p=>{p.addEventListener("click",v=>{v.stopPropagation(),_("Esta liga es privada. Pide el enlace de invitación a cualquier miembro para unirte.","info")})}),(a=document.getElementById("btnShowCreate"))==null||a.addEventListener("click",()=>{var p,v;(p=document.getElementById("createLeaguePanel"))==null||p.classList.remove("hidden"),(v=document.getElementById("btnShowCreate"))==null||v.classList.add("hidden")}),(t=document.getElementById("btnCancelCreate"))==null||t.addEventListener("click",()=>{var p,v;(p=document.getElementById("createLeaguePanel"))==null||p.classList.add("hidden"),(v=document.getElementById("btnShowCreate"))==null||v.classList.remove("hidden")}),(s=document.getElementById("joinCodeForm"))==null||s.addEventListener("submit",async p=>{p.preventDefault();const v=document.getElementById("inviteCode").value.trim().toUpperCase();if(v)try{const{league:f}=await c.leagues.join({invite_code:v});_(`Te has unido a "${f.name}"`),S.navigate(`/ligas/${f.id}`)}catch(f){_(f.message,"error")}}),(n=document.getElementById("createLeagueForm"))==null||n.addEventListener("submit",async p=>{var L;p.preventDefault();const v=document.getElementById("createBtn");v.disabled=!0,v.textContent="Creando…";const f=document.getElementById("leagueName").value.trim(),$=document.getElementById("leagueDesc").value.trim(),y=document.getElementById("leaguePrize").value.trim(),j=document.getElementById("isPublic").checked,I=((L=document.getElementById("isOfficial"))==null?void 0:L.checked)??!1;try{const{league:b}=await c.leagues.create({name:f,description:$,prize:y,is_public:j,is_official:I});_a(b)}catch(b){_(b.message,"error"),v.disabled=!1,v.textContent="Crear liga"}})}catch(i){e.innerHTML=`<div class="container"><p class="form__error">Error: ${i.message}</p></div>`}}function $e(e,a=!1,t=new Set,s=!1){const n=e.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"",i=e.is_public?"🌍":"🔒",o=s?`<button class="btn btn--sm btn--outline btn-admin-view" data-id="${e.id}">Ver (admin)</button>`:a?`<button class="btn btn--sm btn--outline" onclick="event.stopPropagation(); window.location.hash='/ligas/${e.id}'">Ver liga</button>`:e.is_public?`<button class="btn btn--sm btn--primary btn-join-league" data-id="${e.id}">Unirse</button>`:'<button class="btn btn--sm btn--ghost btn-private-info">🔒 Solicitar enlace</button>';return`
  ...
  `,(s=document.getElementById("btnCopyLink"))==null||s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a),_("Enlace copiado")}catch{_("No se pudo copiar","error")}}),(n=document.getElementById("btnShare"))==null||n.addEventListener("click",async()=>{try{await navigator.share({title:`Únete a ${e.name} en PickGoal`,url:a})}catch{}}))}async function ga(e,{params:a}){var s,n,i,o,r;const t=parseInt(a.id);e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const d=await c.leagues.get(t),{league:l,ranking:h,is_member:p,is_admin_view:v}=d,f=E.getUser(),$=l.is_official?'<span class="league-badge league-badge--official">⭐ Oficial</span>':"";e.innerHTML=`
      <div class="container">
        ...
        ${(p||f!=null&&f.is_admin)&&l.invite_link?`
        ...
        <div class="league-actions">
          ${p?'<button class="btn btn--danger btn--sm" id="btnLeave">Abandonar liga</button>':!(f!=null&&f.is_admin)&&f?'<button class="btn btn--primary" id="btnJoin">Unirse a esta liga</button>':""}
          ${f!=null&&f.is_admin||p&&f&&l.created_by===f.id?'<button class="btn btn--outline btn--sm" id="btnEditLeague">Editar liga</button>':""}
        </div>
  ...
  `,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add("edit-league-modal--open"));const i=()=>{n.classList.remove("edit-league-modal--open"),n.addEventListener("transitionend",()=>n.remove(),{once:!0})};n.querySelector(".edit-league-modal__overlay").addEventListener("click",i),document.getElementById("btnCancelEdit").addEventListener("click",i),document.getElementById("editLeagueForm").addEventListener("submit",async o=>{o.preventDefault();const r=document.getElementById("btnSaveEdit");r.disabled=!0,r.textContent="Guardando…";const d={name:document.getElementById("editName").value.trim(),description:document.getElementById("editDesc").value.trim(),prize:document.getElementById("editPrize").value.trim(),is_public:document.getElementById("editPublic").checked};t!=null&&t.is_admin&&(d.is_official=document.getElementById("editOfficial").checked);try{await c.leagues.update(a,d),_("Liga actualizada"),i(),S.navigate(`/ligas/${a}`)}catch(l){_(l.message,"error"),r.disabled=!1,r.textContent="Guardar cambios"}})}async function ha(e){var t,s,n,i,o,r;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const a=E.getUser();try{const[d,l,h]=await Promise.all([c.clasificacion.division(),c.auth.me(),a!=null&&a.is_admin?c.leagues.adminAll():Promise.resolve({leagues:[]})]),p=l.user,v=p.status,f=p.total_points_all_time,$=(t=d.standings)==null?void 0:t.find(y=>y.user_id===p.id);e.innerHTML=`
    ...
    </div>`}async function Ea(e){var t,s;const a=e.querySelector("#predStatsWrap");if(a)try{const{total_predictions:n,correct_results:i,predictions:o}=await c.jornada.myStats();if(n===0){a.innerHTML='<p class="empty">Aún no tienes predicciones en esta temporada.</p>';return}const r=Math.round(i/n*100),d=50,l=+(2*Math.PI*d).toFixed(2),h=+(r/100*l).toFixed(2),p=+(l-h).toFixed(2);a.innerHTML=`
        ...
        <div class="pred-circle__chart">
          <svg viewBox="0 0 120 120" aria-hidden="true">
            ...
            <circle cx="60" cy="60" r="${d}" fill="none" stroke="#39FF14" stroke-width="12"
              stroke-dasharray="${h} ${p}" stroke-linecap="round"
    ...
    `,(t=a.querySelector("#predCircleBtn"))==null||t.addEventListener("click",()=>{Ee(o)}),(s=a.querySelector("#predCircleBtn"))==null||s.addEventListener("keydown",v=>{(v.key==="Enter"||v.key===" ")&&Ee(o)})}catch{a.innerHTML='<p class="empty">No se pudieron cargar las predicciones.</p>'}}function Ee(e){var i,o;let a="all";const t=document.createElement("div");t.className="pred-modal",t.innerHTML=`
  ...
  `}const R=20,Fe=5;let P={},U=0,ce=null,je=null,ee=[];async function Wa(e){e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const{jornadas:a}=await c.jornada.list();if(!a.length){e.innerHTML=Xa();return}const t=[...a].sort((i,o)=>i.jornada.number-o.jornada.number),s=t.findIndex(i=>i.jornada.status==="active"||i.jornada.status==="upcoming"),n=s>=0?s:t.length-1;Je(e,t,n)}catch(a){e.innerHTML=`<div class="container"><p class="form__error">Error cargando jornadas: ${a.message}</p></div>`}}function Je(e,a,t){var l,h;je=a[t];const{jornada:s,matches:n,units_used:i}=je;P={};for(const p of n)P[p.jornada_match_id]={predicted_result:((l=p.prediction)==null?void 0:l.predicted_result)??null,units:((h=p.prediction)==null?void 0:h.units_wagered)??0};U=i;const o=n.filter(p=>!p.predict_locked);ee=o,ce=o.length===1?o[0].jornada_match_id:null;const r=s.status==="finished",d=a.length>1?`<div class="jornada-tabs">
        ${a.map((p,v)=>{const f=p.jornada.status==="finished",{pts:$,cls:y}=et(p);return`
            <button class="jornada-tab jornada-tab--stacked ${v===t?"jornada-tab--active":""} ${f?"jornada-tab--finished":""}" data-idx="${v}">
              <span class="jornada-tab__num">J${p.jornada.number}</span>
  ...
  `,ze(),Ve(),_e(),st(e,a,t),Q(e),requestAnimationFrame(()=>{var p;(p=e.querySelector(".jornada-tab--active"))==null||p.scrollIntoView({block:"nearest",inline:"center"})})}function Xa(){return`
    <div class="container">
  ...
  `}function Le(e){return new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit"})}function Ka(e){return new Date(e).toLocaleString("es-ES",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}function le(e){return e!=null?e.toFixed(2):"—"}function Ya(e){return e.jm_status==="cancelled"?'<span class="tag tag--cancelled">Suspendido</span>':e.status==="finished"?`<span class="tag tag--done">Finalizado ${e.home_score_90??"?"}–${e.away_score_90??"?"}</span>`:e.predict_locked?'<span class="tag tag--locked">Bloqueado</span>':`<span class="tag tag--open">Abierto hasta ${Ka(e.opens_until)}</span>`}const Za=new Set(["r32","r16","quarters","semis","third","final","no_draw"]);function ue(e,a,t){const n={1:t.odds_1,X:t.odds_x,2:t.odds_2}[a];return n!=null?Math.round(e.units_wagered*parseFloat(n)*100)/100:e.points_earned??0}function Qa(e){let a=0,t=0,s=0;for(const o of e.matches){if(o.jm_status==="cancelled")continue;const r=o.prediction,d=o.status==="finished"&&o.result_90!=null;if(r&&r.units_wagered&&(a+=r.units_wagered),d){if(!r){s+=1;continue}r.predicted_result===o.result_90&&(t+=ue(r,o.result_90,o));continue}r&&r.units_wagered&&(t+=ue(r,r.predicted_result,o))}const n=Math.max(0,R-a),i=Math.max(0,t+n-s);return Math.round(i*100)/100}function et(e){const a=Qa(e),t=e.jornada.status;return{pts:a,cls:t==="finished"?"finished":t==="active"?"active":"upcoming"}}function at(e){if(e.jm_status==="cancelled")return"";const a=e.prediction;if(e.status==="finished"&&e.result_90!=null){if(!a)return'<span class="jornada-pts-label jornada-pts-label--penalty">-1 pt ⚠️</span>';if(a.predicted_result===e.result_90){const n=ue(a,e.result_90,e);return`<span class="jornada-pts-label jornada-pts-label--win">+${w(n)} pts</span>`}return'<span class="jornada-pts-label jornada-pts-label--loss">0 pts</span>'}if(!a||!a.units_wagered)return"";const s=e.predict_locked;return`<span class="jornada-pts-label jornada-pts-label--${s?"live":"pending"}">${a.units_wagered}u${s?" en juego":" apostadas"}</span>`}function tt(e){const a=e.jm_status==="cancelled",t=e.predict_locked,s=P[e.jornada_match_id]??{predicted_result:null,units:0},n=Za.has(e.phase);return`
...
¿Guardar igualmente?`))return;if(U>R){_(`Superas el máximo de ${R} unidades`,"error");return}const a=ee.filter(i=>{var o;return(o=P[i.jornada_match_id])==null?void 0:o.predicted_result});if(!a.length){_("No hay predicciones que guardar","error");return}const t=document.getElementById("jornadaSaveAllBtn");t&&(t.disabled=!0,t.textContent="Guardando…");const n=(await Promise.allSettled(a.map(i=>c.jornada.predict({jornada_match_id:i.jornada_match_id,predicted_result:P[i.jornada_match_id].predicted_result,units:P[i.jornada_match_id].units})))).filter(i=>i.status==="rejected").length;n===0?_(`${a.length} predicción${a.length!==1?"es":""} guardadas ✓`):_(`${n} error${n!==1?"es":""} al guardar`,"error"),t&&(t.disabled=!1,_e())}let te=null;function ge(){te&&(clearInterval(te),te=null)}const Se={en_curso:{label:"En curso",cls:"duelo-status--curso"},ganado:{label:"Ganaste",cls:"duelo-status--ganado"},perdido:{label:"Perdiste",cls:"duelo-status--perdido"},empate:{label:"Empate",cls:"duelo-status--empate"}},it={ganado:"🏆 Victoria",perdido:"💔 Derrota",empate:"🤝 Empate"};function ot(e){return e.is_bye?{icon:"",cls:""}:e.jornada_status==="active"||e.jornada_status==="upcoming"?{icon:e.my_points>e.rival_points?"✓":e.my_points<e.rival_points?"✗":"=",cls:"live"}:e.status==="ganado"?{icon:"✓",cls:"win"}:e.status==="perdido"?{icon:"✗",cls:"loss"}:e.status==="empate"?{icon:"=",cls:"draw"}:{icon:"",cls:""}}async function rt(e){ge(),e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';try{const[{duelos:a},t]=await Promise.all([c.duelo.list(),Promise.resolve(E.getUser())]);if(!a.length){e.innerHTML=`
      ...
      `;return}const s=a.findIndex(o=>o.jornada_status==="active"||o.jornada_status==="upcoming"),n=s>=0?s:a.length-1,i=a.map((o,r)=>{const{icon:d,cls:l}=ot(o),h=o.jornada_status==="finished"?"finished":o.jornada_status==="active"?"active":"upcoming",p=`${w(o.my_points)}-${o.is_bye?"—":w(o.rival_points)}`;return`
        <button class="jornada-tab jornada-tab--stacked ${r===n?"jornada-tab--active":""}" data-idx="${r}">
          ...
          <span class="jornada-tab__pts jornada-tab__pts--${h}">
            ${p}${d?` <span class="jornada-tab__result jornada-tab__result--${l}">${d}</span>`:""}
          </span>
        </button>
      `}).join("");e.innerHTML=`
      <div class="container">
  ...
  `}function lt(e,a,t){var L;const s=((L=e.rival)==null?void 0:L.username)??(e.is_bye?"Descanso":"—"),n=it[e.status],i=(a==null?void 0:a.matches)??[];let o=0,r=0,d=0,l=0;for(const b of i)b.jm_status!=="cancelled"&&(b.my_prediction?(d+=b.my_prediction.units_wagered,b.status==="finished"&&b.result_90!=null&&(r+=b.my_prediction.points_earned??0,b.my_prediction.predicted_result===b.result_90&&o++)):b.status==="finished"&&b.result_90!=null&&l++);const h=20-d,p=o>=10?10:o>=9?5:o>=8?2:0,v=o>=10;function f(b){if(!b.result_90)return"—";const g={1:b.odds_1,X:b.odds_x,2:b.odds_2}[b.result_90];return g!=null?parseFloat(g).toFixed(2):"—"}function $(b,u){return u?b?b.predicted_result===u?`<span class="pts-label pts-label--win">+${w(b.points_earned??0)} pts</span>`:'<span class="pts-label pts-label--loss">0 pts</span>':'<span class="pts-label pts-label--penalty">-1 pt</span>':"—"}const y=i.map(b=>{const u=b.my_prediction?`${b.my_prediction.predicted_result} · ${b.my_prediction.units_wagered}u`:"—",g=b.rival_prediction?`${b.rival_prediction.predicted_result} · ${b.rival_prediction.units_wagered}u`:b.started?"—":"?",k=b.result_90!=null?`${b.home_score_90??"?"}–${b.away_score_90??"?"} (${b.result_90})`:"—";return`
    ...
    <tr class="duelo-breakdown__footer-row">
      <td colspan="5" class="duelo-breakdown__total-label">
        ${v?"🎯 ¡Pleno! ":""}Bonus (${o}/10 aciertos)
      </td>
      <td class="duelo-breakdown__pts duelo-breakdown__pts--bonus" colspan="2">+${p} pts</td>
    </tr>`:""}
  ...
  `}async function Et(e,a){var s;e.innerHTML='<div class="loading"><div class="loading__spinner"></div></div>';const t=E.getUser();try{const{messages:n,partner:i}=await c.messages.get(a);document.dispatchEvent(new CustomEvent("messages:read")),e.innerHTML=`
    ...
    `;const o=document.getElementById("chatMessages");o&&(o.scrollTop=o.scrollHeight),(s=document.getElementById("chatForm"))==null||s.addEventListener("submit",async r=>{r.preventDefault();const d=document.getElementById("chatMsg"),l=d.value.trim();if(!l)return;const h=r.target.querySelector('button[type="submit"]');h.disabled=!0;try{const{message:p}=await c.messages.send(a,l);d.value="";const v=document.getElementById("chatMessages"),f=v==null?void 0:v.querySelector(".empty");f&&f.remove(),v==null||v.insertAdjacentHTML("beforeend",Te(p,t)),v&&(v.scrollTop=v.scrollHeight)}catch(p){_(p.message,"error")}finally{h.disabled=!1}})}catch(n){e.innerHTML=`<div class="container"><p class="form__error">Error: ${n.message}</p></div>`}}function Te(e,a){return`
